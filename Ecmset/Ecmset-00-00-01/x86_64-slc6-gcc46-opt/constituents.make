...
#cmt_local_tagfile = $(Ecmset_tag).make
cmt_local_tagfile = $(bin)$(Ecmset_tag).make
...
cmt_local_setup_Ecmset = $(bin)setup_Ecmset$$$$.make
...
Ecmset_extratags = -tag_add=target_Ecmset

#$(cmt_local_tagfile_Ecmset) : $(cmt_lock_setup)
ifndef QUICK
$(cmt_local_tagfile_Ecmset) ::
else
$(cmt_local_tagfile_Ecmset) :
endif
	$(echo) "(constituents.make) Rebuilding $@"; \
	  if test -f $(cmt_local_tagfile_Ecmset); then /bin/rm -f $(cmt_local_tagfile_Ecmset); fi ; \
	  $(cmtexe) -tag=$(tags) $(Ecmset_extratags) build tag_makefile >>$(cmt_local_tagfile_Ecmset)
	$(echo) "(constituents.make) Rebuilding $(cmt_final_setup_Ecmset)"; \
	  test ! -f $(cmt_local_setup_Ecmset) || \rm -f $(cmt_local_setup_Ecmset); \
	  trap '\rm -f $(cmt_local_setup_Ecmset)' 0 1 2 15; \
	  $(cmtexe) -tag=$(tags) $(Ecmset_extratags) show setup >$(cmt_local_setup_Ecmset) && \
	  if [ -f $(cmt_final_setup_Ecmset) ] && \
	    \cmp -s $(cmt_final_setup_Ecmset) $(cmt_local_setup_Ecmset); then \
	    \rm $(cmt_local_setup_Ecmset); else \
	    \mv -f $(cmt_local_setup_Ecmset) $(cmt_final_setup_Ecmset); fi
...
not_Ecmset_dependencies = { n=0; for p in $?; do m=0; for d in $(Ecmset_dependencies); do if [ $$p = $$d ]; then m=1; break; fi; done; if [ $$m -eq 0 ]; then n=1; break; fi; done; [ $$n -eq 1 ]; }

ifdef STRUCTURED_OUTPUT
Ecmsetdirs :
	@if test ! -d $(bin)Ecmset; then $(mkdir) -p $(bin)Ecmset; fi
	$(echo) "STRUCTURED_OUTPUT="$(bin)Ecmset
else
Ecmsetdirs : ;
endif
...
#	$(echo) "STRUCTURED_OUTPUT="$(bin)Ecmset
#
#$(cmt_local_Ecmset_makefile) :: $(Ecmset_dependencies) $(cmt_local_tagfile_Ecmset) build_library_links dirs Ecmsetdirs
#else
#$(cmt_local_Ecmset_makefile) :: $(Ecmset_dependencies) $(cmt_local_tagfile_Ecmset) build_library_links dirs
#endif
#else
#$(cmt_local_Ecmset_makefile) :: $(cmt_local_tagfile_Ecmset)
#endif

ifdef cmt_Ecmset_has_target_tag

ifndef QUICK
$(cmt_local_Ecmset_makefile) : $(Ecmset_dependencies) build_library_links
	$(echo) "(constituents.make) Building Ecmset.make"; \
	  $(cmtexe) -tag=$(tags) $(Ecmset_extratags) build constituent_config -out=$(cmt_local_Ecmset_makefile) Ecmset
else
$(cmt_local_Ecmset_makefile) : $(Ecmset_dependencies) $(cmt_build_library_linksstamp) $(use_requirements)
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_Ecmset) ] || \
	  [ ! -f $(cmt_final_setup_Ecmset) ] || \
	  $(not_Ecmset_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
	  echo "$(CMTMSGPREFIX)" "(constituents.make) Building Ecmset.make"; \
	  $(cmtexe) -tag=$(tags) $(Ecmset_extratags) build constituent_config -out=$(cmt_local_Ecmset_makefile) Ecmset; \
	  fi
endif
...
$(cmt_local_Ecmset_makefile) : $(Ecmset_dependencies) build_library_links
	$(echo) "(constituents.make) Building Ecmset.make"; \
	  $(cmtexe) -f=$(bin)Ecmset.in -tag=$(tags) $(Ecmset_extratags) build constituent_makefile -without_cmt -out=$(cmt_local_Ecmset_makefile) Ecmset
else
$(cmt_local_Ecmset_makefile) : $(Ecmset_dependencies) $(cmt_build_library_linksstamp) $(bin)Ecmset.in
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_Ecmset) ] || \
	  [ ! -f $(cmt_final_setup_Ecmset) ] || \
	  $(not_Ecmset_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
...
#	  $(cmtexe) -tag=$(tags) $(Ecmset_extratags) build constituent_makefile -out=$(cmt_local_Ecmset_makefile) Ecmset

Ecmset :: $(Ecmset_dependencies) $(cmt_local_Ecmset_makefile) dirs Ecmsetdirs
	$(echo) "(constituents.make) Starting Ecmset"
	@if test -f $(cmt_local_Ecmset_makefile); then \
	  $(MAKE) -f $(cmt_local_Ecmset_makefile) Ecmset; \
	  fi
#	@$(MAKE) -f $(cmt_local_Ecmset_makefile) Ecmset
	$(echo) "(constituents.make) Ecmset done"

clean :: Ecmsetclean

Ecmsetclean :: $(Ecmsetclean_dependencies) ##$(cmt_local_Ecmset_makefile)
	$(echo) "(constituents.make) Starting Ecmsetclean"
	@-if test -f $(cmt_local_Ecmset_makefile); then \
	  $(MAKE) -f $(cmt_local_Ecmset_makefile) Ecmsetclean; \
	fi
	$(echo) "(constituents.make) Ecmsetclean done"
#	@-$(MAKE) -f $(cmt_local_Ecmset_makefile) Ecmsetclean

##	  /bin/rm -f $(cmt_local_Ecmset_makefile) $(bin)Ecmset_dependencies.make

install :: Ecmsetinstall

Ecmsetinstall :: $(Ecmset_dependencies) $(cmt_local_Ecmset_makefile)
	$(echo) "(constituents.make) Starting install Ecmset"
	@-$(MAKE) -f $(cmt_local_Ecmset_makefile) install
	$(echo) "(constituents.make) install Ecmset done"

uninstall : Ecmsetuninstall

$(foreach d,$(Ecmset_dependencies),$(eval $(d)uninstall_dependencies += Ecmsetuninstall))

Ecmsetuninstall : $(Ecmsetuninstall_dependencies) ##$(cmt_local_Ecmset_makefile)
	$(echo) "(constituents.make) Starting uninstall Ecmset"
	@if test -f $(cmt_local_Ecmset_makefile); then \
	  $(MAKE) -f $(cmt_local_Ecmset_makefile) uninstall; \
	  fi
#	@$(MAKE) -f $(cmt_local_Ecmset_makefile) uninstall
	$(echo) "(constituents.make) uninstall Ecmset done"

remove_library_links :: Ecmsetuninstall
...
#cmt_local_tagfile_config = $(Ecmset_tag)_config.make
cmt_local_tagfile_config = $(bin)$(Ecmset_tag)_config.make
cmt_local_setup_config = $(bin)setup_config$$$$.make
cmt_final_setup_config = $(bin)setup_config.make
#cmt_final_setup_config = $(bin)Ecmset_configsetup.make
...
#cmt_local_tagfile_config = $(Ecmset_tag).make
cmt_local_tagfile_config = $(bin)$(Ecmset_tag).make
cmt_final_setup_config = $(bin)setup.make
#cmt_final_setup_config = $(bin)Ecmsetsetup.make
cmt_local_config_makefile = $(bin)config.make
...
#cmt_local_tagfile_install_includes = $(Ecmset_tag)_install_includes.make
cmt_local_tagfile_install_includes = $(bin)$(Ecmset_tag)_install_includes.make
...
#cmt_final_setup_install_includes = $(bin)Ecmset_install_includessetup.make
...
#cmt_local_tagfile_install_includes = $(Ecmset_tag).make
cmt_local_tagfile_install_includes = $(bin)$(Ecmset_tag).make
cmt_final_setup_install_includes = $(bin)setup.make
#cmt_final_setup_install_includes = $(bin)Ecmsetsetup.make
cmt_local_install_includes_makefile = $(bin)install_includes.make
...
#cmt_local_tagfile_make = $(Ecmset_tag)_make.make
cmt_local_tagfile_make = $(bin)$(Ecmset_tag)_make.make
cmt_local_setup_make = $(bin)setup_make$$$$.make
cmt_final_setup_make = $(bin)setup_make.make
#cmt_final_setup_make = $(bin)Ecmset_makesetup.make
...
#cmt_local_tagfile_make = $(Ecmset_tag).make
cmt_local_tagfile_make = $(bin)$(Ecmset_tag).make
cmt_final_setup_make = $(bin)setup.make
#cmt_final_setup_make = $(bin)Ecmsetsetup.make
cmt_local_make_makefile = $(bin)make.make
...
#cmt_local_tagfile_CompilePython = $(Ecmset_tag)_CompilePython.make
cmt_local_tagfile_CompilePython = $(bin)$(Ecmset_tag)_CompilePython.make
cmt_local_setup_CompilePython = $(bin)setup_CompilePython$$$$.make
cmt_final_setup_CompilePython = $(bin)setup_CompilePython.make
#cmt_final_setup_CompilePython = $(bin)Ecmset_CompilePythonsetup.make
...
#cmt_local_tagfile_CompilePython = $(Ecmset_tag).make
cmt_local_tagfile_CompilePython = $(bin)$(Ecmset_tag).make
cmt_final_setup_CompilePython = $(bin)setup.make
#cmt_final_setup_CompilePython = $(bin)Ecmsetsetup.make
cmt_local_CompilePython_makefile = $(bin)CompilePython.make
...
#cmt_local_tagfile_qmtest_run = $(Ecmset_tag)_qmtest_run.make
cmt_local_tagfile_qmtest_run = $(bin)$(Ecmset_tag)_qmtest_run.make
cmt_local_setup_qmtest_run = $(bin)setup_qmtest_run$$$$.make
cmt_final_setup_qmtest_run = $(bin)setup_qmtest_run.make
#cmt_final_setup_qmtest_run = $(bin)Ecmset_qmtest_runsetup.make
...
#cmt_local_tagfile_qmtest_run = $(Ecmset_tag).make
cmt_local_tagfile_qmtest_run = $(bin)$(Ecmset_tag).make
cmt_final_setup_qmtest_run = $(bin)setup.make
#cmt_final_setup_qmtest_run = $(bin)Ecmsetsetup.make
cmt_local_qmtest_run_makefile = $(bin)qmtest_run.make
...
#cmt_local_tagfile_qmtest_summarize = $(Ecmset_tag)_qmtest_summarize.make
cmt_local_tagfile_qmtest_summarize = $(bin)$(Ecmset_tag)_qmtest_summarize.make
...
#cmt_final_setup_qmtest_summarize = $(bin)Ecmset_qmtest_summarizesetup.make
...
#cmt_local_tagfile_qmtest_summarize = $(Ecmset_tag).make
cmt_local_tagfile_qmtest_summarize = $(bin)$(Ecmset_tag).make
cmt_final_setup_qmtest_summarize = $(bin)setup.make
#cmt_final_setup_qmtest_summarize = $(bin)Ecmsetsetup.make
cmt_local_qmtest_summarize_makefile = $(bin)qmtest_summarize.make
...
#cmt_local_tagfile_TestPackage = $(Ecmset_tag)_TestPackage.make
cmt_local_tagfile_TestPackage = $(bin)$(Ecmset_tag)_TestPackage.make
cmt_local_setup_TestPackage = $(bin)setup_TestPackage$$$$.make
cmt_final_setup_TestPackage = $(bin)setup_TestPackage.make
#cmt_final_setup_TestPackage = $(bin)Ecmset_TestPackagesetup.make
...
#cmt_local_tagfile_TestPackage = $(Ecmset_tag).make
cmt_local_tagfile_TestPackage = $(bin)$(Ecmset_tag).make
cmt_final_setup_TestPackage = $(bin)setup.make
#cmt_final_setup_TestPackage = $(bin)Ecmsetsetup.make
cmt_local_TestPackage_makefile = $(bin)TestPackage.make
...
#cmt_local_tagfile_TestProject = $(Ecmset_tag)_TestProject.make
cmt_local_tagfile_TestProject = $(bin)$(Ecmset_tag)_TestProject.make
cmt_local_setup_TestProject = $(bin)setup_TestProject$$$$.make
cmt_final_setup_TestProject = $(bin)setup_TestProject.make
#cmt_final_setup_TestProject = $(bin)Ecmset_TestProjectsetup.make
...
#cmt_local_tagfile_TestProject = $(Ecmset_tag).make
cmt_local_tagfile_TestProject = $(bin)$(Ecmset_tag).make
cmt_final_setup_TestProject = $(bin)setup.make
#cmt_final_setup_TestProject = $(bin)Ecmsetsetup.make
cmt_local_TestProject_makefile = $(bin)TestProject.make
...
#cmt_local_tagfile_new_rootsys = $(Ecmset_tag)_new_rootsys.make
cmt_local_tagfile_new_rootsys = $(bin)$(Ecmset_tag)_new_rootsys.make
cmt_local_setup_new_rootsys = $(bin)setup_new_rootsys$$$$.make
cmt_final_setup_new_rootsys = $(bin)setup_new_rootsys.make
#cmt_final_setup_new_rootsys = $(bin)Ecmset_new_rootsyssetup.make
...
#cmt_local_tagfile_new_rootsys = $(Ecmset_tag).make
cmt_local_tagfile_new_rootsys = $(bin)$(Ecmset_tag).make
cmt_final_setup_new_rootsys = $(bin)setup.make
#cmt_final_setup_new_rootsys = $(bin)Ecmsetsetup.make
cmt_local_new_rootsys_makefile = $(bin)new_rootsys.make
...
#cmt_local_tagfile_DatabaseSvc_check_install_scripts = $(Ecmset_tag)_DatabaseSvc_check_install_scripts.make
cmt_local_tagfile_DatabaseSvc_check_install_scripts = $(bin)$(Ecmset_tag)_DatabaseSvc_check_install_scripts.make
...
#cmt_final_setup_DatabaseSvc_check_install_scripts = $(bin)Ecmset_DatabaseSvc_check_install_scriptssetup.make
...
#cmt_local_tagfile_DatabaseSvc_check_install_scripts = $(Ecmset_tag).make
cmt_local_tagfile_DatabaseSvc_check_install_scripts = $(bin)$(Ecmset_tag).make
cmt_final_setup_DatabaseSvc_check_install_scripts = $(bin)setup.make
#cmt_final_setup_DatabaseSvc_check_install_scripts = $(bin)Ecmsetsetup.make
cmt_local_DatabaseSvc_check_install_scripts_makefile = $(bin)DatabaseSvc_check_install_scripts.make
