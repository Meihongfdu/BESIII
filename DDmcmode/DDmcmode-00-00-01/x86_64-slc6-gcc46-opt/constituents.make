...
#cmt_local_tagfile = $(DDmcmode_tag).make
cmt_local_tagfile = $(bin)$(DDmcmode_tag).make
...
cmt_local_setup_DDmcmode = $(bin)setup_DDmcmode$$$$.make
...
DDmcmode_extratags = -tag_add=target_DDmcmode

#$(cmt_local_tagfile_DDmcmode) : $(cmt_lock_setup)
ifndef QUICK
$(cmt_local_tagfile_DDmcmode) ::
else
$(cmt_local_tagfile_DDmcmode) :
endif
	$(echo) "(constituents.make) Rebuilding $@"; \
	  if test -f $(cmt_local_tagfile_DDmcmode); then /bin/rm -f $(cmt_local_tagfile_DDmcmode); fi ; \
	  $(cmtexe) -tag=$(tags) $(DDmcmode_extratags) build tag_makefile >>$(cmt_local_tagfile_DDmcmode)
	$(echo) "(constituents.make) Rebuilding $(cmt_final_setup_DDmcmode)"; \
	  test ! -f $(cmt_local_setup_DDmcmode) || \rm -f $(cmt_local_setup_DDmcmode); \
	  trap '\rm -f $(cmt_local_setup_DDmcmode)' 0 1 2 15; \
	  $(cmtexe) -tag=$(tags) $(DDmcmode_extratags) show setup >$(cmt_local_setup_DDmcmode) && \
	  if [ -f $(cmt_final_setup_DDmcmode) ] && \
	    \cmp -s $(cmt_final_setup_DDmcmode) $(cmt_local_setup_DDmcmode); then \
	    \rm $(cmt_local_setup_DDmcmode); else \
	    \mv -f $(cmt_local_setup_DDmcmode) $(cmt_final_setup_DDmcmode); fi
...
not_DDmcmode_dependencies = { n=0; for p in $?; do m=0; for d in $(DDmcmode_dependencies); do if [ $$p = $$d ]; then m=1; break; fi; done; if [ $$m -eq 0 ]; then n=1; break; fi; done; [ $$n -eq 1 ]; }

ifdef STRUCTURED_OUTPUT
DDmcmodedirs :
	@if test ! -d $(bin)DDmcmode; then $(mkdir) -p $(bin)DDmcmode; fi
	$(echo) "STRUCTURED_OUTPUT="$(bin)DDmcmode
else
DDmcmodedirs : ;
endif
...
#	$(echo) "STRUCTURED_OUTPUT="$(bin)DDmcmode
#
#$(cmt_local_DDmcmode_makefile) :: $(DDmcmode_dependencies) $(cmt_local_tagfile_DDmcmode) build_library_links dirs DDmcmodedirs
#else
#$(cmt_local_DDmcmode_makefile) :: $(DDmcmode_dependencies) $(cmt_local_tagfile_DDmcmode) build_library_links dirs
#endif
#else
#$(cmt_local_DDmcmode_makefile) :: $(cmt_local_tagfile_DDmcmode)
#endif

ifdef cmt_DDmcmode_has_target_tag

ifndef QUICK
$(cmt_local_DDmcmode_makefile) : $(DDmcmode_dependencies) build_library_links
	$(echo) "(constituents.make) Building DDmcmode.make"; \
	  $(cmtexe) -tag=$(tags) $(DDmcmode_extratags) build constituent_config -out=$(cmt_local_DDmcmode_makefile) DDmcmode
else
$(cmt_local_DDmcmode_makefile) : $(DDmcmode_dependencies) $(cmt_build_library_linksstamp) $(use_requirements)
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_DDmcmode) ] || \
	  [ ! -f $(cmt_final_setup_DDmcmode) ] || \
	  $(not_DDmcmode_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
	  echo "$(CMTMSGPREFIX)" "(constituents.make) Building DDmcmode.make"; \
	  $(cmtexe) -tag=$(tags) $(DDmcmode_extratags) build constituent_config -out=$(cmt_local_DDmcmode_makefile) DDmcmode; \
	  fi
endif
...
$(cmt_local_DDmcmode_makefile) : $(DDmcmode_dependencies) build_library_links
	$(echo) "(constituents.make) Building DDmcmode.make"; \
	  $(cmtexe) -f=$(bin)DDmcmode.in -tag=$(tags) $(DDmcmode_extratags) build constituent_makefile -without_cmt -out=$(cmt_local_DDmcmode_makefile) DDmcmode
else
$(cmt_local_DDmcmode_makefile) : $(DDmcmode_dependencies) $(cmt_build_library_linksstamp) $(bin)DDmcmode.in
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_DDmcmode) ] || \
	  [ ! -f $(cmt_final_setup_DDmcmode) ] || \
	  $(not_DDmcmode_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
...
#	  $(cmtexe) -tag=$(tags) $(DDmcmode_extratags) build constituent_makefile -out=$(cmt_local_DDmcmode_makefile) DDmcmode

DDmcmode :: $(DDmcmode_dependencies) $(cmt_local_DDmcmode_makefile) dirs DDmcmodedirs
	$(echo) "(constituents.make) Starting DDmcmode"
	@if test -f $(cmt_local_DDmcmode_makefile); then \
	  $(MAKE) -f $(cmt_local_DDmcmode_makefile) DDmcmode; \
	  fi
#	@$(MAKE) -f $(cmt_local_DDmcmode_makefile) DDmcmode
	$(echo) "(constituents.make) DDmcmode done"

clean :: DDmcmodeclean

DDmcmodeclean :: $(DDmcmodeclean_dependencies) ##$(cmt_local_DDmcmode_makefile)
	$(echo) "(constituents.make) Starting DDmcmodeclean"
	@-if test -f $(cmt_local_DDmcmode_makefile); then \
	  $(MAKE) -f $(cmt_local_DDmcmode_makefile) DDmcmodeclean; \
	fi
	$(echo) "(constituents.make) DDmcmodeclean done"
#	@-$(MAKE) -f $(cmt_local_DDmcmode_makefile) DDmcmodeclean

##	  /bin/rm -f $(cmt_local_DDmcmode_makefile) $(bin)DDmcmode_dependencies.make

install :: DDmcmodeinstall

DDmcmodeinstall :: $(DDmcmode_dependencies) $(cmt_local_DDmcmode_makefile)
	$(echo) "(constituents.make) Starting install DDmcmode"
	@-$(MAKE) -f $(cmt_local_DDmcmode_makefile) install
	$(echo) "(constituents.make) install DDmcmode done"

uninstall : DDmcmodeuninstall

$(foreach d,$(DDmcmode_dependencies),$(eval $(d)uninstall_dependencies += DDmcmodeuninstall))

DDmcmodeuninstall : $(DDmcmodeuninstall_dependencies) ##$(cmt_local_DDmcmode_makefile)
	$(echo) "(constituents.make) Starting uninstall DDmcmode"
	@if test -f $(cmt_local_DDmcmode_makefile); then \
	  $(MAKE) -f $(cmt_local_DDmcmode_makefile) uninstall; \
	  fi
#	@$(MAKE) -f $(cmt_local_DDmcmode_makefile) uninstall
	$(echo) "(constituents.make) uninstall DDmcmode done"

remove_library_links :: DDmcmodeuninstall
...
#cmt_local_tagfile_config = $(DDmcmode_tag)_config.make
cmt_local_tagfile_config = $(bin)$(DDmcmode_tag)_config.make
cmt_local_setup_config = $(bin)setup_config$$$$.make
cmt_final_setup_config = $(bin)setup_config.make
#cmt_final_setup_config = $(bin)DDmcmode_configsetup.make
...
#cmt_local_tagfile_config = $(DDmcmode_tag).make
cmt_local_tagfile_config = $(bin)$(DDmcmode_tag).make
cmt_final_setup_config = $(bin)setup.make
#cmt_final_setup_config = $(bin)DDmcmodesetup.make
cmt_local_config_makefile = $(bin)config.make
...
#cmt_local_tagfile_install_includes = $(DDmcmode_tag)_install_includes.make
cmt_local_tagfile_install_includes = $(bin)$(DDmcmode_tag)_install_includes.make
...
#cmt_final_setup_install_includes = $(bin)DDmcmode_install_includessetup.make
...
#cmt_local_tagfile_install_includes = $(DDmcmode_tag).make
cmt_local_tagfile_install_includes = $(bin)$(DDmcmode_tag).make
cmt_final_setup_install_includes = $(bin)setup.make
#cmt_final_setup_install_includes = $(bin)DDmcmodesetup.make
cmt_local_install_includes_makefile = $(bin)install_includes.make
...
#cmt_local_tagfile_make = $(DDmcmode_tag)_make.make
cmt_local_tagfile_make = $(bin)$(DDmcmode_tag)_make.make
cmt_local_setup_make = $(bin)setup_make$$$$.make
cmt_final_setup_make = $(bin)setup_make.make
#cmt_final_setup_make = $(bin)DDmcmode_makesetup.make
...
#cmt_local_tagfile_make = $(DDmcmode_tag).make
cmt_local_tagfile_make = $(bin)$(DDmcmode_tag).make
cmt_final_setup_make = $(bin)setup.make
#cmt_final_setup_make = $(bin)DDmcmodesetup.make
cmt_local_make_makefile = $(bin)make.make
...
#cmt_local_tagfile_CompilePython = $(DDmcmode_tag)_CompilePython.make
cmt_local_tagfile_CompilePython = $(bin)$(DDmcmode_tag)_CompilePython.make
cmt_local_setup_CompilePython = $(bin)setup_CompilePython$$$$.make
cmt_final_setup_CompilePython = $(bin)setup_CompilePython.make
#cmt_final_setup_CompilePython = $(bin)DDmcmode_CompilePythonsetup.make
...
#cmt_local_tagfile_CompilePython = $(DDmcmode_tag).make
cmt_local_tagfile_CompilePython = $(bin)$(DDmcmode_tag).make
cmt_final_setup_CompilePython = $(bin)setup.make
#cmt_final_setup_CompilePython = $(bin)DDmcmodesetup.make
cmt_local_CompilePython_makefile = $(bin)CompilePython.make
...
#cmt_local_tagfile_qmtest_run = $(DDmcmode_tag)_qmtest_run.make
cmt_local_tagfile_qmtest_run = $(bin)$(DDmcmode_tag)_qmtest_run.make
cmt_local_setup_qmtest_run = $(bin)setup_qmtest_run$$$$.make
cmt_final_setup_qmtest_run = $(bin)setup_qmtest_run.make
#cmt_final_setup_qmtest_run = $(bin)DDmcmode_qmtest_runsetup.make
...
#cmt_local_tagfile_qmtest_run = $(DDmcmode_tag).make
cmt_local_tagfile_qmtest_run = $(bin)$(DDmcmode_tag).make
cmt_final_setup_qmtest_run = $(bin)setup.make
#cmt_final_setup_qmtest_run = $(bin)DDmcmodesetup.make
cmt_local_qmtest_run_makefile = $(bin)qmtest_run.make
...
#cmt_local_tagfile_qmtest_summarize = $(DDmcmode_tag)_qmtest_summarize.make
cmt_local_tagfile_qmtest_summarize = $(bin)$(DDmcmode_tag)_qmtest_summarize.make
...
#cmt_final_setup_qmtest_summarize = $(bin)DDmcmode_qmtest_summarizesetup.make
...
#cmt_local_tagfile_qmtest_summarize = $(DDmcmode_tag).make
cmt_local_tagfile_qmtest_summarize = $(bin)$(DDmcmode_tag).make
cmt_final_setup_qmtest_summarize = $(bin)setup.make
#cmt_final_setup_qmtest_summarize = $(bin)DDmcmodesetup.make
cmt_local_qmtest_summarize_makefile = $(bin)qmtest_summarize.make
...
#cmt_local_tagfile_TestPackage = $(DDmcmode_tag)_TestPackage.make
cmt_local_tagfile_TestPackage = $(bin)$(DDmcmode_tag)_TestPackage.make
cmt_local_setup_TestPackage = $(bin)setup_TestPackage$$$$.make
cmt_final_setup_TestPackage = $(bin)setup_TestPackage.make
#cmt_final_setup_TestPackage = $(bin)DDmcmode_TestPackagesetup.make
...
#cmt_local_tagfile_TestPackage = $(DDmcmode_tag).make
cmt_local_tagfile_TestPackage = $(bin)$(DDmcmode_tag).make
cmt_final_setup_TestPackage = $(bin)setup.make
#cmt_final_setup_TestPackage = $(bin)DDmcmodesetup.make
cmt_local_TestPackage_makefile = $(bin)TestPackage.make
...
#cmt_local_tagfile_TestProject = $(DDmcmode_tag)_TestProject.make
cmt_local_tagfile_TestProject = $(bin)$(DDmcmode_tag)_TestProject.make
cmt_local_setup_TestProject = $(bin)setup_TestProject$$$$.make
cmt_final_setup_TestProject = $(bin)setup_TestProject.make
#cmt_final_setup_TestProject = $(bin)DDmcmode_TestProjectsetup.make
...
#cmt_local_tagfile_TestProject = $(DDmcmode_tag).make
cmt_local_tagfile_TestProject = $(bin)$(DDmcmode_tag).make
cmt_final_setup_TestProject = $(bin)setup.make
#cmt_final_setup_TestProject = $(bin)DDmcmodesetup.make
cmt_local_TestProject_makefile = $(bin)TestProject.make
...
#cmt_local_tagfile_new_rootsys = $(DDmcmode_tag)_new_rootsys.make
cmt_local_tagfile_new_rootsys = $(bin)$(DDmcmode_tag)_new_rootsys.make
cmt_local_setup_new_rootsys = $(bin)setup_new_rootsys$$$$.make
cmt_final_setup_new_rootsys = $(bin)setup_new_rootsys.make
#cmt_final_setup_new_rootsys = $(bin)DDmcmode_new_rootsyssetup.make
...
#cmt_local_tagfile_new_rootsys = $(DDmcmode_tag).make
cmt_local_tagfile_new_rootsys = $(bin)$(DDmcmode_tag).make
cmt_final_setup_new_rootsys = $(bin)setup.make
#cmt_final_setup_new_rootsys = $(bin)DDmcmodesetup.make
cmt_local_new_rootsys_makefile = $(bin)new_rootsys.make
...
#cmt_local_tagfile_DatabaseSvc_check_install_scripts = $(DDmcmode_tag)_DatabaseSvc_check_install_scripts.make
cmt_local_tagfile_DatabaseSvc_check_install_scripts = $(bin)$(DDmcmode_tag)_DatabaseSvc_check_install_scripts.make
...
#cmt_final_setup_DatabaseSvc_check_install_scripts = $(bin)DDmcmode_DatabaseSvc_check_install_scriptssetup.make
...
#cmt_local_tagfile_DatabaseSvc_check_install_scripts = $(DDmcmode_tag).make
cmt_local_tagfile_DatabaseSvc_check_install_scripts = $(bin)$(DDmcmode_tag).make
cmt_final_setup_DatabaseSvc_check_install_scripts = $(bin)setup.make
#cmt_final_setup_DatabaseSvc_check_install_scripts = $(bin)DDmcmodesetup.make
cmt_local_DatabaseSvc_check_install_scripts_makefile = $(bin)DatabaseSvc_check_install_scripts.make
