...
#endif
#include "mmppetapAlg/util/MyIsPID.h"
#include "mmppetapAlg/util/MyUtil.h"
#include "mmppetapAlg/util/MyInitIP.h"
#include "mmppetapAlg/util/MyIsGoodtrack.h"
#include "mmppetapAlg/util/MyTrk.h"
...
#include "mmppetapAlg/mmppetapAlg.h"
...
const double mmu  = 0.1056584;
typedef std::vector<int> Vint;
typedef std::vector<HepLorentzVector> Vp4;

int Ncut[10];
////////////:///////////////////////////////////////////////////////////////
mmppetapAlg::mmppetapAlg(const std::string& name, ISvcLocator* pSvcLocator) :
...
//########################################################################
StatusCode mmppetapAlg::initialize(){
    ...
    if ( nt1 ) m_tuple1 = nt1;
        ...
        if ( m_tuple1 ){
            ...
            m_tuple1->addItem ("mctrue_meppimetap_4c",                    m_mctrue_meppimetap_4c);
            m_tuple1->addItem ("mctrue_mempipetap_4c",                    m_mctrue_mempipetap_4c);
            m_tuple1->addItem ("mctrue_meeetap_4c",                    m_mctrue_meeetap_4c);
            m_tuple1->addItem ("mctrue_mee_4c",                    m_mctruth_ee_4c);
            m_tuple1->addItem ("mctrue_epim_4c",                    m_mctruth_epim_4c);
            m_tuple1->addItem ("mctrue_epip_4c",                    m_mctruth_epip_4c);
    ...
    if ( nt2 ) m_tuple2 = nt2;
        ...
        if ( m_tuple2 ){
            ...
            m_tuple2->addItem ("ngam",              m_ngam,      0, 10000 );
           ...
           // m_tuple2->addItem ("mgam0ee_allcomb_5c",      m_ncomb_pi0_ppe,  m_mgam0ee_allcomb_5c );
            ...
            m_tuple2->addItem ("numpion",  m_npion);
             ...
             m_tuple2->addItem ("E1",  E1);
             m_tuple2->addItem ("E2",  E2);
             m_tuple2->addItem ("E3",  E3);
             m_tuple2->addItem ("E4",  E4);
             m_tuple2->addItem ("E5",  E5);
             m_tuple2->addItem ("E6",  E6);
             m_tuple2->addItem ("ep1",  ep1);
             m_tuple2->addItem ("ep2",  ep2);
             m_tuple2->addItem ("ep3",  ep3);
             m_tuple2->addItem ("ep4",  ep4);
             m_tuple2->addItem ("ep5",  ep5);
             m_tuple2->addItem ("ep6",  ep6);
             m_tuple2->addItem ("trk1p",  trk1p);
             m_tuple2->addItem ("trk2p",  trk2p);
             m_tuple2->addItem ("trk3p",  trk3p);
             m_tuple2->addItem ("trk4p",  trk4p);
             m_tuple2->addItem ("trk5p",  trk5p);
             m_tuple2->addItem ("trk6p",  trk6p);

            m_tuple2->addItem ("mu1_Lay",  m_mu1_Lay);
            m_tuple2->addItem ("mu2_Lay",  m_mu2_Lay);
            m_tuple2->addItem ("mu3_Lay",  m_mu3_Lay);
            m_tuple2->addItem ("mu4_Lay",  m_mu4_Lay);
            m_tuple2->addItem ("mu5_Lay",  m_mu5_Lay);
            m_tuple2->addItem ("mu6_Lay",  m_mu6_Lay);
            m_tuple2->addItem ("mu1_Dep",  m_mu1_Dep);
            m_tuple2->addItem ("mu2_Dep",  m_mu2_Dep);
            m_tuple2->addItem ("mu3_Dep",  m_mu3_Dep);
            m_tuple2->addItem ("mu4_Dep",  m_mu4_Dep);
            m_tuple2->addItem ("mu5_Dep",  m_mu5_Dep);
            m_tuple2->addItem ("mu6_Dep",  m_mu6_Dep);
            m_tuple2->addItem ("mu1_Nhits",  m_mu1_Nhits);
            m_tuple2->addItem ("mu2_Nhits",  m_mu2_Nhits);
            m_tuple2->addItem ("mu3_Nhits",  m_mu3_Nhits);
            m_tuple2->addItem ("mu4_Nhits",  m_mu4_Nhits);
            m_tuple2->addItem ("mu5_Nhits",  m_mu5_Nhits);
            m_tuple2->addItem ("mu6_Nhits",  m_mu6_Nhits);
            m_tuple2->addItem ("mu1_LastLay",  m_mu1_LastLay);
            m_tuple2->addItem ("mu2_LastLay",  m_mu2_LastLay);
            m_tuple2->addItem ("mu3_LastLay",  m_mu3_LastLay);
            m_tuple2->addItem ("mu4_LastLay",  m_mu4_LastLay);
            m_tuple2->addItem ("mu5_LastLay",  m_mu5_LastLay);
            m_tuple2->addItem ("mu6_LastLay",  m_mu6_LastLay);
            m_tuple2->addItem ("mu1_maxHitsInLay",  m_mu1_maxHitsInLay);
            m_tuple2->addItem ("mu2_maxHitsInLay",  m_mu2_maxHitsInLay);
            m_tuple2->addItem ("mu3_maxHitsInLay",  m_mu3_maxHitsInLay);
            m_tuple2->addItem ("mu4_maxHitsInLay",  m_mu4_maxHitsInLay);
            m_tuple2->addItem ("mu5_maxHitsInLay",  m_mu5_maxHitsInLay);
            m_tuple2->addItem ("mu6_maxHitsInLay",  m_mu6_maxHitsInLay);
            ...
            m_tuple2->addItem ("costheta_eg",                    m_costheta_eg);
            ...
            m_tuple2->addItem ("theta1_kal",                     m_theta1_kal);
            m_tuple2->addItem ("theta2_kal",                     m_theta2_kal);
            ...
            m_tuple1->addItem ("mctrue_epim_4c",                    m_mctruth_epim_4c);
            m_tuple2->addItem ("mepim_rho_4c",                     m_epim_rho_4c);
            m_tuple2->addItem ("mepip_rho_4c",                     m_epip_rho_4c);
            ...
            m_tuple2->addItem ("theta_rho_kal",                  m_theta_rho_kal);
            m_tuple2->addItem ("theta_rho_kal_test",             m_theta_rho_kal_test);
...
//************************************************************************
StatusCode mmppetapAlg::execute() {
    ...
    for(int k=0; k < iGood.size(); k++){
        ...
        double prob_electron_true_e = -1.;
        double R_electron    = -1.;

        prob_pion     = pid->probPion();
        prob_kaon     = pid->probKaon();
        prob_proton     = pid->probProton();
        prob_electron = pid->probMuon();
        prob_electron_true_e = pid->probElectron();

        R_electron  =  prob_electron / (prob_electron + prob_pion + prob_kaon + prob_electron_true_e) ; 


        if(c0 >0) { 
            //isProton(*itTrk, m_prob_chp, nchp);
            //if(prob_electron > 0.001 && R_electron > 0.8)
            if(prob_electron > prob_pion && prob_electron > prob_kaon && prob_electron > prob_electron_true_e)
            {
                ...
                track1Info.settrack(1, *itTrk);// e, mu, pi, K, p: 0,1,2,3,4;
    ...
    WTrackParameter wvpip1Trk,wvpim1Trk, wvpip2Trk,wvpim2Trk,wvelp1Trk,wvelm1Trk;
     EvtRecTrackIterator itTrk1, itTrk2, itTrk3, itTrk4, itTrk5, itTrk6;
...
itTrk1 = evtRecTrkCol->begin() + iGood[ipip[0]];
     E1 = -1.;
     ep1 = 0;
    trk1p = pip1Trk->p();
    if((*itTrk1)->isEmcShowerValid()) {
        RecEmcShower *emcTrk1 = (*itTrk1)->emcShower();
        E1 = emcTrk1->energy();
        ep1 = E1/trk1p;
    }
    m_mu1_Lay = -999., m_mu1_Dep = -999., m_mu1_Nhits = -999., m_mu1_LastLay = -999., m_mu1_maxHitsInLay = -999.;
    if((*itTrk1)->isMucTrackValid()){
        RecMucTrack *mucTrk1  = (*itTrk1)->mucTrack();
        m_mu1_Lay          = mucTrk1->numLayers();
        m_mu1_Dep          = mucTrk1->depth();
        m_mu1_Nhits        = mucTrk1->numHits();
        m_mu1_LastLay      = mucTrk1->brLastLayer();
        m_mu1_maxHitsInLay = mucTrk1->maxHitsInLayer();
    }
...
itTrk2 = evtRecTrkCol->begin() + iGood[ipip[1]];
     E2 = -1.;
     ep2 = 0;
     trk2p = pip2Trk->p();
    if((*itTrk2)->isEmcShowerValid()) {
        RecEmcShower *emcTrk2 = (*itTrk2)->emcShower();
        E2 = emcTrk2->energy();
        ep2 = E2/trk2p;
    }
     m_mu2_Lay = -999., m_mu2_Dep = -999., m_mu2_Nhits = -999., m_mu2_LastLay = -999., m_mu2_maxHitsInLay = -999.;
    if((*itTrk2)->isMucTrackValid()){
        RecMucTrack *mucTrk2  = (*itTrk2)->mucTrack();
        m_mu2_Lay          = mucTrk2->numLayers();
        m_mu2_Dep          = mucTrk2->depth();
        m_mu2_Nhits        = mucTrk2->numHits();
        m_mu2_LastLay      = mucTrk2->brLastLayer();
        m_mu2_maxHitsInLay = mucTrk2->maxHitsInLayer();
    }
...
itTrk3 = evtRecTrkCol->begin() + iGood[ipim[0]];
     E3 = -1.;
     ep3 = 0;
     trk3p = pim1Trk->p();
    if((*itTrk3)->isEmcShowerValid()) {
        RecEmcShower *emcTrk3 = (*itTrk3)->emcShower();
        E3 = emcTrk3->energy();
        ep3 = E3/trk3p;
    }
     m_mu3_Lay = -999., m_mu3_Dep = -999., m_mu3_Nhits = -999., m_mu3_LastLay = -999., m_mu3_maxHitsInLay = -999.;
    if((*itTrk3)->isMucTrackValid()){
        RecMucTrack *mucTrk3  = (*itTrk3)->mucTrack();
        m_mu3_Lay          = mucTrk3->numLayers();
        m_mu3_Dep          = mucTrk3->depth();
        m_mu3_Nhits        = mucTrk3->numHits();
        m_mu3_LastLay      = mucTrk3->brLastLayer();
        m_mu3_maxHitsInLay = mucTrk3->maxHitsInLayer();
    }
...
itTrk4 = evtRecTrkCol->begin() + iGood[ipim[1]];
     E4 = -1.;
     ep4 = 0;
     trk4p = pim2Trk->p();
    if((*itTrk4)->isEmcShowerValid()) {
        RecEmcShower *emcTrk4 = (*itTrk4)->emcShower();
        E4 = emcTrk4->energy();
        ep4 = E4/trk4p;
    }
     m_mu4_Lay = -999., m_mu4_Dep = -999., m_mu4_Nhits = -999., m_mu4_LastLay = -999., m_mu4_maxHitsInLay = -999.;
    if((*itTrk4)->isMucTrackValid()){
        RecMucTrack *mucTrk4  = (*itTrk4)->mucTrack();
        m_mu4_Lay          = mucTrk4->numLayers();
        m_mu4_Dep          = mucTrk4->depth();
        m_mu4_Nhits        = mucTrk4->numHits();
        m_mu4_LastLay      = mucTrk4->brLastLayer();
        m_mu4_maxHitsInLay = mucTrk4->maxHitsInLayer();
    }
    RecMdcKalTrack *elp1Trk = (*(evtRecTrkCol->begin()+iGood[ielp[0]]))->mdcKalTrack();
    RecMdcKalTrack::setPidType(RecMdcKalTrack::muon);
    wvelp1Trk = WTrackParameter(mmu, elp1Trk->getZHelixMu(), elp1Trk->getZErrorMu());

itTrk5 = evtRecTrkCol->begin() + iGood[ielp[0]];
      E5 = -1.;
      ep5 = 0;
     trk5p = elp1Trk->p();
    if((*itTrk5)->isEmcShowerValid()) {
        RecEmcShower *emcTrk5 = (*itTrk5)->emcShower();
        E5 = emcTrk5->energy();
        ep5 = E5/trk5p;
    }
     m_mu5_Lay = -999., m_mu5_Dep = -999., m_mu5_Nhits = -999., m_mu5_LastLay = -999., m_mu5_maxHitsInLay = -999.;
    if((*itTrk5)->isMucTrackValid()){
        RecMucTrack *mucTrk5  = (*itTrk5)->mucTrack();
        m_mu5_Lay          = mucTrk5->numLayers();
        m_mu5_Dep          = mucTrk5->depth();
        m_mu5_Nhits        = mucTrk5->numHits();
        m_mu5_LastLay      = mucTrk5->brLastLayer();
        m_mu5_maxHitsInLay = mucTrk5->maxHitsInLayer();
    }
    RecMdcKalTrack *elm1Trk = (*(evtRecTrkCol->begin()+iGood[ielm[0]]))->mdcKalTrack();
    RecMdcKalTrack::setPidType(RecMdcKalTrack::muon);
    wvelm1Trk = WTrackParameter(mmu, elm1Trk->getZHelixMu(), elm1Trk->getZErrorMu());
itTrk6 = evtRecTrkCol->begin() + iGood[ielm[0]];
     E6 = -1.;
     ep6 = 0;
     trk6p = elm1Trk->p();
    if((*itTrk6)->isEmcShowerValid()) {
        RecEmcShower *emcTrk6 = (*itTrk6)->emcShower();
        E6 = emcTrk6->energy();
        ep6 = E6/trk6p;
    }
     m_mu6_Lay = -999., m_mu6_Dep = -999., m_mu6_Nhits = -999., m_mu6_LastLay = -999., m_mu6_maxHitsInLay = -999.;
    if((*itTrk6)->isMucTrackValid()){
        RecMucTrack *mucTrk6  = (*itTrk6)->mucTrack();
        m_mu6_Lay          = mucTrk6->numLayers();
        m_mu6_Dep          = mucTrk6->depth();
        m_mu6_Nhits        = mucTrk6->numHits();
        m_mu6_LastLay      = mucTrk6->brLastLayer();
        m_mu6_maxHitsInLay = mucTrk6->maxHitsInLayer();
    }
...
/*
            cout<<"nGam=="<<nGam<<endl;
            cout<<"ncomb_pi0_ppe ="<<ncomb_pi0_ppe<<endl;
        ...
        */
                    ...
                    if (ipip_etap > -1 && ipim_etap > -1) {
                        ...
                        m_theta1_kal = pGam[ig1].vect().theta();
                        m_theta2_kal = pGam[ig2].vect().theta();
...
*/
                ...
                m_epim_rho_4c = (pelp1_rho_4c + pPim_4c[1-ipim_etap]).m();
                m_epip_rho_4c = (pelm1_rho_4c + pPip_4c[1-ipip_etap]).m();

                m_ee_rho_4c_rec = (ecms - pelp1_rho_4c - pelm1_rho_4c).m();
                m_pipietap_rho_4c_rec = (ecms - ppip1_rho_4c - ppim1_rho_4c - ppip2_rho_4c - ppim2_rho_4c - pgam1_rho_4c).m();
                m_ee_rho_rec = (ecms - pElep_kal - pElem_kal).m();
                m_pipietap_rho_rec = (ecms - pPip_kal[ipip_etap] - pPim_kal[ipim_etap] - pPip_kal[1-ipip_etap] - pPim_kal[1-ipim_etap] - pGam[ig3] ).m();
                ...
                if (ipip_etap > -1 && ipim_etap > -1) {
                    ...
                    m_theta_rho_kal = pGam[ig3].vect().theta();
                    m_theta_rho_kal_test = pGam[ig3].theta();
...
//&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&
StatusCode mmppetapAlg::finalize() {
    MsgStream log(msgSvc(), name());
...
bool mmppetapAlg::mctruth(){
    ...
    if(m_truthRun<0){
        ...
        if (!mcParticleCol) {
            ...
            for (; iter_mc != mcParticleCol->end(); iter_mc++) {
                ...
                //}
                ////================================================================================================
                if((mctrue_id == -13)&&(mctrue_mothPID==m_cms_id)){
    ...
    /////////////////////////////gamrho////////////////////////////////
    if(mctrue_ep.size()==1&&mctrue_em.size()==1&&mctrue_pip.size()==1&&mctrue_pim.size()==1&&mctrue_pip_etap_4c.size()==1&&mctrue_pim_etap_4c.size()==1&&mctrue_gam_etap_4c.size()==1){
        m_mctrue_mpipietap_4c = (mctrue_pip[0] + mctrue_pim[0] + mctrue_pip_etap_4c[0] + mctrue_pim_etap_4c[0] + mctrue_gam_etap_4c[0]).m();
        m_mctrue_meppimetap_4c = (mctrue_ep[0] + mctrue_pim[0] + mctrue_pip_etap_4c[0] + mctrue_pim_etap_4c[0] + mctrue_gam_etap_4c[0]).m(); 
        m_mctrue_mempipetap_4c = (mctrue_em[0] + mctrue_pip[0] + mctrue_pip_etap_4c[0] + mctrue_pim_etap_4c[0] + mctrue_gam_etap_4c[0]).m(); 
        m_mctrue_meeetap_4c = (mctrue_em[0] + mctrue_ep[0] + mctrue_pip_etap_4c[0] + mctrue_pim_etap_4c[0] + mctrue_gam_etap_4c[0]).m(); 
    }  
    if(mctrue_ep.size()==1&&mctrue_em.size()==1&&mctrue_pip.size()==1&&mctrue_pim.size()==1){
       m_mctruth_ee_4c = (mctrue_ep[0] + mctrue_em[0]).m();
       m_mctruth_epim_4c = (mctrue_ep[0] + mctrue_pim[0]).m();
       m_mctruth_epip_4c = (mctrue_em[0] + mctrue_pip[0]).m();
    }
   ...
   // if(mctrue_ep.size()==1&&mctrue_em.size()==1){
...
double mmppetapAlg::Get_HelixRadius(HepVector helix){
...
HepPoint3D mmppetapAlg::Get_HelixCenter(HepVector helix){
...
HepPoint3D mmppetapAlg::intersections(HepVector helix,double r){
    double xc, yc,rc;
...
double mmppetapAlg::Get_Dee(HepVector helixe,HepVector helixp,double r){
