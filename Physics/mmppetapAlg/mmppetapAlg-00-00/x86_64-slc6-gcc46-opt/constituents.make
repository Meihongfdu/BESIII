...
#cmt_local_tagfile = $(mmppetapAlg_tag).make
cmt_local_tagfile = $(bin)$(mmppetapAlg_tag).make
...
cmt_local_setup_mmppetapAlg = $(bin)setup_mmppetapAlg$$$$.make
...
mmppetapAlg_extratags = -tag_add=target_mmppetapAlg

#$(cmt_local_tagfile_mmppetapAlg) : $(cmt_lock_setup)
ifndef QUICK
$(cmt_local_tagfile_mmppetapAlg) ::
else
$(cmt_local_tagfile_mmppetapAlg) :
endif
	$(echo) "(constituents.make) Rebuilding $@"; \
	  if test -f $(cmt_local_tagfile_mmppetapAlg); then /bin/rm -f $(cmt_local_tagfile_mmppetapAlg); fi ; \
	  $(cmtexe) -tag=$(tags) $(mmppetapAlg_extratags) build tag_makefile >>$(cmt_local_tagfile_mmppetapAlg)
	$(echo) "(constituents.make) Rebuilding $(cmt_final_setup_mmppetapAlg)"; \
	  test ! -f $(cmt_local_setup_mmppetapAlg) || \rm -f $(cmt_local_setup_mmppetapAlg); \
	  trap '\rm -f $(cmt_local_setup_mmppetapAlg)' 0 1 2 15; \
	  $(cmtexe) -tag=$(tags) $(mmppetapAlg_extratags) show setup >$(cmt_local_setup_mmppetapAlg) && \
	  if [ -f $(cmt_final_setup_mmppetapAlg) ] && \
	    \cmp -s $(cmt_final_setup_mmppetapAlg) $(cmt_local_setup_mmppetapAlg); then \
	    \rm $(cmt_local_setup_mmppetapAlg); else \
	    \mv -f $(cmt_local_setup_mmppetapAlg) $(cmt_final_setup_mmppetapAlg); fi
...
not_mmppetapAlg_dependencies = { n=0; for p in $?; do m=0; for d in $(mmppetapAlg_dependencies); do if [ $$p = $$d ]; then m=1; break; fi; done; if [ $$m -eq 0 ]; then n=1; break; fi; done; [ $$n -eq 1 ]; }

ifdef STRUCTURED_OUTPUT
mmppetapAlgdirs :
	@if test ! -d $(bin)mmppetapAlg; then $(mkdir) -p $(bin)mmppetapAlg; fi
	$(echo) "STRUCTURED_OUTPUT="$(bin)mmppetapAlg
else
mmppetapAlgdirs : ;
endif
...
#	$(echo) "STRUCTURED_OUTPUT="$(bin)mmppetapAlg
#
#$(cmt_local_mmppetapAlg_makefile) :: $(mmppetapAlg_dependencies) $(cmt_local_tagfile_mmppetapAlg) build_library_links dirs mmppetapAlgdirs
#else
#$(cmt_local_mmppetapAlg_makefile) :: $(mmppetapAlg_dependencies) $(cmt_local_tagfile_mmppetapAlg) build_library_links dirs
#endif
#else
#$(cmt_local_mmppetapAlg_makefile) :: $(cmt_local_tagfile_mmppetapAlg)
#endif

ifdef cmt_mmppetapAlg_has_target_tag

ifndef QUICK
$(cmt_local_mmppetapAlg_makefile) : $(mmppetapAlg_dependencies) build_library_links
	$(echo) "(constituents.make) Building mmppetapAlg.make"; \
	  $(cmtexe) -tag=$(tags) $(mmppetapAlg_extratags) build constituent_config -out=$(cmt_local_mmppetapAlg_makefile) mmppetapAlg
else
$(cmt_local_mmppetapAlg_makefile) : $(mmppetapAlg_dependencies) $(cmt_build_library_linksstamp) $(use_requirements)
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_mmppetapAlg) ] || \
	  [ ! -f $(cmt_final_setup_mmppetapAlg) ] || \
	  $(not_mmppetapAlg_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
	  echo "$(CMTMSGPREFIX)" "(constituents.make) Building mmppetapAlg.make"; \
	  $(cmtexe) -tag=$(tags) $(mmppetapAlg_extratags) build constituent_config -out=$(cmt_local_mmppetapAlg_makefile) mmppetapAlg; \
	  fi
endif
...
$(cmt_local_mmppetapAlg_makefile) : $(mmppetapAlg_dependencies) build_library_links
	$(echo) "(constituents.make) Building mmppetapAlg.make"; \
	  $(cmtexe) -f=$(bin)mmppetapAlg.in -tag=$(tags) $(mmppetapAlg_extratags) build constituent_makefile -without_cmt -out=$(cmt_local_mmppetapAlg_makefile) mmppetapAlg
else
$(cmt_local_mmppetapAlg_makefile) : $(mmppetapAlg_dependencies) $(cmt_build_library_linksstamp) $(bin)mmppetapAlg.in
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_mmppetapAlg) ] || \
	  [ ! -f $(cmt_final_setup_mmppetapAlg) ] || \
	  $(not_mmppetapAlg_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
...
#	  $(cmtexe) -tag=$(tags) $(mmppetapAlg_extratags) build constituent_makefile -out=$(cmt_local_mmppetapAlg_makefile) mmppetapAlg

mmppetapAlg :: $(mmppetapAlg_dependencies) $(cmt_local_mmppetapAlg_makefile) dirs mmppetapAlgdirs
	$(echo) "(constituents.make) Starting mmppetapAlg"
	@if test -f $(cmt_local_mmppetapAlg_makefile); then \
	  $(MAKE) -f $(cmt_local_mmppetapAlg_makefile) mmppetapAlg; \
	  fi
#	@$(MAKE) -f $(cmt_local_mmppetapAlg_makefile) mmppetapAlg
	$(echo) "(constituents.make) mmppetapAlg done"

clean :: mmppetapAlgclean

mmppetapAlgclean :: $(mmppetapAlgclean_dependencies) ##$(cmt_local_mmppetapAlg_makefile)
	$(echo) "(constituents.make) Starting mmppetapAlgclean"
	@-if test -f $(cmt_local_mmppetapAlg_makefile); then \
	  $(MAKE) -f $(cmt_local_mmppetapAlg_makefile) mmppetapAlgclean; \
	fi
	$(echo) "(constituents.make) mmppetapAlgclean done"
#	@-$(MAKE) -f $(cmt_local_mmppetapAlg_makefile) mmppetapAlgclean

##	  /bin/rm -f $(cmt_local_mmppetapAlg_makefile) $(bin)mmppetapAlg_dependencies.make

install :: mmppetapAlginstall

mmppetapAlginstall :: $(mmppetapAlg_dependencies) $(cmt_local_mmppetapAlg_makefile)
	$(echo) "(constituents.make) Starting install mmppetapAlg"
	@-$(MAKE) -f $(cmt_local_mmppetapAlg_makefile) install
	$(echo) "(constituents.make) install mmppetapAlg done"

uninstall : mmppetapAlguninstall

$(foreach d,$(mmppetapAlg_dependencies),$(eval $(d)uninstall_dependencies += mmppetapAlguninstall))

mmppetapAlguninstall : $(mmppetapAlguninstall_dependencies) ##$(cmt_local_mmppetapAlg_makefile)
	$(echo) "(constituents.make) Starting uninstall mmppetapAlg"
	@if test -f $(cmt_local_mmppetapAlg_makefile); then \
	  $(MAKE) -f $(cmt_local_mmppetapAlg_makefile) uninstall; \
	  fi
#	@$(MAKE) -f $(cmt_local_mmppetapAlg_makefile) uninstall
	$(echo) "(constituents.make) uninstall mmppetapAlg done"

remove_library_links :: mmppetapAlguninstall
...
#cmt_local_tagfile_config = $(mmppetapAlg_tag)_config.make
cmt_local_tagfile_config = $(bin)$(mmppetapAlg_tag)_config.make
cmt_local_setup_config = $(bin)setup_config$$$$.make
cmt_final_setup_config = $(bin)setup_config.make
#cmt_final_setup_config = $(bin)mmppetapAlg_configsetup.make
...
#cmt_local_tagfile_config = $(mmppetapAlg_tag).make
cmt_local_tagfile_config = $(bin)$(mmppetapAlg_tag).make
cmt_final_setup_config = $(bin)setup.make
#cmt_final_setup_config = $(bin)mmppetapAlgsetup.make
cmt_local_config_makefile = $(bin)config.make
...
#cmt_local_tagfile_install_includes = $(mmppetapAlg_tag)_install_includes.make
cmt_local_tagfile_install_includes = $(bin)$(mmppetapAlg_tag)_install_includes.make
...
#cmt_final_setup_install_includes = $(bin)mmppetapAlg_install_includessetup.make
...
#cmt_local_tagfile_install_includes = $(mmppetapAlg_tag).make
cmt_local_tagfile_install_includes = $(bin)$(mmppetapAlg_tag).make
cmt_final_setup_install_includes = $(bin)setup.make
#cmt_final_setup_install_includes = $(bin)mmppetapAlgsetup.make
cmt_local_install_includes_makefile = $(bin)install_includes.make
...
#cmt_local_tagfile_make = $(mmppetapAlg_tag)_make.make
cmt_local_tagfile_make = $(bin)$(mmppetapAlg_tag)_make.make
cmt_local_setup_make = $(bin)setup_make$$$$.make
cmt_final_setup_make = $(bin)setup_make.make
#cmt_final_setup_make = $(bin)mmppetapAlg_makesetup.make
...
#cmt_local_tagfile_make = $(mmppetapAlg_tag).make
cmt_local_tagfile_make = $(bin)$(mmppetapAlg_tag).make
cmt_final_setup_make = $(bin)setup.make
#cmt_final_setup_make = $(bin)mmppetapAlgsetup.make
cmt_local_make_makefile = $(bin)make.make
...
#cmt_local_tagfile_CompilePython = $(mmppetapAlg_tag)_CompilePython.make
cmt_local_tagfile_CompilePython = $(bin)$(mmppetapAlg_tag)_CompilePython.make
cmt_local_setup_CompilePython = $(bin)setup_CompilePython$$$$.make
cmt_final_setup_CompilePython = $(bin)setup_CompilePython.make
#cmt_final_setup_CompilePython = $(bin)mmppetapAlg_CompilePythonsetup.make
...
#cmt_local_tagfile_CompilePython = $(mmppetapAlg_tag).make
cmt_local_tagfile_CompilePython = $(bin)$(mmppetapAlg_tag).make
cmt_final_setup_CompilePython = $(bin)setup.make
#cmt_final_setup_CompilePython = $(bin)mmppetapAlgsetup.make
cmt_local_CompilePython_makefile = $(bin)CompilePython.make
...
#cmt_local_tagfile_qmtest_run = $(mmppetapAlg_tag)_qmtest_run.make
cmt_local_tagfile_qmtest_run = $(bin)$(mmppetapAlg_tag)_qmtest_run.make
cmt_local_setup_qmtest_run = $(bin)setup_qmtest_run$$$$.make
cmt_final_setup_qmtest_run = $(bin)setup_qmtest_run.make
#cmt_final_setup_qmtest_run = $(bin)mmppetapAlg_qmtest_runsetup.make
...
#cmt_local_tagfile_qmtest_run = $(mmppetapAlg_tag).make
cmt_local_tagfile_qmtest_run = $(bin)$(mmppetapAlg_tag).make
cmt_final_setup_qmtest_run = $(bin)setup.make
#cmt_final_setup_qmtest_run = $(bin)mmppetapAlgsetup.make
cmt_local_qmtest_run_makefile = $(bin)qmtest_run.make
...
#cmt_local_tagfile_qmtest_summarize = $(mmppetapAlg_tag)_qmtest_summarize.make
cmt_local_tagfile_qmtest_summarize = $(bin)$(mmppetapAlg_tag)_qmtest_summarize.make
...
#cmt_final_setup_qmtest_summarize = $(bin)mmppetapAlg_qmtest_summarizesetup.make
...
#cmt_local_tagfile_qmtest_summarize = $(mmppetapAlg_tag).make
cmt_local_tagfile_qmtest_summarize = $(bin)$(mmppetapAlg_tag).make
cmt_final_setup_qmtest_summarize = $(bin)setup.make
#cmt_final_setup_qmtest_summarize = $(bin)mmppetapAlgsetup.make
cmt_local_qmtest_summarize_makefile = $(bin)qmtest_summarize.make
...
#cmt_local_tagfile_TestPackage = $(mmppetapAlg_tag)_TestPackage.make
cmt_local_tagfile_TestPackage = $(bin)$(mmppetapAlg_tag)_TestPackage.make
cmt_local_setup_TestPackage = $(bin)setup_TestPackage$$$$.make
cmt_final_setup_TestPackage = $(bin)setup_TestPackage.make
#cmt_final_setup_TestPackage = $(bin)mmppetapAlg_TestPackagesetup.make
...
#cmt_local_tagfile_TestPackage = $(mmppetapAlg_tag).make
cmt_local_tagfile_TestPackage = $(bin)$(mmppetapAlg_tag).make
cmt_final_setup_TestPackage = $(bin)setup.make
#cmt_final_setup_TestPackage = $(bin)mmppetapAlgsetup.make
cmt_local_TestPackage_makefile = $(bin)TestPackage.make
...
#cmt_local_tagfile_TestProject = $(mmppetapAlg_tag)_TestProject.make
cmt_local_tagfile_TestProject = $(bin)$(mmppetapAlg_tag)_TestProject.make
cmt_local_setup_TestProject = $(bin)setup_TestProject$$$$.make
cmt_final_setup_TestProject = $(bin)setup_TestProject.make
#cmt_final_setup_TestProject = $(bin)mmppetapAlg_TestProjectsetup.make
...
#cmt_local_tagfile_TestProject = $(mmppetapAlg_tag).make
cmt_local_tagfile_TestProject = $(bin)$(mmppetapAlg_tag).make
cmt_final_setup_TestProject = $(bin)setup.make
#cmt_final_setup_TestProject = $(bin)mmppetapAlgsetup.make
cmt_local_TestProject_makefile = $(bin)TestProject.make
...
#cmt_local_tagfile_new_rootsys = $(mmppetapAlg_tag)_new_rootsys.make
cmt_local_tagfile_new_rootsys = $(bin)$(mmppetapAlg_tag)_new_rootsys.make
cmt_local_setup_new_rootsys = $(bin)setup_new_rootsys$$$$.make
cmt_final_setup_new_rootsys = $(bin)setup_new_rootsys.make
#cmt_final_setup_new_rootsys = $(bin)mmppetapAlg_new_rootsyssetup.make
...
#cmt_local_tagfile_new_rootsys = $(mmppetapAlg_tag).make
cmt_local_tagfile_new_rootsys = $(bin)$(mmppetapAlg_tag).make
cmt_final_setup_new_rootsys = $(bin)setup.make
#cmt_final_setup_new_rootsys = $(bin)mmppetapAlgsetup.make
cmt_local_new_rootsys_makefile = $(bin)new_rootsys.make
...
#cmt_local_tagfile_DatabaseSvc_check_install_scripts = $(mmppetapAlg_tag)_DatabaseSvc_check_install_scripts.make
cmt_local_tagfile_DatabaseSvc_check_install_scripts = $(bin)$(mmppetapAlg_tag)_DatabaseSvc_check_install_scripts.make
...
#cmt_final_setup_DatabaseSvc_check_install_scripts = $(bin)mmppetapAlg_DatabaseSvc_check_install_scriptssetup.make
...
#cmt_local_tagfile_DatabaseSvc_check_install_scripts = $(mmppetapAlg_tag).make
cmt_local_tagfile_DatabaseSvc_check_install_scripts = $(bin)$(mmppetapAlg_tag).make
cmt_final_setup_DatabaseSvc_check_install_scripts = $(bin)setup.make
#cmt_final_setup_DatabaseSvc_check_install_scripts = $(bin)mmppetapAlgsetup.make
cmt_local_DatabaseSvc_check_install_scripts_makefile = $(bin)DatabaseSvc_check_install_scripts.make
