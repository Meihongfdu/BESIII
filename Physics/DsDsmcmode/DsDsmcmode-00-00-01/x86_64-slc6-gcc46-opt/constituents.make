...
#cmt_local_tagfile = $(DsDsmcmode_tag).make
cmt_local_tagfile = $(bin)$(DsDsmcmode_tag).make
...
cmt_local_setup_DsDsmcmode = $(bin)setup_DsDsmcmode$$$$.make
...
DsDsmcmode_extratags = -tag_add=target_DsDsmcmode

#$(cmt_local_tagfile_DsDsmcmode) : $(cmt_lock_setup)
ifndef QUICK
$(cmt_local_tagfile_DsDsmcmode) ::
else
$(cmt_local_tagfile_DsDsmcmode) :
endif
	$(echo) "(constituents.make) Rebuilding $@"; \
	  if test -f $(cmt_local_tagfile_DsDsmcmode); then /bin/rm -f $(cmt_local_tagfile_DsDsmcmode); fi ; \
	  $(cmtexe) -tag=$(tags) $(DsDsmcmode_extratags) build tag_makefile >>$(cmt_local_tagfile_DsDsmcmode)
	$(echo) "(constituents.make) Rebuilding $(cmt_final_setup_DsDsmcmode)"; \
	  test ! -f $(cmt_local_setup_DsDsmcmode) || \rm -f $(cmt_local_setup_DsDsmcmode); \
	  trap '\rm -f $(cmt_local_setup_DsDsmcmode)' 0 1 2 15; \
	  $(cmtexe) -tag=$(tags) $(DsDsmcmode_extratags) show setup >$(cmt_local_setup_DsDsmcmode) && \
	  if [ -f $(cmt_final_setup_DsDsmcmode) ] && \
	    \cmp -s $(cmt_final_setup_DsDsmcmode) $(cmt_local_setup_DsDsmcmode); then \
	    \rm $(cmt_local_setup_DsDsmcmode); else \
	    \mv -f $(cmt_local_setup_DsDsmcmode) $(cmt_final_setup_DsDsmcmode); fi
...
not_DsDsmcmode_dependencies = { n=0; for p in $?; do m=0; for d in $(DsDsmcmode_dependencies); do if [ $$p = $$d ]; then m=1; break; fi; done; if [ $$m -eq 0 ]; then n=1; break; fi; done; [ $$n -eq 1 ]; }

ifdef STRUCTURED_OUTPUT
DsDsmcmodedirs :
	@if test ! -d $(bin)DsDsmcmode; then $(mkdir) -p $(bin)DsDsmcmode; fi
	$(echo) "STRUCTURED_OUTPUT="$(bin)DsDsmcmode
else
DsDsmcmodedirs : ;
endif
...
#	$(echo) "STRUCTURED_OUTPUT="$(bin)DsDsmcmode
#
#$(cmt_local_DsDsmcmode_makefile) :: $(DsDsmcmode_dependencies) $(cmt_local_tagfile_DsDsmcmode) build_library_links dirs DsDsmcmodedirs
#else
#$(cmt_local_DsDsmcmode_makefile) :: $(DsDsmcmode_dependencies) $(cmt_local_tagfile_DsDsmcmode) build_library_links dirs
#endif
#else
#$(cmt_local_DsDsmcmode_makefile) :: $(cmt_local_tagfile_DsDsmcmode)
#endif

ifdef cmt_DsDsmcmode_has_target_tag

ifndef QUICK
$(cmt_local_DsDsmcmode_makefile) : $(DsDsmcmode_dependencies) build_library_links
	$(echo) "(constituents.make) Building DsDsmcmode.make"; \
	  $(cmtexe) -tag=$(tags) $(DsDsmcmode_extratags) build constituent_config -out=$(cmt_local_DsDsmcmode_makefile) DsDsmcmode
else
$(cmt_local_DsDsmcmode_makefile) : $(DsDsmcmode_dependencies) $(cmt_build_library_linksstamp) $(use_requirements)
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_DsDsmcmode) ] || \
	  [ ! -f $(cmt_final_setup_DsDsmcmode) ] || \
	  $(not_DsDsmcmode_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
	  echo "$(CMTMSGPREFIX)" "(constituents.make) Building DsDsmcmode.make"; \
	  $(cmtexe) -tag=$(tags) $(DsDsmcmode_extratags) build constituent_config -out=$(cmt_local_DsDsmcmode_makefile) DsDsmcmode; \
	  fi
endif
...
$(cmt_local_DsDsmcmode_makefile) : $(DsDsmcmode_dependencies) build_library_links
	$(echo) "(constituents.make) Building DsDsmcmode.make"; \
	  $(cmtexe) -f=$(bin)DsDsmcmode.in -tag=$(tags) $(DsDsmcmode_extratags) build constituent_makefile -without_cmt -out=$(cmt_local_DsDsmcmode_makefile) DsDsmcmode
else
$(cmt_local_DsDsmcmode_makefile) : $(DsDsmcmode_dependencies) $(cmt_build_library_linksstamp) $(bin)DsDsmcmode.in
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_DsDsmcmode) ] || \
	  [ ! -f $(cmt_final_setup_DsDsmcmode) ] || \
	  $(not_DsDsmcmode_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
...
#	  $(cmtexe) -tag=$(tags) $(DsDsmcmode_extratags) build constituent_makefile -out=$(cmt_local_DsDsmcmode_makefile) DsDsmcmode

DsDsmcmode :: $(DsDsmcmode_dependencies) $(cmt_local_DsDsmcmode_makefile) dirs DsDsmcmodedirs
	$(echo) "(constituents.make) Starting DsDsmcmode"
	@if test -f $(cmt_local_DsDsmcmode_makefile); then \
	  $(MAKE) -f $(cmt_local_DsDsmcmode_makefile) DsDsmcmode; \
	  fi
#	@$(MAKE) -f $(cmt_local_DsDsmcmode_makefile) DsDsmcmode
	$(echo) "(constituents.make) DsDsmcmode done"

clean :: DsDsmcmodeclean

DsDsmcmodeclean :: $(DsDsmcmodeclean_dependencies) ##$(cmt_local_DsDsmcmode_makefile)
	$(echo) "(constituents.make) Starting DsDsmcmodeclean"
	@-if test -f $(cmt_local_DsDsmcmode_makefile); then \
	  $(MAKE) -f $(cmt_local_DsDsmcmode_makefile) DsDsmcmodeclean; \
	fi
	$(echo) "(constituents.make) DsDsmcmodeclean done"
#	@-$(MAKE) -f $(cmt_local_DsDsmcmode_makefile) DsDsmcmodeclean

##	  /bin/rm -f $(cmt_local_DsDsmcmode_makefile) $(bin)DsDsmcmode_dependencies.make

install :: DsDsmcmodeinstall

DsDsmcmodeinstall :: $(DsDsmcmode_dependencies) $(cmt_local_DsDsmcmode_makefile)
	$(echo) "(constituents.make) Starting install DsDsmcmode"
	@-$(MAKE) -f $(cmt_local_DsDsmcmode_makefile) install
	$(echo) "(constituents.make) install DsDsmcmode done"

uninstall : DsDsmcmodeuninstall

$(foreach d,$(DsDsmcmode_dependencies),$(eval $(d)uninstall_dependencies += DsDsmcmodeuninstall))

DsDsmcmodeuninstall : $(DsDsmcmodeuninstall_dependencies) ##$(cmt_local_DsDsmcmode_makefile)
	$(echo) "(constituents.make) Starting uninstall DsDsmcmode"
	@if test -f $(cmt_local_DsDsmcmode_makefile); then \
	  $(MAKE) -f $(cmt_local_DsDsmcmode_makefile) uninstall; \
	  fi
#	@$(MAKE) -f $(cmt_local_DsDsmcmode_makefile) uninstall
	$(echo) "(constituents.make) uninstall DsDsmcmode done"

remove_library_links :: DsDsmcmodeuninstall
...
#cmt_local_tagfile_config = $(DsDsmcmode_tag)_config.make
cmt_local_tagfile_config = $(bin)$(DsDsmcmode_tag)_config.make
cmt_local_setup_config = $(bin)setup_config$$$$.make
cmt_final_setup_config = $(bin)setup_config.make
#cmt_final_setup_config = $(bin)DsDsmcmode_configsetup.make
...
#cmt_local_tagfile_config = $(DsDsmcmode_tag).make
cmt_local_tagfile_config = $(bin)$(DsDsmcmode_tag).make
cmt_final_setup_config = $(bin)setup.make
#cmt_final_setup_config = $(bin)DsDsmcmodesetup.make
cmt_local_config_makefile = $(bin)config.make
...
#cmt_local_tagfile_install_includes = $(DsDsmcmode_tag)_install_includes.make
cmt_local_tagfile_install_includes = $(bin)$(DsDsmcmode_tag)_install_includes.make
...
#cmt_final_setup_install_includes = $(bin)DsDsmcmode_install_includessetup.make
...
#cmt_local_tagfile_install_includes = $(DsDsmcmode_tag).make
cmt_local_tagfile_install_includes = $(bin)$(DsDsmcmode_tag).make
cmt_final_setup_install_includes = $(bin)setup.make
#cmt_final_setup_install_includes = $(bin)DsDsmcmodesetup.make
cmt_local_install_includes_makefile = $(bin)install_includes.make
...
#cmt_local_tagfile_make = $(DsDsmcmode_tag)_make.make
cmt_local_tagfile_make = $(bin)$(DsDsmcmode_tag)_make.make
cmt_local_setup_make = $(bin)setup_make$$$$.make
cmt_final_setup_make = $(bin)setup_make.make
#cmt_final_setup_make = $(bin)DsDsmcmode_makesetup.make
...
#cmt_local_tagfile_make = $(DsDsmcmode_tag).make
cmt_local_tagfile_make = $(bin)$(DsDsmcmode_tag).make
cmt_final_setup_make = $(bin)setup.make
#cmt_final_setup_make = $(bin)DsDsmcmodesetup.make
cmt_local_make_makefile = $(bin)make.make
...
#cmt_local_tagfile_CompilePython = $(DsDsmcmode_tag)_CompilePython.make
cmt_local_tagfile_CompilePython = $(bin)$(DsDsmcmode_tag)_CompilePython.make
cmt_local_setup_CompilePython = $(bin)setup_CompilePython$$$$.make
cmt_final_setup_CompilePython = $(bin)setup_CompilePython.make
#cmt_final_setup_CompilePython = $(bin)DsDsmcmode_CompilePythonsetup.make
...
#cmt_local_tagfile_CompilePython = $(DsDsmcmode_tag).make
cmt_local_tagfile_CompilePython = $(bin)$(DsDsmcmode_tag).make
cmt_final_setup_CompilePython = $(bin)setup.make
#cmt_final_setup_CompilePython = $(bin)DsDsmcmodesetup.make
cmt_local_CompilePython_makefile = $(bin)CompilePython.make
...
#cmt_local_tagfile_qmtest_run = $(DsDsmcmode_tag)_qmtest_run.make
cmt_local_tagfile_qmtest_run = $(bin)$(DsDsmcmode_tag)_qmtest_run.make
cmt_local_setup_qmtest_run = $(bin)setup_qmtest_run$$$$.make
cmt_final_setup_qmtest_run = $(bin)setup_qmtest_run.make
#cmt_final_setup_qmtest_run = $(bin)DsDsmcmode_qmtest_runsetup.make
...
#cmt_local_tagfile_qmtest_run = $(DsDsmcmode_tag).make
cmt_local_tagfile_qmtest_run = $(bin)$(DsDsmcmode_tag).make
cmt_final_setup_qmtest_run = $(bin)setup.make
#cmt_final_setup_qmtest_run = $(bin)DsDsmcmodesetup.make
cmt_local_qmtest_run_makefile = $(bin)qmtest_run.make
...
#cmt_local_tagfile_qmtest_summarize = $(DsDsmcmode_tag)_qmtest_summarize.make
cmt_local_tagfile_qmtest_summarize = $(bin)$(DsDsmcmode_tag)_qmtest_summarize.make
...
#cmt_final_setup_qmtest_summarize = $(bin)DsDsmcmode_qmtest_summarizesetup.make
...
#cmt_local_tagfile_qmtest_summarize = $(DsDsmcmode_tag).make
cmt_local_tagfile_qmtest_summarize = $(bin)$(DsDsmcmode_tag).make
cmt_final_setup_qmtest_summarize = $(bin)setup.make
#cmt_final_setup_qmtest_summarize = $(bin)DsDsmcmodesetup.make
cmt_local_qmtest_summarize_makefile = $(bin)qmtest_summarize.make
...
#cmt_local_tagfile_TestPackage = $(DsDsmcmode_tag)_TestPackage.make
cmt_local_tagfile_TestPackage = $(bin)$(DsDsmcmode_tag)_TestPackage.make
cmt_local_setup_TestPackage = $(bin)setup_TestPackage$$$$.make
cmt_final_setup_TestPackage = $(bin)setup_TestPackage.make
#cmt_final_setup_TestPackage = $(bin)DsDsmcmode_TestPackagesetup.make
...
#cmt_local_tagfile_TestPackage = $(DsDsmcmode_tag).make
cmt_local_tagfile_TestPackage = $(bin)$(DsDsmcmode_tag).make
cmt_final_setup_TestPackage = $(bin)setup.make
#cmt_final_setup_TestPackage = $(bin)DsDsmcmodesetup.make
cmt_local_TestPackage_makefile = $(bin)TestPackage.make
...
#cmt_local_tagfile_TestProject = $(DsDsmcmode_tag)_TestProject.make
cmt_local_tagfile_TestProject = $(bin)$(DsDsmcmode_tag)_TestProject.make
cmt_local_setup_TestProject = $(bin)setup_TestProject$$$$.make
cmt_final_setup_TestProject = $(bin)setup_TestProject.make
#cmt_final_setup_TestProject = $(bin)DsDsmcmode_TestProjectsetup.make
...
#cmt_local_tagfile_TestProject = $(DsDsmcmode_tag).make
cmt_local_tagfile_TestProject = $(bin)$(DsDsmcmode_tag).make
cmt_final_setup_TestProject = $(bin)setup.make
#cmt_final_setup_TestProject = $(bin)DsDsmcmodesetup.make
cmt_local_TestProject_makefile = $(bin)TestProject.make
...
#cmt_local_tagfile_new_rootsys = $(DsDsmcmode_tag)_new_rootsys.make
cmt_local_tagfile_new_rootsys = $(bin)$(DsDsmcmode_tag)_new_rootsys.make
cmt_local_setup_new_rootsys = $(bin)setup_new_rootsys$$$$.make
cmt_final_setup_new_rootsys = $(bin)setup_new_rootsys.make
#cmt_final_setup_new_rootsys = $(bin)DsDsmcmode_new_rootsyssetup.make
...
#cmt_local_tagfile_new_rootsys = $(DsDsmcmode_tag).make
cmt_local_tagfile_new_rootsys = $(bin)$(DsDsmcmode_tag).make
cmt_final_setup_new_rootsys = $(bin)setup.make
#cmt_final_setup_new_rootsys = $(bin)DsDsmcmodesetup.make
cmt_local_new_rootsys_makefile = $(bin)new_rootsys.make
...
#cmt_local_tagfile_DatabaseSvc_check_install_scripts = $(DsDsmcmode_tag)_DatabaseSvc_check_install_scripts.make
cmt_local_tagfile_DatabaseSvc_check_install_scripts = $(bin)$(DsDsmcmode_tag)_DatabaseSvc_check_install_scripts.make
...
#cmt_final_setup_DatabaseSvc_check_install_scripts = $(bin)DsDsmcmode_DatabaseSvc_check_install_scriptssetup.make
...
#cmt_local_tagfile_DatabaseSvc_check_install_scripts = $(DsDsmcmode_tag).make
cmt_local_tagfile_DatabaseSvc_check_install_scripts = $(bin)$(DsDsmcmode_tag).make
cmt_final_setup_DatabaseSvc_check_install_scripts = $(bin)setup.make
#cmt_final_setup_DatabaseSvc_check_install_scripts = $(bin)DsDsmcmodesetup.make
cmt_local_DatabaseSvc_check_install_scripts_makefile = $(bin)DatabaseSvc_check_install_scripts.make
