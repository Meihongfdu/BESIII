#ifndef DsDsmcmode_selection_H 
#define DsDsmcmode_selection_H
...
class  DsDsmcmode 
{
 ...
 public:
  ...
  void  Dspmcmode(SmartDataPtr<Event::McParticleCol> mcParticleCol);
  void  Dsnmcmode(SmartDataPtr<Event::McParticleCol> mcParticleCol);

  void  Taupmcmode(SmartDataPtr<Event::McParticleCol> mcParticleCol);
  void  Taunmcmode(SmartDataPtr<Event::McParticleCol> mcParticleCol);
  ...
  void  DspmcmodeF(SmartDataPtr<Event::McParticleCol>);
  void  DsnmcmodeF(SmartDataPtr<Event::McParticleCol>);  

  void  Psimcmode(SmartDataPtr<Event::McParticleCol>);

  void  Dst1mcmode(SmartDataPtr<Event::McParticleCol>);
  void  Dst2mcmode(SmartDataPtr<Event::McParticleCol>);
