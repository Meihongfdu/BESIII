...
#cmt_local_tagfile = $(neeAlg_tag).make
cmt_local_tagfile = $(bin)$(neeAlg_tag).make
...
cmt_local_setup_neeAlg = $(bin)setup_neeAlg$$$$.make
...
neeAlg_extratags = -tag_add=target_neeAlg

#$(cmt_local_tagfile_neeAlg) : $(cmt_lock_setup)
ifndef QUICK
$(cmt_local_tagfile_neeAlg) ::
else
$(cmt_local_tagfile_neeAlg) :
endif
	$(echo) "(constituents.make) Rebuilding $@"; \
	  if test -f $(cmt_local_tagfile_neeAlg); then /bin/rm -f $(cmt_local_tagfile_neeAlg); fi ; \
	  $(cmtexe) -tag=$(tags) $(neeAlg_extratags) build tag_makefile >>$(cmt_local_tagfile_neeAlg)
	$(echo) "(constituents.make) Rebuilding $(cmt_final_setup_neeAlg)"; \
	  test ! -f $(cmt_local_setup_neeAlg) || \rm -f $(cmt_local_setup_neeAlg); \
	  trap '\rm -f $(cmt_local_setup_neeAlg)' 0 1 2 15; \
	  $(cmtexe) -tag=$(tags) $(neeAlg_extratags) show setup >$(cmt_local_setup_neeAlg) && \
	  if [ -f $(cmt_final_setup_neeAlg) ] && \
	    \cmp -s $(cmt_final_setup_neeAlg) $(cmt_local_setup_neeAlg); then \
	    \rm $(cmt_local_setup_neeAlg); else \
	    \mv -f $(cmt_local_setup_neeAlg) $(cmt_final_setup_neeAlg); fi
...
not_neeAlg_dependencies = { n=0; for p in $?; do m=0; for d in $(neeAlg_dependencies); do if [ $$p = $$d ]; then m=1; break; fi; done; if [ $$m -eq 0 ]; then n=1; break; fi; done; [ $$n -eq 1 ]; }

ifdef STRUCTURED_OUTPUT
neeAlgdirs :
	@if test ! -d $(bin)neeAlg; then $(mkdir) -p $(bin)neeAlg; fi
	$(echo) "STRUCTURED_OUTPUT="$(bin)neeAlg
else
neeAlgdirs : ;
endif
...
#	$(echo) "STRUCTURED_OUTPUT="$(bin)neeAlg
#
#$(cmt_local_neeAlg_makefile) :: $(neeAlg_dependencies) $(cmt_local_tagfile_neeAlg) build_library_links dirs neeAlgdirs
#else
#$(cmt_local_neeAlg_makefile) :: $(neeAlg_dependencies) $(cmt_local_tagfile_neeAlg) build_library_links dirs
#endif
#else
#$(cmt_local_neeAlg_makefile) :: $(cmt_local_tagfile_neeAlg)
#endif

ifdef cmt_neeAlg_has_target_tag

ifndef QUICK
$(cmt_local_neeAlg_makefile) : $(neeAlg_dependencies) build_library_links
	$(echo) "(constituents.make) Building neeAlg.make"; \
	  $(cmtexe) -tag=$(tags) $(neeAlg_extratags) build constituent_config -out=$(cmt_local_neeAlg_makefile) neeAlg
else
$(cmt_local_neeAlg_makefile) : $(neeAlg_dependencies) $(cmt_build_library_linksstamp) $(use_requirements)
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_neeAlg) ] || \
	  [ ! -f $(cmt_final_setup_neeAlg) ] || \
	  $(not_neeAlg_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
	  echo "$(CMTMSGPREFIX)" "(constituents.make) Building neeAlg.make"; \
	  $(cmtexe) -tag=$(tags) $(neeAlg_extratags) build constituent_config -out=$(cmt_local_neeAlg_makefile) neeAlg; \
	  fi
endif
...
$(cmt_local_neeAlg_makefile) : $(neeAlg_dependencies) build_library_links
	$(echo) "(constituents.make) Building neeAlg.make"; \
	  $(cmtexe) -f=$(bin)neeAlg.in -tag=$(tags) $(neeAlg_extratags) build constituent_makefile -without_cmt -out=$(cmt_local_neeAlg_makefile) neeAlg
else
$(cmt_local_neeAlg_makefile) : $(neeAlg_dependencies) $(cmt_build_library_linksstamp) $(bin)neeAlg.in
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_neeAlg) ] || \
	  [ ! -f $(cmt_final_setup_neeAlg) ] || \
	  $(not_neeAlg_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
...
#	  $(cmtexe) -tag=$(tags) $(neeAlg_extratags) build constituent_makefile -out=$(cmt_local_neeAlg_makefile) neeAlg

neeAlg :: $(neeAlg_dependencies) $(cmt_local_neeAlg_makefile) dirs neeAlgdirs
	$(echo) "(constituents.make) Starting neeAlg"
	@if test -f $(cmt_local_neeAlg_makefile); then \
	  $(MAKE) -f $(cmt_local_neeAlg_makefile) neeAlg; \
	  fi
#	@$(MAKE) -f $(cmt_local_neeAlg_makefile) neeAlg
	$(echo) "(constituents.make) neeAlg done"

clean :: neeAlgclean

neeAlgclean :: $(neeAlgclean_dependencies) ##$(cmt_local_neeAlg_makefile)
	$(echo) "(constituents.make) Starting neeAlgclean"
	@-if test -f $(cmt_local_neeAlg_makefile); then \
	  $(MAKE) -f $(cmt_local_neeAlg_makefile) neeAlgclean; \
	fi
	$(echo) "(constituents.make) neeAlgclean done"
#	@-$(MAKE) -f $(cmt_local_neeAlg_makefile) neeAlgclean

##	  /bin/rm -f $(cmt_local_neeAlg_makefile) $(bin)neeAlg_dependencies.make

install :: neeAlginstall

neeAlginstall :: $(neeAlg_dependencies) $(cmt_local_neeAlg_makefile)
	$(echo) "(constituents.make) Starting install neeAlg"
	@-$(MAKE) -f $(cmt_local_neeAlg_makefile) install
	$(echo) "(constituents.make) install neeAlg done"

uninstall : neeAlguninstall

$(foreach d,$(neeAlg_dependencies),$(eval $(d)uninstall_dependencies += neeAlguninstall))

neeAlguninstall : $(neeAlguninstall_dependencies) ##$(cmt_local_neeAlg_makefile)
	$(echo) "(constituents.make) Starting uninstall neeAlg"
	@if test -f $(cmt_local_neeAlg_makefile); then \
	  $(MAKE) -f $(cmt_local_neeAlg_makefile) uninstall; \
	  fi
#	@$(MAKE) -f $(cmt_local_neeAlg_makefile) uninstall
	$(echo) "(constituents.make) uninstall neeAlg done"

remove_library_links :: neeAlguninstall
...
#cmt_local_tagfile_install_runtime = $(neeAlg_tag)_install_runtime.make
cmt_local_tagfile_install_runtime = $(bin)$(neeAlg_tag)_install_runtime.make
...
#cmt_final_setup_install_runtime = $(bin)neeAlg_install_runtimesetup.make
...
#cmt_local_tagfile_install_runtime = $(neeAlg_tag).make
cmt_local_tagfile_install_runtime = $(bin)$(neeAlg_tag).make
cmt_final_setup_install_runtime = $(bin)setup.make
#cmt_final_setup_install_runtime = $(bin)neeAlgsetup.make
cmt_local_install_runtime_makefile = $(bin)install_runtime.make
...
#cmt_local_tagfile_config = $(neeAlg_tag)_config.make
cmt_local_tagfile_config = $(bin)$(neeAlg_tag)_config.make
cmt_local_setup_config = $(bin)setup_config$$$$.make
cmt_final_setup_config = $(bin)setup_config.make
#cmt_final_setup_config = $(bin)neeAlg_configsetup.make
...
#cmt_local_tagfile_config = $(neeAlg_tag).make
cmt_local_tagfile_config = $(bin)$(neeAlg_tag).make
cmt_final_setup_config = $(bin)setup.make
#cmt_final_setup_config = $(bin)neeAlgsetup.make
cmt_local_config_makefile = $(bin)config.make
...
#cmt_local_tagfile_install_includes = $(neeAlg_tag)_install_includes.make
cmt_local_tagfile_install_includes = $(bin)$(neeAlg_tag)_install_includes.make
...
#cmt_final_setup_install_includes = $(bin)neeAlg_install_includessetup.make
...
#cmt_local_tagfile_install_includes = $(neeAlg_tag).make
cmt_local_tagfile_install_includes = $(bin)$(neeAlg_tag).make
cmt_final_setup_install_includes = $(bin)setup.make
#cmt_final_setup_install_includes = $(bin)neeAlgsetup.make
cmt_local_install_includes_makefile = $(bin)install_includes.make
...
#cmt_local_tagfile_make = $(neeAlg_tag)_make.make
cmt_local_tagfile_make = $(bin)$(neeAlg_tag)_make.make
cmt_local_setup_make = $(bin)setup_make$$$$.make
cmt_final_setup_make = $(bin)setup_make.make
#cmt_final_setup_make = $(bin)neeAlg_makesetup.make
...
#cmt_local_tagfile_make = $(neeAlg_tag).make
cmt_local_tagfile_make = $(bin)$(neeAlg_tag).make
cmt_final_setup_make = $(bin)setup.make
#cmt_final_setup_make = $(bin)neeAlgsetup.make
cmt_local_make_makefile = $(bin)make.make
...
#cmt_local_tagfile_CompilePython = $(neeAlg_tag)_CompilePython.make
cmt_local_tagfile_CompilePython = $(bin)$(neeAlg_tag)_CompilePython.make
cmt_local_setup_CompilePython = $(bin)setup_CompilePython$$$$.make
cmt_final_setup_CompilePython = $(bin)setup_CompilePython.make
#cmt_final_setup_CompilePython = $(bin)neeAlg_CompilePythonsetup.make
...
#cmt_local_tagfile_CompilePython = $(neeAlg_tag).make
cmt_local_tagfile_CompilePython = $(bin)$(neeAlg_tag).make
cmt_final_setup_CompilePython = $(bin)setup.make
#cmt_final_setup_CompilePython = $(bin)neeAlgsetup.make
cmt_local_CompilePython_makefile = $(bin)CompilePython.make
...
#cmt_local_tagfile_qmtest_run = $(neeAlg_tag)_qmtest_run.make
cmt_local_tagfile_qmtest_run = $(bin)$(neeAlg_tag)_qmtest_run.make
cmt_local_setup_qmtest_run = $(bin)setup_qmtest_run$$$$.make
cmt_final_setup_qmtest_run = $(bin)setup_qmtest_run.make
#cmt_final_setup_qmtest_run = $(bin)neeAlg_qmtest_runsetup.make
...
#cmt_local_tagfile_qmtest_run = $(neeAlg_tag).make
cmt_local_tagfile_qmtest_run = $(bin)$(neeAlg_tag).make
cmt_final_setup_qmtest_run = $(bin)setup.make
#cmt_final_setup_qmtest_run = $(bin)neeAlgsetup.make
cmt_local_qmtest_run_makefile = $(bin)qmtest_run.make
...
#cmt_local_tagfile_qmtest_summarize = $(neeAlg_tag)_qmtest_summarize.make
cmt_local_tagfile_qmtest_summarize = $(bin)$(neeAlg_tag)_qmtest_summarize.make
...
#cmt_final_setup_qmtest_summarize = $(bin)neeAlg_qmtest_summarizesetup.make
...
#cmt_local_tagfile_qmtest_summarize = $(neeAlg_tag).make
cmt_local_tagfile_qmtest_summarize = $(bin)$(neeAlg_tag).make
cmt_final_setup_qmtest_summarize = $(bin)setup.make
#cmt_final_setup_qmtest_summarize = $(bin)neeAlgsetup.make
cmt_local_qmtest_summarize_makefile = $(bin)qmtest_summarize.make
...
#cmt_local_tagfile_TestPackage = $(neeAlg_tag)_TestPackage.make
cmt_local_tagfile_TestPackage = $(bin)$(neeAlg_tag)_TestPackage.make
cmt_local_setup_TestPackage = $(bin)setup_TestPackage$$$$.make
cmt_final_setup_TestPackage = $(bin)setup_TestPackage.make
#cmt_final_setup_TestPackage = $(bin)neeAlg_TestPackagesetup.make
...
#cmt_local_tagfile_TestPackage = $(neeAlg_tag).make
cmt_local_tagfile_TestPackage = $(bin)$(neeAlg_tag).make
cmt_final_setup_TestPackage = $(bin)setup.make
#cmt_final_setup_TestPackage = $(bin)neeAlgsetup.make
cmt_local_TestPackage_makefile = $(bin)TestPackage.make
...
#cmt_local_tagfile_TestProject = $(neeAlg_tag)_TestProject.make
cmt_local_tagfile_TestProject = $(bin)$(neeAlg_tag)_TestProject.make
cmt_local_setup_TestProject = $(bin)setup_TestProject$$$$.make
cmt_final_setup_TestProject = $(bin)setup_TestProject.make
#cmt_final_setup_TestProject = $(bin)neeAlg_TestProjectsetup.make
...
#cmt_local_tagfile_TestProject = $(neeAlg_tag).make
cmt_local_tagfile_TestProject = $(bin)$(neeAlg_tag).make
cmt_final_setup_TestProject = $(bin)setup.make
#cmt_final_setup_TestProject = $(bin)neeAlgsetup.make
cmt_local_TestProject_makefile = $(bin)TestProject.make
...
#cmt_local_tagfile_new_rootsys = $(neeAlg_tag)_new_rootsys.make
cmt_local_tagfile_new_rootsys = $(bin)$(neeAlg_tag)_new_rootsys.make
cmt_local_setup_new_rootsys = $(bin)setup_new_rootsys$$$$.make
cmt_final_setup_new_rootsys = $(bin)setup_new_rootsys.make
#cmt_final_setup_new_rootsys = $(bin)neeAlg_new_rootsyssetup.make
...
#cmt_local_tagfile_new_rootsys = $(neeAlg_tag).make
cmt_local_tagfile_new_rootsys = $(bin)$(neeAlg_tag).make
cmt_final_setup_new_rootsys = $(bin)setup.make
#cmt_final_setup_new_rootsys = $(bin)neeAlgsetup.make
cmt_local_new_rootsys_makefile = $(bin)new_rootsys.make
...
#cmt_local_tagfile_DatabaseSvc_check_install_scripts = $(neeAlg_tag)_DatabaseSvc_check_install_scripts.make
cmt_local_tagfile_DatabaseSvc_check_install_scripts = $(bin)$(neeAlg_tag)_DatabaseSvc_check_install_scripts.make
...
#cmt_final_setup_DatabaseSvc_check_install_scripts = $(bin)neeAlg_DatabaseSvc_check_install_scriptssetup.make
...
#cmt_local_tagfile_DatabaseSvc_check_install_scripts = $(neeAlg_tag).make
cmt_local_tagfile_DatabaseSvc_check_install_scripts = $(bin)$(neeAlg_tag).make
cmt_final_setup_DatabaseSvc_check_install_scripts = $(bin)setup.make
#cmt_final_setup_DatabaseSvc_check_install_scripts = $(bin)neeAlgsetup.make
cmt_local_DatabaseSvc_check_install_scripts_makefile = $(bin)DatabaseSvc_check_install_scripts.make
...
cmt_local_setup_neeAlg_check_install_runtime = $(bin)setup_neeAlg_check_install_runtime$$$$.make
...
neeAlg_check_install_runtime_extratags = -tag_add=target_neeAlg_check_install_runtime

#$(cmt_local_tagfile_neeAlg_check_install_runtime) : $(cmt_lock_setup)
ifndef QUICK
$(cmt_local_tagfile_neeAlg_check_install_runtime) ::
else
$(cmt_local_tagfile_neeAlg_check_install_runtime) :
endif
	$(echo) "(constituents.make) Rebuilding $@"; \
	  if test -f $(cmt_local_tagfile_neeAlg_check_install_runtime); then /bin/rm -f $(cmt_local_tagfile_neeAlg_check_install_runtime); fi ; \
	  $(cmtexe) -tag=$(tags) $(neeAlg_check_install_runtime_extratags) build tag_makefile >>$(cmt_local_tagfile_neeAlg_check_install_runtime)
	$(echo) "(constituents.make) Rebuilding $(cmt_final_setup_neeAlg_check_install_runtime)"; \
	  test ! -f $(cmt_local_setup_neeAlg_check_install_runtime) || \rm -f $(cmt_local_setup_neeAlg_check_install_runtime); \
	  trap '\rm -f $(cmt_local_setup_neeAlg_check_install_runtime)' 0 1 2 15; \
	  $(cmtexe) -tag=$(tags) $(neeAlg_check_install_runtime_extratags) show setup >$(cmt_local_setup_neeAlg_check_install_runtime) && \
	  if [ -f $(cmt_final_setup_neeAlg_check_install_runtime) ] && \
	    \cmp -s $(cmt_final_setup_neeAlg_check_install_runtime) $(cmt_local_setup_neeAlg_check_install_runtime); then \
	    \rm $(cmt_local_setup_neeAlg_check_install_runtime); else \
	    \mv -f $(cmt_local_setup_neeAlg_check_install_runtime) $(cmt_final_setup_neeAlg_check_install_runtime); fi
...
not_neeAlg_check_install_runtime_dependencies = { n=0; for p in $?; do m=0; for d in $(neeAlg_check_install_runtime_dependencies); do if [ $$p = $$d ]; then m=1; break; fi; done; if [ $$m -eq 0 ]; then n=1; break; fi; done; [ $$n -eq 1 ]; }

ifdef STRUCTURED_OUTPUT
neeAlg_check_install_runtimedirs :
	@if test ! -d $(bin)neeAlg_check_install_runtime; then $(mkdir) -p $(bin)neeAlg_check_install_runtime; fi
	$(echo) "STRUCTURED_OUTPUT="$(bin)neeAlg_check_install_runtime
else
neeAlg_check_install_runtimedirs : ;
endif
...
#	$(echo) "STRUCTURED_OUTPUT="$(bin)neeAlg_check_install_runtime
#
#$(cmt_local_neeAlg_check_install_runtime_makefile) :: $(neeAlg_check_install_runtime_dependencies) $(cmt_local_tagfile_neeAlg_check_install_runtime) build_library_links dirs neeAlg_check_install_runtimedirs
#else
#$(cmt_local_neeAlg_check_install_runtime_makefile) :: $(neeAlg_check_install_runtime_dependencies) $(cmt_local_tagfile_neeAlg_check_install_runtime) build_library_links dirs
#endif
#else
#$(cmt_local_neeAlg_check_install_runtime_makefile) :: $(cmt_local_tagfile_neeAlg_check_install_runtime)
#endif

ifdef cmt_neeAlg_check_install_runtime_has_target_tag

ifndef QUICK
$(cmt_local_neeAlg_check_install_runtime_makefile) : $(neeAlg_check_install_runtime_dependencies) build_library_links
	$(echo) "(constituents.make) Building neeAlg_check_install_runtime.make"; \
	  $(cmtexe) -tag=$(tags) $(neeAlg_check_install_runtime_extratags) build constituent_config -out=$(cmt_local_neeAlg_check_install_runtime_makefile) neeAlg_check_install_runtime
else
$(cmt_local_neeAlg_check_install_runtime_makefile) : $(neeAlg_check_install_runtime_dependencies) $(cmt_build_library_linksstamp) $(use_requirements)
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_neeAlg_check_install_runtime) ] || \
	  [ ! -f $(cmt_final_setup_neeAlg_check_install_runtime) ] || \
	  $(not_neeAlg_check_install_runtime_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
	  echo "$(CMTMSGPREFIX)" "(constituents.make) Building neeAlg_check_install_runtime.make"; \
	  $(cmtexe) -tag=$(tags) $(neeAlg_check_install_runtime_extratags) build constituent_config -out=$(cmt_local_neeAlg_check_install_runtime_makefile) neeAlg_check_install_runtime; \
	  fi
endif
...
$(cmt_local_neeAlg_check_install_runtime_makefile) : $(neeAlg_check_install_runtime_dependencies) build_library_links
	$(echo) "(constituents.make) Building neeAlg_check_install_runtime.make"; \
	  $(cmtexe) -f=$(bin)neeAlg_check_install_runtime.in -tag=$(tags) $(neeAlg_check_install_runtime_extratags) build constituent_makefile -without_cmt -out=$(cmt_local_neeAlg_check_install_runtime_makefile) neeAlg_check_install_runtime
else
$(cmt_local_neeAlg_check_install_runtime_makefile) : $(neeAlg_check_install_runtime_dependencies) $(cmt_build_library_linksstamp) $(bin)neeAlg_check_install_runtime.in
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_neeAlg_check_install_runtime) ] || \
	  [ ! -f $(cmt_final_setup_neeAlg_check_install_runtime) ] || \
	  $(not_neeAlg_check_install_runtime_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
...
#	  $(cmtexe) -tag=$(tags) $(neeAlg_check_install_runtime_extratags) build constituent_makefile -out=$(cmt_local_neeAlg_check_install_runtime_makefile) neeAlg_check_install_runtime

neeAlg_check_install_runtime :: $(neeAlg_check_install_runtime_dependencies) $(cmt_local_neeAlg_check_install_runtime_makefile) dirs neeAlg_check_install_runtimedirs
	$(echo) "(constituents.make) Starting neeAlg_check_install_runtime"
	@if test -f $(cmt_local_neeAlg_check_install_runtime_makefile); then \
	  $(MAKE) -f $(cmt_local_neeAlg_check_install_runtime_makefile) neeAlg_check_install_runtime; \
	  fi
#	@$(MAKE) -f $(cmt_local_neeAlg_check_install_runtime_makefile) neeAlg_check_install_runtime
	$(echo) "(constituents.make) neeAlg_check_install_runtime done"

clean :: neeAlg_check_install_runtimeclean

neeAlg_check_install_runtimeclean :: $(neeAlg_check_install_runtimeclean_dependencies) ##$(cmt_local_neeAlg_check_install_runtime_makefile)
	$(echo) "(constituents.make) Starting neeAlg_check_install_runtimeclean"
	@-if test -f $(cmt_local_neeAlg_check_install_runtime_makefile); then \
	  $(MAKE) -f $(cmt_local_neeAlg_check_install_runtime_makefile) neeAlg_check_install_runtimeclean; \
	fi
	$(echo) "(constituents.make) neeAlg_check_install_runtimeclean done"
#	@-$(MAKE) -f $(cmt_local_neeAlg_check_install_runtime_makefile) neeAlg_check_install_runtimeclean

##	  /bin/rm -f $(cmt_local_neeAlg_check_install_runtime_makefile) $(bin)neeAlg_check_install_runtime_dependencies.make

install :: neeAlg_check_install_runtimeinstall

neeAlg_check_install_runtimeinstall :: $(neeAlg_check_install_runtime_dependencies) $(cmt_local_neeAlg_check_install_runtime_makefile)
	$(echo) "(constituents.make) Starting install neeAlg_check_install_runtime"
	@-$(MAKE) -f $(cmt_local_neeAlg_check_install_runtime_makefile) install
	$(echo) "(constituents.make) install neeAlg_check_install_runtime done"

uninstall : neeAlg_check_install_runtimeuninstall

$(foreach d,$(neeAlg_check_install_runtime_dependencies),$(eval $(d)uninstall_dependencies += neeAlg_check_install_runtimeuninstall))

neeAlg_check_install_runtimeuninstall : $(neeAlg_check_install_runtimeuninstall_dependencies) ##$(cmt_local_neeAlg_check_install_runtime_makefile)
	$(echo) "(constituents.make) Starting uninstall neeAlg_check_install_runtime"
	@if test -f $(cmt_local_neeAlg_check_install_runtime_makefile); then \
	  $(MAKE) -f $(cmt_local_neeAlg_check_install_runtime_makefile) uninstall; \
	  fi
#	@$(MAKE) -f $(cmt_local_neeAlg_check_install_runtime_makefile) uninstall
	$(echo) "(constituents.make) uninstall neeAlg_check_install_runtime done"

remove_library_links :: neeAlg_check_install_runtimeuninstall
