...
#cmt_local_tagfile = $(Lambda_eeAlg_tag).make
cmt_local_tagfile = $(bin)$(Lambda_eeAlg_tag).make
...
cmt_local_setup_Lambda_eeAlg = $(bin)setup_Lambda_eeAlg$$$$.make
...
Lambda_eeAlg_extratags = -tag_add=target_Lambda_eeAlg

#$(cmt_local_tagfile_Lambda_eeAlg) : $(cmt_lock_setup)
ifndef QUICK
$(cmt_local_tagfile_Lambda_eeAlg) ::
else
$(cmt_local_tagfile_Lambda_eeAlg) :
endif
	$(echo) "(constituents.make) Rebuilding $@"; \
	  if test -f $(cmt_local_tagfile_Lambda_eeAlg); then /bin/rm -f $(cmt_local_tagfile_Lambda_eeAlg); fi ; \
	  $(cmtexe) -tag=$(tags) $(Lambda_eeAlg_extratags) build tag_makefile >>$(cmt_local_tagfile_Lambda_eeAlg)
	$(echo) "(constituents.make) Rebuilding $(cmt_final_setup_Lambda_eeAlg)"; \
	  test ! -f $(cmt_local_setup_Lambda_eeAlg) || \rm -f $(cmt_local_setup_Lambda_eeAlg); \
	  trap '\rm -f $(cmt_local_setup_Lambda_eeAlg)' 0 1 2 15; \
	  $(cmtexe) -tag=$(tags) $(Lambda_eeAlg_extratags) show setup >$(cmt_local_setup_Lambda_eeAlg) && \
	  if [ -f $(cmt_final_setup_Lambda_eeAlg) ] && \
	    \cmp -s $(cmt_final_setup_Lambda_eeAlg) $(cmt_local_setup_Lambda_eeAlg); then \
	    \rm $(cmt_local_setup_Lambda_eeAlg); else \
	    \mv -f $(cmt_local_setup_Lambda_eeAlg) $(cmt_final_setup_Lambda_eeAlg); fi
...
not_Lambda_eeAlg_dependencies = { n=0; for p in $?; do m=0; for d in $(Lambda_eeAlg_dependencies); do if [ $$p = $$d ]; then m=1; break; fi; done; if [ $$m -eq 0 ]; then n=1; break; fi; done; [ $$n -eq 1 ]; }

ifdef STRUCTURED_OUTPUT
Lambda_eeAlgdirs :
	@if test ! -d $(bin)Lambda_eeAlg; then $(mkdir) -p $(bin)Lambda_eeAlg; fi
	$(echo) "STRUCTURED_OUTPUT="$(bin)Lambda_eeAlg
else
Lambda_eeAlgdirs : ;
endif
...
#	$(echo) "STRUCTURED_OUTPUT="$(bin)Lambda_eeAlg
#
#$(cmt_local_Lambda_eeAlg_makefile) :: $(Lambda_eeAlg_dependencies) $(cmt_local_tagfile_Lambda_eeAlg) build_library_links dirs Lambda_eeAlgdirs
#else
#$(cmt_local_Lambda_eeAlg_makefile) :: $(Lambda_eeAlg_dependencies) $(cmt_local_tagfile_Lambda_eeAlg) build_library_links dirs
#endif
#else
#$(cmt_local_Lambda_eeAlg_makefile) :: $(cmt_local_tagfile_Lambda_eeAlg)
#endif

ifdef cmt_Lambda_eeAlg_has_target_tag

ifndef QUICK
$(cmt_local_Lambda_eeAlg_makefile) : $(Lambda_eeAlg_dependencies) build_library_links
	$(echo) "(constituents.make) Building Lambda_eeAlg.make"; \
	  $(cmtexe) -tag=$(tags) $(Lambda_eeAlg_extratags) build constituent_config -out=$(cmt_local_Lambda_eeAlg_makefile) Lambda_eeAlg
else
$(cmt_local_Lambda_eeAlg_makefile) : $(Lambda_eeAlg_dependencies) $(cmt_build_library_linksstamp) $(use_requirements)
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_Lambda_eeAlg) ] || \
	  [ ! -f $(cmt_final_setup_Lambda_eeAlg) ] || \
	  $(not_Lambda_eeAlg_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
	  echo "$(CMTMSGPREFIX)" "(constituents.make) Building Lambda_eeAlg.make"; \
	  $(cmtexe) -tag=$(tags) $(Lambda_eeAlg_extratags) build constituent_config -out=$(cmt_local_Lambda_eeAlg_makefile) Lambda_eeAlg; \
	  fi
endif
...
$(cmt_local_Lambda_eeAlg_makefile) : $(Lambda_eeAlg_dependencies) build_library_links
	$(echo) "(constituents.make) Building Lambda_eeAlg.make"; \
	  $(cmtexe) -f=$(bin)Lambda_eeAlg.in -tag=$(tags) $(Lambda_eeAlg_extratags) build constituent_makefile -without_cmt -out=$(cmt_local_Lambda_eeAlg_makefile) Lambda_eeAlg
else
$(cmt_local_Lambda_eeAlg_makefile) : $(Lambda_eeAlg_dependencies) $(cmt_build_library_linksstamp) $(bin)Lambda_eeAlg.in
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_Lambda_eeAlg) ] || \
	  [ ! -f $(cmt_final_setup_Lambda_eeAlg) ] || \
	  $(not_Lambda_eeAlg_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
...
#	  $(cmtexe) -tag=$(tags) $(Lambda_eeAlg_extratags) build constituent_makefile -out=$(cmt_local_Lambda_eeAlg_makefile) Lambda_eeAlg

Lambda_eeAlg :: $(Lambda_eeAlg_dependencies) $(cmt_local_Lambda_eeAlg_makefile) dirs Lambda_eeAlgdirs
	$(echo) "(constituents.make) Starting Lambda_eeAlg"
	@if test -f $(cmt_local_Lambda_eeAlg_makefile); then \
	  $(MAKE) -f $(cmt_local_Lambda_eeAlg_makefile) Lambda_eeAlg; \
	  fi
#	@$(MAKE) -f $(cmt_local_Lambda_eeAlg_makefile) Lambda_eeAlg
	$(echo) "(constituents.make) Lambda_eeAlg done"

clean :: Lambda_eeAlgclean

Lambda_eeAlgclean :: $(Lambda_eeAlgclean_dependencies) ##$(cmt_local_Lambda_eeAlg_makefile)
	$(echo) "(constituents.make) Starting Lambda_eeAlgclean"
	@-if test -f $(cmt_local_Lambda_eeAlg_makefile); then \
	  $(MAKE) -f $(cmt_local_Lambda_eeAlg_makefile) Lambda_eeAlgclean; \
	fi
	$(echo) "(constituents.make) Lambda_eeAlgclean done"
#	@-$(MAKE) -f $(cmt_local_Lambda_eeAlg_makefile) Lambda_eeAlgclean

##	  /bin/rm -f $(cmt_local_Lambda_eeAlg_makefile) $(bin)Lambda_eeAlg_dependencies.make

install :: Lambda_eeAlginstall

Lambda_eeAlginstall :: $(Lambda_eeAlg_dependencies) $(cmt_local_Lambda_eeAlg_makefile)
	$(echo) "(constituents.make) Starting install Lambda_eeAlg"
	@-$(MAKE) -f $(cmt_local_Lambda_eeAlg_makefile) install
	$(echo) "(constituents.make) install Lambda_eeAlg done"

uninstall : Lambda_eeAlguninstall

$(foreach d,$(Lambda_eeAlg_dependencies),$(eval $(d)uninstall_dependencies += Lambda_eeAlguninstall))

Lambda_eeAlguninstall : $(Lambda_eeAlguninstall_dependencies) ##$(cmt_local_Lambda_eeAlg_makefile)
	$(echo) "(constituents.make) Starting uninstall Lambda_eeAlg"
	@if test -f $(cmt_local_Lambda_eeAlg_makefile); then \
	  $(MAKE) -f $(cmt_local_Lambda_eeAlg_makefile) uninstall; \
	  fi
#	@$(MAKE) -f $(cmt_local_Lambda_eeAlg_makefile) uninstall
	$(echo) "(constituents.make) uninstall Lambda_eeAlg done"

remove_library_links :: Lambda_eeAlguninstall
...
#cmt_local_tagfile_install_runtime = $(Lambda_eeAlg_tag)_install_runtime.make
cmt_local_tagfile_install_runtime = $(bin)$(Lambda_eeAlg_tag)_install_runtime.make
...
#cmt_final_setup_install_runtime = $(bin)Lambda_eeAlg_install_runtimesetup.make
...
#cmt_local_tagfile_install_runtime = $(Lambda_eeAlg_tag).make
cmt_local_tagfile_install_runtime = $(bin)$(Lambda_eeAlg_tag).make
cmt_final_setup_install_runtime = $(bin)setup.make
#cmt_final_setup_install_runtime = $(bin)Lambda_eeAlgsetup.make
cmt_local_install_runtime_makefile = $(bin)install_runtime.make
...
#cmt_local_tagfile_config = $(Lambda_eeAlg_tag)_config.make
cmt_local_tagfile_config = $(bin)$(Lambda_eeAlg_tag)_config.make
cmt_local_setup_config = $(bin)setup_config$$$$.make
cmt_final_setup_config = $(bin)setup_config.make
#cmt_final_setup_config = $(bin)Lambda_eeAlg_configsetup.make
...
#cmt_local_tagfile_config = $(Lambda_eeAlg_tag).make
cmt_local_tagfile_config = $(bin)$(Lambda_eeAlg_tag).make
cmt_final_setup_config = $(bin)setup.make
#cmt_final_setup_config = $(bin)Lambda_eeAlgsetup.make
cmt_local_config_makefile = $(bin)config.make
...
#cmt_local_tagfile_install_includes = $(Lambda_eeAlg_tag)_install_includes.make
cmt_local_tagfile_install_includes = $(bin)$(Lambda_eeAlg_tag)_install_includes.make
...
#cmt_final_setup_install_includes = $(bin)Lambda_eeAlg_install_includessetup.make
...
#cmt_local_tagfile_install_includes = $(Lambda_eeAlg_tag).make
cmt_local_tagfile_install_includes = $(bin)$(Lambda_eeAlg_tag).make
cmt_final_setup_install_includes = $(bin)setup.make
#cmt_final_setup_install_includes = $(bin)Lambda_eeAlgsetup.make
cmt_local_install_includes_makefile = $(bin)install_includes.make
...
#cmt_local_tagfile_make = $(Lambda_eeAlg_tag)_make.make
cmt_local_tagfile_make = $(bin)$(Lambda_eeAlg_tag)_make.make
cmt_local_setup_make = $(bin)setup_make$$$$.make
cmt_final_setup_make = $(bin)setup_make.make
#cmt_final_setup_make = $(bin)Lambda_eeAlg_makesetup.make
...
#cmt_local_tagfile_make = $(Lambda_eeAlg_tag).make
cmt_local_tagfile_make = $(bin)$(Lambda_eeAlg_tag).make
cmt_final_setup_make = $(bin)setup.make
#cmt_final_setup_make = $(bin)Lambda_eeAlgsetup.make
cmt_local_make_makefile = $(bin)make.make
...
#cmt_local_tagfile_CompilePython = $(Lambda_eeAlg_tag)_CompilePython.make
cmt_local_tagfile_CompilePython = $(bin)$(Lambda_eeAlg_tag)_CompilePython.make
cmt_local_setup_CompilePython = $(bin)setup_CompilePython$$$$.make
cmt_final_setup_CompilePython = $(bin)setup_CompilePython.make
#cmt_final_setup_CompilePython = $(bin)Lambda_eeAlg_CompilePythonsetup.make
...
#cmt_local_tagfile_CompilePython = $(Lambda_eeAlg_tag).make
cmt_local_tagfile_CompilePython = $(bin)$(Lambda_eeAlg_tag).make
cmt_final_setup_CompilePython = $(bin)setup.make
#cmt_final_setup_CompilePython = $(bin)Lambda_eeAlgsetup.make
cmt_local_CompilePython_makefile = $(bin)CompilePython.make
...
#cmt_local_tagfile_qmtest_run = $(Lambda_eeAlg_tag)_qmtest_run.make
cmt_local_tagfile_qmtest_run = $(bin)$(Lambda_eeAlg_tag)_qmtest_run.make
cmt_local_setup_qmtest_run = $(bin)setup_qmtest_run$$$$.make
cmt_final_setup_qmtest_run = $(bin)setup_qmtest_run.make
#cmt_final_setup_qmtest_run = $(bin)Lambda_eeAlg_qmtest_runsetup.make
...
#cmt_local_tagfile_qmtest_run = $(Lambda_eeAlg_tag).make
cmt_local_tagfile_qmtest_run = $(bin)$(Lambda_eeAlg_tag).make
cmt_final_setup_qmtest_run = $(bin)setup.make
#cmt_final_setup_qmtest_run = $(bin)Lambda_eeAlgsetup.make
cmt_local_qmtest_run_makefile = $(bin)qmtest_run.make
...
#cmt_local_tagfile_qmtest_summarize = $(Lambda_eeAlg_tag)_qmtest_summarize.make
cmt_local_tagfile_qmtest_summarize = $(bin)$(Lambda_eeAlg_tag)_qmtest_summarize.make
...
#cmt_final_setup_qmtest_summarize = $(bin)Lambda_eeAlg_qmtest_summarizesetup.make
...
#cmt_local_tagfile_qmtest_summarize = $(Lambda_eeAlg_tag).make
cmt_local_tagfile_qmtest_summarize = $(bin)$(Lambda_eeAlg_tag).make
cmt_final_setup_qmtest_summarize = $(bin)setup.make
#cmt_final_setup_qmtest_summarize = $(bin)Lambda_eeAlgsetup.make
cmt_local_qmtest_summarize_makefile = $(bin)qmtest_summarize.make
...
#cmt_local_tagfile_TestPackage = $(Lambda_eeAlg_tag)_TestPackage.make
cmt_local_tagfile_TestPackage = $(bin)$(Lambda_eeAlg_tag)_TestPackage.make
cmt_local_setup_TestPackage = $(bin)setup_TestPackage$$$$.make
cmt_final_setup_TestPackage = $(bin)setup_TestPackage.make
#cmt_final_setup_TestPackage = $(bin)Lambda_eeAlg_TestPackagesetup.make
...
#cmt_local_tagfile_TestPackage = $(Lambda_eeAlg_tag).make
cmt_local_tagfile_TestPackage = $(bin)$(Lambda_eeAlg_tag).make
cmt_final_setup_TestPackage = $(bin)setup.make
#cmt_final_setup_TestPackage = $(bin)Lambda_eeAlgsetup.make
cmt_local_TestPackage_makefile = $(bin)TestPackage.make
...
#cmt_local_tagfile_TestProject = $(Lambda_eeAlg_tag)_TestProject.make
cmt_local_tagfile_TestProject = $(bin)$(Lambda_eeAlg_tag)_TestProject.make
cmt_local_setup_TestProject = $(bin)setup_TestProject$$$$.make
cmt_final_setup_TestProject = $(bin)setup_TestProject.make
#cmt_final_setup_TestProject = $(bin)Lambda_eeAlg_TestProjectsetup.make
...
#cmt_local_tagfile_TestProject = $(Lambda_eeAlg_tag).make
cmt_local_tagfile_TestProject = $(bin)$(Lambda_eeAlg_tag).make
cmt_final_setup_TestProject = $(bin)setup.make
#cmt_final_setup_TestProject = $(bin)Lambda_eeAlgsetup.make
cmt_local_TestProject_makefile = $(bin)TestProject.make
...
#cmt_local_tagfile_new_rootsys = $(Lambda_eeAlg_tag)_new_rootsys.make
cmt_local_tagfile_new_rootsys = $(bin)$(Lambda_eeAlg_tag)_new_rootsys.make
cmt_local_setup_new_rootsys = $(bin)setup_new_rootsys$$$$.make
cmt_final_setup_new_rootsys = $(bin)setup_new_rootsys.make
#cmt_final_setup_new_rootsys = $(bin)Lambda_eeAlg_new_rootsyssetup.make
...
#cmt_local_tagfile_new_rootsys = $(Lambda_eeAlg_tag).make
cmt_local_tagfile_new_rootsys = $(bin)$(Lambda_eeAlg_tag).make
cmt_final_setup_new_rootsys = $(bin)setup.make
#cmt_final_setup_new_rootsys = $(bin)Lambda_eeAlgsetup.make
cmt_local_new_rootsys_makefile = $(bin)new_rootsys.make
...
#cmt_local_tagfile_DatabaseSvc_check_install_scripts = $(Lambda_eeAlg_tag)_DatabaseSvc_check_install_scripts.make
cmt_local_tagfile_DatabaseSvc_check_install_scripts = $(bin)$(Lambda_eeAlg_tag)_DatabaseSvc_check_install_scripts.make
...
#cmt_final_setup_DatabaseSvc_check_install_scripts = $(bin)Lambda_eeAlg_DatabaseSvc_check_install_scriptssetup.make
...
#cmt_local_tagfile_DatabaseSvc_check_install_scripts = $(Lambda_eeAlg_tag).make
cmt_local_tagfile_DatabaseSvc_check_install_scripts = $(bin)$(Lambda_eeAlg_tag).make
cmt_final_setup_DatabaseSvc_check_install_scripts = $(bin)setup.make
#cmt_final_setup_DatabaseSvc_check_install_scripts = $(bin)Lambda_eeAlgsetup.make
cmt_local_DatabaseSvc_check_install_scripts_makefile = $(bin)DatabaseSvc_check_install_scripts.make
...
cmt_local_setup_Lambda_eeAlg_check_install_runtime = $(bin)setup_Lambda_eeAlg_check_install_runtime$$$$.make
...
Lambda_eeAlg_check_install_runtime_extratags = -tag_add=target_Lambda_eeAlg_check_install_runtime

#$(cmt_local_tagfile_Lambda_eeAlg_check_install_runtime) : $(cmt_lock_setup)
ifndef QUICK
$(cmt_local_tagfile_Lambda_eeAlg_check_install_runtime) ::
else
$(cmt_local_tagfile_Lambda_eeAlg_check_install_runtime) :
endif
	$(echo) "(constituents.make) Rebuilding $@"; \
	  if test -f $(cmt_local_tagfile_Lambda_eeAlg_check_install_runtime); then /bin/rm -f $(cmt_local_tagfile_Lambda_eeAlg_check_install_runtime); fi ; \
	  $(cmtexe) -tag=$(tags) $(Lambda_eeAlg_check_install_runtime_extratags) build tag_makefile >>$(cmt_local_tagfile_Lambda_eeAlg_check_install_runtime)
	$(echo) "(constituents.make) Rebuilding $(cmt_final_setup_Lambda_eeAlg_check_install_runtime)"; \
	  test ! -f $(cmt_local_setup_Lambda_eeAlg_check_install_runtime) || \rm -f $(cmt_local_setup_Lambda_eeAlg_check_install_runtime); \
	  trap '\rm -f $(cmt_local_setup_Lambda_eeAlg_check_install_runtime)' 0 1 2 15; \
	  $(cmtexe) -tag=$(tags) $(Lambda_eeAlg_check_install_runtime_extratags) show setup >$(cmt_local_setup_Lambda_eeAlg_check_install_runtime) && \
	  if [ -f $(cmt_final_setup_Lambda_eeAlg_check_install_runtime) ] && \
	    \cmp -s $(cmt_final_setup_Lambda_eeAlg_check_install_runtime) $(cmt_local_setup_Lambda_eeAlg_check_install_runtime); then \
	    \rm $(cmt_local_setup_Lambda_eeAlg_check_install_runtime); else \
	    \mv -f $(cmt_local_setup_Lambda_eeAlg_check_install_runtime) $(cmt_final_setup_Lambda_eeAlg_check_install_runtime); fi
...
not_Lambda_eeAlg_check_install_runtime_dependencies = { n=0; for p in $?; do m=0; for d in $(Lambda_eeAlg_check_install_runtime_dependencies); do if [ $$p = $$d ]; then m=1; break; fi; done; if [ $$m -eq 0 ]; then n=1; break; fi; done; [ $$n -eq 1 ]; }

ifdef STRUCTURED_OUTPUT
Lambda_eeAlg_check_install_runtimedirs :
	@if test ! -d $(bin)Lambda_eeAlg_check_install_runtime; then $(mkdir) -p $(bin)Lambda_eeAlg_check_install_runtime; fi
	$(echo) "STRUCTURED_OUTPUT="$(bin)Lambda_eeAlg_check_install_runtime
else
Lambda_eeAlg_check_install_runtimedirs : ;
endif
...
#	$(echo) "STRUCTURED_OUTPUT="$(bin)Lambda_eeAlg_check_install_runtime
#
#$(cmt_local_Lambda_eeAlg_check_install_runtime_makefile) :: $(Lambda_eeAlg_check_install_runtime_dependencies) $(cmt_local_tagfile_Lambda_eeAlg_check_install_runtime) build_library_links dirs Lambda_eeAlg_check_install_runtimedirs
#else
#$(cmt_local_Lambda_eeAlg_check_install_runtime_makefile) :: $(Lambda_eeAlg_check_install_runtime_dependencies) $(cmt_local_tagfile_Lambda_eeAlg_check_install_runtime) build_library_links dirs
#endif
#else
#$(cmt_local_Lambda_eeAlg_check_install_runtime_makefile) :: $(cmt_local_tagfile_Lambda_eeAlg_check_install_runtime)
#endif

ifdef cmt_Lambda_eeAlg_check_install_runtime_has_target_tag

ifndef QUICK
$(cmt_local_Lambda_eeAlg_check_install_runtime_makefile) : $(Lambda_eeAlg_check_install_runtime_dependencies) build_library_links
	$(echo) "(constituents.make) Building Lambda_eeAlg_check_install_runtime.make"; \
	  $(cmtexe) -tag=$(tags) $(Lambda_eeAlg_check_install_runtime_extratags) build constituent_config -out=$(cmt_local_Lambda_eeAlg_check_install_runtime_makefile) Lambda_eeAlg_check_install_runtime
else
$(cmt_local_Lambda_eeAlg_check_install_runtime_makefile) : $(Lambda_eeAlg_check_install_runtime_dependencies) $(cmt_build_library_linksstamp) $(use_requirements)
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_Lambda_eeAlg_check_install_runtime) ] || \
	  [ ! -f $(cmt_final_setup_Lambda_eeAlg_check_install_runtime) ] || \
	  $(not_Lambda_eeAlg_check_install_runtime_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
	  echo "$(CMTMSGPREFIX)" "(constituents.make) Building Lambda_eeAlg_check_install_runtime.make"; \
	  $(cmtexe) -tag=$(tags) $(Lambda_eeAlg_check_install_runtime_extratags) build constituent_config -out=$(cmt_local_Lambda_eeAlg_check_install_runtime_makefile) Lambda_eeAlg_check_install_runtime; \
	  fi
endif
...
$(cmt_local_Lambda_eeAlg_check_install_runtime_makefile) : $(Lambda_eeAlg_check_install_runtime_dependencies) build_library_links
	$(echo) "(constituents.make) Building Lambda_eeAlg_check_install_runtime.make"; \
	  $(cmtexe) -f=$(bin)Lambda_eeAlg_check_install_runtime.in -tag=$(tags) $(Lambda_eeAlg_check_install_runtime_extratags) build constituent_makefile -without_cmt -out=$(cmt_local_Lambda_eeAlg_check_install_runtime_makefile) Lambda_eeAlg_check_install_runtime
else
$(cmt_local_Lambda_eeAlg_check_install_runtime_makefile) : $(Lambda_eeAlg_check_install_runtime_dependencies) $(cmt_build_library_linksstamp) $(bin)Lambda_eeAlg_check_install_runtime.in
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_Lambda_eeAlg_check_install_runtime) ] || \
	  [ ! -f $(cmt_final_setup_Lambda_eeAlg_check_install_runtime) ] || \
	  $(not_Lambda_eeAlg_check_install_runtime_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
...
#	  $(cmtexe) -tag=$(tags) $(Lambda_eeAlg_check_install_runtime_extratags) build constituent_makefile -out=$(cmt_local_Lambda_eeAlg_check_install_runtime_makefile) Lambda_eeAlg_check_install_runtime

Lambda_eeAlg_check_install_runtime :: $(Lambda_eeAlg_check_install_runtime_dependencies) $(cmt_local_Lambda_eeAlg_check_install_runtime_makefile) dirs Lambda_eeAlg_check_install_runtimedirs
	$(echo) "(constituents.make) Starting Lambda_eeAlg_check_install_runtime"
	@if test -f $(cmt_local_Lambda_eeAlg_check_install_runtime_makefile); then \
	  $(MAKE) -f $(cmt_local_Lambda_eeAlg_check_install_runtime_makefile) Lambda_eeAlg_check_install_runtime; \
	  fi
#	@$(MAKE) -f $(cmt_local_Lambda_eeAlg_check_install_runtime_makefile) Lambda_eeAlg_check_install_runtime
	$(echo) "(constituents.make) Lambda_eeAlg_check_install_runtime done"

clean :: Lambda_eeAlg_check_install_runtimeclean

Lambda_eeAlg_check_install_runtimeclean :: $(Lambda_eeAlg_check_install_runtimeclean_dependencies) ##$(cmt_local_Lambda_eeAlg_check_install_runtime_makefile)
	$(echo) "(constituents.make) Starting Lambda_eeAlg_check_install_runtimeclean"
	@-if test -f $(cmt_local_Lambda_eeAlg_check_install_runtime_makefile); then \
	  $(MAKE) -f $(cmt_local_Lambda_eeAlg_check_install_runtime_makefile) Lambda_eeAlg_check_install_runtimeclean; \
	fi
	$(echo) "(constituents.make) Lambda_eeAlg_check_install_runtimeclean done"
#	@-$(MAKE) -f $(cmt_local_Lambda_eeAlg_check_install_runtime_makefile) Lambda_eeAlg_check_install_runtimeclean

##	  /bin/rm -f $(cmt_local_Lambda_eeAlg_check_install_runtime_makefile) $(bin)Lambda_eeAlg_check_install_runtime_dependencies.make

install :: Lambda_eeAlg_check_install_runtimeinstall

Lambda_eeAlg_check_install_runtimeinstall :: $(Lambda_eeAlg_check_install_runtime_dependencies) $(cmt_local_Lambda_eeAlg_check_install_runtime_makefile)
	$(echo) "(constituents.make) Starting install Lambda_eeAlg_check_install_runtime"
	@-$(MAKE) -f $(cmt_local_Lambda_eeAlg_check_install_runtime_makefile) install
	$(echo) "(constituents.make) install Lambda_eeAlg_check_install_runtime done"

uninstall : Lambda_eeAlg_check_install_runtimeuninstall

$(foreach d,$(Lambda_eeAlg_check_install_runtime_dependencies),$(eval $(d)uninstall_dependencies += Lambda_eeAlg_check_install_runtimeuninstall))

Lambda_eeAlg_check_install_runtimeuninstall : $(Lambda_eeAlg_check_install_runtimeuninstall_dependencies) ##$(cmt_local_Lambda_eeAlg_check_install_runtime_makefile)
	$(echo) "(constituents.make) Starting uninstall Lambda_eeAlg_check_install_runtime"
	@if test -f $(cmt_local_Lambda_eeAlg_check_install_runtime_makefile); then \
	  $(MAKE) -f $(cmt_local_Lambda_eeAlg_check_install_runtime_makefile) uninstall; \
	  fi
#	@$(MAKE) -f $(cmt_local_Lambda_eeAlg_check_install_runtime_makefile) uninstall
	$(echo) "(constituents.make) uninstall Lambda_eeAlg_check_install_runtime done"

remove_library_links :: Lambda_eeAlg_check_install_runtimeuninstall
