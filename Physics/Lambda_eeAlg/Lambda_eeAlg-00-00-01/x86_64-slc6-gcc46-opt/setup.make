...
use BesTimerSvc BesTimerSvc-00-00-12 Utilities (/besfs5/groups/jpsi/jpsigroup/user/liumeihong/workarea/boss7.0.5)
...
use EventTag EventTag-00-01-07 Event (/cvmfs/bes3.ihep.ac.cn/bes3sw/Boss/7.0.5)
...
use VertexFit VertexFit-00-02-85 Analysis (/besfs5/groups/jpsi/jpsigroup/user/liumeihong/workarea/boss7.0.5)
use GammaConv GammaConv-00-00-01 Analysis (/besfs5/groups/jpsi/jpsigroup/user/liumeihong/workarea/boss7.0.5)
use ParticleID ParticleID-00-04-68 Analysis (/cvmfs/bes3.ihep.ac.cn/bes3sw/Boss/7.0.5)
use SimplePIDSvc SimplePIDSvc-00-00-16 Utilities (/besfs5/groups/jpsi/jpsigroup/user/liumeihong/workarea/boss7.0.5)
use DTagTool DTagTool-00-00-13 Analysis (/cvmfs/bes3.ihep.ac.cn/bes3sw/Boss/7.0.5)
use Ecmset Ecmset-00-00-01 Analysis (/besfs5/groups/jpsi/jpsigroup/user/liumeihong/workarea/boss7.0.5)
use DDmcmode DDmcmode-00-00-01 Analysis (/besfs5/groups/jpsi/jpsigroup/user/liumeihong/workarea/boss7.0.5)
----------> tags
...
boss_no_config (from PROJECT) excludes [boss_config]
boss_no_root (from PROJECT) excludes [boss_root]
boss_cleanup (from PROJECT) excludes [boss_no_cleanup]
boss_scripts (from PROJECT) excludes [boss_no_scripts]
boss_prototypes (from PROJECT) excludes [boss_no_prototypes]
boss_without_installarea (from PROJECT) excludes [boss_with_installarea]
boss_with_version_directory (from PROJECT) excludes [boss_without_version_directory]
...
----------> CMTPATH
# Add path /besfs5/groups/jpsi/jpsigroup/user/liumeihong/workarea/boss7.0.5 from initialization
