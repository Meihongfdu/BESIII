...
bool mini_delE;
int       T_tagmode,   tagmode_temp, tagcharge_temp=8888,         sigtagcharge=7777,                ncount,                 ncount2;
int      Ncharge_ex,tag_pid_temp,	tag_pi0id1_temp,	tag_pi0id2_temp,  tag_piid_temp,  tag_gamid_temp, sig_gamid;
...
double  eemc_sig_ep, eemc_sig_p1, evp_sig_ep, evp_sig_p1;
double  eemc_sig_em, eemc_sig_p2, evp_sig_em, evp_sig_p2;
double  eemc_sig_pi,evp_sig_pi;
double 	eemc_sig_1_4c, eemc_sig_2_4c, evp_sig_1_4c, evp_sig_2_4c;
double p_sig_1,		p_sig_2,	p_sig_3,    p_sig_4=5555.;
...
double chi_cut,	tag_mass_bc,	gam_cut,	gam_e1,	gam_emax,	gam_e,           kmfit_chi,  Msigma_4c,Mlambda_4c,Mlambda_4c_sgm0cms,Elambda_4c_sgm0cms,Mee_4c,MJpsi_4c,tag_mass,             tag_deltaE, chi2_min,chi2_pi0;
...
double p_5_temp_b_1_sig=6666.,p_6_temp_b_1_sig=6666.;
//double p_5_1_sig_temp=6666.,p_6_1_sig_temp=6666.;
...
Lambda_ee::Lambda_ee(const std::string& name, ISvcLocator* pSvcLocator) :
...
// * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * 
StatusCode Lambda_ee::initialize(){
    ...
    if ( nt1 ) m_tuple1 = nt1;
        ...
        if ( m_tuple1)     {
            ...
            status = m_tuple1->addItem ("T_angle3",           T_angle3_temp_1);//sgm0_gam
...
//2020.10.24 gammaconversion
            ...
            status = m_tuple11->addItem ("msigma_4c",                 m_sigma_4c);
            ...
            status = m_tuple11->addItem ("mass_lambda",                   m_lambda_4c);
            status = m_tuple11->addItem ("mass_lambda_4c_sgm0cms",                   m_lambda_4c_sgm0cms);
            status = m_tuple11->addItem ("E_lambda_4c_sgm0cms",                   m_elambda_4c_sgm0cms);
            status = m_tuple11->addItem ("mass_ee",                   m_ee_4c);
            status = m_tuple11->addItem ("mass_jpsi",                 m_jpsi_4c);
            ...
            status = m_tuple11->addIndexedItem ("V4_8",                  index_temp_11,  V4_8_temp_11);//sig nu_e
            status = m_tuple11->addIndexedItem ("V4_9",                  index_temp_11,  V4_9_temp_11);//sig nu_e
            status = m_tuple11->addIndexedItem ("V4_10",                  index_temp_11, V4_10_temp_11);//sig nu_e
            ...
            status = m_tuple11->addItem ("index_temp",           index_temp_b_sig,0, 20);
            status = m_tuple11->addItem ("P_1_0_sig", p_1_temp_b_0_sig);//xi
            status = m_tuple11->addItem ("P_2_0_sig", p_2_temp_b_0_sig);//lambda
            status = m_tuple11->addItem ("P_3_0_sig", p_3_temp_b_0_sig);//lambda p
            status = m_tuple11->addItem ("P_4_0_sig", p_4_temp_b_0_sig);//lambda pi
            status = m_tuple11->addItem ("P_5_0_sig", p_5_temp_b_0_sig);//xi pi
            status = m_tuple11->addItem ("P_6_0_sig", p_6_temp_b_0_sig);//e
            status = m_tuple11->addItem ("P_7_0_sig", p_7_temp_b_0_sig);//nue
            status = m_tuple11->addItem ("P_8_0_sig", p_8_temp_b_0_sig);//gamma
            status = m_tuple11->addItem ("P_9_0_sig", p_9_temp_b_0_sig);//nue
            status = m_tuple11->addItem ("P_10_0_sig", p_10_temp_b_0_sig);//gamma

            status = m_tuple11->addItem ("P_1_1_sig", p_1_temp_b_1_sig);//xi
            status = m_tuple11->addItem ("P_2_1_sig", p_2_temp_b_1_sig);//lambda
            status = m_tuple11->addItem ("P_3_1_sig", p_3_temp_b_1_sig);//lambda p
            status = m_tuple11->addItem ("P_4_1_sig", p_4_temp_b_1_sig);//lambda pi
            status = m_tuple11->addItem ("P_5_1_sig", p_5_1_sig_temp);//xi pi
            status = m_tuple11->addItem ("P_6_1_sig", p_6_temp_b_1_sig);//e
            status = m_tuple11->addItem ("P_7_1_sig", p_7_temp_b_1_sig);//nue
            status = m_tuple11->addItem ("P_8_1_sig", p_8_temp_b_1_sig);//gamma
            status = m_tuple11->addItem ("P_9_1_sig", p_9_temp_b_1_sig);//nue
            status = m_tuple11->addItem ("P_10_1_sig", p_10_temp_b_1_sig);//gamma

            status = m_tuple11->addIndexedItem ("V4_1_0_sig",     index_temp_b_sig,  V4_1_temp_b_0_sig);//xi
            status = m_tuple11->addIndexedItem ("V4_2_0_sig",     index_temp_b_sig,  V4_2_temp_b_0_sig);//lambda
            status = m_tuple11->addIndexedItem ("V4_3_0_sig",     index_temp_b_sig,  V4_3_temp_b_0_sig);//lambda p
            status = m_tuple11->addIndexedItem ("V4_4_0_sig",     index_temp_b_sig,  V4_4_temp_b_0_sig);//lambda pi
            status = m_tuple11->addIndexedItem ("V4_5_0_sig",     index_temp_b_sig,  V4_5_temp_b_0_sig);//xi pi
            status = m_tuple11->addIndexedItem ("V4_6_0_sig",     index_temp_b_sig,  V4_6_temp_b_0_sig);//e
            status = m_tuple11->addIndexedItem ("V4_7_0_sig",     index_temp_b_sig,  V4_7_temp_b_0_sig);//sigma+ 
            status = m_tuple11->addIndexedItem ("V4_8_0_sig",     index_temp_b_sig,  V4_8_temp_b_0_sig);//p sigma+
            status = m_tuple11->addIndexedItem ("V4_9_0_sig",     index_temp_b_sig,  V4_9_temp_b_0_sig);//pi0 sigma+
            status = m_tuple11->addIndexedItem ("V4_10_0_sig",    index_temp_b_sig,  V4_10_temp_b_0_sig);//gamma pi0

            status = m_tuple11->addIndexedItem ("V4_1_1_sig",     index_temp_b_sig,  V4_1_temp_b_1_sig);//xi
            status = m_tuple11->addIndexedItem ("V4_2_1_sig",     index_temp_b_sig,  V4_2_temp_b_1_sig);//lambda
            status = m_tuple11->addIndexedItem ("V4_3_1_sig",     index_temp_b_sig,  V4_3_temp_b_1_sig);//lambda p
            status = m_tuple11->addIndexedItem ("V4_4_1_sig",     index_temp_b_sig,  V4_4_temp_b_1_sig);//lambda pi
            status = m_tuple11->addIndexedItem ("V4_5_1_sig",     index_temp_b_sig,  V4_5_temp_b_1_sig);//xi pi
            status = m_tuple11->addIndexedItem ("V4_6_1_sig",     index_temp_b_sig,  V4_6_temp_b_1_sig);//e
            status = m_tuple11->addIndexedItem ("V4_7_1_sig",     index_temp_b_sig,  V4_7_temp_b_1_sig);//sigma+
            status = m_tuple11->addIndexedItem ("V4_8_1_sig",     index_temp_b_sig,  V4_8_temp_b_1_sig);//p sigma+
            status = m_tuple11->addIndexedItem ("V4_9_1_sig",     index_temp_b_sig,  V4_9_temp_b_1_sig);//pi0 sigma+
            status = m_tuple11->addIndexedItem ("V4_10_1_sig",    index_temp_b_sig,  V4_10_temp_b_1_sig);//gamma pi0

            status = m_tuple11->addItem ("C_1_0_sig", c_1_temp_b_0_sig);//xi
            status = m_tuple11->addItem ("C_2_0_sig", c_2_temp_b_0_sig);//lambda
            status = m_tuple11->addItem ("C_3_0_sig", c_3_temp_b_0_sig);//lambda p
            status = m_tuple11->addItem ("C_4_0_sig", c_4_temp_b_0_sig);//lambda pi
            status = m_tuple11->addItem ("C_5_0_sig", c_5_temp_b_0_sig);//xi pi
            status = m_tuple11->addItem ("C_6_0_sig", c_6_temp_b_0_sig);//e
            status = m_tuple11->addItem ("C_7_0_sig", c_7_temp_b_0_sig);//nue
            status = m_tuple11->addItem ("C_8_0_sig", c_8_temp_b_0_sig);//gamma
            status = m_tuple11->addItem ("C_9_0_sig", c_9_temp_b_0_sig);//gamma
            status = m_tuple11->addItem ("C_10_0_sig", c_10_temp_b_0_sig);//gamma

            status = m_tuple11->addItem ("C_1_1_sig", c_1_temp_b_1_sig);//xi
            status = m_tuple11->addItem ("C_2_1_sig", c_2_temp_b_1_sig);//lambda
            status = m_tuple11->addItem ("C_3_1_sig", c_3_temp_b_1_sig);//lambda p
            status = m_tuple11->addItem ("C_4_1_sig", c_4_temp_b_1_sig);//lambda pi
            status = m_tuple11->addItem ("C_5_1_sig", c_5_temp_b_1_sig);//xi pi
            status = m_tuple11->addItem ("C_6_1_sig", c_6_temp_b_1_sig);//e
            status = m_tuple11->addItem ("C_7_1_sig", c_7_temp_b_1_sig);//nue
            status = m_tuple11->addItem ("C_8_1_sig", c_8_temp_b_1_sig);//gamma
            status = m_tuple11->addItem ("C_9_1_sig", c_9_temp_b_1_sig);//gamma
            status = m_tuple11->addItem ("C_10_1_sig", c_10_temp_b_1_sig);//gamma

            status = m_tuple11->addItem ("event",   event_temp_b_sig  );
            status = m_tuple11->addItem ("runNo",   run_temp_b_sig  );
            status = m_tuple11->addItem ("mcmodea", mcmodea_temp_b_sig  );
            status = m_tuple11->addItem ("mcmodeb", mcmodeb_temp_b_sig  );
            status = m_tuple11->addItem ("mcmode1", mcmode1_temp_b_sig  );
            status = m_tuple11->addItem ("mcmode2", mcmode2_temp_b_sig  );
            status = m_tuple11->addItem ("mctag",       mctag_temp_b_sig);
...
StatusCode Lambda_ee::execute() {
    ...
    Vp4 T4_sgm0;                    T4_sgm0.clear();
    Vp4 T4_sgm0_lambda;             T4_sgm0_lambda.clear();
    Vp4 T4_sgm0_lambda_p;           T4_sgm0_lambda_p.clear();
    Vp4 T4_sgm0_lambda_pi;          T4_sgm0_lambda_pi.clear();
    Vp4 T4_sgm0_ep;                 T4_sgm0_ep.clear();
    Vp4 T4_sgm0_em;                 T4_sgm0_em.clear();
    Vp4 T4_sgm0_gam;                T4_sgm0_gam.clear();

    Vp4 T4_anti_sgm0;                    T4_anti_sgm0.clear();
    Vp4 T4_anti_sgm0_lambda;             T4_anti_sgm0_lambda.clear();
    Vp4 T4_anti_sgm0_lambda_p;           T4_anti_sgm0_lambda_p.clear();
    Vp4 T4_anti_sgm0_lambda_pi;          T4_anti_sgm0_lambda_pi.clear();
    Vp4 T4_anti_sgm0_ep;                 T4_anti_sgm0_ep.clear();
    Vp4 T4_anti_sgm0_em;                 T4_anti_sgm0_em.clear();
    Vp4 T4_anti_sgm0_gam;                T4_anti_sgm0_gam.clear();

//    Vp4 T4_sgm0_sig;                    T4_sgm0_sig.clear();
//    Vp4 T4_sgm0_lambda_sig;             T4_sgm0_lambda_sig.clear();
//    Vp4 T4_sgm0_lambda_p_sig;           T4_sgm0_lambda_p_sig.clear();
//    Vp4 T4_sgm0_lambda_pi_sig;          T4_sgm0_lambda_pi_sig.clear();
//    Vp4 T4_sgm0_ep_sig;                 T4_sgm0_ep_sig.clear();
//    Vp4 T4_sgm0_em_sig;                 T4_sgm0_em_sig.clear();
//    Vp4 T4_sgm0_gam_sig;                T4_sgm0_gam_sig.clear();
//
//    Vp4 T4_anti_sgm0_sig;                    T4_anti_sgm0_sig.clear();
//    Vp4 T4_anti_sgm0_lambda_sig;             T4_anti_sgm0_lambda_sig.clear();
//    Vp4 T4_anti_sgm0_lambda_p_sig;           T4_anti_sgm0_lambda_p_sig.clear();
//    Vp4 T4_anti_sgm0_lambda_pi_sig;          T4_anti_sgm0_lambda_pi_sig.clear();
//    Vp4 T4_anti_sgm0_ep_sig;                 T4_anti_sgm0_ep_sig.clear();
//    Vp4 T4_anti_sgm0_em_sig;                 T4_anti_sgm0_em_sig.clear();
//    Vp4 T4_anti_sgm0_gam_sig;                T4_anti_sgm0_gam_sig.clear();
//    index_temp_b_sig=4;
    index_temp_b_sig=4;
    ...
    if(runNo<0) {
        ...
        if(mcParticleCol){
            ...
            for (; iter_mc != mcParticleCol->end(); iter_mc++){
                ...
                /////////////////////////////Sigma_0
                if(pdgid==3212||p_mid==3212||p_m2id==3212||p_m3id==3212||p_m4id==3212||p_m5id==3212){//sigma_0 3212
                    if(pdgid==3212){//sigma_0 3212
                        HepLorentzVector  P4_1=(*iter_mc)->initialFourMomentum();
                        P4_1.boost(-0.011,0,0);
                        T4_sgm0.push_back(P4_1);
                        ...
                        p_1_temp_b_1_sig=P4_1.rho();
                        c_1_temp_b_1_sig=P4_1.cosTheta();
                        V4_1_temp_b_1_sig[0]=P4_1.px();
                        V4_1_temp_b_1_sig[1]=P4_1.py();
                        V4_1_temp_b_1_sig[2]=P4_1.pz();
                        V4_1_temp_b_1_sig[3]=P4_1.e();

                    }
                    if(pdgid==3122&&p_mid==3212){//Lambda0 3122
                        HepLorentzVector  P4_1=(*iter_mc)->initialFourMomentum();
                        P4_1.boost(-0.011,0,0);
                        T4_sgm0_lambda.push_back(P4_1);
                        ...
                        p_2_temp_b_1_sig=P4_1.rho();
                        c_2_temp_b_1_sig=P4_1.cosTheta();
                        V4_2_temp_b_1_sig[0]=P4_1.px();
                        V4_2_temp_b_1_sig[1]=P4_1.py();
                        V4_2_temp_b_1_sig[2]=P4_1.pz();
                        V4_2_temp_b_1_sig[3]=P4_1.e();

                    }
                    if(pdgid==2212&&p_mid==3122&&p_m2id==3212){//proton+ 2212
                        HepLorentzVector  P4_1=(*iter_mc)->initialFourMomentum();
                        P4_1.boost(-0.011,0,0);
                        T4_sgm0_lambda_p.push_back(P4_1);
                        ...
                        p_3_temp_b_1_sig=P4_1.rho();
                        c_3_temp_b_1_sig=P4_1.cosTheta();
                        V4_3_temp_b_1_sig[0]=P4_1.px();
                        V4_3_temp_b_1_sig[1]=P4_1.py();
                        V4_3_temp_b_1_sig[2]=P4_1.pz();
                        V4_3_temp_b_1_sig[3]=P4_1.e();

                    }
                    if(pdgid==-211&&p_mid==3122&&p_m2id==3212){//pi- -211
                        HepLorentzVector  P4_1=(*iter_mc)->initialFourMomentum();
                        P4_1.boost(-0.011,0,0);
                        T4_sgm0_lambda_pi.push_back(P4_1);
                        ...
                        p_4_temp_b_1_sig=P4_1.rho();
                        c_4_temp_b_1_sig=P4_1.cosTheta();
                        V4_4_temp_b_1_sig[0]=P4_1.px();
                        V4_4_temp_b_1_sig[1]=P4_1.py();
                        V4_4_temp_b_1_sig[2]=P4_1.pz();
                        V4_4_temp_b_1_sig[3]=P4_1.e();

                    }
                    if(pdgid==-11&&p_mid==3212){// e+ -11
                        HepLorentzVector  P4_1=(*iter_mc)->initialFourMomentum();
                        P4_1.boost(-0.011,0,0);
                        T4_sgm0_ep.push_back(P4_1);

                        p_5_temp_b_1=P4_1.rho();
             //           cout<<"mctruth"<<"\t"<<p_5_temp_b_1<<endl;
                        c_5_temp_b_1=P4_1.cosTheta();
                        V4_5_temp_b_1[0]=P4_1.px();
                        V4_5_temp_b_1[1]=P4_1.py();
                        V4_5_temp_b_1[2]=P4_1.pz();
                        V4_5_temp_b_1[3]=P4_1.e();
                        p_5_temp_b_1_sig=P4_1.rho();
               //         cout<<"signal "<<"\t"<<p_5_temp_b_1_sig<<endl;
                        c_5_temp_b_1_sig=P4_1.cosTheta();
                        V4_5_temp_b_1_sig[0]=P4_1.px();
                        V4_5_temp_b_1_sig[1]=P4_1.py();
                        V4_5_temp_b_1_sig[2]=P4_1.pz();
                        V4_5_temp_b_1_sig[3]=P4_1.e();



                    }

                    if(pdgid==11&&p_mid==3212){//electron 11
                        HepLorentzVector  P4_1=(*iter_mc)->initialFourMomentum();
                        P4_1.boost(-0.011,0,0);
                        T4_sgm0_em.push_back(P4_1);
                        ...
                        p_6_temp_b_1_sig=P4_1.rho();
                        c_6_temp_b_1_sig=P4_1.cosTheta();
                        V4_6_temp_b_1_sig[0]=P4_1.px();
                        V4_6_temp_b_1_sig[1]=P4_1.py();
                        V4_6_temp_b_1_sig[2]=P4_1.pz();
                        V4_6_temp_b_1_sig[3]=P4_1.e();



                    }
                    if(pdgid==22&&p_mid==3212){//gam 22 
                        HepLorentzVector  P4_1=(*iter_mc)->initialFourMomentum();
                        P4_1.boost(-0.011,0,0);
                        T4_sgm0_gam.push_back(P4_1);
                        ...
                        p_7_temp_b_1_sig=P4_1.rho();
                        c_7_temp_b_1_sig=P4_1.cosTheta();
                        V4_7_temp_b_1_sig[0]=P4_1.px();
                        V4_7_temp_b_1_sig[1]=P4_1.py();
                        V4_7_temp_b_1_sig[2]=P4_1.pz();
                        V4_7_temp_b_1_sig[3]=P4_1.e();
                ...
                /////////////////////////////anti-Sigma0
                if(pdgid==-3212||p_mid==-3212||p_m2id==-3212||p_m3id==-3212||p_m4id==-3212||p_m5id==-3212){//anti-Sigma0 -3212
                    if(pdgid==-3212){//anti-Sigma0 -3212
                        HepLorentzVector  P4_1=(*iter_mc)->initialFourMomentum();
                        P4_1.boost(-0.011,0,0);
                        T4_anti_sgm0.push_back(P4_1);
                    ...
                    if(pdgid==-3122&&p_mid==-3212){//anti-Lambda0 -3122
                        HepLorentzVector  P4_1=(*iter_mc)->initialFourMomentum();
                        P4_1.boost(-0.011,0,0);
                        T4_anti_sgm0_lambda.push_back(P4_1);
                    ...
                    if(pdgid==-2212&&p_mid==-3122&&p_m2id==-3212){//anti-proton- -2212
                        HepLorentzVector  P4_1=(*iter_mc)->initialFourMomentum();
                        P4_1.boost(-0.011,0,0);
                        T4_anti_sgm0_lambda_p.push_back(P4_1);
                    ...
                    if(pdgid==211&&p_mid==-3122&&p_m2id==-3212){//pi+ 211 anti-lambda-3122
                        HepLorentzVector  P4_1=(*iter_mc)->initialFourMomentum();
                        P4_1.boost(-0.011,0,0);
                        T4_anti_sgm0_lambda_pi.push_back(P4_1);
                    ...
                    if(pdgid==-11&&p_mid==-3212){//positron -11
                        HepLorentzVector  P4_1=(*iter_mc)->initialFourMomentum();
                        P4_1.boost(-0.011,0,0);
                        T4_anti_sgm0_ep.push_back(P4_1);
                    ...
                    if(pdgid==11&&p_mid==-3212){//electron 11
                        HepLorentzVector  P4_1=(*iter_mc)->initialFourMomentum();
                        P4_1.boost(-0.011,0,0);
                        T4_anti_sgm0_em.push_back(P4_1);
                      ...
                      //angEE_mctruth = T4_anti_sgm0_ep.vect().angle(T4_anti_sgm0_em.vect())/(CLHEP::pi)*180;
                    if(pdgid==22&&p_mid==-3212){//gam 22 
                        HepLorentzVector  P4_1=(*iter_mc)->initialFourMomentum();
                        P4_1.boost(-0.011,0,0);
                        T4_anti_sgm0_gam.push_back(P4_1);
...
// m_tuple11->write();
    ...
    Vint    tag_gamid;             tag_gamid.clear(); 
    ...
    Vp4    tag_Gamvector;          tag_Gamvector.clear();
    ...
    if(m_debug)     cout << "/ ------ [ Lambda_eeAlg.execute ]: Select all kaon successfully. " << endl;
    ...
    if(m_debug)     cout << "/ ------ [ Lambda_eeAlg.execute ]: Select all pion successfully. " << endl;
    ...
    if(m_debug)     cout << "/ ------ [ Lambda_eeAlg.execute ]: Select all kso successfully. " << endl;
...
*/
    ...
    if(m_debug)     cout << "/ ------ [ Lambda_eeAlg.execute ]: Select all gamma successfully. " << endl;
    ...
    if(m_debug)     cout << "/ ------ [ Lambda_eeAlg.execute ]: Select all pi0 successfully. " << endl;
    ...
    if(m_debug)     cout << "/ ------ [ Lambda_eeAlg.execute ]: Select all eta successfully. " << endl;
    ...
    if(m_debug)     cout << "/ ------ [ Lambda_eeAlg.execute ]: Select all muon successfully. " << endl;
...
*/
    ...
    if(m_debug)     cout << "/ ------ [ Lambda_eeAlg.execute ]: Select all electron/positron successfully. " << endl;
    ...
    if(m_debug)     cout << "/ ------ [ Lambda_eeAlg.execute ]: Select all proton successfully. " << endl;
...
if(m_debug)     cout << "/ ------ [ Lambda_eeAlg.execute ]: Select all lambda and xi successfully. " << endl;
...
if(m_debug)     cout << "/ ------ [ xi0peAlg.execute ]: Select all lambda successfully. " << endl;



/////////////////////////////////////////////////////////////////////////
HepLorentzVector P4_tag_p,P4_tag_pi,P4_tag_lam,P4_tag_gam;
HepLorentzVector P4_sig_p,P4_sig_pi,pdp_new;
      HepLorentzVector P4_tag_lam_p,P4_tag_lam_pi,P4_tag_xi_pi, P4_tag_sigma0;
      ...
      HepLorentzVector pdp,pdp_2,p_uv,p_ev,p_kpi,p_ku,p_ke,p_kpiu,p_kpie,Evector_new,p_keta,p_ketae,p_ketau,p_v2_1,p_v3_1,pdp4,pdp5,p_piu,p_kv,p_piv,p_pie,v4_k,v4_pi,v4_u,v4_v,v4_0,v4_1,v4_2,v4_3,v4_4,v4_5,v4_6,v4_7,v4_8,v4_9,v4_10;
      ...
      HepLorentzVector v4_8_4c(0.,0.,0.,0.);
      HepLorentzVector v4_9_4c(0.,0.,0.,0.);
      HepLorentzVector v4_10_4c(0.,0.,0.,0.);
      ...
      for(int q=0;q<2;q++){//charge conjugation
          ...
          for (int tagmode=1; tagmode<2; tagmode++){
              ...
              if(tagmode==1){
                ...
                x0[8]++;
                int ig_confirm = -1;
                for(int ig=0;ig<gamnumber;ig++){
                    HepLorentzVector pdp_temp = Lamvector[i] + Gamvector[ig]; 


                double temp1 = (ecm/2.)*(ecm/2.)-pdp_temp.rho()*pdp_temp.rho() ;
                if(temp1<0) temp1 =0;
                double mass_bc  = sqrt(temp1);
                if(mass_bc< 1. || mass_bc> 1.4)  continue;
                double  delE_tag =(ecm/2.)-pdp_temp.e();
                double  delmlam_tag =Lamvector[i].m()-mlambda;
                double  delmsgm0_tag =pdp_temp.m()-msigma0;
                //double  del_mme=delE_tag*delE_tag+delmlam_tag*delmlam_tag+delmxi_tag*delmxi_tag;
                ...
                if(fabs(delE_tag)<=deltaE_cut)   {
                   ...
                   // deltaE_cut  =  del_mme;
                    ...
                    HepLorentzVector reco_sigma0=p_all-pdp_temp;//jpsi-sigma0

                    mass_tag_lam_temp  =  Lamvector[i].m();//tag side sigma0 mass
                    mass_tag_reco_temp =  reco_sigma0.m();//mass without sigma0 ->>>>sigma0bar
                    pdp           =  pdp_temp;//4V sigma0 
                    xinvmass      =  pdp.m();//mass sigma0
                    ...
                    p_tag_3     =  Lamvector[i].rho();
                    c_tag_3     =  Lamvector[i].cosTheta();
                    phi_tag_3   =  Lamvector[i].phi();

                    P4_tag_lam_p      =  Lam_p[i];
                    P4_tag_lam_pi     =  Lam_pi[i];
                    P4_tag_lam        =  Lamvector[i];
                    P4_tag_gam    =  Gamvector[ig_confirm];
                    P4_tag_sigma0     =  pdp;

                    tag_pid_temp      =  Lamid_p[i];
                    tag_piid_temp     =  Lamid_pi[i];
                    tag_gamid_temp    =  Gamid[ig_confirm];
                    ...
                    tag_trk_lam     = Trk_lam[i];
                    tag_trk_lam_pi  = Trk_lam_pi[i];
                    tag_trk_lam_p   = Trk_lam_p[i];
                    //tag_trk_pi      = Trk_pi[i];
                    ...
                    if(runNo<0){
                        if(tagcharge==-1 && T4_sgm0_lambda_p.size()>0 && T4_sgm0_lambda_pi.size()>0 && T4_sgm0_gam.size()>0 &&T4_sgm0_lambda.size()>0){
                            T_angle1=((Lam_p[i].vect()).angle(T4_sgm0_lambda_p[0].vect()))/(CLHEP::pi)*180;
                            T_angle2=((Lam_pi[i].vect()).angle(T4_sgm0_lambda_pi[0].vect()))/(CLHEP::pi)*180;
                            T_angle3=((Gamvector[ig_confirm].vect()).angle(T4_sgm0_gam[0].vect()))/(CLHEP::pi)*180;
                            T_angle4=((Lamvector[i].vect()).angle(T4_sgm0_lambda[0].vect()))/(CLHEP::pi)*180;
                        }
                        if(tagcharge==1 && T4_anti_sgm0_lambda_p.size()>0 && T4_anti_sgm0_lambda_pi.size()>0 && T4_anti_sgm0_gam.size()>0 &&T4_anti_sgm0_lambda.size()>0){
                            T_angle1=((Lam_p[i].vect()).angle(T4_anti_sgm0_lambda_p[0].vect()))/(CLHEP::pi)*180;
                            T_angle2=((Lam_pi[i].vect()).angle(T4_anti_sgm0_lambda_pi[0].vect()))/(CLHEP::pi)*180;
                            T_angle3=((Gamvector[ig_confirm].vect()).angle(T4_anti_sgm0_gam[0].vect()))/(CLHEP::pi)*180;
                            T_angle4=((Lamvector[i].vect()).angle(T4_anti_sgm0_lambda[0].vect()))/(CLHEP::pi)*180;
                        }
                    }////////runNo<0
        ...
        if(ncount>0&&ncount<10){//be used for double tag
            ...
            tag_gamid.push_back(tag_gamid_temp);
            ...
            tag_Gamvector.push_back(P4_tag_gam);
        ...
        if(ncount>0&&ncount<10  ) {//fill tree
            ...
            V4_3_temp_1[0]      =     P4_tag_lam.px();
            V4_3_temp_1[1]      =     P4_tag_lam.py();
            V4_3_temp_1[2]      =     P4_tag_lam.pz();
            V4_3_temp_1[3]      =     P4_tag_lam.e();
...
sig_number=Vtagmode.size();
    ...
    /////////////////////////////////////////////////
        ...
        if(Vtagmode[n]==1){ 
            ...
            //
            // sigma0 -> lambda electron positron
            //             |
            //            \|/
            //             v
            //             p pi
           ...
           //     x0[11]++;
                for(int c_temp=0;c_temp<enumber;c_temp++){
                if(Echarge[c_temp]!=tag_tagcharge[n]) continue;//e+
                x0[10]++;
                for(int d_temp=0;d_temp<enumber;d_temp++){
                if(Echarge[d_temp]==tag_tagcharge[n]) continue; //e-
                x0[12]++;
                for(int e=0;e<lamnumber;e++){
                if(Lamcharge[e]!=tag_tagcharge[n])continue;
                        ...
                        //s_id[1]=Piid[b];
                        s_id[2]=Eid[c_temp];
                        s_id[3]=Eid[d_temp];//////Qmh1:double e????
                        s_id[4]=tag_pid[n];
                        s_id[5]=tag_piid[n];
                        s_id[6]=tag_gamid[n];
                        if(same(s_id))continue;
                        ...
                        //2020.09.19 make sure the "c" represents the positron ID while the "d" represents the electron ID.
                        if(Echarge[c_temp]==1){
                            c=c_temp;
                            d=d_temp;
                        }
                        ...
                        if(e!=-1&&c!=-1&&d!=-1){
                            ...
                            KalmanKinematicFit * kmfit =KalmanKinematicFit::instance();
                            RecEmcShower *g1Trk = (*(evtRecTrkCol->begin()+tag_gamid[n]))->emcShower();
                            //RecEmcShower *g1Trk = (*(evtRecTrkCol->begin()+Gamid[n]))->emcShower();
                            //RecEmcShower *g2Trk = (*(evtRecTrkCol->begin()+Pi0id2[c]))->emcShower();
                            kmfit->init();
                            kmfit->setChisqCut(100000,0.05);//
                            kmfit->AddTrack(0,Trk_e[c]);//
                            kmfit->AddTrack(1,Trk_e[d]);//
                            kmfit->AddTrack(2,Trk_lam_p[e]);//
                            kmfit->AddTrack(3,Trk_lam_pi[e]);//
                            kmfit->AddTrack(4,trk_lam_p_tag[n]);//
                            kmfit->AddTrack(5,trk_lam_pi_tag[n]);//
                            ...
                            if(oksq_4c_2){
                                ...
                                if (m_chi2<chi2_min){
                                    ...
                                    HepLorentzVector Ep_sig_4c_2      = kmfit->pfit(0);                 Ep_sig_4c_2.boost(-0.011,0,0);
                                    HepLorentzVector Em_sig_4c_2      = kmfit->pfit(1);                 Em_sig_4c_2.boost(-0.011,0,0);
                                    HepLorentzVector P_sig_4c_2       = kmfit->pfit(2);                 P_sig_4c_2.boost(-0.011,0,0);
                                    HepLorentzVector Pi_sig_4c_2      = kmfit->pfit(3);                 Pi_sig_4c_2.boost(-0.011,0,0);

                                    HepLorentzVector P_lam_tag_4c_2   = kmfit->pfit(4);                 P_lam_tag_4c_2.boost(-0.011,0,0);
                                    HepLorentzVector Pi_lam_tag_4c_2  = kmfit->pfit(5);                 Pi_lam_tag_4c_2.boost(-0.011,0,0);
                                    HepLorentzVector Gam_tag_4c_2     = kmfit->pfit(6);                 Gam_tag_4c_2.boost(-0.011,0,0);
                                    ...
                                    eemc_sig_ep=e_eemc[i_ep];
                                    eemc_sig_em=e_eemc[i_em];
                                    evp_sig_ep=e_evp[i_ep];
                                    evp_sig_em=e_evp[i_em];

                                    //1 for p; 2 for pi; 3 for ep; 4 for em;
                                    p_sig_1         =       P_sig_4c_2.rho();
                                    p_sig_2         =       Pi_sig_4c_2.rho();
                                    p_sig_3         =       Ep_sig_4c_2.rho();
                                    //here
                                    p_sig_4         =       Em_sig_4c_2.rho();

                                    c_sig_1         =       P_sig_4c_2.cosTheta();
                                    c_sig_2         =       Pi_sig_4c_2.cosTheta();
                                    c_sig_3         =       Ep_sig_4c_2.cosTheta();
                                    c_sig_4         =       Em_sig_4c_2.cosTheta();
                                    ...
                                    v4_5            =       tag_Lam_p[n];
                                    v4_6            =       tag_Lam_pi[n];
                                    v4_7            =       tag_Lamvector[n];
                                    v4_8            =       tag_Gamvector[n];
                                    ...
                                    v4_7_4c         =       P_lam_tag_4c_2+Pi_lam_tag_4c_2;
                                    v4_8_4c         =       Gam_tag_4c_2;
                                    
                                    lam_sig_chi_temp  =  Lamchi[e];
                                    lam_sig_len_temp       =  Lamlen[e];
                                    lam_sig_lenerr_temp    =  Lamlenerr[e];
    ...
    pdp_temp.setE(ecm/2.);
    double rho_temp=sqrt((ecm/2.)*(ecm/2.)-msigma*msigma);
    pdp_temp.setRho(rho_temp);
                    HepLorentzVector p_all(0,0,0,ecm);
                                    
                                    HepLorentzVector V_sigma_4c;
                                    V_sigma_4c =  P_sig_4c_2+Pi_sig_4c_2+Ep_sig_4c_2+Em_sig_4c_2; 
                                    Msigma_4c = V_sigma_4c.m();
                                    Mlambda_4c = (P_sig_4c_2+Pi_sig_4c_2).m();
                                    Mee_4c = (Ep_sig_4c_2+Em_sig_4c_2).m();
                                    MJpsi_4c = (Gam_tag_4c_2+P_sig_4c_2+Pi_sig_4c_2+Ep_sig_4c_2+Em_sig_4c_2+P_lam_tag_4c_2+Pi_lam_tag_4c_2).m();


                                    HepLorentzVector V_sigma_4c_tag = P_lam_tag_4c_2 + Pi_lam_tag_4c_2 +Gam_tag_4c_2 ;
                                    Hep3Vector P_sgm0 = V_sigma_4c_tag.boostVector();
                                    HepLorentzVector V_Lambda_4c_tag = P_lam_tag_4c_2+Pi_lam_tag_4c_2;
                                    HepLorentzVector V_gam_4c_tag = Gam_tag_4c_2;
                                    V_Lambda_4c_tag.boost(-P_sgm0);
                                    V_gam_4c_tag.boost(-P_sgm0);
                                    Mlambda_4c_sgm0cms = V_Lambda_4c_tag.m();
                                    Elambda_4c_sgm0cms = V_Lambda_4c_tag.e();
                                    v4_9_4c = V_Lambda_4c_tag;
                                    v4_10_4c = V_gam_4c_tag;
                                    //cout<<" V_Lambda_4c" << V_Lambda_4c_tag<<endl;
                                    //cout<<" V_gam_4c   " << V_gam_4c_tag<<endl;
                                    //Mlambda_4c_sgm0cms = P_Lambda.m();
                                    /////////////////////////////!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!/////////////
if(runNo<0){
    int tep=0,tem=0;
    if(tag_tagcharge[n]==1 && T4_sgm0_ep.size()>0 && T4_sgm0_em.size()>0 && T4_sgm0_lambda_pi.size()>0 && T4_sgm0_lambda_p.size()>0 && T4_anti_sgm0_lambda_p.size()>0 && T4_anti_sgm0_lambda_pi.size()>0 && T4_anti_sgm0_gam.size()>0)
          tep=1;

    if(tag_tagcharge[n]==-1 && T4_anti_sgm0_ep.size()>0 && T4_anti_sgm0_em.size()>0 && T4_anti_sgm0_lambda_pi.size()>0 && T4_anti_sgm0_lambda_p.size()>0 && T4_sgm0_lambda_p.size()>0 && T4_sgm0_lambda_pi.size()>0 && T4_sgm0_gam.size()>0)
    ...
    if(tep==1){
        angle1=((P_sig_4c_2.vect()).angle(T4_sgm0_lambda_p[0].vect()))/(CLHEP::pi)*180;
        angle2=((Pi_sig_4c_2.vect()).angle(T4_sgm0_lambda_pi[0].vect()))/(CLHEP::pi)*180;
        angle3=((Ep_sig_4c_2.vect()).angle(T4_sgm0_ep[0].vect()))/(CLHEP::pi)*180;
        angle4=((Em_sig_4c_2.vect()).angle(T4_sgm0_em[0].vect()))/(CLHEP::pi)*180;
        //if (sig_gamid<999)angle7=((Gamvector[sig_gamid].vect()).angle(T4_xi_gamma[0].vect()))/(CLHEP::pi)*180;
    }//////////if(tagcharge==-1)
    if(tem==-1){
        angle1=((P_sig_4c_2.vect()).angle(T4_anti_sgm0_lambda_p[0].vect()))/(CLHEP::pi)*180;
        angle2=((Pi_sig_4c_2.vect()).angle(T4_anti_sgm0_lambda_pi[0].vect()))/(CLHEP::pi)*180;
        angle3=((Ep_sig_4c_2.vect()).angle(T4_anti_sgm0_ep[0].vect()))/(CLHEP::pi)*180;
        angle4=((Em_sig_4c_2.vect()).angle(T4_anti_sgm0_em[0].vect()))/(CLHEP::pi)*180;
...
/////////////////////////////!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!/////////////
                        ...
                        RecMdcKalTrack *elp1Trk = (*(evtRecTrkCol->begin()+Eid[i_ep]))->mdcKalTrack();
                        RecMdcKalTrack::setPidType(RecMdcKalTrack::electron);
                        wvelp1Trk = WTrackParameter(me, elp1Trk->getZHelixE(), elp1Trk->getZErrorE());

                        RecMdcKalTrack *elm1Trk = (*(evtRecTrkCol->begin()+Eid[i_em]))->mdcKalTrack();
                        RecMdcKalTrack::setPidType(RecMdcKalTrack::electron);
...
if(e!=-1) {//sig Lambda_p
EvtRecTrackIterator itTrk = evtRecTrkCol->begin() + Lamid_p[i_p];
if(!(*itTrk)->isMdcKalTrackValid()) continue;
RecMdcKalTrack*  mdcKalTrk = (*itTrk)->mdcKalTrack();
RecMdcKalTrack::setPidType(RecMdcKalTrack::proton);
if(fabs(mdcKalTrk->charge()) != 1) continue;
...
if(e!=-1) {//sig lambda_pi
EvtRecTrackIterator itTrk = evtRecTrkCol->begin() + Lamid_pi[i_pi];
if(!(*itTrk)->isMdcKalTrackValid()) continue;
RecMdcKalTrack*  mdcKalTrk = (*itTrk)->mdcKalTrack();
RecMdcKalTrack::setPidType(RecMdcKalTrack::pion);
if(fabs(mdcKalTrk->charge()) != 1) continue;
...
if(c!=-1) {//sig e1
EvtRecTrackIterator itTrk = evtRecTrkCol->begin() + Eid[i_ep];
if(!(*itTrk)->isMdcKalTrackValid()) continue;
RecMdcKalTrack*  mdcKalTrk = (*itTrk)->mdcKalTrack();
RecMdcKalTrack::setPidType(RecMdcKalTrack::electron);
if(fabs(mdcKalTrk->charge()) != 1) continue;
...
if(d!=-1){//sig e2
EvtRecTrackIterator itTrk2 = evtRecTrkCol->begin() + Eid[i_em];
if(!(*itTrk2)->isMdcKalTrackValid()) continue;
RecMdcKalTrack*  mdcKalTrk2 = (*itTrk2)->mdcKalTrack();
RecMdcKalTrack::setPidType(RecMdcKalTrack::electron);
            ...
            for (; iter_mc != mcParticleCol->end(); iter_mc++){
                ...
                if(pdgid==3212||p_mid==3212||p_m2id==3212||p_m3id==3212||p_m4id==3212||p_m5id==3212){//sigma_0 3212
                   if(pdgid==3212){//sigma_0 3212
                    ...
                    if(pdgid==3122&&p_mid==3212){//Lambda0 3122
                        HepLorentzVector  P4_1=(*iter_mc)->initialFourMomentum();
                        P4_1.boost(-0.011,0,0);
                        T4_sgm0_lambda_sig.push_back(P4_1);
                    ...
                    if(pdgid==2212&&p_mid==3122&&p_m2id==3212){//proton+ 2212
                        HepLorentzVector  P4_1=(*iter_mc)->initialFourMomentum();
                        P4_1.boost(-0.011,0,0);
                        T4_sgm0_lambda_p_sig.push_back(P4_1);
                    ...
                    if(pdgid==-211&&p_mid==3122&&p_m2id==3212){//pi- -211
                        HepLorentzVector  P4_1=(*iter_mc)->initialFourMomentum();
                        P4_1.boost(-0.011,0,0);
                        T4_sgm0_lambda_pi_sig.push_back(P4_1);
                    ...
                    if(pdgid==22&&p_mid==3212){//gam 22 
                        HepLorentzVector  P4_1=(*iter_mc)->initialFourMomentum();
                        P4_1.boost(-0.011,0,0);
                        T4_sgm0_gam_sig.push_back(P4_1);
                ...
                if(pdgid==-3212||p_mid==-3212||p_m2id==-3212||p_m3id==-3212||p_m4id==-3212||p_m5id==-3212){//anti-Sigma0 -3212
                    if(pdgid==-3212){//anti-Sigma0 -3212
                        HepLorentzVector  P4_1=(*iter_mc)->initialFourMomentum();
                        P4_1.boost(-0.011,0,0);
                        T4_anti_sgm0_sig.push_back(P4_1);

                        p_1_temp_b_0_sig=P4_1.rho();
                        c_1_temp_b_0_sig=P4_1.cosTheta();
                        V4_1_temp_b_0_sig[0]=P4_1.px();
                        V4_1_temp_b_0_sig[1]=P4_1.py();
                        V4_1_temp_b_0_sig[2]=P4_1.pz();
                        V4_1_temp_b_0_sig[3]=P4_1.e();

                    }
                    if(pdgid==-3122&&p_mid==-3212){//anti-Lambda0 -3122
                        HepLorentzVector  P4_1=(*iter_mc)->initialFourMomentum();
                        P4_1.boost(-0.011,0,0);
                        T4_anti_sgm0_lambda_sig.push_back(P4_1);

                        p_2_temp_b_0_sig=P4_1.rho();
                        c_2_temp_b_0_sig=P4_1.cosTheta();
                        V4_2_temp_b_0_sig[0]=P4_1.px();
                        V4_2_temp_b_0_sig[1]=P4_1.py();
                        V4_2_temp_b_0_sig[2]=P4_1.pz();
                        V4_2_temp_b_0_sig[3]=P4_1.e();

                    }
                    if(pdgid==-2212&&p_mid==-3122&&p_m2id==-3212){//anti-proton- -2212
                        HepLorentzVector  P4_1=(*iter_mc)->initialFourMomentum();
                        P4_1.boost(-0.011,0,0);
                        T4_anti_sgm0_lambda_p_sig.push_back(P4_1);

                        p_3_temp_b_0_sig=P4_1.rho();
                        c_3_temp_b_0_sig=P4_1.cosTheta();
                        V4_3_temp_b_0_sig[0]=P4_1.px();
                        V4_3_temp_b_0_sig[1]=P4_1.py();
                        V4_3_temp_b_0_sig[2]=P4_1.pz();
                        V4_3_temp_b_0_sig[3]=P4_1.e();

                    }
                    if(pdgid==211&&p_mid==-3122&&p_m2id==-3212){//pi+ 211 anti-lambda-3122
                        HepLorentzVector  P4_1=(*iter_mc)->initialFourMomentum();
                        P4_1.boost(-0.011,0,0);
                        T4_anti_sgm0_lambda_pi_sig.push_back(P4_1);

                        p_4_temp_b_0_sig=P4_1.rho();
                        c_4_temp_b_0_sig=P4_1.cosTheta();
                        V4_4_temp_b_0_sig[0]=P4_1.px();
                        V4_4_temp_b_0_sig[1]=P4_1.py();
                        V4_4_temp_b_0_sig[2]=P4_1.pz();
                        V4_4_temp_b_0_sig[3]=P4_1.e();

                    }
                    if(pdgid==-11&&p_mid==-3212){//positron -11
                        HepLorentzVector  P4_1=(*iter_mc)->initialFourMomentum();
                        P4_1.boost(-0.011,0,0);
                        T4_anti_sgm0_ep_sig.push_back(P4_1);

                        p_5_temp_b_0_sig=P4_1.rho();
                        c_5_temp_b_0_sig=P4_1.cosTheta();
                        V4_5_temp_b_0_sig[0]=P4_1.px();
                        V4_5_temp_b_0_sig[1]=P4_1.py();
                        V4_5_temp_b_0_sig[2]=P4_1.pz();
                        V4_5_temp_b_0_sig[3]=P4_1.e();

                    }
                    if(pdgid==11&&p_mid==-3212){//electron 11
                        HepLorentzVector  P4_1=(*iter_mc)->initialFourMomentum();
                        P4_1.boost(-0.011,0,0);
                        T4_anti_sgm0_em_sig.push_back(P4_1);

                        p_6_temp_b_0_sig=P4_1.rho();
                        c_6_temp_b_0_sig=P4_1.cosTheta();
                        V4_6_temp_b_0_sig[0]=P4_1.px();
                        V4_6_temp_b_0_sig[1]=P4_1.py();
                        V4_6_temp_b_0_sig[2]=P4_1.pz();
                        V4_6_temp_b_0_sig[3]=P4_1.e();
                    ...
                    if(pdgid==22&&p_mid==-3212){//gam 22 
                        HepLorentzVector  P4_1=(*iter_mc)->initialFourMomentum();
                        P4_1.boost(-0.011,0,0);
                        T4_anti_sgm0_gam_sig.push_back(P4_1);

                        p_7_temp_b_0_sig=P4_1.rho();
                        c_7_temp_b_0_sig=P4_1.cosTheta();
                        V4_7_temp_b_0_sig[0]=P4_1.px();
                        V4_7_temp_b_0_sig[1]=P4_1.py();
                        V4_7_temp_b_0_sig[2]=P4_1.pz();
                        V4_7_temp_b_0_sig[3]=P4_1.e();
...
//        event_temp_b_sig=event;
//        run_temp_b_sig=runNo;
//        mcmode1_temp_b_sig=mcmode1;
//        mcmode2_temp_b_sig=mcmode2;
//        mcmodea_temp_b_sig=mcmodea;
//        mcmodeb_temp_b_sig=mcmodeb;
//
//        mctag_temp_b_sig=m_mctag;
...
if(ncount2==1)
{
    ...
    V4_8_temp_11[0]           =                v4_8_4c.px();
    V4_8_temp_11[1]           =                v4_8_4c.py();
    V4_8_temp_11[2]           =                v4_8_4c.pz();
    V4_8_temp_11[3]           =                v4_8_4c.e();

    V4_9_temp_11[0]           =                v4_9_4c.px();
    V4_9_temp_11[1]           =                v4_9_4c.py();
    V4_9_temp_11[2]           =                v4_9_4c.pz();
    V4_9_temp_11[3]           =                v4_9_4c.e();

    V4_10_temp_11[0]           =                v4_10_4c.px();
    V4_10_temp_11[1]           =                v4_10_4c.py();
    V4_10_temp_11[2]           =                v4_10_4c.pz();
    V4_10_temp_11[3]           =                v4_10_4c.e();

    evp_2_temp_11             =                evp_sig_ep;
    eemc_2_temp_11            =                eemc_sig_ep; 
    evp_3_temp_11             =               evp_sig_em;
    eemc_3_temp_11            =               eemc_sig_em; 
    ...
    //m_chi2_pi0          =                 chi2_pi0;
    m_chi2_min                =                 chi2_min;
    m_sigma_4c                =              Msigma_4c;
    m_lambda_4c               =               Mlambda_4c;
    m_lambda_4c_sgm0cms       =               Mlambda_4c_sgm0cms;
    m_elambda_4c_sgm0cms      =               Elambda_4c_sgm0cms;
    m_ee_4c                   =                   Mee_4c;
    m_jpsi_4c                 =                 MJpsi_4c;
...
//    xi_tag_len_temp_11     =   tag_Xilen[n];
  //  xi_tag_lenerr_temp_11  =   tag_Xilenerr[n];
   ...
   // tag_xi_mass_temp_11    =   tag_Xivector[n].m();
    sig_lam_mass_temp_11   =   v4_7.m();
   // sig_sigma0_mass_temp_11=   v4_0.m();
    recomass_xilam_temp_11 =   recomass_xilam_temp;
    recomass_xie_temp_11   =   recomass_xie_temp;
    p_5_1_sig_temp=p_5_temp_b_1_sig;
                //        cout<<"signal before write"<<"\t"<<p_5_temp_b_1_sig<<endl;
                //        cout<<"tagcharge == " <<"\t"<<tagcharge<<endl;
                //        cout<<"tag_tagcharge_temp_11 == " <<"\t"<<sigtagcharge<<endl;
                //        cout<<"tagcharge_temp == " <<"\t"<<tagcharge_temp<<endl;
                //        cout<<"******************" <<"\t"<<endl;
    m_tuple11->write();                              
                       // cout<<"signal after write "<<"\t"<<p_5_temp_b_1_sig<<endl;
}//fill tree
...
//bool Lambda_ee::FIndMode(int mode){
//}

bool Lambda_ee::same(int id[20]){
    bool sm=false;
    for(int i=0;i<20;i++){
        for(int j=0;j<20;j++){
...
void Lambda_ee::set0()
{
    ...
    //////int
    T_tagmode=0;	tagmode_temp=0;		ncount=0;	
    //T_tagmode=0;	tagmode_temp=0;	tagcharge_temp=8888;	sigtagcharge=9999;	ncount=0;	
    ...
    eemc_sig_ep=0.; eemc_sig_p1=0.; evp_sig_ep=0.; evp_sig_p1=0.;
    eemc_sig_em=0.; eemc_sig_p2=0.; evp_sig_em=0.; evp_sig_p2=0.;
    ...
    tag_gamid_temp=999; sig_gamid=999;
    ...
    tag_deltaE=999;Msigma_4c=999; Mlambda_4c=999;Mlambda_4c_sgm0cms=999.,Elambda_4c_sgm0cms=999; Mee_4c=999.;MJpsi_4c=999.;tag_mass=999;chi2_pi0=999 ;recomass_xilam_temp=0; recomass_xie_temp=0; chi2_min=999;
}

// * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * 
StatusCode Lambda_ee::finalize() {
    MsgStream log(msgSvc(), name());/////////////////////
...
//double Lambda_ee::Get_HelixRadius(HepVector helix){
...
//}
//
//HepPoint3D Lambda_ee::Get_HelixCenter(HepVector helix){
//
//    double bField = VertexFitBField::instance()->getBFieldZ(HepPoint3D(helix[0]*cos(helix[1]), helix[0]*sin(helix[1]), helix[3]));
...
//HepPoint3D Lambda_ee::intersections(HepVector helix,double r){
//    double xc, yc,rc;
...
//}
//
//double Lambda_ee::Get_Dee(HepVector helixe,HepVector helixp,double r){
