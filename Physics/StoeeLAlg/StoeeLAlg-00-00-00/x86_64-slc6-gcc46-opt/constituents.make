...
#cmt_local_tagfile = $(StoeeLAlg_tag).make
cmt_local_tagfile = $(bin)$(StoeeLAlg_tag).make
...
cmt_local_setup_StoeeLAlg = $(bin)setup_StoeeLAlg$$$$.make
...
StoeeLAlg_extratags = -tag_add=target_StoeeLAlg

#$(cmt_local_tagfile_StoeeLAlg) : $(cmt_lock_setup)
ifndef QUICK
$(cmt_local_tagfile_StoeeLAlg) ::
else
$(cmt_local_tagfile_StoeeLAlg) :
endif
	$(echo) "(constituents.make) Rebuilding $@"; \
	  if test -f $(cmt_local_tagfile_StoeeLAlg); then /bin/rm -f $(cmt_local_tagfile_StoeeLAlg); fi ; \
	  $(cmtexe) -tag=$(tags) $(StoeeLAlg_extratags) build tag_makefile >>$(cmt_local_tagfile_StoeeLAlg)
	$(echo) "(constituents.make) Rebuilding $(cmt_final_setup_StoeeLAlg)"; \
	  test ! -f $(cmt_local_setup_StoeeLAlg) || \rm -f $(cmt_local_setup_StoeeLAlg); \
	  trap '\rm -f $(cmt_local_setup_StoeeLAlg)' 0 1 2 15; \
	  $(cmtexe) -tag=$(tags) $(StoeeLAlg_extratags) show setup >$(cmt_local_setup_StoeeLAlg) && \
	  if [ -f $(cmt_final_setup_StoeeLAlg) ] && \
	    \cmp -s $(cmt_final_setup_StoeeLAlg) $(cmt_local_setup_StoeeLAlg); then \
	    \rm $(cmt_local_setup_StoeeLAlg); else \
	    \mv -f $(cmt_local_setup_StoeeLAlg) $(cmt_final_setup_StoeeLAlg); fi
...
not_StoeeLAlg_dependencies = { n=0; for p in $?; do m=0; for d in $(StoeeLAlg_dependencies); do if [ $$p = $$d ]; then m=1; break; fi; done; if [ $$m -eq 0 ]; then n=1; break; fi; done; [ $$n -eq 1 ]; }

ifdef STRUCTURED_OUTPUT
StoeeLAlgdirs :
	@if test ! -d $(bin)StoeeLAlg; then $(mkdir) -p $(bin)StoeeLAlg; fi
	$(echo) "STRUCTURED_OUTPUT="$(bin)StoeeLAlg
else
StoeeLAlgdirs : ;
endif
...
#	$(echo) "STRUCTURED_OUTPUT="$(bin)StoeeLAlg
#
#$(cmt_local_StoeeLAlg_makefile) :: $(StoeeLAlg_dependencies) $(cmt_local_tagfile_StoeeLAlg) build_library_links dirs StoeeLAlgdirs
#else
#$(cmt_local_StoeeLAlg_makefile) :: $(StoeeLAlg_dependencies) $(cmt_local_tagfile_StoeeLAlg) build_library_links dirs
#endif
#else
#$(cmt_local_StoeeLAlg_makefile) :: $(cmt_local_tagfile_StoeeLAlg)
#endif

ifdef cmt_StoeeLAlg_has_target_tag

ifndef QUICK
$(cmt_local_StoeeLAlg_makefile) : $(StoeeLAlg_dependencies) build_library_links
	$(echo) "(constituents.make) Building StoeeLAlg.make"; \
	  $(cmtexe) -tag=$(tags) $(StoeeLAlg_extratags) build constituent_config -out=$(cmt_local_StoeeLAlg_makefile) StoeeLAlg
else
$(cmt_local_StoeeLAlg_makefile) : $(StoeeLAlg_dependencies) $(cmt_build_library_linksstamp) $(use_requirements)
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_StoeeLAlg) ] || \
	  [ ! -f $(cmt_final_setup_StoeeLAlg) ] || \
	  $(not_StoeeLAlg_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
	  echo "$(CMTMSGPREFIX)" "(constituents.make) Building StoeeLAlg.make"; \
	  $(cmtexe) -tag=$(tags) $(StoeeLAlg_extratags) build constituent_config -out=$(cmt_local_StoeeLAlg_makefile) StoeeLAlg; \
	  fi
endif
...
$(cmt_local_StoeeLAlg_makefile) : $(StoeeLAlg_dependencies) build_library_links
	$(echo) "(constituents.make) Building StoeeLAlg.make"; \
	  $(cmtexe) -f=$(bin)StoeeLAlg.in -tag=$(tags) $(StoeeLAlg_extratags) build constituent_makefile -without_cmt -out=$(cmt_local_StoeeLAlg_makefile) StoeeLAlg
else
$(cmt_local_StoeeLAlg_makefile) : $(StoeeLAlg_dependencies) $(cmt_build_library_linksstamp) $(bin)StoeeLAlg.in
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_StoeeLAlg) ] || \
	  [ ! -f $(cmt_final_setup_StoeeLAlg) ] || \
	  $(not_StoeeLAlg_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
...
#	  $(cmtexe) -tag=$(tags) $(StoeeLAlg_extratags) build constituent_makefile -out=$(cmt_local_StoeeLAlg_makefile) StoeeLAlg

StoeeLAlg :: $(StoeeLAlg_dependencies) $(cmt_local_StoeeLAlg_makefile) dirs StoeeLAlgdirs
	$(echo) "(constituents.make) Starting StoeeLAlg"
	@if test -f $(cmt_local_StoeeLAlg_makefile); then \
	  $(MAKE) -f $(cmt_local_StoeeLAlg_makefile) StoeeLAlg; \
	  fi
#	@$(MAKE) -f $(cmt_local_StoeeLAlg_makefile) StoeeLAlg
	$(echo) "(constituents.make) StoeeLAlg done"

clean :: StoeeLAlgclean

StoeeLAlgclean :: $(StoeeLAlgclean_dependencies) ##$(cmt_local_StoeeLAlg_makefile)
	$(echo) "(constituents.make) Starting StoeeLAlgclean"
	@-if test -f $(cmt_local_StoeeLAlg_makefile); then \
	  $(MAKE) -f $(cmt_local_StoeeLAlg_makefile) StoeeLAlgclean; \
	fi
	$(echo) "(constituents.make) StoeeLAlgclean done"
#	@-$(MAKE) -f $(cmt_local_StoeeLAlg_makefile) StoeeLAlgclean

##	  /bin/rm -f $(cmt_local_StoeeLAlg_makefile) $(bin)StoeeLAlg_dependencies.make

install :: StoeeLAlginstall

StoeeLAlginstall :: $(StoeeLAlg_dependencies) $(cmt_local_StoeeLAlg_makefile)
	$(echo) "(constituents.make) Starting install StoeeLAlg"
	@-$(MAKE) -f $(cmt_local_StoeeLAlg_makefile) install
	$(echo) "(constituents.make) install StoeeLAlg done"

uninstall : StoeeLAlguninstall

$(foreach d,$(StoeeLAlg_dependencies),$(eval $(d)uninstall_dependencies += StoeeLAlguninstall))

StoeeLAlguninstall : $(StoeeLAlguninstall_dependencies) ##$(cmt_local_StoeeLAlg_makefile)
	$(echo) "(constituents.make) Starting uninstall StoeeLAlg"
	@if test -f $(cmt_local_StoeeLAlg_makefile); then \
	  $(MAKE) -f $(cmt_local_StoeeLAlg_makefile) uninstall; \
	  fi
#	@$(MAKE) -f $(cmt_local_StoeeLAlg_makefile) uninstall
	$(echo) "(constituents.make) uninstall StoeeLAlg done"

remove_library_links :: StoeeLAlguninstall
...
#cmt_local_tagfile_config = $(StoeeLAlg_tag)_config.make
cmt_local_tagfile_config = $(bin)$(StoeeLAlg_tag)_config.make
cmt_local_setup_config = $(bin)setup_config$$$$.make
cmt_final_setup_config = $(bin)setup_config.make
#cmt_final_setup_config = $(bin)StoeeLAlg_configsetup.make
...
#cmt_local_tagfile_config = $(StoeeLAlg_tag).make
cmt_local_tagfile_config = $(bin)$(StoeeLAlg_tag).make
cmt_final_setup_config = $(bin)setup.make
#cmt_final_setup_config = $(bin)StoeeLAlgsetup.make
cmt_local_config_makefile = $(bin)config.make
...
#cmt_local_tagfile_install_includes = $(StoeeLAlg_tag)_install_includes.make
cmt_local_tagfile_install_includes = $(bin)$(StoeeLAlg_tag)_install_includes.make
...
#cmt_final_setup_install_includes = $(bin)StoeeLAlg_install_includessetup.make
...
#cmt_local_tagfile_install_includes = $(StoeeLAlg_tag).make
cmt_local_tagfile_install_includes = $(bin)$(StoeeLAlg_tag).make
cmt_final_setup_install_includes = $(bin)setup.make
#cmt_final_setup_install_includes = $(bin)StoeeLAlgsetup.make
cmt_local_install_includes_makefile = $(bin)install_includes.make
...
#cmt_local_tagfile_make = $(StoeeLAlg_tag)_make.make
cmt_local_tagfile_make = $(bin)$(StoeeLAlg_tag)_make.make
cmt_local_setup_make = $(bin)setup_make$$$$.make
cmt_final_setup_make = $(bin)setup_make.make
#cmt_final_setup_make = $(bin)StoeeLAlg_makesetup.make
...
#cmt_local_tagfile_make = $(StoeeLAlg_tag).make
cmt_local_tagfile_make = $(bin)$(StoeeLAlg_tag).make
cmt_final_setup_make = $(bin)setup.make
#cmt_final_setup_make = $(bin)StoeeLAlgsetup.make
cmt_local_make_makefile = $(bin)make.make
...
#cmt_local_tagfile_CompilePython = $(StoeeLAlg_tag)_CompilePython.make
cmt_local_tagfile_CompilePython = $(bin)$(StoeeLAlg_tag)_CompilePython.make
cmt_local_setup_CompilePython = $(bin)setup_CompilePython$$$$.make
cmt_final_setup_CompilePython = $(bin)setup_CompilePython.make
#cmt_final_setup_CompilePython = $(bin)StoeeLAlg_CompilePythonsetup.make
...
#cmt_local_tagfile_CompilePython = $(StoeeLAlg_tag).make
cmt_local_tagfile_CompilePython = $(bin)$(StoeeLAlg_tag).make
cmt_final_setup_CompilePython = $(bin)setup.make
#cmt_final_setup_CompilePython = $(bin)StoeeLAlgsetup.make
cmt_local_CompilePython_makefile = $(bin)CompilePython.make
...
#cmt_local_tagfile_qmtest_run = $(StoeeLAlg_tag)_qmtest_run.make
cmt_local_tagfile_qmtest_run = $(bin)$(StoeeLAlg_tag)_qmtest_run.make
cmt_local_setup_qmtest_run = $(bin)setup_qmtest_run$$$$.make
cmt_final_setup_qmtest_run = $(bin)setup_qmtest_run.make
#cmt_final_setup_qmtest_run = $(bin)StoeeLAlg_qmtest_runsetup.make
...
#cmt_local_tagfile_qmtest_run = $(StoeeLAlg_tag).make
cmt_local_tagfile_qmtest_run = $(bin)$(StoeeLAlg_tag).make
cmt_final_setup_qmtest_run = $(bin)setup.make
#cmt_final_setup_qmtest_run = $(bin)StoeeLAlgsetup.make
cmt_local_qmtest_run_makefile = $(bin)qmtest_run.make
...
#cmt_local_tagfile_qmtest_summarize = $(StoeeLAlg_tag)_qmtest_summarize.make
cmt_local_tagfile_qmtest_summarize = $(bin)$(StoeeLAlg_tag)_qmtest_summarize.make
...
#cmt_final_setup_qmtest_summarize = $(bin)StoeeLAlg_qmtest_summarizesetup.make
...
#cmt_local_tagfile_qmtest_summarize = $(StoeeLAlg_tag).make
cmt_local_tagfile_qmtest_summarize = $(bin)$(StoeeLAlg_tag).make
cmt_final_setup_qmtest_summarize = $(bin)setup.make
#cmt_final_setup_qmtest_summarize = $(bin)StoeeLAlgsetup.make
cmt_local_qmtest_summarize_makefile = $(bin)qmtest_summarize.make
...
#cmt_local_tagfile_TestPackage = $(StoeeLAlg_tag)_TestPackage.make
cmt_local_tagfile_TestPackage = $(bin)$(StoeeLAlg_tag)_TestPackage.make
cmt_local_setup_TestPackage = $(bin)setup_TestPackage$$$$.make
cmt_final_setup_TestPackage = $(bin)setup_TestPackage.make
#cmt_final_setup_TestPackage = $(bin)StoeeLAlg_TestPackagesetup.make
...
#cmt_local_tagfile_TestPackage = $(StoeeLAlg_tag).make
cmt_local_tagfile_TestPackage = $(bin)$(StoeeLAlg_tag).make
cmt_final_setup_TestPackage = $(bin)setup.make
#cmt_final_setup_TestPackage = $(bin)StoeeLAlgsetup.make
cmt_local_TestPackage_makefile = $(bin)TestPackage.make
...
#cmt_local_tagfile_TestProject = $(StoeeLAlg_tag)_TestProject.make
cmt_local_tagfile_TestProject = $(bin)$(StoeeLAlg_tag)_TestProject.make
cmt_local_setup_TestProject = $(bin)setup_TestProject$$$$.make
cmt_final_setup_TestProject = $(bin)setup_TestProject.make
#cmt_final_setup_TestProject = $(bin)StoeeLAlg_TestProjectsetup.make
...
#cmt_local_tagfile_TestProject = $(StoeeLAlg_tag).make
cmt_local_tagfile_TestProject = $(bin)$(StoeeLAlg_tag).make
cmt_final_setup_TestProject = $(bin)setup.make
#cmt_final_setup_TestProject = $(bin)StoeeLAlgsetup.make
cmt_local_TestProject_makefile = $(bin)TestProject.make
...
#cmt_local_tagfile_new_rootsys = $(StoeeLAlg_tag)_new_rootsys.make
cmt_local_tagfile_new_rootsys = $(bin)$(StoeeLAlg_tag)_new_rootsys.make
cmt_local_setup_new_rootsys = $(bin)setup_new_rootsys$$$$.make
cmt_final_setup_new_rootsys = $(bin)setup_new_rootsys.make
#cmt_final_setup_new_rootsys = $(bin)StoeeLAlg_new_rootsyssetup.make
...
#cmt_local_tagfile_new_rootsys = $(StoeeLAlg_tag).make
cmt_local_tagfile_new_rootsys = $(bin)$(StoeeLAlg_tag).make
cmt_final_setup_new_rootsys = $(bin)setup.make
#cmt_final_setup_new_rootsys = $(bin)StoeeLAlgsetup.make
cmt_local_new_rootsys_makefile = $(bin)new_rootsys.make
...
#cmt_local_tagfile_DatabaseSvc_check_install_scripts = $(StoeeLAlg_tag)_DatabaseSvc_check_install_scripts.make
cmt_local_tagfile_DatabaseSvc_check_install_scripts = $(bin)$(StoeeLAlg_tag)_DatabaseSvc_check_install_scripts.make
...
#cmt_final_setup_DatabaseSvc_check_install_scripts = $(bin)StoeeLAlg_DatabaseSvc_check_install_scriptssetup.make
...
#cmt_local_tagfile_DatabaseSvc_check_install_scripts = $(StoeeLAlg_tag).make
cmt_local_tagfile_DatabaseSvc_check_install_scripts = $(bin)$(StoeeLAlg_tag).make
cmt_final_setup_DatabaseSvc_check_install_scripts = $(bin)setup.make
#cmt_final_setup_DatabaseSvc_check_install_scripts = $(bin)StoeeLAlgsetup.make
cmt_local_DatabaseSvc_check_install_scripts_makefile = $(bin)DatabaseSvc_check_install_scripts.make
...
#cmt_local_tagfile_EventNavigator_check_install_runtime = $(StoeeLAlg_tag)_EventNavigator_check_install_runtime.make
cmt_local_tagfile_EventNavigator_check_install_runtime = $(bin)$(StoeeLAlg_tag)_EventNavigator_check_install_runtime.make
...
#cmt_final_setup_EventNavigator_check_install_runtime = $(bin)StoeeLAlg_EventNavigator_check_install_runtimesetup.make
...
#cmt_local_tagfile_EventNavigator_check_install_runtime = $(StoeeLAlg_tag).make
cmt_local_tagfile_EventNavigator_check_install_runtime = $(bin)$(StoeeLAlg_tag).make
cmt_final_setup_EventNavigator_check_install_runtime = $(bin)setup.make
#cmt_final_setup_EventNavigator_check_install_runtime = $(bin)StoeeLAlgsetup.make
cmt_local_EventNavigator_check_install_runtime_makefile = $(bin)EventNavigator_check_install_runtime.make
