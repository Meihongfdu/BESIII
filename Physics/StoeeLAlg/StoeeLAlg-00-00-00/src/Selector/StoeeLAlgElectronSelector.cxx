...
using std::cout;
using std::endl;
StoeeLAlgElectronSelector::StoeeLAlgElectronSelector()
{
    ...
    jobSvc->setMyProperties("StoeeLAlgElectronSelector", &m_propMgr);
}

bool StoeeLAlgElectronSelector::operator()(CDElectron& aElectron)
{
