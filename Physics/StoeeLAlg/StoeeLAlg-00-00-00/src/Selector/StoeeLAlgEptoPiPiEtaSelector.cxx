...
StoeeLAlgEptoPiPiEtaSelector::StoeeLAlgEptoPiPiEtaSelector(){
    ...
    jobSvc->setMyProperties("StoeeLAlgEptoPiPiEtaSelector", &m_propMgr);
}

bool StoeeLAlgEptoPiPiEtaSelector::operator() (CDDecay& aEp) {
