...
#include <iostream>
using std::vector;
StoeeLAlgPhotonSelector::StoeeLAlgPhotonSelector()
{
   ...
   jobSvc->setMyProperties("StoeeLAlgPhotonSelector", &m_propMgr);
}

bool StoeeLAlgPhotonSelector::operator() (CDPhoton& aPhoton) {
...
void StoeeLAlgPhotonSelector::setPi0s(vector<const EvtRecPi0*> pi0s){
    m_pi0s = pi0s;
    return;
}
bool StoeeLAlgPhotonSelector::FromPi0(int ID, vector<const EvtRecPi0*> _pi0s){
