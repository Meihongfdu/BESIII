...
StoeeLAlgKsSelector::StoeeLAlgKsSelector()
{
   ...
   jobSvc->setMyProperties("StoeeLAlgKsSelector", &m_propMgr);
}

bool StoeeLAlgKsSelector::operator() (CDKs& aKs) {
    ...
    if( !m_doSecondaryVFit){
     ...
     //   cout<<"mass after second vertex:\t"<<aKs.mass()<<"\t"<<( svtxfit->p4par() ).m()<<endl ; 
