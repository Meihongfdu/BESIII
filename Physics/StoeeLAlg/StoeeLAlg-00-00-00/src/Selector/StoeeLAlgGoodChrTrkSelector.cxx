...
using std::cout;
using std::endl;
StoeeLAlgGoodChrTrkSelector::StoeeLAlgGoodChrTrkSelector(){
    ...
    jobSvc->setMyProperties("StoeeLAlgGoodChrTrkSelector", &m_propMgr);
}

bool StoeeLAlgGoodChrTrkSelector::operator() (CDElectron& aGoodChrTrk) {
