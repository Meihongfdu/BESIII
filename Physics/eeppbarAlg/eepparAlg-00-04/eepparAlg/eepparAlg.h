#ifndef Physics_Analysis_eeppetapAlg_H
#define Physics_Analysis_eeppetapAlg_H 
//#include <string>
...
class eeppetapAlg : public Algorithm {
public:
  eeppetapAlg(const std::string& name, ISvcLocator* pSvcLocator);
