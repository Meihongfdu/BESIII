...
#cmt_local_tagfile = $(eeppetapAlg_tag).make
cmt_local_tagfile = $(bin)$(eeppetapAlg_tag).make
...
cmt_local_setup_eeppetapAlg = $(bin)setup_eeppetapAlg$$$$.make
...
eeppetapAlg_extratags = -tag_add=target_eeppetapAlg

#$(cmt_local_tagfile_eeppetapAlg) : $(cmt_lock_setup)
ifndef QUICK
$(cmt_local_tagfile_eeppetapAlg) ::
else
$(cmt_local_tagfile_eeppetapAlg) :
endif
	$(echo) "(constituents.make) Rebuilding $@"; \
	  if test -f $(cmt_local_tagfile_eeppetapAlg); then /bin/rm -f $(cmt_local_tagfile_eeppetapAlg); fi ; \
	  $(cmtexe) -tag=$(tags) $(eeppetapAlg_extratags) build tag_makefile >>$(cmt_local_tagfile_eeppetapAlg)
	$(echo) "(constituents.make) Rebuilding $(cmt_final_setup_eeppetapAlg)"; \
	  test ! -f $(cmt_local_setup_eeppetapAlg) || \rm -f $(cmt_local_setup_eeppetapAlg); \
	  trap '\rm -f $(cmt_local_setup_eeppetapAlg)' 0 1 2 15; \
	  $(cmtexe) -tag=$(tags) $(eeppetapAlg_extratags) show setup >$(cmt_local_setup_eeppetapAlg) && \
	  if [ -f $(cmt_final_setup_eeppetapAlg) ] && \
	    \cmp -s $(cmt_final_setup_eeppetapAlg) $(cmt_local_setup_eeppetapAlg); then \
	    \rm $(cmt_local_setup_eeppetapAlg); else \
	    \mv -f $(cmt_local_setup_eeppetapAlg) $(cmt_final_setup_eeppetapAlg); fi
...
not_eeppetapAlg_dependencies = { n=0; for p in $?; do m=0; for d in $(eeppetapAlg_dependencies); do if [ $$p = $$d ]; then m=1; break; fi; done; if [ $$m -eq 0 ]; then n=1; break; fi; done; [ $$n -eq 1 ]; }

ifdef STRUCTURED_OUTPUT
eeppetapAlgdirs :
	@if test ! -d $(bin)eeppetapAlg; then $(mkdir) -p $(bin)eeppetapAlg; fi
	$(echo) "STRUCTURED_OUTPUT="$(bin)eeppetapAlg
else
eeppetapAlgdirs : ;
endif
...
#	$(echo) "STRUCTURED_OUTPUT="$(bin)eeppetapAlg
#
#$(cmt_local_eeppetapAlg_makefile) :: $(eeppetapAlg_dependencies) $(cmt_local_tagfile_eeppetapAlg) build_library_links dirs eeppetapAlgdirs
#else
#$(cmt_local_eeppetapAlg_makefile) :: $(eeppetapAlg_dependencies) $(cmt_local_tagfile_eeppetapAlg) build_library_links dirs
#endif
#else
#$(cmt_local_eeppetapAlg_makefile) :: $(cmt_local_tagfile_eeppetapAlg)
#endif

ifdef cmt_eeppetapAlg_has_target_tag

ifndef QUICK
$(cmt_local_eeppetapAlg_makefile) : $(eeppetapAlg_dependencies) build_library_links
	$(echo) "(constituents.make) Building eeppetapAlg.make"; \
	  $(cmtexe) -tag=$(tags) $(eeppetapAlg_extratags) build constituent_config -out=$(cmt_local_eeppetapAlg_makefile) eeppetapAlg
else
$(cmt_local_eeppetapAlg_makefile) : $(eeppetapAlg_dependencies) $(cmt_build_library_linksstamp) $(use_requirements)
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_eeppetapAlg) ] || \
	  [ ! -f $(cmt_final_setup_eeppetapAlg) ] || \
	  $(not_eeppetapAlg_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
	  echo "$(CMTMSGPREFIX)" "(constituents.make) Building eeppetapAlg.make"; \
	  $(cmtexe) -tag=$(tags) $(eeppetapAlg_extratags) build constituent_config -out=$(cmt_local_eeppetapAlg_makefile) eeppetapAlg; \
	  fi
endif
...
$(cmt_local_eeppetapAlg_makefile) : $(eeppetapAlg_dependencies) build_library_links
	$(echo) "(constituents.make) Building eeppetapAlg.make"; \
	  $(cmtexe) -f=$(bin)eeppetapAlg.in -tag=$(tags) $(eeppetapAlg_extratags) build constituent_makefile -without_cmt -out=$(cmt_local_eeppetapAlg_makefile) eeppetapAlg
else
$(cmt_local_eeppetapAlg_makefile) : $(eeppetapAlg_dependencies) $(cmt_build_library_linksstamp) $(bin)eeppetapAlg.in
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_eeppetapAlg) ] || \
	  [ ! -f $(cmt_final_setup_eeppetapAlg) ] || \
	  $(not_eeppetapAlg_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
...
#	  $(cmtexe) -tag=$(tags) $(eeppetapAlg_extratags) build constituent_makefile -out=$(cmt_local_eeppetapAlg_makefile) eeppetapAlg

eeppetapAlg :: $(eeppetapAlg_dependencies) $(cmt_local_eeppetapAlg_makefile) dirs eeppetapAlgdirs
	$(echo) "(constituents.make) Starting eeppetapAlg"
	@if test -f $(cmt_local_eeppetapAlg_makefile); then \
	  $(MAKE) -f $(cmt_local_eeppetapAlg_makefile) eeppetapAlg; \
	  fi
#	@$(MAKE) -f $(cmt_local_eeppetapAlg_makefile) eeppetapAlg
	$(echo) "(constituents.make) eeppetapAlg done"

clean :: eeppetapAlgclean

eeppetapAlgclean :: $(eeppetapAlgclean_dependencies) ##$(cmt_local_eeppetapAlg_makefile)
	$(echo) "(constituents.make) Starting eeppetapAlgclean"
	@-if test -f $(cmt_local_eeppetapAlg_makefile); then \
	  $(MAKE) -f $(cmt_local_eeppetapAlg_makefile) eeppetapAlgclean; \
	fi
	$(echo) "(constituents.make) eeppetapAlgclean done"
#	@-$(MAKE) -f $(cmt_local_eeppetapAlg_makefile) eeppetapAlgclean

##	  /bin/rm -f $(cmt_local_eeppetapAlg_makefile) $(bin)eeppetapAlg_dependencies.make

install :: eeppetapAlginstall

eeppetapAlginstall :: $(eeppetapAlg_dependencies) $(cmt_local_eeppetapAlg_makefile)
	$(echo) "(constituents.make) Starting install eeppetapAlg"
	@-$(MAKE) -f $(cmt_local_eeppetapAlg_makefile) install
	$(echo) "(constituents.make) install eeppetapAlg done"

uninstall : eeppetapAlguninstall

$(foreach d,$(eeppetapAlg_dependencies),$(eval $(d)uninstall_dependencies += eeppetapAlguninstall))

eeppetapAlguninstall : $(eeppetapAlguninstall_dependencies) ##$(cmt_local_eeppetapAlg_makefile)
	$(echo) "(constituents.make) Starting uninstall eeppetapAlg"
	@if test -f $(cmt_local_eeppetapAlg_makefile); then \
	  $(MAKE) -f $(cmt_local_eeppetapAlg_makefile) uninstall; \
	  fi
#	@$(MAKE) -f $(cmt_local_eeppetapAlg_makefile) uninstall
	$(echo) "(constituents.make) uninstall eeppetapAlg done"

remove_library_links :: eeppetapAlguninstall
...
#cmt_local_tagfile_config = $(eeppetapAlg_tag)_config.make
cmt_local_tagfile_config = $(bin)$(eeppetapAlg_tag)_config.make
cmt_local_setup_config = $(bin)setup_config$$$$.make
cmt_final_setup_config = $(bin)setup_config.make
#cmt_final_setup_config = $(bin)eeppetapAlg_configsetup.make
...
#cmt_local_tagfile_config = $(eeppetapAlg_tag).make
cmt_local_tagfile_config = $(bin)$(eeppetapAlg_tag).make
cmt_final_setup_config = $(bin)setup.make
#cmt_final_setup_config = $(bin)eeppetapAlgsetup.make
cmt_local_config_makefile = $(bin)config.make
...
#cmt_local_tagfile_install_includes = $(eeppetapAlg_tag)_install_includes.make
cmt_local_tagfile_install_includes = $(bin)$(eeppetapAlg_tag)_install_includes.make
...
#cmt_final_setup_install_includes = $(bin)eeppetapAlg_install_includessetup.make
...
#cmt_local_tagfile_install_includes = $(eeppetapAlg_tag).make
cmt_local_tagfile_install_includes = $(bin)$(eeppetapAlg_tag).make
cmt_final_setup_install_includes = $(bin)setup.make
#cmt_final_setup_install_includes = $(bin)eeppetapAlgsetup.make
cmt_local_install_includes_makefile = $(bin)install_includes.make
...
#cmt_local_tagfile_make = $(eeppetapAlg_tag)_make.make
cmt_local_tagfile_make = $(bin)$(eeppetapAlg_tag)_make.make
cmt_local_setup_make = $(bin)setup_make$$$$.make
cmt_final_setup_make = $(bin)setup_make.make
#cmt_final_setup_make = $(bin)eeppetapAlg_makesetup.make
...
#cmt_local_tagfile_make = $(eeppetapAlg_tag).make
cmt_local_tagfile_make = $(bin)$(eeppetapAlg_tag).make
cmt_final_setup_make = $(bin)setup.make
#cmt_final_setup_make = $(bin)eeppetapAlgsetup.make
cmt_local_make_makefile = $(bin)make.make
...
#cmt_local_tagfile_CompilePython = $(eeppetapAlg_tag)_CompilePython.make
cmt_local_tagfile_CompilePython = $(bin)$(eeppetapAlg_tag)_CompilePython.make
cmt_local_setup_CompilePython = $(bin)setup_CompilePython$$$$.make
cmt_final_setup_CompilePython = $(bin)setup_CompilePython.make
#cmt_final_setup_CompilePython = $(bin)eeppetapAlg_CompilePythonsetup.make
...
#cmt_local_tagfile_CompilePython = $(eeppetapAlg_tag).make
cmt_local_tagfile_CompilePython = $(bin)$(eeppetapAlg_tag).make
cmt_final_setup_CompilePython = $(bin)setup.make
#cmt_final_setup_CompilePython = $(bin)eeppetapAlgsetup.make
cmt_local_CompilePython_makefile = $(bin)CompilePython.make
...
#cmt_local_tagfile_qmtest_run = $(eeppetapAlg_tag)_qmtest_run.make
cmt_local_tagfile_qmtest_run = $(bin)$(eeppetapAlg_tag)_qmtest_run.make
cmt_local_setup_qmtest_run = $(bin)setup_qmtest_run$$$$.make
cmt_final_setup_qmtest_run = $(bin)setup_qmtest_run.make
#cmt_final_setup_qmtest_run = $(bin)eeppetapAlg_qmtest_runsetup.make
...
#cmt_local_tagfile_qmtest_run = $(eeppetapAlg_tag).make
cmt_local_tagfile_qmtest_run = $(bin)$(eeppetapAlg_tag).make
cmt_final_setup_qmtest_run = $(bin)setup.make
#cmt_final_setup_qmtest_run = $(bin)eeppetapAlgsetup.make
cmt_local_qmtest_run_makefile = $(bin)qmtest_run.make
...
#cmt_local_tagfile_qmtest_summarize = $(eeppetapAlg_tag)_qmtest_summarize.make
cmt_local_tagfile_qmtest_summarize = $(bin)$(eeppetapAlg_tag)_qmtest_summarize.make
...
#cmt_final_setup_qmtest_summarize = $(bin)eeppetapAlg_qmtest_summarizesetup.make
...
#cmt_local_tagfile_qmtest_summarize = $(eeppetapAlg_tag).make
cmt_local_tagfile_qmtest_summarize = $(bin)$(eeppetapAlg_tag).make
cmt_final_setup_qmtest_summarize = $(bin)setup.make
#cmt_final_setup_qmtest_summarize = $(bin)eeppetapAlgsetup.make
cmt_local_qmtest_summarize_makefile = $(bin)qmtest_summarize.make
...
#cmt_local_tagfile_TestPackage = $(eeppetapAlg_tag)_TestPackage.make
cmt_local_tagfile_TestPackage = $(bin)$(eeppetapAlg_tag)_TestPackage.make
cmt_local_setup_TestPackage = $(bin)setup_TestPackage$$$$.make
cmt_final_setup_TestPackage = $(bin)setup_TestPackage.make
#cmt_final_setup_TestPackage = $(bin)eeppetapAlg_TestPackagesetup.make
...
#cmt_local_tagfile_TestPackage = $(eeppetapAlg_tag).make
cmt_local_tagfile_TestPackage = $(bin)$(eeppetapAlg_tag).make
cmt_final_setup_TestPackage = $(bin)setup.make
#cmt_final_setup_TestPackage = $(bin)eeppetapAlgsetup.make
cmt_local_TestPackage_makefile = $(bin)TestPackage.make
...
#cmt_local_tagfile_TestProject = $(eeppetapAlg_tag)_TestProject.make
cmt_local_tagfile_TestProject = $(bin)$(eeppetapAlg_tag)_TestProject.make
cmt_local_setup_TestProject = $(bin)setup_TestProject$$$$.make
cmt_final_setup_TestProject = $(bin)setup_TestProject.make
#cmt_final_setup_TestProject = $(bin)eeppetapAlg_TestProjectsetup.make
...
#cmt_local_tagfile_TestProject = $(eeppetapAlg_tag).make
cmt_local_tagfile_TestProject = $(bin)$(eeppetapAlg_tag).make
cmt_final_setup_TestProject = $(bin)setup.make
#cmt_final_setup_TestProject = $(bin)eeppetapAlgsetup.make
cmt_local_TestProject_makefile = $(bin)TestProject.make
...
#cmt_local_tagfile_new_rootsys = $(eeppetapAlg_tag)_new_rootsys.make
cmt_local_tagfile_new_rootsys = $(bin)$(eeppetapAlg_tag)_new_rootsys.make
cmt_local_setup_new_rootsys = $(bin)setup_new_rootsys$$$$.make
cmt_final_setup_new_rootsys = $(bin)setup_new_rootsys.make
#cmt_final_setup_new_rootsys = $(bin)eeppetapAlg_new_rootsyssetup.make
...
#cmt_local_tagfile_new_rootsys = $(eeppetapAlg_tag).make
cmt_local_tagfile_new_rootsys = $(bin)$(eeppetapAlg_tag).make
cmt_final_setup_new_rootsys = $(bin)setup.make
#cmt_final_setup_new_rootsys = $(bin)eeppetapAlgsetup.make
cmt_local_new_rootsys_makefile = $(bin)new_rootsys.make
...
#cmt_local_tagfile_DatabaseSvc_check_install_scripts = $(eeppetapAlg_tag)_DatabaseSvc_check_install_scripts.make
cmt_local_tagfile_DatabaseSvc_check_install_scripts = $(bin)$(eeppetapAlg_tag)_DatabaseSvc_check_install_scripts.make
...
#cmt_final_setup_DatabaseSvc_check_install_scripts = $(bin)eeppetapAlg_DatabaseSvc_check_install_scriptssetup.make
...
#cmt_local_tagfile_DatabaseSvc_check_install_scripts = $(eeppetapAlg_tag).make
cmt_local_tagfile_DatabaseSvc_check_install_scripts = $(bin)$(eeppetapAlg_tag).make
cmt_final_setup_DatabaseSvc_check_install_scripts = $(bin)setup.make
#cmt_final_setup_DatabaseSvc_check_install_scripts = $(bin)eeppetapAlgsetup.make
cmt_local_DatabaseSvc_check_install_scripts_makefile = $(bin)DatabaseSvc_check_install_scripts.make
