...
#cmt_local_tagfile = $(Xi_peeAlg_tag).make
cmt_local_tagfile = $(bin)$(Xi_peeAlg_tag).make
...
cmt_local_setup_Xi_peeAlg = $(bin)setup_Xi_peeAlg$$$$.make
...
Xi_peeAlg_extratags = -tag_add=target_Xi_peeAlg

#$(cmt_local_tagfile_Xi_peeAlg) : $(cmt_lock_setup)
ifndef QUICK
$(cmt_local_tagfile_Xi_peeAlg) ::
else
$(cmt_local_tagfile_Xi_peeAlg) :
endif
	$(echo) "(constituents.make) Rebuilding $@"; \
	  if test -f $(cmt_local_tagfile_Xi_peeAlg); then /bin/rm -f $(cmt_local_tagfile_Xi_peeAlg); fi ; \
	  $(cmtexe) -tag=$(tags) $(Xi_peeAlg_extratags) build tag_makefile >>$(cmt_local_tagfile_Xi_peeAlg)
	$(echo) "(constituents.make) Rebuilding $(cmt_final_setup_Xi_peeAlg)"; \
	  test ! -f $(cmt_local_setup_Xi_peeAlg) || \rm -f $(cmt_local_setup_Xi_peeAlg); \
	  trap '\rm -f $(cmt_local_setup_Xi_peeAlg)' 0 1 2 15; \
	  $(cmtexe) -tag=$(tags) $(Xi_peeAlg_extratags) show setup >$(cmt_local_setup_Xi_peeAlg) && \
	  if [ -f $(cmt_final_setup_Xi_peeAlg) ] && \
	    \cmp -s $(cmt_final_setup_Xi_peeAlg) $(cmt_local_setup_Xi_peeAlg); then \
	    \rm $(cmt_local_setup_Xi_peeAlg); else \
	    \mv -f $(cmt_local_setup_Xi_peeAlg) $(cmt_final_setup_Xi_peeAlg); fi
...
not_Xi_peeAlg_dependencies = { n=0; for p in $?; do m=0; for d in $(Xi_peeAlg_dependencies); do if [ $$p = $$d ]; then m=1; break; fi; done; if [ $$m -eq 0 ]; then n=1; break; fi; done; [ $$n -eq 1 ]; }

ifdef STRUCTURED_OUTPUT
Xi_peeAlgdirs :
	@if test ! -d $(bin)Xi_peeAlg; then $(mkdir) -p $(bin)Xi_peeAlg; fi
	$(echo) "STRUCTURED_OUTPUT="$(bin)Xi_peeAlg
else
Xi_peeAlgdirs : ;
endif
...
#	$(echo) "STRUCTURED_OUTPUT="$(bin)Xi_peeAlg
#
#$(cmt_local_Xi_peeAlg_makefile) :: $(Xi_peeAlg_dependencies) $(cmt_local_tagfile_Xi_peeAlg) build_library_links dirs Xi_peeAlgdirs
#else
#$(cmt_local_Xi_peeAlg_makefile) :: $(Xi_peeAlg_dependencies) $(cmt_local_tagfile_Xi_peeAlg) build_library_links dirs
#endif
#else
#$(cmt_local_Xi_peeAlg_makefile) :: $(cmt_local_tagfile_Xi_peeAlg)
#endif

ifdef cmt_Xi_peeAlg_has_target_tag

ifndef QUICK
$(cmt_local_Xi_peeAlg_makefile) : $(Xi_peeAlg_dependencies) build_library_links
	$(echo) "(constituents.make) Building Xi_peeAlg.make"; \
	  $(cmtexe) -tag=$(tags) $(Xi_peeAlg_extratags) build constituent_config -out=$(cmt_local_Xi_peeAlg_makefile) Xi_peeAlg
else
$(cmt_local_Xi_peeAlg_makefile) : $(Xi_peeAlg_dependencies) $(cmt_build_library_linksstamp) $(use_requirements)
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_Xi_peeAlg) ] || \
	  [ ! -f $(cmt_final_setup_Xi_peeAlg) ] || \
	  $(not_Xi_peeAlg_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
	  echo "$(CMTMSGPREFIX)" "(constituents.make) Building Xi_peeAlg.make"; \
	  $(cmtexe) -tag=$(tags) $(Xi_peeAlg_extratags) build constituent_config -out=$(cmt_local_Xi_peeAlg_makefile) Xi_peeAlg; \
	  fi
endif
...
$(cmt_local_Xi_peeAlg_makefile) : $(Xi_peeAlg_dependencies) build_library_links
	$(echo) "(constituents.make) Building Xi_peeAlg.make"; \
	  $(cmtexe) -f=$(bin)Xi_peeAlg.in -tag=$(tags) $(Xi_peeAlg_extratags) build constituent_makefile -without_cmt -out=$(cmt_local_Xi_peeAlg_makefile) Xi_peeAlg
else
$(cmt_local_Xi_peeAlg_makefile) : $(Xi_peeAlg_dependencies) $(cmt_build_library_linksstamp) $(bin)Xi_peeAlg.in
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_Xi_peeAlg) ] || \
	  [ ! -f $(cmt_final_setup_Xi_peeAlg) ] || \
	  $(not_Xi_peeAlg_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
...
#	  $(cmtexe) -tag=$(tags) $(Xi_peeAlg_extratags) build constituent_makefile -out=$(cmt_local_Xi_peeAlg_makefile) Xi_peeAlg

Xi_peeAlg :: $(Xi_peeAlg_dependencies) $(cmt_local_Xi_peeAlg_makefile) dirs Xi_peeAlgdirs
	$(echo) "(constituents.make) Starting Xi_peeAlg"
	@if test -f $(cmt_local_Xi_peeAlg_makefile); then \
	  $(MAKE) -f $(cmt_local_Xi_peeAlg_makefile) Xi_peeAlg; \
	  fi
#	@$(MAKE) -f $(cmt_local_Xi_peeAlg_makefile) Xi_peeAlg
	$(echo) "(constituents.make) Xi_peeAlg done"

clean :: Xi_peeAlgclean

Xi_peeAlgclean :: $(Xi_peeAlgclean_dependencies) ##$(cmt_local_Xi_peeAlg_makefile)
	$(echo) "(constituents.make) Starting Xi_peeAlgclean"
	@-if test -f $(cmt_local_Xi_peeAlg_makefile); then \
	  $(MAKE) -f $(cmt_local_Xi_peeAlg_makefile) Xi_peeAlgclean; \
	fi
	$(echo) "(constituents.make) Xi_peeAlgclean done"
#	@-$(MAKE) -f $(cmt_local_Xi_peeAlg_makefile) Xi_peeAlgclean

##	  /bin/rm -f $(cmt_local_Xi_peeAlg_makefile) $(bin)Xi_peeAlg_dependencies.make

install :: Xi_peeAlginstall

Xi_peeAlginstall :: $(Xi_peeAlg_dependencies) $(cmt_local_Xi_peeAlg_makefile)
	$(echo) "(constituents.make) Starting install Xi_peeAlg"
	@-$(MAKE) -f $(cmt_local_Xi_peeAlg_makefile) install
	$(echo) "(constituents.make) install Xi_peeAlg done"

uninstall : Xi_peeAlguninstall

$(foreach d,$(Xi_peeAlg_dependencies),$(eval $(d)uninstall_dependencies += Xi_peeAlguninstall))

Xi_peeAlguninstall : $(Xi_peeAlguninstall_dependencies) ##$(cmt_local_Xi_peeAlg_makefile)
	$(echo) "(constituents.make) Starting uninstall Xi_peeAlg"
	@if test -f $(cmt_local_Xi_peeAlg_makefile); then \
	  $(MAKE) -f $(cmt_local_Xi_peeAlg_makefile) uninstall; \
	  fi
#	@$(MAKE) -f $(cmt_local_Xi_peeAlg_makefile) uninstall
	$(echo) "(constituents.make) uninstall Xi_peeAlg done"

remove_library_links :: Xi_peeAlguninstall
...
#cmt_local_tagfile_install_runtime = $(Xi_peeAlg_tag)_install_runtime.make
cmt_local_tagfile_install_runtime = $(bin)$(Xi_peeAlg_tag)_install_runtime.make
...
#cmt_final_setup_install_runtime = $(bin)Xi_peeAlg_install_runtimesetup.make
...
#cmt_local_tagfile_install_runtime = $(Xi_peeAlg_tag).make
cmt_local_tagfile_install_runtime = $(bin)$(Xi_peeAlg_tag).make
cmt_final_setup_install_runtime = $(bin)setup.make
#cmt_final_setup_install_runtime = $(bin)Xi_peeAlgsetup.make
cmt_local_install_runtime_makefile = $(bin)install_runtime.make
...
#cmt_local_tagfile_install_includes = $(Xi_peeAlg_tag)_install_includes.make
cmt_local_tagfile_install_includes = $(bin)$(Xi_peeAlg_tag)_install_includes.make
...
#cmt_final_setup_install_includes = $(bin)Xi_peeAlg_install_includessetup.make
...
#cmt_local_tagfile_install_includes = $(Xi_peeAlg_tag).make
cmt_local_tagfile_install_includes = $(bin)$(Xi_peeAlg_tag).make
cmt_final_setup_install_includes = $(bin)setup.make
#cmt_final_setup_install_includes = $(bin)Xi_peeAlgsetup.make
cmt_local_install_includes_makefile = $(bin)install_includes.make
...
#cmt_local_tagfile_make = $(Xi_peeAlg_tag)_make.make
cmt_local_tagfile_make = $(bin)$(Xi_peeAlg_tag)_make.make
cmt_local_setup_make = $(bin)setup_make$$$$.make
cmt_final_setup_make = $(bin)setup_make.make
#cmt_final_setup_make = $(bin)Xi_peeAlg_makesetup.make
...
#cmt_local_tagfile_make = $(Xi_peeAlg_tag).make
cmt_local_tagfile_make = $(bin)$(Xi_peeAlg_tag).make
cmt_final_setup_make = $(bin)setup.make
#cmt_final_setup_make = $(bin)Xi_peeAlgsetup.make
cmt_local_make_makefile = $(bin)make.make
...
#cmt_local_tagfile_CompilePython = $(Xi_peeAlg_tag)_CompilePython.make
cmt_local_tagfile_CompilePython = $(bin)$(Xi_peeAlg_tag)_CompilePython.make
cmt_local_setup_CompilePython = $(bin)setup_CompilePython$$$$.make
cmt_final_setup_CompilePython = $(bin)setup_CompilePython.make
#cmt_final_setup_CompilePython = $(bin)Xi_peeAlg_CompilePythonsetup.make
...
#cmt_local_tagfile_CompilePython = $(Xi_peeAlg_tag).make
cmt_local_tagfile_CompilePython = $(bin)$(Xi_peeAlg_tag).make
cmt_final_setup_CompilePython = $(bin)setup.make
#cmt_final_setup_CompilePython = $(bin)Xi_peeAlgsetup.make
cmt_local_CompilePython_makefile = $(bin)CompilePython.make
...
#cmt_local_tagfile_qmtest_run = $(Xi_peeAlg_tag)_qmtest_run.make
cmt_local_tagfile_qmtest_run = $(bin)$(Xi_peeAlg_tag)_qmtest_run.make
cmt_local_setup_qmtest_run = $(bin)setup_qmtest_run$$$$.make
cmt_final_setup_qmtest_run = $(bin)setup_qmtest_run.make
#cmt_final_setup_qmtest_run = $(bin)Xi_peeAlg_qmtest_runsetup.make
...
#cmt_local_tagfile_qmtest_run = $(Xi_peeAlg_tag).make
cmt_local_tagfile_qmtest_run = $(bin)$(Xi_peeAlg_tag).make
cmt_final_setup_qmtest_run = $(bin)setup.make
#cmt_final_setup_qmtest_run = $(bin)Xi_peeAlgsetup.make
cmt_local_qmtest_run_makefile = $(bin)qmtest_run.make
...
#cmt_local_tagfile_qmtest_summarize = $(Xi_peeAlg_tag)_qmtest_summarize.make
cmt_local_tagfile_qmtest_summarize = $(bin)$(Xi_peeAlg_tag)_qmtest_summarize.make
...
#cmt_final_setup_qmtest_summarize = $(bin)Xi_peeAlg_qmtest_summarizesetup.make
...
#cmt_local_tagfile_qmtest_summarize = $(Xi_peeAlg_tag).make
cmt_local_tagfile_qmtest_summarize = $(bin)$(Xi_peeAlg_tag).make
cmt_final_setup_qmtest_summarize = $(bin)setup.make
#cmt_final_setup_qmtest_summarize = $(bin)Xi_peeAlgsetup.make
cmt_local_qmtest_summarize_makefile = $(bin)qmtest_summarize.make
...
#cmt_local_tagfile_TestPackage = $(Xi_peeAlg_tag)_TestPackage.make
cmt_local_tagfile_TestPackage = $(bin)$(Xi_peeAlg_tag)_TestPackage.make
cmt_local_setup_TestPackage = $(bin)setup_TestPackage$$$$.make
cmt_final_setup_TestPackage = $(bin)setup_TestPackage.make
#cmt_final_setup_TestPackage = $(bin)Xi_peeAlg_TestPackagesetup.make
...
#cmt_local_tagfile_TestPackage = $(Xi_peeAlg_tag).make
cmt_local_tagfile_TestPackage = $(bin)$(Xi_peeAlg_tag).make
cmt_final_setup_TestPackage = $(bin)setup.make
#cmt_final_setup_TestPackage = $(bin)Xi_peeAlgsetup.make
cmt_local_TestPackage_makefile = $(bin)TestPackage.make
...
#cmt_local_tagfile_TestProject = $(Xi_peeAlg_tag)_TestProject.make
cmt_local_tagfile_TestProject = $(bin)$(Xi_peeAlg_tag)_TestProject.make
cmt_local_setup_TestProject = $(bin)setup_TestProject$$$$.make
cmt_final_setup_TestProject = $(bin)setup_TestProject.make
#cmt_final_setup_TestProject = $(bin)Xi_peeAlg_TestProjectsetup.make
...
#cmt_local_tagfile_TestProject = $(Xi_peeAlg_tag).make
cmt_local_tagfile_TestProject = $(bin)$(Xi_peeAlg_tag).make
cmt_final_setup_TestProject = $(bin)setup.make
#cmt_final_setup_TestProject = $(bin)Xi_peeAlgsetup.make
cmt_local_TestProject_makefile = $(bin)TestProject.make
...
#cmt_local_tagfile_new_rootsys = $(Xi_peeAlg_tag)_new_rootsys.make
cmt_local_tagfile_new_rootsys = $(bin)$(Xi_peeAlg_tag)_new_rootsys.make
cmt_local_setup_new_rootsys = $(bin)setup_new_rootsys$$$$.make
cmt_final_setup_new_rootsys = $(bin)setup_new_rootsys.make
#cmt_final_setup_new_rootsys = $(bin)Xi_peeAlg_new_rootsyssetup.make
...
#cmt_local_tagfile_new_rootsys = $(Xi_peeAlg_tag).make
cmt_local_tagfile_new_rootsys = $(bin)$(Xi_peeAlg_tag).make
cmt_final_setup_new_rootsys = $(bin)setup.make
#cmt_final_setup_new_rootsys = $(bin)Xi_peeAlgsetup.make
cmt_local_new_rootsys_makefile = $(bin)new_rootsys.make
...
#cmt_local_tagfile_DatabaseSvc_check_install_scripts = $(Xi_peeAlg_tag)_DatabaseSvc_check_install_scripts.make
cmt_local_tagfile_DatabaseSvc_check_install_scripts = $(bin)$(Xi_peeAlg_tag)_DatabaseSvc_check_install_scripts.make
...
#cmt_final_setup_DatabaseSvc_check_install_scripts = $(bin)Xi_peeAlg_DatabaseSvc_check_install_scriptssetup.make
...
#cmt_local_tagfile_DatabaseSvc_check_install_scripts = $(Xi_peeAlg_tag).make
cmt_local_tagfile_DatabaseSvc_check_install_scripts = $(bin)$(Xi_peeAlg_tag).make
cmt_final_setup_DatabaseSvc_check_install_scripts = $(bin)setup.make
#cmt_final_setup_DatabaseSvc_check_install_scripts = $(bin)Xi_peeAlgsetup.make
cmt_local_DatabaseSvc_check_install_scripts_makefile = $(bin)DatabaseSvc_check_install_scripts.make
...
cmt_local_setup_Xi_peeAlg_check_install_runtime = $(bin)setup_Xi_peeAlg_check_install_runtime$$$$.make
...
Xi_peeAlg_check_install_runtime_extratags = -tag_add=target_Xi_peeAlg_check_install_runtime

#$(cmt_local_tagfile_Xi_peeAlg_check_install_runtime) : $(cmt_lock_setup)
ifndef QUICK
$(cmt_local_tagfile_Xi_peeAlg_check_install_runtime) ::
else
$(cmt_local_tagfile_Xi_peeAlg_check_install_runtime) :
endif
	$(echo) "(constituents.make) Rebuilding $@"; \
	  if test -f $(cmt_local_tagfile_Xi_peeAlg_check_install_runtime); then /bin/rm -f $(cmt_local_tagfile_Xi_peeAlg_check_install_runtime); fi ; \
	  $(cmtexe) -tag=$(tags) $(Xi_peeAlg_check_install_runtime_extratags) build tag_makefile >>$(cmt_local_tagfile_Xi_peeAlg_check_install_runtime)
	$(echo) "(constituents.make) Rebuilding $(cmt_final_setup_Xi_peeAlg_check_install_runtime)"; \
	  test ! -f $(cmt_local_setup_Xi_peeAlg_check_install_runtime) || \rm -f $(cmt_local_setup_Xi_peeAlg_check_install_runtime); \
	  trap '\rm -f $(cmt_local_setup_Xi_peeAlg_check_install_runtime)' 0 1 2 15; \
	  $(cmtexe) -tag=$(tags) $(Xi_peeAlg_check_install_runtime_extratags) show setup >$(cmt_local_setup_Xi_peeAlg_check_install_runtime) && \
	  if [ -f $(cmt_final_setup_Xi_peeAlg_check_install_runtime) ] && \
	    \cmp -s $(cmt_final_setup_Xi_peeAlg_check_install_runtime) $(cmt_local_setup_Xi_peeAlg_check_install_runtime); then \
	    \rm $(cmt_local_setup_Xi_peeAlg_check_install_runtime); else \
	    \mv -f $(cmt_local_setup_Xi_peeAlg_check_install_runtime) $(cmt_final_setup_Xi_peeAlg_check_install_runtime); fi
...
not_Xi_peeAlg_check_install_runtime_dependencies = { n=0; for p in $?; do m=0; for d in $(Xi_peeAlg_check_install_runtime_dependencies); do if [ $$p = $$d ]; then m=1; break; fi; done; if [ $$m -eq 0 ]; then n=1; break; fi; done; [ $$n -eq 1 ]; }

ifdef STRUCTURED_OUTPUT
Xi_peeAlg_check_install_runtimedirs :
	@if test ! -d $(bin)Xi_peeAlg_check_install_runtime; then $(mkdir) -p $(bin)Xi_peeAlg_check_install_runtime; fi
	$(echo) "STRUCTURED_OUTPUT="$(bin)Xi_peeAlg_check_install_runtime
else
Xi_peeAlg_check_install_runtimedirs : ;
endif
...
#	$(echo) "STRUCTURED_OUTPUT="$(bin)Xi_peeAlg_check_install_runtime
#
#$(cmt_local_Xi_peeAlg_check_install_runtime_makefile) :: $(Xi_peeAlg_check_install_runtime_dependencies) $(cmt_local_tagfile_Xi_peeAlg_check_install_runtime) build_library_links dirs Xi_peeAlg_check_install_runtimedirs
#else
#$(cmt_local_Xi_peeAlg_check_install_runtime_makefile) :: $(Xi_peeAlg_check_install_runtime_dependencies) $(cmt_local_tagfile_Xi_peeAlg_check_install_runtime) build_library_links dirs
#endif
#else
#$(cmt_local_Xi_peeAlg_check_install_runtime_makefile) :: $(cmt_local_tagfile_Xi_peeAlg_check_install_runtime)
#endif

ifdef cmt_Xi_peeAlg_check_install_runtime_has_target_tag

ifndef QUICK
$(cmt_local_Xi_peeAlg_check_install_runtime_makefile) : $(Xi_peeAlg_check_install_runtime_dependencies) build_library_links
	$(echo) "(constituents.make) Building Xi_peeAlg_check_install_runtime.make"; \
	  $(cmtexe) -tag=$(tags) $(Xi_peeAlg_check_install_runtime_extratags) build constituent_config -out=$(cmt_local_Xi_peeAlg_check_install_runtime_makefile) Xi_peeAlg_check_install_runtime
else
$(cmt_local_Xi_peeAlg_check_install_runtime_makefile) : $(Xi_peeAlg_check_install_runtime_dependencies) $(cmt_build_library_linksstamp) $(use_requirements)
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_Xi_peeAlg_check_install_runtime) ] || \
	  [ ! -f $(cmt_final_setup_Xi_peeAlg_check_install_runtime) ] || \
	  $(not_Xi_peeAlg_check_install_runtime_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
	  echo "$(CMTMSGPREFIX)" "(constituents.make) Building Xi_peeAlg_check_install_runtime.make"; \
	  $(cmtexe) -tag=$(tags) $(Xi_peeAlg_check_install_runtime_extratags) build constituent_config -out=$(cmt_local_Xi_peeAlg_check_install_runtime_makefile) Xi_peeAlg_check_install_runtime; \
	  fi
endif
...
$(cmt_local_Xi_peeAlg_check_install_runtime_makefile) : $(Xi_peeAlg_check_install_runtime_dependencies) build_library_links
	$(echo) "(constituents.make) Building Xi_peeAlg_check_install_runtime.make"; \
	  $(cmtexe) -f=$(bin)Xi_peeAlg_check_install_runtime.in -tag=$(tags) $(Xi_peeAlg_check_install_runtime_extratags) build constituent_makefile -without_cmt -out=$(cmt_local_Xi_peeAlg_check_install_runtime_makefile) Xi_peeAlg_check_install_runtime
else
$(cmt_local_Xi_peeAlg_check_install_runtime_makefile) : $(Xi_peeAlg_check_install_runtime_dependencies) $(cmt_build_library_linksstamp) $(bin)Xi_peeAlg_check_install_runtime.in
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_Xi_peeAlg_check_install_runtime) ] || \
	  [ ! -f $(cmt_final_setup_Xi_peeAlg_check_install_runtime) ] || \
	  $(not_Xi_peeAlg_check_install_runtime_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
...
#	  $(cmtexe) -tag=$(tags) $(Xi_peeAlg_check_install_runtime_extratags) build constituent_makefile -out=$(cmt_local_Xi_peeAlg_check_install_runtime_makefile) Xi_peeAlg_check_install_runtime

Xi_peeAlg_check_install_runtime :: $(Xi_peeAlg_check_install_runtime_dependencies) $(cmt_local_Xi_peeAlg_check_install_runtime_makefile) dirs Xi_peeAlg_check_install_runtimedirs
	$(echo) "(constituents.make) Starting Xi_peeAlg_check_install_runtime"
	@if test -f $(cmt_local_Xi_peeAlg_check_install_runtime_makefile); then \
	  $(MAKE) -f $(cmt_local_Xi_peeAlg_check_install_runtime_makefile) Xi_peeAlg_check_install_runtime; \
	  fi
#	@$(MAKE) -f $(cmt_local_Xi_peeAlg_check_install_runtime_makefile) Xi_peeAlg_check_install_runtime
	$(echo) "(constituents.make) Xi_peeAlg_check_install_runtime done"

clean :: Xi_peeAlg_check_install_runtimeclean

Xi_peeAlg_check_install_runtimeclean :: $(Xi_peeAlg_check_install_runtimeclean_dependencies) ##$(cmt_local_Xi_peeAlg_check_install_runtime_makefile)
	$(echo) "(constituents.make) Starting Xi_peeAlg_check_install_runtimeclean"
	@-if test -f $(cmt_local_Xi_peeAlg_check_install_runtime_makefile); then \
	  $(MAKE) -f $(cmt_local_Xi_peeAlg_check_install_runtime_makefile) Xi_peeAlg_check_install_runtimeclean; \
	fi
	$(echo) "(constituents.make) Xi_peeAlg_check_install_runtimeclean done"
#	@-$(MAKE) -f $(cmt_local_Xi_peeAlg_check_install_runtime_makefile) Xi_peeAlg_check_install_runtimeclean

##	  /bin/rm -f $(cmt_local_Xi_peeAlg_check_install_runtime_makefile) $(bin)Xi_peeAlg_check_install_runtime_dependencies.make

install :: Xi_peeAlg_check_install_runtimeinstall

Xi_peeAlg_check_install_runtimeinstall :: $(Xi_peeAlg_check_install_runtime_dependencies) $(cmt_local_Xi_peeAlg_check_install_runtime_makefile)
	$(echo) "(constituents.make) Starting install Xi_peeAlg_check_install_runtime"
	@-$(MAKE) -f $(cmt_local_Xi_peeAlg_check_install_runtime_makefile) install
	$(echo) "(constituents.make) install Xi_peeAlg_check_install_runtime done"

uninstall : Xi_peeAlg_check_install_runtimeuninstall

$(foreach d,$(Xi_peeAlg_check_install_runtime_dependencies),$(eval $(d)uninstall_dependencies += Xi_peeAlg_check_install_runtimeuninstall))

Xi_peeAlg_check_install_runtimeuninstall : $(Xi_peeAlg_check_install_runtimeuninstall_dependencies) ##$(cmt_local_Xi_peeAlg_check_install_runtime_makefile)
	$(echo) "(constituents.make) Starting uninstall Xi_peeAlg_check_install_runtime"
	@if test -f $(cmt_local_Xi_peeAlg_check_install_runtime_makefile); then \
	  $(MAKE) -f $(cmt_local_Xi_peeAlg_check_install_runtime_makefile) uninstall; \
	  fi
#	@$(MAKE) -f $(cmt_local_Xi_peeAlg_check_install_runtime_makefile) uninstall
	$(echo) "(constituents.make) uninstall Xi_peeAlg_check_install_runtime done"

remove_library_links :: Xi_peeAlg_check_install_runtimeuninstall
