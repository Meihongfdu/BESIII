...
#
#   Generated Fri Mar 19 19:36:37 2021  by pengcheng6499
#
#====================================
...
jobOptions_Xi_pee_txt_dependencies = ../share/jobOptions_Xi_pee.txt


install_runtimeinstall :: ${install_dir}/jobOptions_Xi_pee.txt
	@if test ! "${installarea}" = ""; then\
	  echo "installation done"; \
	fi

${install_dir}/jobOptions_Xi_pee.txt :: ../share/jobOptions_Xi_pee.txt
	@if test ! "${installarea}" = ""; then \
	  d=`dirname ../share/jobOptions_Xi_pee.txt`; \
	  d=`(cd $${d}; pwd)`; \
	  CMTINSTALLAREA=${CMTINSTALLAREA}; export CMTINSTALLAREA; \
	  $(cmt_install_action) "$${d}" "jobOptions_Xi_pee.txt" "$(install_dir)" "cp -R" ; \
	fi
...
install_runtimeuninstall ::
	@if test ! "${installarea}" = ""; then \
	  ...
	  d=`(cd $${d}; pwd)`; \
	  CMTINSTALLAREA=${CMTINSTALLAREA}; export CMTINSTALLAREA; \
	  $(cmt_uninstall_action) "$${d}" "jobOptions_Xi_pee.txt" "$(install_dir)" "cp -R" ; \
	fi
