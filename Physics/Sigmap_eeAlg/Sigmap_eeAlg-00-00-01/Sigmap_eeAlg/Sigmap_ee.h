#ifndef Physics_Analysis_Sigmap_ee_H
#define Physics_Analysis_Sigmap_ee_H 
...
class Sigmap_ee : public Algorithm {

public:
  Sigmap_ee(const std::string& name, ISvcLocator* pSvcLocator);
