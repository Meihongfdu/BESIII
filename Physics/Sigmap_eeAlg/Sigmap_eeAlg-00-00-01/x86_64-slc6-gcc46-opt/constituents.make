...
#cmt_local_tagfile = $(Sigmap_eeAlg_tag).make
cmt_local_tagfile = $(bin)$(Sigmap_eeAlg_tag).make
...
cmt_local_setup_Sigmap_eeAlg = $(bin)setup_Sigmap_eeAlg$$$$.make
...
Sigmap_eeAlg_extratags = -tag_add=target_Sigmap_eeAlg

#$(cmt_local_tagfile_Sigmap_eeAlg) : $(cmt_lock_setup)
ifndef QUICK
$(cmt_local_tagfile_Sigmap_eeAlg) ::
else
$(cmt_local_tagfile_Sigmap_eeAlg) :
endif
	$(echo) "(constituents.make) Rebuilding $@"; \
	  if test -f $(cmt_local_tagfile_Sigmap_eeAlg); then /bin/rm -f $(cmt_local_tagfile_Sigmap_eeAlg); fi ; \
	  $(cmtexe) -tag=$(tags) $(Sigmap_eeAlg_extratags) build tag_makefile >>$(cmt_local_tagfile_Sigmap_eeAlg)
	$(echo) "(constituents.make) Rebuilding $(cmt_final_setup_Sigmap_eeAlg)"; \
	  test ! -f $(cmt_local_setup_Sigmap_eeAlg) || \rm -f $(cmt_local_setup_Sigmap_eeAlg); \
	  trap '\rm -f $(cmt_local_setup_Sigmap_eeAlg)' 0 1 2 15; \
	  $(cmtexe) -tag=$(tags) $(Sigmap_eeAlg_extratags) show setup >$(cmt_local_setup_Sigmap_eeAlg) && \
	  if [ -f $(cmt_final_setup_Sigmap_eeAlg) ] && \
	    \cmp -s $(cmt_final_setup_Sigmap_eeAlg) $(cmt_local_setup_Sigmap_eeAlg); then \
	    \rm $(cmt_local_setup_Sigmap_eeAlg); else \
	    \mv -f $(cmt_local_setup_Sigmap_eeAlg) $(cmt_final_setup_Sigmap_eeAlg); fi
...
not_Sigmap_eeAlg_dependencies = { n=0; for p in $?; do m=0; for d in $(Sigmap_eeAlg_dependencies); do if [ $$p = $$d ]; then m=1; break; fi; done; if [ $$m -eq 0 ]; then n=1; break; fi; done; [ $$n -eq 1 ]; }

ifdef STRUCTURED_OUTPUT
Sigmap_eeAlgdirs :
	@if test ! -d $(bin)Sigmap_eeAlg; then $(mkdir) -p $(bin)Sigmap_eeAlg; fi
	$(echo) "STRUCTURED_OUTPUT="$(bin)Sigmap_eeAlg
else
Sigmap_eeAlgdirs : ;
endif
...
#	$(echo) "STRUCTURED_OUTPUT="$(bin)Sigmap_eeAlg
#
#$(cmt_local_Sigmap_eeAlg_makefile) :: $(Sigmap_eeAlg_dependencies) $(cmt_local_tagfile_Sigmap_eeAlg) build_library_links dirs Sigmap_eeAlgdirs
#else
#$(cmt_local_Sigmap_eeAlg_makefile) :: $(Sigmap_eeAlg_dependencies) $(cmt_local_tagfile_Sigmap_eeAlg) build_library_links dirs
#endif
#else
#$(cmt_local_Sigmap_eeAlg_makefile) :: $(cmt_local_tagfile_Sigmap_eeAlg)
#endif

ifdef cmt_Sigmap_eeAlg_has_target_tag

ifndef QUICK
$(cmt_local_Sigmap_eeAlg_makefile) : $(Sigmap_eeAlg_dependencies) build_library_links
	$(echo) "(constituents.make) Building Sigmap_eeAlg.make"; \
	  $(cmtexe) -tag=$(tags) $(Sigmap_eeAlg_extratags) build constituent_config -out=$(cmt_local_Sigmap_eeAlg_makefile) Sigmap_eeAlg
else
$(cmt_local_Sigmap_eeAlg_makefile) : $(Sigmap_eeAlg_dependencies) $(cmt_build_library_linksstamp) $(use_requirements)
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_Sigmap_eeAlg) ] || \
	  [ ! -f $(cmt_final_setup_Sigmap_eeAlg) ] || \
	  $(not_Sigmap_eeAlg_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
	  echo "$(CMTMSGPREFIX)" "(constituents.make) Building Sigmap_eeAlg.make"; \
	  $(cmtexe) -tag=$(tags) $(Sigmap_eeAlg_extratags) build constituent_config -out=$(cmt_local_Sigmap_eeAlg_makefile) Sigmap_eeAlg; \
	  fi
endif
...
$(cmt_local_Sigmap_eeAlg_makefile) : $(Sigmap_eeAlg_dependencies) build_library_links
	$(echo) "(constituents.make) Building Sigmap_eeAlg.make"; \
	  $(cmtexe) -f=$(bin)Sigmap_eeAlg.in -tag=$(tags) $(Sigmap_eeAlg_extratags) build constituent_makefile -without_cmt -out=$(cmt_local_Sigmap_eeAlg_makefile) Sigmap_eeAlg
else
$(cmt_local_Sigmap_eeAlg_makefile) : $(Sigmap_eeAlg_dependencies) $(cmt_build_library_linksstamp) $(bin)Sigmap_eeAlg.in
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_Sigmap_eeAlg) ] || \
	  [ ! -f $(cmt_final_setup_Sigmap_eeAlg) ] || \
	  $(not_Sigmap_eeAlg_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
...
#	  $(cmtexe) -tag=$(tags) $(Sigmap_eeAlg_extratags) build constituent_makefile -out=$(cmt_local_Sigmap_eeAlg_makefile) Sigmap_eeAlg

Sigmap_eeAlg :: $(Sigmap_eeAlg_dependencies) $(cmt_local_Sigmap_eeAlg_makefile) dirs Sigmap_eeAlgdirs
	$(echo) "(constituents.make) Starting Sigmap_eeAlg"
	@if test -f $(cmt_local_Sigmap_eeAlg_makefile); then \
	  $(MAKE) -f $(cmt_local_Sigmap_eeAlg_makefile) Sigmap_eeAlg; \
	  fi
#	@$(MAKE) -f $(cmt_local_Sigmap_eeAlg_makefile) Sigmap_eeAlg
	$(echo) "(constituents.make) Sigmap_eeAlg done"

clean :: Sigmap_eeAlgclean

Sigmap_eeAlgclean :: $(Sigmap_eeAlgclean_dependencies) ##$(cmt_local_Sigmap_eeAlg_makefile)
	$(echo) "(constituents.make) Starting Sigmap_eeAlgclean"
	@-if test -f $(cmt_local_Sigmap_eeAlg_makefile); then \
	  $(MAKE) -f $(cmt_local_Sigmap_eeAlg_makefile) Sigmap_eeAlgclean; \
	fi
	$(echo) "(constituents.make) Sigmap_eeAlgclean done"
#	@-$(MAKE) -f $(cmt_local_Sigmap_eeAlg_makefile) Sigmap_eeAlgclean

##	  /bin/rm -f $(cmt_local_Sigmap_eeAlg_makefile) $(bin)Sigmap_eeAlg_dependencies.make

install :: Sigmap_eeAlginstall

Sigmap_eeAlginstall :: $(Sigmap_eeAlg_dependencies) $(cmt_local_Sigmap_eeAlg_makefile)
	$(echo) "(constituents.make) Starting install Sigmap_eeAlg"
	@-$(MAKE) -f $(cmt_local_Sigmap_eeAlg_makefile) install
	$(echo) "(constituents.make) install Sigmap_eeAlg done"

uninstall : Sigmap_eeAlguninstall

$(foreach d,$(Sigmap_eeAlg_dependencies),$(eval $(d)uninstall_dependencies += Sigmap_eeAlguninstall))

Sigmap_eeAlguninstall : $(Sigmap_eeAlguninstall_dependencies) ##$(cmt_local_Sigmap_eeAlg_makefile)
	$(echo) "(constituents.make) Starting uninstall Sigmap_eeAlg"
	@if test -f $(cmt_local_Sigmap_eeAlg_makefile); then \
	  $(MAKE) -f $(cmt_local_Sigmap_eeAlg_makefile) uninstall; \
	  fi
#	@$(MAKE) -f $(cmt_local_Sigmap_eeAlg_makefile) uninstall
	$(echo) "(constituents.make) uninstall Sigmap_eeAlg done"

remove_library_links :: Sigmap_eeAlguninstall
...
#cmt_local_tagfile_install_runtime = $(Sigmap_eeAlg_tag)_install_runtime.make
cmt_local_tagfile_install_runtime = $(bin)$(Sigmap_eeAlg_tag)_install_runtime.make
...
#cmt_final_setup_install_runtime = $(bin)Sigmap_eeAlg_install_runtimesetup.make
...
#cmt_local_tagfile_install_runtime = $(Sigmap_eeAlg_tag).make
cmt_local_tagfile_install_runtime = $(bin)$(Sigmap_eeAlg_tag).make
cmt_final_setup_install_runtime = $(bin)setup.make
#cmt_final_setup_install_runtime = $(bin)Sigmap_eeAlgsetup.make
cmt_local_install_runtime_makefile = $(bin)install_runtime.make
...
#cmt_local_tagfile_config = $(Sigmap_eeAlg_tag)_config.make
cmt_local_tagfile_config = $(bin)$(Sigmap_eeAlg_tag)_config.make
cmt_local_setup_config = $(bin)setup_config$$$$.make
cmt_final_setup_config = $(bin)setup_config.make
#cmt_final_setup_config = $(bin)Sigmap_eeAlg_configsetup.make
...
#cmt_local_tagfile_config = $(Sigmap_eeAlg_tag).make
cmt_local_tagfile_config = $(bin)$(Sigmap_eeAlg_tag).make
cmt_final_setup_config = $(bin)setup.make
#cmt_final_setup_config = $(bin)Sigmap_eeAlgsetup.make
cmt_local_config_makefile = $(bin)config.make
...
#cmt_local_tagfile_install_includes = $(Sigmap_eeAlg_tag)_install_includes.make
cmt_local_tagfile_install_includes = $(bin)$(Sigmap_eeAlg_tag)_install_includes.make
...
#cmt_final_setup_install_includes = $(bin)Sigmap_eeAlg_install_includessetup.make
...
#cmt_local_tagfile_install_includes = $(Sigmap_eeAlg_tag).make
cmt_local_tagfile_install_includes = $(bin)$(Sigmap_eeAlg_tag).make
cmt_final_setup_install_includes = $(bin)setup.make
#cmt_final_setup_install_includes = $(bin)Sigmap_eeAlgsetup.make
cmt_local_install_includes_makefile = $(bin)install_includes.make
...
#cmt_local_tagfile_make = $(Sigmap_eeAlg_tag)_make.make
cmt_local_tagfile_make = $(bin)$(Sigmap_eeAlg_tag)_make.make
cmt_local_setup_make = $(bin)setup_make$$$$.make
cmt_final_setup_make = $(bin)setup_make.make
#cmt_final_setup_make = $(bin)Sigmap_eeAlg_makesetup.make
...
#cmt_local_tagfile_make = $(Sigmap_eeAlg_tag).make
cmt_local_tagfile_make = $(bin)$(Sigmap_eeAlg_tag).make
cmt_final_setup_make = $(bin)setup.make
#cmt_final_setup_make = $(bin)Sigmap_eeAlgsetup.make
cmt_local_make_makefile = $(bin)make.make
...
#cmt_local_tagfile_CompilePython = $(Sigmap_eeAlg_tag)_CompilePython.make
cmt_local_tagfile_CompilePython = $(bin)$(Sigmap_eeAlg_tag)_CompilePython.make
cmt_local_setup_CompilePython = $(bin)setup_CompilePython$$$$.make
cmt_final_setup_CompilePython = $(bin)setup_CompilePython.make
#cmt_final_setup_CompilePython = $(bin)Sigmap_eeAlg_CompilePythonsetup.make
...
#cmt_local_tagfile_CompilePython = $(Sigmap_eeAlg_tag).make
cmt_local_tagfile_CompilePython = $(bin)$(Sigmap_eeAlg_tag).make
cmt_final_setup_CompilePython = $(bin)setup.make
#cmt_final_setup_CompilePython = $(bin)Sigmap_eeAlgsetup.make
cmt_local_CompilePython_makefile = $(bin)CompilePython.make
...
#cmt_local_tagfile_qmtest_run = $(Sigmap_eeAlg_tag)_qmtest_run.make
cmt_local_tagfile_qmtest_run = $(bin)$(Sigmap_eeAlg_tag)_qmtest_run.make
cmt_local_setup_qmtest_run = $(bin)setup_qmtest_run$$$$.make
cmt_final_setup_qmtest_run = $(bin)setup_qmtest_run.make
#cmt_final_setup_qmtest_run = $(bin)Sigmap_eeAlg_qmtest_runsetup.make
...
#cmt_local_tagfile_qmtest_run = $(Sigmap_eeAlg_tag).make
cmt_local_tagfile_qmtest_run = $(bin)$(Sigmap_eeAlg_tag).make
cmt_final_setup_qmtest_run = $(bin)setup.make
#cmt_final_setup_qmtest_run = $(bin)Sigmap_eeAlgsetup.make
cmt_local_qmtest_run_makefile = $(bin)qmtest_run.make
...
#cmt_local_tagfile_qmtest_summarize = $(Sigmap_eeAlg_tag)_qmtest_summarize.make
cmt_local_tagfile_qmtest_summarize = $(bin)$(Sigmap_eeAlg_tag)_qmtest_summarize.make
...
#cmt_final_setup_qmtest_summarize = $(bin)Sigmap_eeAlg_qmtest_summarizesetup.make
...
#cmt_local_tagfile_qmtest_summarize = $(Sigmap_eeAlg_tag).make
cmt_local_tagfile_qmtest_summarize = $(bin)$(Sigmap_eeAlg_tag).make
cmt_final_setup_qmtest_summarize = $(bin)setup.make
#cmt_final_setup_qmtest_summarize = $(bin)Sigmap_eeAlgsetup.make
cmt_local_qmtest_summarize_makefile = $(bin)qmtest_summarize.make
...
#cmt_local_tagfile_TestPackage = $(Sigmap_eeAlg_tag)_TestPackage.make
cmt_local_tagfile_TestPackage = $(bin)$(Sigmap_eeAlg_tag)_TestPackage.make
cmt_local_setup_TestPackage = $(bin)setup_TestPackage$$$$.make
cmt_final_setup_TestPackage = $(bin)setup_TestPackage.make
#cmt_final_setup_TestPackage = $(bin)Sigmap_eeAlg_TestPackagesetup.make
...
#cmt_local_tagfile_TestPackage = $(Sigmap_eeAlg_tag).make
cmt_local_tagfile_TestPackage = $(bin)$(Sigmap_eeAlg_tag).make
cmt_final_setup_TestPackage = $(bin)setup.make
#cmt_final_setup_TestPackage = $(bin)Sigmap_eeAlgsetup.make
cmt_local_TestPackage_makefile = $(bin)TestPackage.make
...
#cmt_local_tagfile_TestProject = $(Sigmap_eeAlg_tag)_TestProject.make
cmt_local_tagfile_TestProject = $(bin)$(Sigmap_eeAlg_tag)_TestProject.make
cmt_local_setup_TestProject = $(bin)setup_TestProject$$$$.make
cmt_final_setup_TestProject = $(bin)setup_TestProject.make
#cmt_final_setup_TestProject = $(bin)Sigmap_eeAlg_TestProjectsetup.make
...
#cmt_local_tagfile_TestProject = $(Sigmap_eeAlg_tag).make
cmt_local_tagfile_TestProject = $(bin)$(Sigmap_eeAlg_tag).make
cmt_final_setup_TestProject = $(bin)setup.make
#cmt_final_setup_TestProject = $(bin)Sigmap_eeAlgsetup.make
cmt_local_TestProject_makefile = $(bin)TestProject.make
...
#cmt_local_tagfile_new_rootsys = $(Sigmap_eeAlg_tag)_new_rootsys.make
cmt_local_tagfile_new_rootsys = $(bin)$(Sigmap_eeAlg_tag)_new_rootsys.make
cmt_local_setup_new_rootsys = $(bin)setup_new_rootsys$$$$.make
cmt_final_setup_new_rootsys = $(bin)setup_new_rootsys.make
#cmt_final_setup_new_rootsys = $(bin)Sigmap_eeAlg_new_rootsyssetup.make
...
#cmt_local_tagfile_new_rootsys = $(Sigmap_eeAlg_tag).make
cmt_local_tagfile_new_rootsys = $(bin)$(Sigmap_eeAlg_tag).make
cmt_final_setup_new_rootsys = $(bin)setup.make
#cmt_final_setup_new_rootsys = $(bin)Sigmap_eeAlgsetup.make
cmt_local_new_rootsys_makefile = $(bin)new_rootsys.make
...
#cmt_local_tagfile_DatabaseSvc_check_install_scripts = $(Sigmap_eeAlg_tag)_DatabaseSvc_check_install_scripts.make
cmt_local_tagfile_DatabaseSvc_check_install_scripts = $(bin)$(Sigmap_eeAlg_tag)_DatabaseSvc_check_install_scripts.make
...
#cmt_final_setup_DatabaseSvc_check_install_scripts = $(bin)Sigmap_eeAlg_DatabaseSvc_check_install_scriptssetup.make
...
#cmt_local_tagfile_DatabaseSvc_check_install_scripts = $(Sigmap_eeAlg_tag).make
cmt_local_tagfile_DatabaseSvc_check_install_scripts = $(bin)$(Sigmap_eeAlg_tag).make
cmt_final_setup_DatabaseSvc_check_install_scripts = $(bin)setup.make
#cmt_final_setup_DatabaseSvc_check_install_scripts = $(bin)Sigmap_eeAlgsetup.make
cmt_local_DatabaseSvc_check_install_scripts_makefile = $(bin)DatabaseSvc_check_install_scripts.make
...
cmt_local_setup_Sigmap_eeAlg_check_install_runtime = $(bin)setup_Sigmap_eeAlg_check_install_runtime$$$$.make
...
Sigmap_eeAlg_check_install_runtime_extratags = -tag_add=target_Sigmap_eeAlg_check_install_runtime

#$(cmt_local_tagfile_Sigmap_eeAlg_check_install_runtime) : $(cmt_lock_setup)
ifndef QUICK
$(cmt_local_tagfile_Sigmap_eeAlg_check_install_runtime) ::
else
$(cmt_local_tagfile_Sigmap_eeAlg_check_install_runtime) :
endif
	$(echo) "(constituents.make) Rebuilding $@"; \
	  if test -f $(cmt_local_tagfile_Sigmap_eeAlg_check_install_runtime); then /bin/rm -f $(cmt_local_tagfile_Sigmap_eeAlg_check_install_runtime); fi ; \
	  $(cmtexe) -tag=$(tags) $(Sigmap_eeAlg_check_install_runtime_extratags) build tag_makefile >>$(cmt_local_tagfile_Sigmap_eeAlg_check_install_runtime)
	$(echo) "(constituents.make) Rebuilding $(cmt_final_setup_Sigmap_eeAlg_check_install_runtime)"; \
	  test ! -f $(cmt_local_setup_Sigmap_eeAlg_check_install_runtime) || \rm -f $(cmt_local_setup_Sigmap_eeAlg_check_install_runtime); \
	  trap '\rm -f $(cmt_local_setup_Sigmap_eeAlg_check_install_runtime)' 0 1 2 15; \
	  $(cmtexe) -tag=$(tags) $(Sigmap_eeAlg_check_install_runtime_extratags) show setup >$(cmt_local_setup_Sigmap_eeAlg_check_install_runtime) && \
	  if [ -f $(cmt_final_setup_Sigmap_eeAlg_check_install_runtime) ] && \
	    \cmp -s $(cmt_final_setup_Sigmap_eeAlg_check_install_runtime) $(cmt_local_setup_Sigmap_eeAlg_check_install_runtime); then \
	    \rm $(cmt_local_setup_Sigmap_eeAlg_check_install_runtime); else \
	    \mv -f $(cmt_local_setup_Sigmap_eeAlg_check_install_runtime) $(cmt_final_setup_Sigmap_eeAlg_check_install_runtime); fi
...
not_Sigmap_eeAlg_check_install_runtime_dependencies = { n=0; for p in $?; do m=0; for d in $(Sigmap_eeAlg_check_install_runtime_dependencies); do if [ $$p = $$d ]; then m=1; break; fi; done; if [ $$m -eq 0 ]; then n=1; break; fi; done; [ $$n -eq 1 ]; }

ifdef STRUCTURED_OUTPUT
Sigmap_eeAlg_check_install_runtimedirs :
	@if test ! -d $(bin)Sigmap_eeAlg_check_install_runtime; then $(mkdir) -p $(bin)Sigmap_eeAlg_check_install_runtime; fi
	$(echo) "STRUCTURED_OUTPUT="$(bin)Sigmap_eeAlg_check_install_runtime
else
Sigmap_eeAlg_check_install_runtimedirs : ;
endif
...
#	$(echo) "STRUCTURED_OUTPUT="$(bin)Sigmap_eeAlg_check_install_runtime
#
#$(cmt_local_Sigmap_eeAlg_check_install_runtime_makefile) :: $(Sigmap_eeAlg_check_install_runtime_dependencies) $(cmt_local_tagfile_Sigmap_eeAlg_check_install_runtime) build_library_links dirs Sigmap_eeAlg_check_install_runtimedirs
#else
#$(cmt_local_Sigmap_eeAlg_check_install_runtime_makefile) :: $(Sigmap_eeAlg_check_install_runtime_dependencies) $(cmt_local_tagfile_Sigmap_eeAlg_check_install_runtime) build_library_links dirs
#endif
#else
#$(cmt_local_Sigmap_eeAlg_check_install_runtime_makefile) :: $(cmt_local_tagfile_Sigmap_eeAlg_check_install_runtime)
#endif

ifdef cmt_Sigmap_eeAlg_check_install_runtime_has_target_tag

ifndef QUICK
$(cmt_local_Sigmap_eeAlg_check_install_runtime_makefile) : $(Sigmap_eeAlg_check_install_runtime_dependencies) build_library_links
	$(echo) "(constituents.make) Building Sigmap_eeAlg_check_install_runtime.make"; \
	  $(cmtexe) -tag=$(tags) $(Sigmap_eeAlg_check_install_runtime_extratags) build constituent_config -out=$(cmt_local_Sigmap_eeAlg_check_install_runtime_makefile) Sigmap_eeAlg_check_install_runtime
else
$(cmt_local_Sigmap_eeAlg_check_install_runtime_makefile) : $(Sigmap_eeAlg_check_install_runtime_dependencies) $(cmt_build_library_linksstamp) $(use_requirements)
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_Sigmap_eeAlg_check_install_runtime) ] || \
	  [ ! -f $(cmt_final_setup_Sigmap_eeAlg_check_install_runtime) ] || \
	  $(not_Sigmap_eeAlg_check_install_runtime_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
	  echo "$(CMTMSGPREFIX)" "(constituents.make) Building Sigmap_eeAlg_check_install_runtime.make"; \
	  $(cmtexe) -tag=$(tags) $(Sigmap_eeAlg_check_install_runtime_extratags) build constituent_config -out=$(cmt_local_Sigmap_eeAlg_check_install_runtime_makefile) Sigmap_eeAlg_check_install_runtime; \
	  fi
endif
...
$(cmt_local_Sigmap_eeAlg_check_install_runtime_makefile) : $(Sigmap_eeAlg_check_install_runtime_dependencies) build_library_links
	$(echo) "(constituents.make) Building Sigmap_eeAlg_check_install_runtime.make"; \
	  $(cmtexe) -f=$(bin)Sigmap_eeAlg_check_install_runtime.in -tag=$(tags) $(Sigmap_eeAlg_check_install_runtime_extratags) build constituent_makefile -without_cmt -out=$(cmt_local_Sigmap_eeAlg_check_install_runtime_makefile) Sigmap_eeAlg_check_install_runtime
else
$(cmt_local_Sigmap_eeAlg_check_install_runtime_makefile) : $(Sigmap_eeAlg_check_install_runtime_dependencies) $(cmt_build_library_linksstamp) $(bin)Sigmap_eeAlg_check_install_runtime.in
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_Sigmap_eeAlg_check_install_runtime) ] || \
	  [ ! -f $(cmt_final_setup_Sigmap_eeAlg_check_install_runtime) ] || \
	  $(not_Sigmap_eeAlg_check_install_runtime_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
...
#	  $(cmtexe) -tag=$(tags) $(Sigmap_eeAlg_check_install_runtime_extratags) build constituent_makefile -out=$(cmt_local_Sigmap_eeAlg_check_install_runtime_makefile) Sigmap_eeAlg_check_install_runtime

Sigmap_eeAlg_check_install_runtime :: $(Sigmap_eeAlg_check_install_runtime_dependencies) $(cmt_local_Sigmap_eeAlg_check_install_runtime_makefile) dirs Sigmap_eeAlg_check_install_runtimedirs
	$(echo) "(constituents.make) Starting Sigmap_eeAlg_check_install_runtime"
	@if test -f $(cmt_local_Sigmap_eeAlg_check_install_runtime_makefile); then \
	  $(MAKE) -f $(cmt_local_Sigmap_eeAlg_check_install_runtime_makefile) Sigmap_eeAlg_check_install_runtime; \
	  fi
#	@$(MAKE) -f $(cmt_local_Sigmap_eeAlg_check_install_runtime_makefile) Sigmap_eeAlg_check_install_runtime
	$(echo) "(constituents.make) Sigmap_eeAlg_check_install_runtime done"

clean :: Sigmap_eeAlg_check_install_runtimeclean

Sigmap_eeAlg_check_install_runtimeclean :: $(Sigmap_eeAlg_check_install_runtimeclean_dependencies) ##$(cmt_local_Sigmap_eeAlg_check_install_runtime_makefile)
	$(echo) "(constituents.make) Starting Sigmap_eeAlg_check_install_runtimeclean"
	@-if test -f $(cmt_local_Sigmap_eeAlg_check_install_runtime_makefile); then \
	  $(MAKE) -f $(cmt_local_Sigmap_eeAlg_check_install_runtime_makefile) Sigmap_eeAlg_check_install_runtimeclean; \
	fi
	$(echo) "(constituents.make) Sigmap_eeAlg_check_install_runtimeclean done"
#	@-$(MAKE) -f $(cmt_local_Sigmap_eeAlg_check_install_runtime_makefile) Sigmap_eeAlg_check_install_runtimeclean

##	  /bin/rm -f $(cmt_local_Sigmap_eeAlg_check_install_runtime_makefile) $(bin)Sigmap_eeAlg_check_install_runtime_dependencies.make

install :: Sigmap_eeAlg_check_install_runtimeinstall

Sigmap_eeAlg_check_install_runtimeinstall :: $(Sigmap_eeAlg_check_install_runtime_dependencies) $(cmt_local_Sigmap_eeAlg_check_install_runtime_makefile)
	$(echo) "(constituents.make) Starting install Sigmap_eeAlg_check_install_runtime"
	@-$(MAKE) -f $(cmt_local_Sigmap_eeAlg_check_install_runtime_makefile) install
	$(echo) "(constituents.make) install Sigmap_eeAlg_check_install_runtime done"

uninstall : Sigmap_eeAlg_check_install_runtimeuninstall

$(foreach d,$(Sigmap_eeAlg_check_install_runtime_dependencies),$(eval $(d)uninstall_dependencies += Sigmap_eeAlg_check_install_runtimeuninstall))

Sigmap_eeAlg_check_install_runtimeuninstall : $(Sigmap_eeAlg_check_install_runtimeuninstall_dependencies) ##$(cmt_local_Sigmap_eeAlg_check_install_runtime_makefile)
	$(echo) "(constituents.make) Starting uninstall Sigmap_eeAlg_check_install_runtime"
	@if test -f $(cmt_local_Sigmap_eeAlg_check_install_runtime_makefile); then \
	  $(MAKE) -f $(cmt_local_Sigmap_eeAlg_check_install_runtime_makefile) uninstall; \
	  fi
#	@$(MAKE) -f $(cmt_local_Sigmap_eeAlg_check_install_runtime_makefile) uninstall
	$(echo) "(constituents.make) uninstall Sigmap_eeAlg_check_install_runtime done"

remove_library_links :: Sigmap_eeAlg_check_install_runtimeuninstall
