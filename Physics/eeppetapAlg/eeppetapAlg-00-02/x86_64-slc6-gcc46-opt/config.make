...
#  Document config
#
#   Generated Wed Jul 22 16:03:26 2020  by liumeihong
#
#====================================
...
config :: ../eeppetapAlg/config.h
	@/bin/echo "------> config.h ok"

../eeppetapAlg/config.h :: ../eeppetapAlg/config.h.in
	@if test -f ../eeppetapAlg/config.h.in; then \
	  cd ../eeppetapAlg; \
