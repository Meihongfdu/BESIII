...
bool eeppetapAlg::mctruth(){
    ...
    if(m_truthRun<0){
        ...
        if (!mcParticleCol) {
            ...
            for (; iter_mc != mcParticleCol->end(); iter_mc++) {
                ...
                ////================================================================================================
                if((mctrue_id == 211)&&(mctrue_mothPID==9999111)&&(mctrue_moth_mothPID==m_cms_id)){
                ...
                //================================================================================================
                if((mctrue_id == 211)&&(mctrue_mothPID==113)&&(mctrue_moth_mothPID==331)&&(mctrue_moth_moth_mothPID==9999111)&&(mctrue_moth_moth_moth_mothPID==m_cms_id)){
                ...
                //================================================================================================
                if((mctrue_id ==22)&&(mctrue_mothPID==331)&&(mctrue_moth_mothPID==9999111)&&(mctrue_moth_moth_mothPID==m_cms_id)){
                    mctrue_gam_etap_4c.push_back((*iter_mc)->initialFourMomentum());
                }
                //================================================================================================
                ...
                // }
                // 
                 if((mctrue_id ==9999111)&&(mctrue_mothPID == m_cms_id)){
    ...
    m_mctruth_m1835[1] = mctruth_m1835[0].py();
    m_mctruth_m1835[2] = mctruth_m1835[0].pz();
    m_mctruth_m1835[3] = mctruth_m1835[0].e();
