...
$(eeppetapAlglib) :: $(bin)eeppetapAlg.o $(bin)entries.o $(bin)load.o $(bin)MyIsGoodtrack.o $(bin)MyTrk.o $(bin)MyUtil.o $(bin)MyIsPID.o $(bin)MyInitIP.o
	$(lib_echo) library
	$(lib_silent) cd $(bin); \
	  $(ar) $(eeppetapAlglib) $?
...
eeppetapAlgclean ::
	...
	$(cleanup_silent) cd $(bin); /bin/rm -f $(bin)eeppetapAlg.o $(bin)entries.o $(bin)load.o $(bin)MyIsGoodtrack.o $(bin)MyTrk.o $(bin)MyUtil.o $(bin)MyIsPID.o $(bin)MyInitIP.o
