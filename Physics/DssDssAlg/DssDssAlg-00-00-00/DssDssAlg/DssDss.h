#ifndef Physics_Analysis_DssDss_H
#define Physics_Analysis_DssDss_H 
#include "GaudiKernel/AlgFactory.h"
#include "GaudiKernel/Algorithm.h"
#include "GaudiKernel/NTuple.h"
//#include "VertexFit/ReadBeamParFromDb.h"
#include "DssDssAlg/ReadBeamInfFromDb.h"
#include "DssDssAlg/Match.h"
#include "CLHEP/Vector/LorentzVector.h"
#include "VertexFit/KalmanKinematicFit.h"
#include "VertexFit/KinematicFit.h"

class DssDss : public Algorithm {

public:
  DssDss(const std::string& name, ISvcLocator* pSvcLocator);
...
private:
  ...
  NTuple::Item<double>  mDss_tag_temp1;
  ...
  NTuple::Item<double>   mDss_tag_temp2;
