...
#cmt_local_tagfile = $(DssDssAlg_tag).make
cmt_local_tagfile = $(bin)$(DssDssAlg_tag).make
...
cmt_local_setup_DssDssAlg = $(bin)setup_DssDssAlg$$$$.make
...
DssDssAlg_extratags = -tag_add=target_DssDssAlg

#$(cmt_local_tagfile_DssDssAlg) : $(cmt_lock_setup)
ifndef QUICK
$(cmt_local_tagfile_DssDssAlg) ::
else
$(cmt_local_tagfile_DssDssAlg) :
endif
	$(echo) "(constituents.make) Rebuilding $@"; \
	  if test -f $(cmt_local_tagfile_DssDssAlg); then /bin/rm -f $(cmt_local_tagfile_DssDssAlg); fi ; \
	  $(cmtexe) -tag=$(tags) $(DssDssAlg_extratags) build tag_makefile >>$(cmt_local_tagfile_DssDssAlg)
	$(echo) "(constituents.make) Rebuilding $(cmt_final_setup_DssDssAlg)"; \
	  test ! -f $(cmt_local_setup_DssDssAlg) || \rm -f $(cmt_local_setup_DssDssAlg); \
	  trap '\rm -f $(cmt_local_setup_DssDssAlg)' 0 1 2 15; \
	  $(cmtexe) -tag=$(tags) $(DssDssAlg_extratags) show setup >$(cmt_local_setup_DssDssAlg) && \
	  if [ -f $(cmt_final_setup_DssDssAlg) ] && \
	    \cmp -s $(cmt_final_setup_DssDssAlg) $(cmt_local_setup_DssDssAlg); then \
	    \rm $(cmt_local_setup_DssDssAlg); else \
	    \mv -f $(cmt_local_setup_DssDssAlg) $(cmt_final_setup_DssDssAlg); fi
...
not_DssDssAlg_dependencies = { n=0; for p in $?; do m=0; for d in $(DssDssAlg_dependencies); do if [ $$p = $$d ]; then m=1; break; fi; done; if [ $$m -eq 0 ]; then n=1; break; fi; done; [ $$n -eq 1 ]; }

ifdef STRUCTURED_OUTPUT
DssDssAlgdirs :
	@if test ! -d $(bin)DssDssAlg; then $(mkdir) -p $(bin)DssDssAlg; fi
	$(echo) "STRUCTURED_OUTPUT="$(bin)DssDssAlg
else
DssDssAlgdirs : ;
endif
...
#	$(echo) "STRUCTURED_OUTPUT="$(bin)DssDssAlg
#
#$(cmt_local_DssDssAlg_makefile) :: $(DssDssAlg_dependencies) $(cmt_local_tagfile_DssDssAlg) build_library_links dirs DssDssAlgdirs
#else
#$(cmt_local_DssDssAlg_makefile) :: $(DssDssAlg_dependencies) $(cmt_local_tagfile_DssDssAlg) build_library_links dirs
#endif
#else
#$(cmt_local_DssDssAlg_makefile) :: $(cmt_local_tagfile_DssDssAlg)
#endif

ifdef cmt_DssDssAlg_has_target_tag

ifndef QUICK
$(cmt_local_DssDssAlg_makefile) : $(DssDssAlg_dependencies) build_library_links
	$(echo) "(constituents.make) Building DssDssAlg.make"; \
	  $(cmtexe) -tag=$(tags) $(DssDssAlg_extratags) build constituent_config -out=$(cmt_local_DssDssAlg_makefile) DssDssAlg
else
$(cmt_local_DssDssAlg_makefile) : $(DssDssAlg_dependencies) $(cmt_build_library_linksstamp) $(use_requirements)
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_DssDssAlg) ] || \
	  [ ! -f $(cmt_final_setup_DssDssAlg) ] || \
	  $(not_DssDssAlg_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
	  echo "$(CMTMSGPREFIX)" "(constituents.make) Building DssDssAlg.make"; \
	  $(cmtexe) -tag=$(tags) $(DssDssAlg_extratags) build constituent_config -out=$(cmt_local_DssDssAlg_makefile) DssDssAlg; \
	  fi
endif
...
$(cmt_local_DssDssAlg_makefile) : $(DssDssAlg_dependencies) build_library_links
	$(echo) "(constituents.make) Building DssDssAlg.make"; \
	  $(cmtexe) -f=$(bin)DssDssAlg.in -tag=$(tags) $(DssDssAlg_extratags) build constituent_makefile -without_cmt -out=$(cmt_local_DssDssAlg_makefile) DssDssAlg
else
$(cmt_local_DssDssAlg_makefile) : $(DssDssAlg_dependencies) $(cmt_build_library_linksstamp) $(bin)DssDssAlg.in
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_DssDssAlg) ] || \
	  [ ! -f $(cmt_final_setup_DssDssAlg) ] || \
	  $(not_DssDssAlg_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
...
#	  $(cmtexe) -tag=$(tags) $(DssDssAlg_extratags) build constituent_makefile -out=$(cmt_local_DssDssAlg_makefile) DssDssAlg

DssDssAlg :: $(DssDssAlg_dependencies) $(cmt_local_DssDssAlg_makefile) dirs DssDssAlgdirs
	$(echo) "(constituents.make) Starting DssDssAlg"
	@if test -f $(cmt_local_DssDssAlg_makefile); then \
	  $(MAKE) -f $(cmt_local_DssDssAlg_makefile) DssDssAlg; \
	  fi
#	@$(MAKE) -f $(cmt_local_DssDssAlg_makefile) DssDssAlg
	$(echo) "(constituents.make) DssDssAlg done"

clean :: DssDssAlgclean

DssDssAlgclean :: $(DssDssAlgclean_dependencies) ##$(cmt_local_DssDssAlg_makefile)
	$(echo) "(constituents.make) Starting DssDssAlgclean"
	@-if test -f $(cmt_local_DssDssAlg_makefile); then \
	  $(MAKE) -f $(cmt_local_DssDssAlg_makefile) DssDssAlgclean; \
	fi
	$(echo) "(constituents.make) DssDssAlgclean done"
#	@-$(MAKE) -f $(cmt_local_DssDssAlg_makefile) DssDssAlgclean

##	  /bin/rm -f $(cmt_local_DssDssAlg_makefile) $(bin)DssDssAlg_dependencies.make

install :: DssDssAlginstall

DssDssAlginstall :: $(DssDssAlg_dependencies) $(cmt_local_DssDssAlg_makefile)
	$(echo) "(constituents.make) Starting install DssDssAlg"
	@-$(MAKE) -f $(cmt_local_DssDssAlg_makefile) install
	$(echo) "(constituents.make) install DssDssAlg done"

uninstall : DssDssAlguninstall

$(foreach d,$(DssDssAlg_dependencies),$(eval $(d)uninstall_dependencies += DssDssAlguninstall))

DssDssAlguninstall : $(DssDssAlguninstall_dependencies) ##$(cmt_local_DssDssAlg_makefile)
	$(echo) "(constituents.make) Starting uninstall DssDssAlg"
	@if test -f $(cmt_local_DssDssAlg_makefile); then \
	  $(MAKE) -f $(cmt_local_DssDssAlg_makefile) uninstall; \
	  fi
#	@$(MAKE) -f $(cmt_local_DssDssAlg_makefile) uninstall
	$(echo) "(constituents.make) uninstall DssDssAlg done"

remove_library_links :: DssDssAlguninstall
...
#cmt_local_tagfile_install_runtime = $(DssDssAlg_tag)_install_runtime.make
cmt_local_tagfile_install_runtime = $(bin)$(DssDssAlg_tag)_install_runtime.make
...
#cmt_final_setup_install_runtime = $(bin)DssDssAlg_install_runtimesetup.make
...
#cmt_local_tagfile_install_runtime = $(DssDssAlg_tag).make
cmt_local_tagfile_install_runtime = $(bin)$(DssDssAlg_tag).make
cmt_final_setup_install_runtime = $(bin)setup.make
#cmt_final_setup_install_runtime = $(bin)DssDssAlgsetup.make
cmt_local_install_runtime_makefile = $(bin)install_runtime.make
...
#cmt_local_tagfile_config = $(DssDssAlg_tag)_config.make
cmt_local_tagfile_config = $(bin)$(DssDssAlg_tag)_config.make
cmt_local_setup_config = $(bin)setup_config$$$$.make
cmt_final_setup_config = $(bin)setup_config.make
#cmt_final_setup_config = $(bin)DssDssAlg_configsetup.make
...
#cmt_local_tagfile_config = $(DssDssAlg_tag).make
cmt_local_tagfile_config = $(bin)$(DssDssAlg_tag).make
cmt_final_setup_config = $(bin)setup.make
#cmt_final_setup_config = $(bin)DssDssAlgsetup.make
cmt_local_config_makefile = $(bin)config.make
...
#cmt_local_tagfile_install_includes = $(DssDssAlg_tag)_install_includes.make
cmt_local_tagfile_install_includes = $(bin)$(DssDssAlg_tag)_install_includes.make
...
#cmt_final_setup_install_includes = $(bin)DssDssAlg_install_includessetup.make
...
#cmt_local_tagfile_install_includes = $(DssDssAlg_tag).make
cmt_local_tagfile_install_includes = $(bin)$(DssDssAlg_tag).make
cmt_final_setup_install_includes = $(bin)setup.make
#cmt_final_setup_install_includes = $(bin)DssDssAlgsetup.make
cmt_local_install_includes_makefile = $(bin)install_includes.make
...
#cmt_local_tagfile_make = $(DssDssAlg_tag)_make.make
cmt_local_tagfile_make = $(bin)$(DssDssAlg_tag)_make.make
cmt_local_setup_make = $(bin)setup_make$$$$.make
cmt_final_setup_make = $(bin)setup_make.make
#cmt_final_setup_make = $(bin)DssDssAlg_makesetup.make
...
#cmt_local_tagfile_make = $(DssDssAlg_tag).make
cmt_local_tagfile_make = $(bin)$(DssDssAlg_tag).make
cmt_final_setup_make = $(bin)setup.make
#cmt_final_setup_make = $(bin)DssDssAlgsetup.make
cmt_local_make_makefile = $(bin)make.make
...
#cmt_local_tagfile_CompilePython = $(DssDssAlg_tag)_CompilePython.make
cmt_local_tagfile_CompilePython = $(bin)$(DssDssAlg_tag)_CompilePython.make
cmt_local_setup_CompilePython = $(bin)setup_CompilePython$$$$.make
cmt_final_setup_CompilePython = $(bin)setup_CompilePython.make
#cmt_final_setup_CompilePython = $(bin)DssDssAlg_CompilePythonsetup.make
...
#cmt_local_tagfile_CompilePython = $(DssDssAlg_tag).make
cmt_local_tagfile_CompilePython = $(bin)$(DssDssAlg_tag).make
cmt_final_setup_CompilePython = $(bin)setup.make
#cmt_final_setup_CompilePython = $(bin)DssDssAlgsetup.make
cmt_local_CompilePython_makefile = $(bin)CompilePython.make
...
#cmt_local_tagfile_qmtest_run = $(DssDssAlg_tag)_qmtest_run.make
cmt_local_tagfile_qmtest_run = $(bin)$(DssDssAlg_tag)_qmtest_run.make
cmt_local_setup_qmtest_run = $(bin)setup_qmtest_run$$$$.make
cmt_final_setup_qmtest_run = $(bin)setup_qmtest_run.make
#cmt_final_setup_qmtest_run = $(bin)DssDssAlg_qmtest_runsetup.make
...
#cmt_local_tagfile_qmtest_run = $(DssDssAlg_tag).make
cmt_local_tagfile_qmtest_run = $(bin)$(DssDssAlg_tag).make
cmt_final_setup_qmtest_run = $(bin)setup.make
#cmt_final_setup_qmtest_run = $(bin)DssDssAlgsetup.make
cmt_local_qmtest_run_makefile = $(bin)qmtest_run.make
...
#cmt_local_tagfile_qmtest_summarize = $(DssDssAlg_tag)_qmtest_summarize.make
cmt_local_tagfile_qmtest_summarize = $(bin)$(DssDssAlg_tag)_qmtest_summarize.make
...
#cmt_final_setup_qmtest_summarize = $(bin)DssDssAlg_qmtest_summarizesetup.make
...
#cmt_local_tagfile_qmtest_summarize = $(DssDssAlg_tag).make
cmt_local_tagfile_qmtest_summarize = $(bin)$(DssDssAlg_tag).make
cmt_final_setup_qmtest_summarize = $(bin)setup.make
#cmt_final_setup_qmtest_summarize = $(bin)DssDssAlgsetup.make
cmt_local_qmtest_summarize_makefile = $(bin)qmtest_summarize.make
...
#cmt_local_tagfile_TestPackage = $(DssDssAlg_tag)_TestPackage.make
cmt_local_tagfile_TestPackage = $(bin)$(DssDssAlg_tag)_TestPackage.make
cmt_local_setup_TestPackage = $(bin)setup_TestPackage$$$$.make
cmt_final_setup_TestPackage = $(bin)setup_TestPackage.make
#cmt_final_setup_TestPackage = $(bin)DssDssAlg_TestPackagesetup.make
...
#cmt_local_tagfile_TestPackage = $(DssDssAlg_tag).make
cmt_local_tagfile_TestPackage = $(bin)$(DssDssAlg_tag).make
cmt_final_setup_TestPackage = $(bin)setup.make
#cmt_final_setup_TestPackage = $(bin)DssDssAlgsetup.make
cmt_local_TestPackage_makefile = $(bin)TestPackage.make
...
#cmt_local_tagfile_TestProject = $(DssDssAlg_tag)_TestProject.make
cmt_local_tagfile_TestProject = $(bin)$(DssDssAlg_tag)_TestProject.make
cmt_local_setup_TestProject = $(bin)setup_TestProject$$$$.make
cmt_final_setup_TestProject = $(bin)setup_TestProject.make
#cmt_final_setup_TestProject = $(bin)DssDssAlg_TestProjectsetup.make
...
#cmt_local_tagfile_TestProject = $(DssDssAlg_tag).make
cmt_local_tagfile_TestProject = $(bin)$(DssDssAlg_tag).make
cmt_final_setup_TestProject = $(bin)setup.make
#cmt_final_setup_TestProject = $(bin)DssDssAlgsetup.make
cmt_local_TestProject_makefile = $(bin)TestProject.make
...
#cmt_local_tagfile_new_rootsys = $(DssDssAlg_tag)_new_rootsys.make
cmt_local_tagfile_new_rootsys = $(bin)$(DssDssAlg_tag)_new_rootsys.make
cmt_local_setup_new_rootsys = $(bin)setup_new_rootsys$$$$.make
cmt_final_setup_new_rootsys = $(bin)setup_new_rootsys.make
#cmt_final_setup_new_rootsys = $(bin)DssDssAlg_new_rootsyssetup.make
...
#cmt_local_tagfile_new_rootsys = $(DssDssAlg_tag).make
cmt_local_tagfile_new_rootsys = $(bin)$(DssDssAlg_tag).make
cmt_final_setup_new_rootsys = $(bin)setup.make
#cmt_final_setup_new_rootsys = $(bin)DssDssAlgsetup.make
cmt_local_new_rootsys_makefile = $(bin)new_rootsys.make
...
#cmt_local_tagfile_DatabaseSvc_check_install_scripts = $(DssDssAlg_tag)_DatabaseSvc_check_install_scripts.make
cmt_local_tagfile_DatabaseSvc_check_install_scripts = $(bin)$(DssDssAlg_tag)_DatabaseSvc_check_install_scripts.make
...
#cmt_final_setup_DatabaseSvc_check_install_scripts = $(bin)DssDssAlg_DatabaseSvc_check_install_scriptssetup.make
...
#cmt_local_tagfile_DatabaseSvc_check_install_scripts = $(DssDssAlg_tag).make
cmt_local_tagfile_DatabaseSvc_check_install_scripts = $(bin)$(DssDssAlg_tag).make
cmt_final_setup_DatabaseSvc_check_install_scripts = $(bin)setup.make
#cmt_final_setup_DatabaseSvc_check_install_scripts = $(bin)DssDssAlgsetup.make
cmt_local_DatabaseSvc_check_install_scripts_makefile = $(bin)DatabaseSvc_check_install_scripts.make
...
cmt_local_setup_DssDssAlg_check_install_runtime = $(bin)setup_DssDssAlg_check_install_runtime$$$$.make
...
DssDssAlg_check_install_runtime_extratags = -tag_add=target_DssDssAlg_check_install_runtime

#$(cmt_local_tagfile_DssDssAlg_check_install_runtime) : $(cmt_lock_setup)
ifndef QUICK
$(cmt_local_tagfile_DssDssAlg_check_install_runtime) ::
else
$(cmt_local_tagfile_DssDssAlg_check_install_runtime) :
endif
	$(echo) "(constituents.make) Rebuilding $@"; \
	  if test -f $(cmt_local_tagfile_DssDssAlg_check_install_runtime); then /bin/rm -f $(cmt_local_tagfile_DssDssAlg_check_install_runtime); fi ; \
	  $(cmtexe) -tag=$(tags) $(DssDssAlg_check_install_runtime_extratags) build tag_makefile >>$(cmt_local_tagfile_DssDssAlg_check_install_runtime)
	$(echo) "(constituents.make) Rebuilding $(cmt_final_setup_DssDssAlg_check_install_runtime)"; \
	  test ! -f $(cmt_local_setup_DssDssAlg_check_install_runtime) || \rm -f $(cmt_local_setup_DssDssAlg_check_install_runtime); \
	  trap '\rm -f $(cmt_local_setup_DssDssAlg_check_install_runtime)' 0 1 2 15; \
	  $(cmtexe) -tag=$(tags) $(DssDssAlg_check_install_runtime_extratags) show setup >$(cmt_local_setup_DssDssAlg_check_install_runtime) && \
	  if [ -f $(cmt_final_setup_DssDssAlg_check_install_runtime) ] && \
	    \cmp -s $(cmt_final_setup_DssDssAlg_check_install_runtime) $(cmt_local_setup_DssDssAlg_check_install_runtime); then \
	    \rm $(cmt_local_setup_DssDssAlg_check_install_runtime); else \
	    \mv -f $(cmt_local_setup_DssDssAlg_check_install_runtime) $(cmt_final_setup_DssDssAlg_check_install_runtime); fi
...
not_DssDssAlg_check_install_runtime_dependencies = { n=0; for p in $?; do m=0; for d in $(DssDssAlg_check_install_runtime_dependencies); do if [ $$p = $$d ]; then m=1; break; fi; done; if [ $$m -eq 0 ]; then n=1; break; fi; done; [ $$n -eq 1 ]; }

ifdef STRUCTURED_OUTPUT
DssDssAlg_check_install_runtimedirs :
	@if test ! -d $(bin)DssDssAlg_check_install_runtime; then $(mkdir) -p $(bin)DssDssAlg_check_install_runtime; fi
	$(echo) "STRUCTURED_OUTPUT="$(bin)DssDssAlg_check_install_runtime
else
DssDssAlg_check_install_runtimedirs : ;
endif
...
#	$(echo) "STRUCTURED_OUTPUT="$(bin)DssDssAlg_check_install_runtime
#
#$(cmt_local_DssDssAlg_check_install_runtime_makefile) :: $(DssDssAlg_check_install_runtime_dependencies) $(cmt_local_tagfile_DssDssAlg_check_install_runtime) build_library_links dirs DssDssAlg_check_install_runtimedirs
#else
#$(cmt_local_DssDssAlg_check_install_runtime_makefile) :: $(DssDssAlg_check_install_runtime_dependencies) $(cmt_local_tagfile_DssDssAlg_check_install_runtime) build_library_links dirs
#endif
#else
#$(cmt_local_DssDssAlg_check_install_runtime_makefile) :: $(cmt_local_tagfile_DssDssAlg_check_install_runtime)
#endif

ifdef cmt_DssDssAlg_check_install_runtime_has_target_tag

ifndef QUICK
$(cmt_local_DssDssAlg_check_install_runtime_makefile) : $(DssDssAlg_check_install_runtime_dependencies) build_library_links
	$(echo) "(constituents.make) Building DssDssAlg_check_install_runtime.make"; \
	  $(cmtexe) -tag=$(tags) $(DssDssAlg_check_install_runtime_extratags) build constituent_config -out=$(cmt_local_DssDssAlg_check_install_runtime_makefile) DssDssAlg_check_install_runtime
else
$(cmt_local_DssDssAlg_check_install_runtime_makefile) : $(DssDssAlg_check_install_runtime_dependencies) $(cmt_build_library_linksstamp) $(use_requirements)
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_DssDssAlg_check_install_runtime) ] || \
	  [ ! -f $(cmt_final_setup_DssDssAlg_check_install_runtime) ] || \
	  $(not_DssDssAlg_check_install_runtime_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
	  echo "$(CMTMSGPREFIX)" "(constituents.make) Building DssDssAlg_check_install_runtime.make"; \
	  $(cmtexe) -tag=$(tags) $(DssDssAlg_check_install_runtime_extratags) build constituent_config -out=$(cmt_local_DssDssAlg_check_install_runtime_makefile) DssDssAlg_check_install_runtime; \
	  fi
endif
...
$(cmt_local_DssDssAlg_check_install_runtime_makefile) : $(DssDssAlg_check_install_runtime_dependencies) build_library_links
	$(echo) "(constituents.make) Building DssDssAlg_check_install_runtime.make"; \
	  $(cmtexe) -f=$(bin)DssDssAlg_check_install_runtime.in -tag=$(tags) $(DssDssAlg_check_install_runtime_extratags) build constituent_makefile -without_cmt -out=$(cmt_local_DssDssAlg_check_install_runtime_makefile) DssDssAlg_check_install_runtime
else
$(cmt_local_DssDssAlg_check_install_runtime_makefile) : $(DssDssAlg_check_install_runtime_dependencies) $(cmt_build_library_linksstamp) $(bin)DssDssAlg_check_install_runtime.in
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_DssDssAlg_check_install_runtime) ] || \
	  [ ! -f $(cmt_final_setup_DssDssAlg_check_install_runtime) ] || \
	  $(not_DssDssAlg_check_install_runtime_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
...
#	  $(cmtexe) -tag=$(tags) $(DssDssAlg_check_install_runtime_extratags) build constituent_makefile -out=$(cmt_local_DssDssAlg_check_install_runtime_makefile) DssDssAlg_check_install_runtime

DssDssAlg_check_install_runtime :: $(DssDssAlg_check_install_runtime_dependencies) $(cmt_local_DssDssAlg_check_install_runtime_makefile) dirs DssDssAlg_check_install_runtimedirs
	$(echo) "(constituents.make) Starting DssDssAlg_check_install_runtime"
	@if test -f $(cmt_local_DssDssAlg_check_install_runtime_makefile); then \
	  $(MAKE) -f $(cmt_local_DssDssAlg_check_install_runtime_makefile) DssDssAlg_check_install_runtime; \
	  fi
#	@$(MAKE) -f $(cmt_local_DssDssAlg_check_install_runtime_makefile) DssDssAlg_check_install_runtime
	$(echo) "(constituents.make) DssDssAlg_check_install_runtime done"

clean :: DssDssAlg_check_install_runtimeclean

DssDssAlg_check_install_runtimeclean :: $(DssDssAlg_check_install_runtimeclean_dependencies) ##$(cmt_local_DssDssAlg_check_install_runtime_makefile)
	$(echo) "(constituents.make) Starting DssDssAlg_check_install_runtimeclean"
	@-if test -f $(cmt_local_DssDssAlg_check_install_runtime_makefile); then \
	  $(MAKE) -f $(cmt_local_DssDssAlg_check_install_runtime_makefile) DssDssAlg_check_install_runtimeclean; \
	fi
	$(echo) "(constituents.make) DssDssAlg_check_install_runtimeclean done"
#	@-$(MAKE) -f $(cmt_local_DssDssAlg_check_install_runtime_makefile) DssDssAlg_check_install_runtimeclean

##	  /bin/rm -f $(cmt_local_DssDssAlg_check_install_runtime_makefile) $(bin)DssDssAlg_check_install_runtime_dependencies.make

install :: DssDssAlg_check_install_runtimeinstall

DssDssAlg_check_install_runtimeinstall :: $(DssDssAlg_check_install_runtime_dependencies) $(cmt_local_DssDssAlg_check_install_runtime_makefile)
	$(echo) "(constituents.make) Starting install DssDssAlg_check_install_runtime"
	@-$(MAKE) -f $(cmt_local_DssDssAlg_check_install_runtime_makefile) install
	$(echo) "(constituents.make) install DssDssAlg_check_install_runtime done"

uninstall : DssDssAlg_check_install_runtimeuninstall

$(foreach d,$(DssDssAlg_check_install_runtime_dependencies),$(eval $(d)uninstall_dependencies += DssDssAlg_check_install_runtimeuninstall))

DssDssAlg_check_install_runtimeuninstall : $(DssDssAlg_check_install_runtimeuninstall_dependencies) ##$(cmt_local_DssDssAlg_check_install_runtime_makefile)
	$(echo) "(constituents.make) Starting uninstall DssDssAlg_check_install_runtime"
	@if test -f $(cmt_local_DssDssAlg_check_install_runtime_makefile); then \
	  $(MAKE) -f $(cmt_local_DssDssAlg_check_install_runtime_makefile) uninstall; \
	  fi
#	@$(MAKE) -f $(cmt_local_DssDssAlg_check_install_runtime_makefile) uninstall
	$(echo) "(constituents.make) uninstall DssDssAlg_check_install_runtime done"

remove_library_links :: DssDssAlg_check_install_runtimeuninstall
