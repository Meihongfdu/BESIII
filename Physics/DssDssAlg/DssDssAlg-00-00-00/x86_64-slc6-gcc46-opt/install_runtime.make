...
jobOptions_DssDss_txt_dependencies = ../share/jobOptions_DssDss.txt


install_runtimeinstall :: ${install_dir}/jobOptions_DssDss.txt
	@if test ! "${installarea}" = ""; then\
	  echo "installation done"; \
	fi

${install_dir}/jobOptions_DssDss.txt :: ../share/jobOptions_DssDss.txt
	@if test ! "${installarea}" = ""; then \
	  d=`dirname ../share/jobOptions_DssDss.txt`; \
	  d=`(cd $${d}; pwd)`; \
	  CMTINSTALLAREA=${CMTINSTALLAREA}; export CMTINSTALLAREA; \
	  $(cmt_install_action) "$${d}" "jobOptions_DssDss.txt" "$(install_dir)" "cp -R" ; \
	fi
...
install_runtimeuninstall ::
	@if test ! "${installarea}" = ""; then \
	  ...
	  d=`(cd $${d}; pwd)`; \
	  CMTINSTALLAREA=${CMTINSTALLAREA}; export CMTINSTALLAREA; \
	  $(cmt_uninstall_action) "$${d}" "jobOptions_DssDss.txt" "$(install_dir)" "cp -R" ; \
	fi
