...
#
#   Generated Fri Apr 17 10:32:15 2020  by qity
#
#====================================
...
jobOptions_DssInc_txt_dependencies = ../share/jobOptions_DssInc.txt


install_runtimeinstall :: ${install_dir}/jobOptions_DssInc.txt
	@if test ! "${installarea}" = ""; then\
	  echo "installation done"; \
	fi

${install_dir}/jobOptions_DssInc.txt :: ../share/jobOptions_DssInc.txt
	@if test ! "${installarea}" = ""; then \
	  d=`dirname ../share/jobOptions_DssInc.txt`; \
	  d=`(cd $${d}; pwd)`; \
	  CMTINSTALLAREA=${CMTINSTALLAREA}; export CMTINSTALLAREA; \
	  $(cmt_install_action) "$${d}" "jobOptions_DssInc.txt" "$(install_dir)" "cp -R" ; \
	fi
...
install_runtimeuninstall ::
	@if test ! "${installarea}" = ""; then \
	  ...
	  d=`(cd $${d}; pwd)`; \
	  CMTINSTALLAREA=${CMTINSTALLAREA}; export CMTINSTALLAREA; \
	  $(cmt_uninstall_action) "$${d}" "jobOptions_DssInc.txt" "$(install_dir)" "cp -R" ; \
	fi
