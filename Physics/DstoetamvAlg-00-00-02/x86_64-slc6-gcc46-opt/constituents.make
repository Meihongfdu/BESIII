...
#cmt_local_tagfile = $(DstoetamvAlg_tag).make
cmt_local_tagfile = $(bin)$(DstoetamvAlg_tag).make
...
cmt_local_setup_DstoetamvAlg = $(bin)setup_DstoetamvAlg$$$$.make
...
DstoetamvAlg_extratags = -tag_add=target_DstoetamvAlg

#$(cmt_local_tagfile_DstoetamvAlg) : $(cmt_lock_setup)
ifndef QUICK
$(cmt_local_tagfile_DstoetamvAlg) ::
else
$(cmt_local_tagfile_DstoetamvAlg) :
endif
	$(echo) "(constituents.make) Rebuilding $@"; \
	  if test -f $(cmt_local_tagfile_DstoetamvAlg); then /bin/rm -f $(cmt_local_tagfile_DstoetamvAlg); fi ; \
	  $(cmtexe) -tag=$(tags) $(DstoetamvAlg_extratags) build tag_makefile >>$(cmt_local_tagfile_DstoetamvAlg)
	$(echo) "(constituents.make) Rebuilding $(cmt_final_setup_DstoetamvAlg)"; \
	  test ! -f $(cmt_local_setup_DstoetamvAlg) || \rm -f $(cmt_local_setup_DstoetamvAlg); \
	  trap '\rm -f $(cmt_local_setup_DstoetamvAlg)' 0 1 2 15; \
	  $(cmtexe) -tag=$(tags) $(DstoetamvAlg_extratags) show setup >$(cmt_local_setup_DstoetamvAlg) && \
	  if [ -f $(cmt_final_setup_DstoetamvAlg) ] && \
	    \cmp -s $(cmt_final_setup_DstoetamvAlg) $(cmt_local_setup_DstoetamvAlg); then \
	    \rm $(cmt_local_setup_DstoetamvAlg); else \
	    \mv -f $(cmt_local_setup_DstoetamvAlg) $(cmt_final_setup_DstoetamvAlg); fi
...
not_DstoetamvAlg_dependencies = { n=0; for p in $?; do m=0; for d in $(DstoetamvAlg_dependencies); do if [ $$p = $$d ]; then m=1; break; fi; done; if [ $$m -eq 0 ]; then n=1; break; fi; done; [ $$n -eq 1 ]; }

ifdef STRUCTURED_OUTPUT
DstoetamvAlgdirs :
	@if test ! -d $(bin)DstoetamvAlg; then $(mkdir) -p $(bin)DstoetamvAlg; fi
	$(echo) "STRUCTURED_OUTPUT="$(bin)DstoetamvAlg
else
DstoetamvAlgdirs : ;
endif
...
#	$(echo) "STRUCTURED_OUTPUT="$(bin)DstoetamvAlg
#
#$(cmt_local_DstoetamvAlg_makefile) :: $(DstoetamvAlg_dependencies) $(cmt_local_tagfile_DstoetamvAlg) build_library_links dirs DstoetamvAlgdirs
#else
#$(cmt_local_DstoetamvAlg_makefile) :: $(DstoetamvAlg_dependencies) $(cmt_local_tagfile_DstoetamvAlg) build_library_links dirs
#endif
#else
#$(cmt_local_DstoetamvAlg_makefile) :: $(cmt_local_tagfile_DstoetamvAlg)
#endif

ifdef cmt_DstoetamvAlg_has_target_tag

ifndef QUICK
$(cmt_local_DstoetamvAlg_makefile) : $(DstoetamvAlg_dependencies) build_library_links
	$(echo) "(constituents.make) Building DstoetamvAlg.make"; \
	  $(cmtexe) -tag=$(tags) $(DstoetamvAlg_extratags) build constituent_config -out=$(cmt_local_DstoetamvAlg_makefile) DstoetamvAlg
else
$(cmt_local_DstoetamvAlg_makefile) : $(DstoetamvAlg_dependencies) $(cmt_build_library_linksstamp) $(use_requirements)
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_DstoetamvAlg) ] || \
	  [ ! -f $(cmt_final_setup_DstoetamvAlg) ] || \
	  $(not_DstoetamvAlg_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
	  echo "$(CMTMSGPREFIX)" "(constituents.make) Building DstoetamvAlg.make"; \
	  $(cmtexe) -tag=$(tags) $(DstoetamvAlg_extratags) build constituent_config -out=$(cmt_local_DstoetamvAlg_makefile) DstoetamvAlg; \
	  fi
endif
...
$(cmt_local_DstoetamvAlg_makefile) : $(DstoetamvAlg_dependencies) build_library_links
	$(echo) "(constituents.make) Building DstoetamvAlg.make"; \
	  $(cmtexe) -f=$(bin)DstoetamvAlg.in -tag=$(tags) $(DstoetamvAlg_extratags) build constituent_makefile -without_cmt -out=$(cmt_local_DstoetamvAlg_makefile) DstoetamvAlg
else
$(cmt_local_DstoetamvAlg_makefile) : $(DstoetamvAlg_dependencies) $(cmt_build_library_linksstamp) $(bin)DstoetamvAlg.in
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_DstoetamvAlg) ] || \
	  [ ! -f $(cmt_final_setup_DstoetamvAlg) ] || \
	  $(not_DstoetamvAlg_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
...
#	  $(cmtexe) -tag=$(tags) $(DstoetamvAlg_extratags) build constituent_makefile -out=$(cmt_local_DstoetamvAlg_makefile) DstoetamvAlg

DstoetamvAlg :: $(DstoetamvAlg_dependencies) $(cmt_local_DstoetamvAlg_makefile) dirs DstoetamvAlgdirs
	$(echo) "(constituents.make) Starting DstoetamvAlg"
	@if test -f $(cmt_local_DstoetamvAlg_makefile); then \
	  $(MAKE) -f $(cmt_local_DstoetamvAlg_makefile) DstoetamvAlg; \
	  fi
#	@$(MAKE) -f $(cmt_local_DstoetamvAlg_makefile) DstoetamvAlg
	$(echo) "(constituents.make) DstoetamvAlg done"

clean :: DstoetamvAlgclean

DstoetamvAlgclean :: $(DstoetamvAlgclean_dependencies) ##$(cmt_local_DstoetamvAlg_makefile)
	$(echo) "(constituents.make) Starting DstoetamvAlgclean"
	@-if test -f $(cmt_local_DstoetamvAlg_makefile); then \
	  $(MAKE) -f $(cmt_local_DstoetamvAlg_makefile) DstoetamvAlgclean; \
	fi
	$(echo) "(constituents.make) DstoetamvAlgclean done"
#	@-$(MAKE) -f $(cmt_local_DstoetamvAlg_makefile) DstoetamvAlgclean

##	  /bin/rm -f $(cmt_local_DstoetamvAlg_makefile) $(bin)DstoetamvAlg_dependencies.make

install :: DstoetamvAlginstall

DstoetamvAlginstall :: $(DstoetamvAlg_dependencies) $(cmt_local_DstoetamvAlg_makefile)
	$(echo) "(constituents.make) Starting install DstoetamvAlg"
	@-$(MAKE) -f $(cmt_local_DstoetamvAlg_makefile) install
	$(echo) "(constituents.make) install DstoetamvAlg done"

uninstall : DstoetamvAlguninstall

$(foreach d,$(DstoetamvAlg_dependencies),$(eval $(d)uninstall_dependencies += DstoetamvAlguninstall))

DstoetamvAlguninstall : $(DstoetamvAlguninstall_dependencies) ##$(cmt_local_DstoetamvAlg_makefile)
	$(echo) "(constituents.make) Starting uninstall DstoetamvAlg"
	@if test -f $(cmt_local_DstoetamvAlg_makefile); then \
	  $(MAKE) -f $(cmt_local_DstoetamvAlg_makefile) uninstall; \
	  fi
#	@$(MAKE) -f $(cmt_local_DstoetamvAlg_makefile) uninstall
	$(echo) "(constituents.make) uninstall DstoetamvAlg done"

remove_library_links :: DstoetamvAlguninstall
...
#cmt_local_tagfile_install_runtime = $(DstoetamvAlg_tag)_install_runtime.make
cmt_local_tagfile_install_runtime = $(bin)$(DstoetamvAlg_tag)_install_runtime.make
...
#cmt_final_setup_install_runtime = $(bin)DstoetamvAlg_install_runtimesetup.make
...
#cmt_local_tagfile_install_runtime = $(DstoetamvAlg_tag).make
cmt_local_tagfile_install_runtime = $(bin)$(DstoetamvAlg_tag).make
cmt_final_setup_install_runtime = $(bin)setup.make
#cmt_final_setup_install_runtime = $(bin)DstoetamvAlgsetup.make
cmt_local_install_runtime_makefile = $(bin)install_runtime.make
...
#cmt_local_tagfile_config = $(DstoetamvAlg_tag)_config.make
cmt_local_tagfile_config = $(bin)$(DstoetamvAlg_tag)_config.make
cmt_local_setup_config = $(bin)setup_config$$$$.make
cmt_final_setup_config = $(bin)setup_config.make
#cmt_final_setup_config = $(bin)DstoetamvAlg_configsetup.make
...
#cmt_local_tagfile_config = $(DstoetamvAlg_tag).make
cmt_local_tagfile_config = $(bin)$(DstoetamvAlg_tag).make
cmt_final_setup_config = $(bin)setup.make
#cmt_final_setup_config = $(bin)DstoetamvAlgsetup.make
cmt_local_config_makefile = $(bin)config.make
...
#cmt_local_tagfile_install_includes = $(DstoetamvAlg_tag)_install_includes.make
cmt_local_tagfile_install_includes = $(bin)$(DstoetamvAlg_tag)_install_includes.make
...
#cmt_final_setup_install_includes = $(bin)DstoetamvAlg_install_includessetup.make
...
#cmt_local_tagfile_install_includes = $(DstoetamvAlg_tag).make
cmt_local_tagfile_install_includes = $(bin)$(DstoetamvAlg_tag).make
cmt_final_setup_install_includes = $(bin)setup.make
#cmt_final_setup_install_includes = $(bin)DstoetamvAlgsetup.make
cmt_local_install_includes_makefile = $(bin)install_includes.make
...
#cmt_local_tagfile_make = $(DstoetamvAlg_tag)_make.make
cmt_local_tagfile_make = $(bin)$(DstoetamvAlg_tag)_make.make
cmt_local_setup_make = $(bin)setup_make$$$$.make
cmt_final_setup_make = $(bin)setup_make.make
#cmt_final_setup_make = $(bin)DstoetamvAlg_makesetup.make
...
#cmt_local_tagfile_make = $(DstoetamvAlg_tag).make
cmt_local_tagfile_make = $(bin)$(DstoetamvAlg_tag).make
cmt_final_setup_make = $(bin)setup.make
#cmt_final_setup_make = $(bin)DstoetamvAlgsetup.make
cmt_local_make_makefile = $(bin)make.make
...
#cmt_local_tagfile_CompilePython = $(DstoetamvAlg_tag)_CompilePython.make
cmt_local_tagfile_CompilePython = $(bin)$(DstoetamvAlg_tag)_CompilePython.make
cmt_local_setup_CompilePython = $(bin)setup_CompilePython$$$$.make
cmt_final_setup_CompilePython = $(bin)setup_CompilePython.make
#cmt_final_setup_CompilePython = $(bin)DstoetamvAlg_CompilePythonsetup.make
...
#cmt_local_tagfile_CompilePython = $(DstoetamvAlg_tag).make
cmt_local_tagfile_CompilePython = $(bin)$(DstoetamvAlg_tag).make
cmt_final_setup_CompilePython = $(bin)setup.make
#cmt_final_setup_CompilePython = $(bin)DstoetamvAlgsetup.make
cmt_local_CompilePython_makefile = $(bin)CompilePython.make
...
#cmt_local_tagfile_qmtest_run = $(DstoetamvAlg_tag)_qmtest_run.make
cmt_local_tagfile_qmtest_run = $(bin)$(DstoetamvAlg_tag)_qmtest_run.make
cmt_local_setup_qmtest_run = $(bin)setup_qmtest_run$$$$.make
cmt_final_setup_qmtest_run = $(bin)setup_qmtest_run.make
#cmt_final_setup_qmtest_run = $(bin)DstoetamvAlg_qmtest_runsetup.make
...
#cmt_local_tagfile_qmtest_run = $(DstoetamvAlg_tag).make
cmt_local_tagfile_qmtest_run = $(bin)$(DstoetamvAlg_tag).make
cmt_final_setup_qmtest_run = $(bin)setup.make
#cmt_final_setup_qmtest_run = $(bin)DstoetamvAlgsetup.make
cmt_local_qmtest_run_makefile = $(bin)qmtest_run.make
...
#cmt_local_tagfile_qmtest_summarize = $(DstoetamvAlg_tag)_qmtest_summarize.make
cmt_local_tagfile_qmtest_summarize = $(bin)$(DstoetamvAlg_tag)_qmtest_summarize.make
...
#cmt_final_setup_qmtest_summarize = $(bin)DstoetamvAlg_qmtest_summarizesetup.make
...
#cmt_local_tagfile_qmtest_summarize = $(DstoetamvAlg_tag).make
cmt_local_tagfile_qmtest_summarize = $(bin)$(DstoetamvAlg_tag).make
cmt_final_setup_qmtest_summarize = $(bin)setup.make
#cmt_final_setup_qmtest_summarize = $(bin)DstoetamvAlgsetup.make
cmt_local_qmtest_summarize_makefile = $(bin)qmtest_summarize.make
...
#cmt_local_tagfile_TestPackage = $(DstoetamvAlg_tag)_TestPackage.make
cmt_local_tagfile_TestPackage = $(bin)$(DstoetamvAlg_tag)_TestPackage.make
cmt_local_setup_TestPackage = $(bin)setup_TestPackage$$$$.make
cmt_final_setup_TestPackage = $(bin)setup_TestPackage.make
#cmt_final_setup_TestPackage = $(bin)DstoetamvAlg_TestPackagesetup.make
...
#cmt_local_tagfile_TestPackage = $(DstoetamvAlg_tag).make
cmt_local_tagfile_TestPackage = $(bin)$(DstoetamvAlg_tag).make
cmt_final_setup_TestPackage = $(bin)setup.make
#cmt_final_setup_TestPackage = $(bin)DstoetamvAlgsetup.make
cmt_local_TestPackage_makefile = $(bin)TestPackage.make
...
#cmt_local_tagfile_TestProject = $(DstoetamvAlg_tag)_TestProject.make
cmt_local_tagfile_TestProject = $(bin)$(DstoetamvAlg_tag)_TestProject.make
cmt_local_setup_TestProject = $(bin)setup_TestProject$$$$.make
cmt_final_setup_TestProject = $(bin)setup_TestProject.make
#cmt_final_setup_TestProject = $(bin)DstoetamvAlg_TestProjectsetup.make
...
#cmt_local_tagfile_TestProject = $(DstoetamvAlg_tag).make
cmt_local_tagfile_TestProject = $(bin)$(DstoetamvAlg_tag).make
cmt_final_setup_TestProject = $(bin)setup.make
#cmt_final_setup_TestProject = $(bin)DstoetamvAlgsetup.make
cmt_local_TestProject_makefile = $(bin)TestProject.make
...
#cmt_local_tagfile_new_rootsys = $(DstoetamvAlg_tag)_new_rootsys.make
cmt_local_tagfile_new_rootsys = $(bin)$(DstoetamvAlg_tag)_new_rootsys.make
cmt_local_setup_new_rootsys = $(bin)setup_new_rootsys$$$$.make
cmt_final_setup_new_rootsys = $(bin)setup_new_rootsys.make
#cmt_final_setup_new_rootsys = $(bin)DstoetamvAlg_new_rootsyssetup.make
...
#cmt_local_tagfile_new_rootsys = $(DstoetamvAlg_tag).make
cmt_local_tagfile_new_rootsys = $(bin)$(DstoetamvAlg_tag).make
cmt_final_setup_new_rootsys = $(bin)setup.make
#cmt_final_setup_new_rootsys = $(bin)DstoetamvAlgsetup.make
cmt_local_new_rootsys_makefile = $(bin)new_rootsys.make
...
#cmt_local_tagfile_DatabaseSvc_check_install_scripts = $(DstoetamvAlg_tag)_DatabaseSvc_check_install_scripts.make
cmt_local_tagfile_DatabaseSvc_check_install_scripts = $(bin)$(DstoetamvAlg_tag)_DatabaseSvc_check_install_scripts.make
...
#cmt_final_setup_DatabaseSvc_check_install_scripts = $(bin)DstoetamvAlg_DatabaseSvc_check_install_scriptssetup.make
...
#cmt_local_tagfile_DatabaseSvc_check_install_scripts = $(DstoetamvAlg_tag).make
cmt_local_tagfile_DatabaseSvc_check_install_scripts = $(bin)$(DstoetamvAlg_tag).make
cmt_final_setup_DatabaseSvc_check_install_scripts = $(bin)setup.make
#cmt_final_setup_DatabaseSvc_check_install_scripts = $(bin)DstoetamvAlgsetup.make
cmt_local_DatabaseSvc_check_install_scripts_makefile = $(bin)DatabaseSvc_check_install_scripts.make
...
cmt_local_setup_DstoetamvAlg_check_install_runtime = $(bin)setup_DstoetamvAlg_check_install_runtime$$$$.make
...
DstoetamvAlg_check_install_runtime_extratags = -tag_add=target_DstoetamvAlg_check_install_runtime

#$(cmt_local_tagfile_DstoetamvAlg_check_install_runtime) : $(cmt_lock_setup)
ifndef QUICK
$(cmt_local_tagfile_DstoetamvAlg_check_install_runtime) ::
else
$(cmt_local_tagfile_DstoetamvAlg_check_install_runtime) :
endif
	$(echo) "(constituents.make) Rebuilding $@"; \
	  if test -f $(cmt_local_tagfile_DstoetamvAlg_check_install_runtime); then /bin/rm -f $(cmt_local_tagfile_DstoetamvAlg_check_install_runtime); fi ; \
	  $(cmtexe) -tag=$(tags) $(DstoetamvAlg_check_install_runtime_extratags) build tag_makefile >>$(cmt_local_tagfile_DstoetamvAlg_check_install_runtime)
	$(echo) "(constituents.make) Rebuilding $(cmt_final_setup_DstoetamvAlg_check_install_runtime)"; \
	  test ! -f $(cmt_local_setup_DstoetamvAlg_check_install_runtime) || \rm -f $(cmt_local_setup_DstoetamvAlg_check_install_runtime); \
	  trap '\rm -f $(cmt_local_setup_DstoetamvAlg_check_install_runtime)' 0 1 2 15; \
	  $(cmtexe) -tag=$(tags) $(DstoetamvAlg_check_install_runtime_extratags) show setup >$(cmt_local_setup_DstoetamvAlg_check_install_runtime) && \
	  if [ -f $(cmt_final_setup_DstoetamvAlg_check_install_runtime) ] && \
	    \cmp -s $(cmt_final_setup_DstoetamvAlg_check_install_runtime) $(cmt_local_setup_DstoetamvAlg_check_install_runtime); then \
	    \rm $(cmt_local_setup_DstoetamvAlg_check_install_runtime); else \
	    \mv -f $(cmt_local_setup_DstoetamvAlg_check_install_runtime) $(cmt_final_setup_DstoetamvAlg_check_install_runtime); fi
...
not_DstoetamvAlg_check_install_runtime_dependencies = { n=0; for p in $?; do m=0; for d in $(DstoetamvAlg_check_install_runtime_dependencies); do if [ $$p = $$d ]; then m=1; break; fi; done; if [ $$m -eq 0 ]; then n=1; break; fi; done; [ $$n -eq 1 ]; }

ifdef STRUCTURED_OUTPUT
DstoetamvAlg_check_install_runtimedirs :
	@if test ! -d $(bin)DstoetamvAlg_check_install_runtime; then $(mkdir) -p $(bin)DstoetamvAlg_check_install_runtime; fi
	$(echo) "STRUCTURED_OUTPUT="$(bin)DstoetamvAlg_check_install_runtime
else
DstoetamvAlg_check_install_runtimedirs : ;
endif
...
#	$(echo) "STRUCTURED_OUTPUT="$(bin)DstoetamvAlg_check_install_runtime
#
#$(cmt_local_DstoetamvAlg_check_install_runtime_makefile) :: $(DstoetamvAlg_check_install_runtime_dependencies) $(cmt_local_tagfile_DstoetamvAlg_check_install_runtime) build_library_links dirs DstoetamvAlg_check_install_runtimedirs
#else
#$(cmt_local_DstoetamvAlg_check_install_runtime_makefile) :: $(DstoetamvAlg_check_install_runtime_dependencies) $(cmt_local_tagfile_DstoetamvAlg_check_install_runtime) build_library_links dirs
#endif
#else
#$(cmt_local_DstoetamvAlg_check_install_runtime_makefile) :: $(cmt_local_tagfile_DstoetamvAlg_check_install_runtime)
#endif

ifdef cmt_DstoetamvAlg_check_install_runtime_has_target_tag

ifndef QUICK
$(cmt_local_DstoetamvAlg_check_install_runtime_makefile) : $(DstoetamvAlg_check_install_runtime_dependencies) build_library_links
	$(echo) "(constituents.make) Building DstoetamvAlg_check_install_runtime.make"; \
	  $(cmtexe) -tag=$(tags) $(DstoetamvAlg_check_install_runtime_extratags) build constituent_config -out=$(cmt_local_DstoetamvAlg_check_install_runtime_makefile) DstoetamvAlg_check_install_runtime
else
$(cmt_local_DstoetamvAlg_check_install_runtime_makefile) : $(DstoetamvAlg_check_install_runtime_dependencies) $(cmt_build_library_linksstamp) $(use_requirements)
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_DstoetamvAlg_check_install_runtime) ] || \
	  [ ! -f $(cmt_final_setup_DstoetamvAlg_check_install_runtime) ] || \
	  $(not_DstoetamvAlg_check_install_runtime_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
	  echo "$(CMTMSGPREFIX)" "(constituents.make) Building DstoetamvAlg_check_install_runtime.make"; \
	  $(cmtexe) -tag=$(tags) $(DstoetamvAlg_check_install_runtime_extratags) build constituent_config -out=$(cmt_local_DstoetamvAlg_check_install_runtime_makefile) DstoetamvAlg_check_install_runtime; \
	  fi
endif
...
$(cmt_local_DstoetamvAlg_check_install_runtime_makefile) : $(DstoetamvAlg_check_install_runtime_dependencies) build_library_links
	$(echo) "(constituents.make) Building DstoetamvAlg_check_install_runtime.make"; \
	  $(cmtexe) -f=$(bin)DstoetamvAlg_check_install_runtime.in -tag=$(tags) $(DstoetamvAlg_check_install_runtime_extratags) build constituent_makefile -without_cmt -out=$(cmt_local_DstoetamvAlg_check_install_runtime_makefile) DstoetamvAlg_check_install_runtime
else
$(cmt_local_DstoetamvAlg_check_install_runtime_makefile) : $(DstoetamvAlg_check_install_runtime_dependencies) $(cmt_build_library_linksstamp) $(bin)DstoetamvAlg_check_install_runtime.in
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_DstoetamvAlg_check_install_runtime) ] || \
	  [ ! -f $(cmt_final_setup_DstoetamvAlg_check_install_runtime) ] || \
	  $(not_DstoetamvAlg_check_install_runtime_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
...
#	  $(cmtexe) -tag=$(tags) $(DstoetamvAlg_check_install_runtime_extratags) build constituent_makefile -out=$(cmt_local_DstoetamvAlg_check_install_runtime_makefile) DstoetamvAlg_check_install_runtime

DstoetamvAlg_check_install_runtime :: $(DstoetamvAlg_check_install_runtime_dependencies) $(cmt_local_DstoetamvAlg_check_install_runtime_makefile) dirs DstoetamvAlg_check_install_runtimedirs
	$(echo) "(constituents.make) Starting DstoetamvAlg_check_install_runtime"
	@if test -f $(cmt_local_DstoetamvAlg_check_install_runtime_makefile); then \
	  $(MAKE) -f $(cmt_local_DstoetamvAlg_check_install_runtime_makefile) DstoetamvAlg_check_install_runtime; \
	  fi
#	@$(MAKE) -f $(cmt_local_DstoetamvAlg_check_install_runtime_makefile) DstoetamvAlg_check_install_runtime
	$(echo) "(constituents.make) DstoetamvAlg_check_install_runtime done"

clean :: DstoetamvAlg_check_install_runtimeclean

DstoetamvAlg_check_install_runtimeclean :: $(DstoetamvAlg_check_install_runtimeclean_dependencies) ##$(cmt_local_DstoetamvAlg_check_install_runtime_makefile)
	$(echo) "(constituents.make) Starting DstoetamvAlg_check_install_runtimeclean"
	@-if test -f $(cmt_local_DstoetamvAlg_check_install_runtime_makefile); then \
	  $(MAKE) -f $(cmt_local_DstoetamvAlg_check_install_runtime_makefile) DstoetamvAlg_check_install_runtimeclean; \
	fi
	$(echo) "(constituents.make) DstoetamvAlg_check_install_runtimeclean done"
#	@-$(MAKE) -f $(cmt_local_DstoetamvAlg_check_install_runtime_makefile) DstoetamvAlg_check_install_runtimeclean

##	  /bin/rm -f $(cmt_local_DstoetamvAlg_check_install_runtime_makefile) $(bin)DstoetamvAlg_check_install_runtime_dependencies.make

install :: DstoetamvAlg_check_install_runtimeinstall

DstoetamvAlg_check_install_runtimeinstall :: $(DstoetamvAlg_check_install_runtime_dependencies) $(cmt_local_DstoetamvAlg_check_install_runtime_makefile)
	$(echo) "(constituents.make) Starting install DstoetamvAlg_check_install_runtime"
	@-$(MAKE) -f $(cmt_local_DstoetamvAlg_check_install_runtime_makefile) install
	$(echo) "(constituents.make) install DstoetamvAlg_check_install_runtime done"

uninstall : DstoetamvAlg_check_install_runtimeuninstall

$(foreach d,$(DstoetamvAlg_check_install_runtime_dependencies),$(eval $(d)uninstall_dependencies += DstoetamvAlg_check_install_runtimeuninstall))

DstoetamvAlg_check_install_runtimeuninstall : $(DstoetamvAlg_check_install_runtimeuninstall_dependencies) ##$(cmt_local_DstoetamvAlg_check_install_runtime_makefile)
	$(echo) "(constituents.make) Starting uninstall DstoetamvAlg_check_install_runtime"
	@if test -f $(cmt_local_DstoetamvAlg_check_install_runtime_makefile); then \
	  $(MAKE) -f $(cmt_local_DstoetamvAlg_check_install_runtime_makefile) uninstall; \
	  fi
#	@$(MAKE) -f $(cmt_local_DstoetamvAlg_check_install_runtime_makefile) uninstall
	$(echo) "(constituents.make) uninstall DstoetamvAlg_check_install_runtime done"

remove_library_links :: DstoetamvAlg_check_install_runtimeuninstall
