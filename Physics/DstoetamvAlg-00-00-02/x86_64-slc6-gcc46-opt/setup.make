...
#   use ExtEvent ExtEvent-* Event
#   use VertexFit VertexFit-* Analysis
# use DsDsmcmode DsDsmcmode-* Analysis
#   use BesPolicy BesPolicy-01-* 
#   use GaudiInterface GaudiInterface-* External
#   use BesCLHEP BesCLHEP-* External
#   use DstEvent DstEvent-* Event
...
use Xt Xt-00-00-02 External (/cvmfs/bes3.ihep.ac.cn/bes3sw/Boss/7.0.3)
use BesExternalArea BesExternalArea-00-00-22 External (/cvmfs/bes3.ihep.ac.cn/bes3sw/Boss/7.0.3)
use GdmlManagement GdmlManagement-00-00-43 DetectorDescription (/cvmfs/bes3.ihep.ac.cn/bes3sw/Boss/7.0.3)
...
use CERNLIB CERNLIB-01-02-03 External (/cvmfs/bes3.ihep.ac.cn/bes3sw/Boss/7.0.3)
use mysql v1 LCG_Interfaces (/cvmfs/bes3.ihep.ac.cn/bes3sw/ExternalLib/SLC6/ExternalLib/LCGCMT/LCGCMT_65a)
use MYSQL MYSQL-00-00-09 External (/cvmfs/bes3.ihep.ac.cn/bes3sw/Boss/7.0.3)
...
use BesCLHEP BesCLHEP-00-00-11 External (/cvmfs/bes3.ihep.ac.cn/bes3sw/Boss/7.0.3)
use BesGeant4 BesGeant4-00-00-11 External (/cvmfs/bes3.ihep.ac.cn/bes3sw/Boss/7.0.3)
use GdmlToG4 GdmlToG4-00-00-11 External (/cvmfs/bes3.ihep.ac.cn/bes3sw/Boss/7.0.3)
...
use BesFortranPolicy BesFortranPolicy-00-01-03  (/cvmfs/bes3.ihep.ac.cn/bes3sw/Boss/7.0.3)
...
use BesROOT BesROOT-00-00-08 External (/cvmfs/bes3.ihep.ac.cn/bes3sw/Boss/7.0.3)
use GdmlToRoot GdmlToRoot-00-00-14 External (/cvmfs/bes3.ihep.ac.cn/bes3sw/Boss/7.0.3)
...
use GaudiInterface GaudiInterface-01-03-07 External (/cvmfs/bes3.ihep.ac.cn/bes3sw/Boss/7.0.3)
use BesCxxPolicy BesCxxPolicy-00-01-01  (/cvmfs/bes3.ihep.ac.cn/bes3sw/Boss/7.0.3)
use BesPolicy BesPolicy-01-05-05  (/cvmfs/bes3.ihep.ac.cn/bes3sw/Boss/7.0.3)
use EmcWaveform EmcWaveform-00-00-03 Emc (/cvmfs/bes3.ihep.ac.cn/bes3sw/Boss/7.0.3)
use DetVerSvc DetVerSvc-00-00-05 Utilities (/cvmfs/bes3.ihep.ac.cn/bes3sw/Boss/7.0.3)
use RootPolicy RootPolicy-00-01-03  (/cvmfs/bes3.ihep.ac.cn/bes3sw/Boss/7.0.3)
use BesTimerSvc BesTimerSvc-00-00-12 Utilities (/cvmfs/bes3.ihep.ac.cn/bes3sw/Boss/7.0.3)
use SimUtil SimUtil-00-00-37 Simulation/BOOST (/cvmfs/bes3.ihep.ac.cn/bes3sw/Boss/7.0.3)
use ROOTGeo ROOTGeo-00-00-15 DetectorDescription (/cvmfs/bes3.ihep.ac.cn/bes3sw/Boss/7.0.3)
use Identifier Identifier-00-02-17 DetectorDescription (/cvmfs/bes3.ihep.ac.cn/bes3sw/Boss/7.0.3)
use EmcGeneralClass EmcGeneralClass-00-00-04 Emc (/cvmfs/bes3.ihep.ac.cn/bes3sw/Boss/7.0.3)
use G4Geo G4Geo-00-00-13 DetectorDescription (/cvmfs/bes3.ihep.ac.cn/bes3sw/Boss/7.0.3)
use MucGeomSvc MucGeomSvc-00-02-25 Muc (/cvmfs/bes3.ihep.ac.cn/bes3sw/Boss/7.0.3)
use EmcRecGeoSvc EmcRecGeoSvc-01-01-07 Emc (/cvmfs/bes3.ihep.ac.cn/bes3sw/Boss/7.0.3)
use RelTable RelTable-00-00-02 Event (/cvmfs/bes3.ihep.ac.cn/bes3sw/Boss/7.0.3)
use DatabaseSvc DatabaseSvc-00-00-24 Database (/cvmfs/bes3.ihep.ac.cn/bes3sw/Boss/7.0.3)
use facilities facilities-00-00-04 Calibration (/cvmfs/bes3.ihep.ac.cn/bes3sw/Boss/7.0.3)
use CalibData CalibData-00-01-18 Calibration (/cvmfs/bes3.ihep.ac.cn/bes3sw/Boss/7.0.3)
use xmlBase xmlBase-00-00-03 Calibration (/cvmfs/bes3.ihep.ac.cn/bes3sw/Boss/7.0.3)
use rdbModel rdbModel-00-01-01 Calibration (/cvmfs/bes3.ihep.ac.cn/bes3sw/Boss/7.0.3)
use calibUtil calibUtil-00-00-43 Calibration (/cvmfs/bes3.ihep.ac.cn/bes3sw/Boss/7.0.3)
use EventModel EventModel-01-05-33 Event (/cvmfs/bes3.ihep.ac.cn/bes3sw/Boss/7.0.3)
use TofQCorrSvc TofQCorrSvc-00-00-10 Tof (/cvmfs/bes3.ihep.ac.cn/bes3sw/Boss/7.0.3)
use RawEvent RawEvent-00-03-19 Event (/cvmfs/bes3.ihep.ac.cn/bes3sw/Boss/7.0.3)
use EmcRawEvent EmcRawEvent-00-02-06 Emc (/cvmfs/bes3.ihep.ac.cn/bes3sw/Boss/7.0.3)
use TofRawEvent TofRawEvent-00-02-07 Tof (/cvmfs/bes3.ihep.ac.cn/bes3sw/Boss/7.0.3)
use MdcRawEvent MdcRawEvent-00-03-08 Mdc (/cvmfs/bes3.ihep.ac.cn/bes3sw/Boss/7.0.3)
use McTruth McTruth-00-02-19 Event (/cvmfs/bes3.ihep.ac.cn/bes3sw/Boss/7.0.3)
use EventTag EventTag-00-01-07 Event (/cvmfs/bes3.ihep.ac.cn/bes3sw/Boss/7.0.3)
use MagneticField MagneticField-00-01-38  (/cvmfs/bes3.ihep.ac.cn/bes3sw/Boss/7.0.3)
use MdcGeomSvc MdcGeomSvc-00-01-37 Mdc (/cvmfs/bes3.ihep.ac.cn/bes3sw/Boss/7.0.3)
use DedxCorrecSvc DedxCorrecSvc-00-02-52 Mdc (/cvmfs/bes3.ihep.ac.cn/bes3sw/Boss/7.0.3)
use EvTimeEvent EvTimeEvent-00-00-08 Event (/cvmfs/bes3.ihep.ac.cn/bes3sw/Boss/7.0.3)
use DstEvent DstEvent-00-02-51 Event (/cvmfs/bes3.ihep.ac.cn/bes3sw/Boss/7.0.3)
use CalibDataSvc CalibDataSvc-00-01-04 Calibration/CalibSvc (/cvmfs/bes3.ihep.ac.cn/bes3sw/Boss/7.0.3)
use CalibXmlCnvSvc CalibXmlCnvSvc-00-01-01 Calibration/CalibSvc (/cvmfs/bes3.ihep.ac.cn/bes3sw/Boss/7.0.3)
use CalibMySQLCnv CalibMySQLCnv-00-01-09 Calibration/CalibSvc (/cvmfs/bes3.ihep.ac.cn/bes3sw/Boss/7.0.3)
use CalibTreeCnv CalibTreeCnv-00-01-18 Calibration/CalibSvc (/cvmfs/bes3.ihep.ac.cn/bes3sw/Boss/7.0.3)
use CalibROOTCnv CalibROOTCnv-00-01-13 Calibration/CalibSvc (/cvmfs/bes3.ihep.ac.cn/bes3sw/Boss/7.0.3)
use EmcCalibConstSvc EmcCalibConstSvc-00-00-12 Emc (/cvmfs/bes3.ihep.ac.cn/bes3sw/Boss/7.0.3)
use CalibSvc CalibSvc-00-02-04 Calibration (/cvmfs/bes3.ihep.ac.cn/bes3sw/Boss/7.0.3)
use MdcCalibFunSvc MdcCalibFunSvc-00-03-16 Mdc (/cvmfs/bes3.ihep.ac.cn/bes3sw/Boss/7.0.3)
use TofQElecSvc TofQElecSvc-00-00-05 Tof (/cvmfs/bes3.ihep.ac.cn/bes3sw/Boss/7.0.3)
use TofCaliSvc TofCaliSvc-00-01-13 Tof (/cvmfs/bes3.ihep.ac.cn/bes3sw/Boss/7.0.3)
use ExtEvent ExtEvent-00-00-13 Event (/cvmfs/bes3.ihep.ac.cn/bes3sw/Boss/7.0.3)
use ReconEvent ReconEvent-00-00-04 Event (/cvmfs/bes3.ihep.ac.cn/bes3sw/Boss/7.0.3)
use MucRecEvent MucRecEvent-00-02-52 Muc (/cvmfs/bes3.ihep.ac.cn/bes3sw/Boss/7.0.3)
use EmcRecEventModel EmcRecEventModel-01-01-18 Emc (/cvmfs/bes3.ihep.ac.cn/bes3sw/Boss/7.0.3)
use TofRecEvent TofRecEvent-00-02-14 Tof (/cvmfs/bes3.ihep.ac.cn/bes3sw/Boss/7.0.3)
use MdcRecEvent MdcRecEvent-00-05-14 Mdc (/cvmfs/bes3.ihep.ac.cn/bes3sw/Boss/7.0.3)
use RawDataProviderSvc RawDataProviderSvc-00-03-46 Event (/cvmfs/bes3.ihep.ac.cn/bes3sw/Boss/7.0.3)
use EvtRecEvent EvtRecEvent-00-02-02 Event (/cvmfs/bes3.ihep.ac.cn/bes3sw/Boss/7.0.3)
use SimplePIDSvc SimplePIDSvc-00-00-11 Utilities (/cvmfs/bes3.ihep.ac.cn/bes3sw/Boss/7.0.3)
use ParticleID ParticleID-00-04-62 Analysis (/cvmfs/bes3.ihep.ac.cn/bes3sw/Boss/7.0.3)
use VertexFit VertexFit-00-02-80 Analysis (/cvmfs/bes3.ihep.ac.cn/bes3sw/Boss/7.0.3)
use DsDsmcmode DsDsmcmode-00-00-01 Analysis (/besfs5/users/panx/workarea/workarea-7.0.3)
use DTagTool DTagTool-00-00-11 Analysis (/cvmfs/bes3.ihep.ac.cn/bes3sw/Boss/7.0.3)
use Ecmset Ecmset-00-00-02 Analysis (/besfs5/users/panx/workarea/workarea-7.0.3)
----------> tags
...
workarea_root (from PROJECT) excludes [workarea_no_root]
workarea_cleanup (from PROJECT) excludes [workarea_no_cleanup]
workarea_scripts (from PROJECT) excludes [workarea_no_scripts]
workarea_prototypes (from PROJECT) excludes [workarea_no_prototypes]
workarea_with_installarea (from PROJECT) excludes [workarea_without_installarea]
workarea_with_version_directory (from PROJECT) excludes [workarea_without_version_directory]
...
----------> CMTPATH
# Add path /besfs5/users/panx/workarea/workarea-7.0.3 from initialization
# Add path /cvmfs/bes3.ihep.ac.cn/bes3sw/Boss/7.0.3 from initialization
