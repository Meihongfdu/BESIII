...
#cmt_local_tagfile = $(pmuAlg_tag).make
cmt_local_tagfile = $(bin)$(pmuAlg_tag).make
...
cmt_local_setup_pmuAlg = $(bin)setup_pmuAlg$$$$.make
...
pmuAlg_extratags = -tag_add=target_pmuAlg

#$(cmt_local_tagfile_pmuAlg) : $(cmt_lock_setup)
ifndef QUICK
$(cmt_local_tagfile_pmuAlg) ::
else
$(cmt_local_tagfile_pmuAlg) :
endif
	$(echo) "(constituents.make) Rebuilding $@"; \
	  if test -f $(cmt_local_tagfile_pmuAlg); then /bin/rm -f $(cmt_local_tagfile_pmuAlg); fi ; \
	  $(cmtexe) -tag=$(tags) $(pmuAlg_extratags) build tag_makefile >>$(cmt_local_tagfile_pmuAlg)
	$(echo) "(constituents.make) Rebuilding $(cmt_final_setup_pmuAlg)"; \
	  test ! -f $(cmt_local_setup_pmuAlg) || \rm -f $(cmt_local_setup_pmuAlg); \
	  trap '\rm -f $(cmt_local_setup_pmuAlg)' 0 1 2 15; \
	  $(cmtexe) -tag=$(tags) $(pmuAlg_extratags) show setup >$(cmt_local_setup_pmuAlg) && \
	  if [ -f $(cmt_final_setup_pmuAlg) ] && \
	    \cmp -s $(cmt_final_setup_pmuAlg) $(cmt_local_setup_pmuAlg); then \
	    \rm $(cmt_local_setup_pmuAlg); else \
	    \mv -f $(cmt_local_setup_pmuAlg) $(cmt_final_setup_pmuAlg); fi
...
not_pmuAlg_dependencies = { n=0; for p in $?; do m=0; for d in $(pmuAlg_dependencies); do if [ $$p = $$d ]; then m=1; break; fi; done; if [ $$m -eq 0 ]; then n=1; break; fi; done; [ $$n -eq 1 ]; }

ifdef STRUCTURED_OUTPUT
pmuAlgdirs :
	@if test ! -d $(bin)pmuAlg; then $(mkdir) -p $(bin)pmuAlg; fi
	$(echo) "STRUCTURED_OUTPUT="$(bin)pmuAlg
else
pmuAlgdirs : ;
endif
...
#	$(echo) "STRUCTURED_OUTPUT="$(bin)pmuAlg
#
#$(cmt_local_pmuAlg_makefile) :: $(pmuAlg_dependencies) $(cmt_local_tagfile_pmuAlg) build_library_links dirs pmuAlgdirs
#else
#$(cmt_local_pmuAlg_makefile) :: $(pmuAlg_dependencies) $(cmt_local_tagfile_pmuAlg) build_library_links dirs
#endif
#else
#$(cmt_local_pmuAlg_makefile) :: $(cmt_local_tagfile_pmuAlg)
#endif

ifdef cmt_pmuAlg_has_target_tag

ifndef QUICK
$(cmt_local_pmuAlg_makefile) : $(pmuAlg_dependencies) build_library_links
	$(echo) "(constituents.make) Building pmuAlg.make"; \
	  $(cmtexe) -tag=$(tags) $(pmuAlg_extratags) build constituent_config -out=$(cmt_local_pmuAlg_makefile) pmuAlg
else
$(cmt_local_pmuAlg_makefile) : $(pmuAlg_dependencies) $(cmt_build_library_linksstamp) $(use_requirements)
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_pmuAlg) ] || \
	  [ ! -f $(cmt_final_setup_pmuAlg) ] || \
	  $(not_pmuAlg_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
	  echo "$(CMTMSGPREFIX)" "(constituents.make) Building pmuAlg.make"; \
	  $(cmtexe) -tag=$(tags) $(pmuAlg_extratags) build constituent_config -out=$(cmt_local_pmuAlg_makefile) pmuAlg; \
	  fi
endif
...
$(cmt_local_pmuAlg_makefile) : $(pmuAlg_dependencies) build_library_links
	$(echo) "(constituents.make) Building pmuAlg.make"; \
	  $(cmtexe) -f=$(bin)pmuAlg.in -tag=$(tags) $(pmuAlg_extratags) build constituent_makefile -without_cmt -out=$(cmt_local_pmuAlg_makefile) pmuAlg
else
$(cmt_local_pmuAlg_makefile) : $(pmuAlg_dependencies) $(cmt_build_library_linksstamp) $(bin)pmuAlg.in
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_pmuAlg) ] || \
	  [ ! -f $(cmt_final_setup_pmuAlg) ] || \
	  $(not_pmuAlg_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
...
#	  $(cmtexe) -tag=$(tags) $(pmuAlg_extratags) build constituent_makefile -out=$(cmt_local_pmuAlg_makefile) pmuAlg

pmuAlg :: $(pmuAlg_dependencies) $(cmt_local_pmuAlg_makefile) dirs pmuAlgdirs
	$(echo) "(constituents.make) Starting pmuAlg"
	@if test -f $(cmt_local_pmuAlg_makefile); then \
	  $(MAKE) -f $(cmt_local_pmuAlg_makefile) pmuAlg; \
	  fi
#	@$(MAKE) -f $(cmt_local_pmuAlg_makefile) pmuAlg
	$(echo) "(constituents.make) pmuAlg done"

clean :: pmuAlgclean

pmuAlgclean :: $(pmuAlgclean_dependencies) ##$(cmt_local_pmuAlg_makefile)
	$(echo) "(constituents.make) Starting pmuAlgclean"
	@-if test -f $(cmt_local_pmuAlg_makefile); then \
	  $(MAKE) -f $(cmt_local_pmuAlg_makefile) pmuAlgclean; \
	fi
	$(echo) "(constituents.make) pmuAlgclean done"
#	@-$(MAKE) -f $(cmt_local_pmuAlg_makefile) pmuAlgclean

##	  /bin/rm -f $(cmt_local_pmuAlg_makefile) $(bin)pmuAlg_dependencies.make

install :: pmuAlginstall

pmuAlginstall :: $(pmuAlg_dependencies) $(cmt_local_pmuAlg_makefile)
	$(echo) "(constituents.make) Starting install pmuAlg"
	@-$(MAKE) -f $(cmt_local_pmuAlg_makefile) install
	$(echo) "(constituents.make) install pmuAlg done"

uninstall : pmuAlguninstall

$(foreach d,$(pmuAlg_dependencies),$(eval $(d)uninstall_dependencies += pmuAlguninstall))

pmuAlguninstall : $(pmuAlguninstall_dependencies) ##$(cmt_local_pmuAlg_makefile)
	$(echo) "(constituents.make) Starting uninstall pmuAlg"
	@if test -f $(cmt_local_pmuAlg_makefile); then \
	  $(MAKE) -f $(cmt_local_pmuAlg_makefile) uninstall; \
	  fi
#	@$(MAKE) -f $(cmt_local_pmuAlg_makefile) uninstall
	$(echo) "(constituents.make) uninstall pmuAlg done"

remove_library_links :: pmuAlguninstall
...
#cmt_local_tagfile_install_runtime = $(pmuAlg_tag)_install_runtime.make
cmt_local_tagfile_install_runtime = $(bin)$(pmuAlg_tag)_install_runtime.make
...
#cmt_final_setup_install_runtime = $(bin)pmuAlg_install_runtimesetup.make
...
#cmt_local_tagfile_install_runtime = $(pmuAlg_tag).make
cmt_local_tagfile_install_runtime = $(bin)$(pmuAlg_tag).make
cmt_final_setup_install_runtime = $(bin)setup.make
#cmt_final_setup_install_runtime = $(bin)pmuAlgsetup.make
cmt_local_install_runtime_makefile = $(bin)install_runtime.make
...
#cmt_local_tagfile_config = $(pmuAlg_tag)_config.make
cmt_local_tagfile_config = $(bin)$(pmuAlg_tag)_config.make
cmt_local_setup_config = $(bin)setup_config$$$$.make
cmt_final_setup_config = $(bin)setup_config.make
#cmt_final_setup_config = $(bin)pmuAlg_configsetup.make
...
#cmt_local_tagfile_config = $(pmuAlg_tag).make
cmt_local_tagfile_config = $(bin)$(pmuAlg_tag).make
cmt_final_setup_config = $(bin)setup.make
#cmt_final_setup_config = $(bin)pmuAlgsetup.make
cmt_local_config_makefile = $(bin)config.make
...
#cmt_local_tagfile_install_includes = $(pmuAlg_tag)_install_includes.make
cmt_local_tagfile_install_includes = $(bin)$(pmuAlg_tag)_install_includes.make
...
#cmt_final_setup_install_includes = $(bin)pmuAlg_install_includessetup.make
...
#cmt_local_tagfile_install_includes = $(pmuAlg_tag).make
cmt_local_tagfile_install_includes = $(bin)$(pmuAlg_tag).make
cmt_final_setup_install_includes = $(bin)setup.make
#cmt_final_setup_install_includes = $(bin)pmuAlgsetup.make
cmt_local_install_includes_makefile = $(bin)install_includes.make
...
#cmt_local_tagfile_make = $(pmuAlg_tag)_make.make
cmt_local_tagfile_make = $(bin)$(pmuAlg_tag)_make.make
cmt_local_setup_make = $(bin)setup_make$$$$.make
cmt_final_setup_make = $(bin)setup_make.make
#cmt_final_setup_make = $(bin)pmuAlg_makesetup.make
...
#cmt_local_tagfile_make = $(pmuAlg_tag).make
cmt_local_tagfile_make = $(bin)$(pmuAlg_tag).make
cmt_final_setup_make = $(bin)setup.make
#cmt_final_setup_make = $(bin)pmuAlgsetup.make
cmt_local_make_makefile = $(bin)make.make
...
#cmt_local_tagfile_CompilePython = $(pmuAlg_tag)_CompilePython.make
cmt_local_tagfile_CompilePython = $(bin)$(pmuAlg_tag)_CompilePython.make
cmt_local_setup_CompilePython = $(bin)setup_CompilePython$$$$.make
cmt_final_setup_CompilePython = $(bin)setup_CompilePython.make
#cmt_final_setup_CompilePython = $(bin)pmuAlg_CompilePythonsetup.make
...
#cmt_local_tagfile_CompilePython = $(pmuAlg_tag).make
cmt_local_tagfile_CompilePython = $(bin)$(pmuAlg_tag).make
cmt_final_setup_CompilePython = $(bin)setup.make
#cmt_final_setup_CompilePython = $(bin)pmuAlgsetup.make
cmt_local_CompilePython_makefile = $(bin)CompilePython.make
...
#cmt_local_tagfile_qmtest_run = $(pmuAlg_tag)_qmtest_run.make
cmt_local_tagfile_qmtest_run = $(bin)$(pmuAlg_tag)_qmtest_run.make
cmt_local_setup_qmtest_run = $(bin)setup_qmtest_run$$$$.make
cmt_final_setup_qmtest_run = $(bin)setup_qmtest_run.make
#cmt_final_setup_qmtest_run = $(bin)pmuAlg_qmtest_runsetup.make
...
#cmt_local_tagfile_qmtest_run = $(pmuAlg_tag).make
cmt_local_tagfile_qmtest_run = $(bin)$(pmuAlg_tag).make
cmt_final_setup_qmtest_run = $(bin)setup.make
#cmt_final_setup_qmtest_run = $(bin)pmuAlgsetup.make
cmt_local_qmtest_run_makefile = $(bin)qmtest_run.make
...
#cmt_local_tagfile_qmtest_summarize = $(pmuAlg_tag)_qmtest_summarize.make
cmt_local_tagfile_qmtest_summarize = $(bin)$(pmuAlg_tag)_qmtest_summarize.make
...
#cmt_final_setup_qmtest_summarize = $(bin)pmuAlg_qmtest_summarizesetup.make
...
#cmt_local_tagfile_qmtest_summarize = $(pmuAlg_tag).make
cmt_local_tagfile_qmtest_summarize = $(bin)$(pmuAlg_tag).make
cmt_final_setup_qmtest_summarize = $(bin)setup.make
#cmt_final_setup_qmtest_summarize = $(bin)pmuAlgsetup.make
cmt_local_qmtest_summarize_makefile = $(bin)qmtest_summarize.make
...
#cmt_local_tagfile_TestPackage = $(pmuAlg_tag)_TestPackage.make
cmt_local_tagfile_TestPackage = $(bin)$(pmuAlg_tag)_TestPackage.make
cmt_local_setup_TestPackage = $(bin)setup_TestPackage$$$$.make
cmt_final_setup_TestPackage = $(bin)setup_TestPackage.make
#cmt_final_setup_TestPackage = $(bin)pmuAlg_TestPackagesetup.make
...
#cmt_local_tagfile_TestPackage = $(pmuAlg_tag).make
cmt_local_tagfile_TestPackage = $(bin)$(pmuAlg_tag).make
cmt_final_setup_TestPackage = $(bin)setup.make
#cmt_final_setup_TestPackage = $(bin)pmuAlgsetup.make
cmt_local_TestPackage_makefile = $(bin)TestPackage.make
...
#cmt_local_tagfile_TestProject = $(pmuAlg_tag)_TestProject.make
cmt_local_tagfile_TestProject = $(bin)$(pmuAlg_tag)_TestProject.make
cmt_local_setup_TestProject = $(bin)setup_TestProject$$$$.make
cmt_final_setup_TestProject = $(bin)setup_TestProject.make
#cmt_final_setup_TestProject = $(bin)pmuAlg_TestProjectsetup.make
...
#cmt_local_tagfile_TestProject = $(pmuAlg_tag).make
cmt_local_tagfile_TestProject = $(bin)$(pmuAlg_tag).make
cmt_final_setup_TestProject = $(bin)setup.make
#cmt_final_setup_TestProject = $(bin)pmuAlgsetup.make
cmt_local_TestProject_makefile = $(bin)TestProject.make
...
#cmt_local_tagfile_new_rootsys = $(pmuAlg_tag)_new_rootsys.make
cmt_local_tagfile_new_rootsys = $(bin)$(pmuAlg_tag)_new_rootsys.make
cmt_local_setup_new_rootsys = $(bin)setup_new_rootsys$$$$.make
cmt_final_setup_new_rootsys = $(bin)setup_new_rootsys.make
#cmt_final_setup_new_rootsys = $(bin)pmuAlg_new_rootsyssetup.make
...
#cmt_local_tagfile_new_rootsys = $(pmuAlg_tag).make
cmt_local_tagfile_new_rootsys = $(bin)$(pmuAlg_tag).make
cmt_final_setup_new_rootsys = $(bin)setup.make
#cmt_final_setup_new_rootsys = $(bin)pmuAlgsetup.make
cmt_local_new_rootsys_makefile = $(bin)new_rootsys.make
...
#cmt_local_tagfile_DatabaseSvc_check_install_scripts = $(pmuAlg_tag)_DatabaseSvc_check_install_scripts.make
cmt_local_tagfile_DatabaseSvc_check_install_scripts = $(bin)$(pmuAlg_tag)_DatabaseSvc_check_install_scripts.make
...
#cmt_final_setup_DatabaseSvc_check_install_scripts = $(bin)pmuAlg_DatabaseSvc_check_install_scriptssetup.make
...
#cmt_local_tagfile_DatabaseSvc_check_install_scripts = $(pmuAlg_tag).make
cmt_local_tagfile_DatabaseSvc_check_install_scripts = $(bin)$(pmuAlg_tag).make
cmt_final_setup_DatabaseSvc_check_install_scripts = $(bin)setup.make
#cmt_final_setup_DatabaseSvc_check_install_scripts = $(bin)pmuAlgsetup.make
cmt_local_DatabaseSvc_check_install_scripts_makefile = $(bin)DatabaseSvc_check_install_scripts.make
...
cmt_local_setup_pmuAlg_check_install_runtime = $(bin)setup_pmuAlg_check_install_runtime$$$$.make
...
pmuAlg_check_install_runtime_extratags = -tag_add=target_pmuAlg_check_install_runtime

#$(cmt_local_tagfile_pmuAlg_check_install_runtime) : $(cmt_lock_setup)
ifndef QUICK
$(cmt_local_tagfile_pmuAlg_check_install_runtime) ::
else
$(cmt_local_tagfile_pmuAlg_check_install_runtime) :
endif
	$(echo) "(constituents.make) Rebuilding $@"; \
	  if test -f $(cmt_local_tagfile_pmuAlg_check_install_runtime); then /bin/rm -f $(cmt_local_tagfile_pmuAlg_check_install_runtime); fi ; \
	  $(cmtexe) -tag=$(tags) $(pmuAlg_check_install_runtime_extratags) build tag_makefile >>$(cmt_local_tagfile_pmuAlg_check_install_runtime)
	$(echo) "(constituents.make) Rebuilding $(cmt_final_setup_pmuAlg_check_install_runtime)"; \
	  test ! -f $(cmt_local_setup_pmuAlg_check_install_runtime) || \rm -f $(cmt_local_setup_pmuAlg_check_install_runtime); \
	  trap '\rm -f $(cmt_local_setup_pmuAlg_check_install_runtime)' 0 1 2 15; \
	  $(cmtexe) -tag=$(tags) $(pmuAlg_check_install_runtime_extratags) show setup >$(cmt_local_setup_pmuAlg_check_install_runtime) && \
	  if [ -f $(cmt_final_setup_pmuAlg_check_install_runtime) ] && \
	    \cmp -s $(cmt_final_setup_pmuAlg_check_install_runtime) $(cmt_local_setup_pmuAlg_check_install_runtime); then \
	    \rm $(cmt_local_setup_pmuAlg_check_install_runtime); else \
	    \mv -f $(cmt_local_setup_pmuAlg_check_install_runtime) $(cmt_final_setup_pmuAlg_check_install_runtime); fi
...
not_pmuAlg_check_install_runtime_dependencies = { n=0; for p in $?; do m=0; for d in $(pmuAlg_check_install_runtime_dependencies); do if [ $$p = $$d ]; then m=1; break; fi; done; if [ $$m -eq 0 ]; then n=1; break; fi; done; [ $$n -eq 1 ]; }

ifdef STRUCTURED_OUTPUT
pmuAlg_check_install_runtimedirs :
	@if test ! -d $(bin)pmuAlg_check_install_runtime; then $(mkdir) -p $(bin)pmuAlg_check_install_runtime; fi
	$(echo) "STRUCTURED_OUTPUT="$(bin)pmuAlg_check_install_runtime
else
pmuAlg_check_install_runtimedirs : ;
endif
...
#	$(echo) "STRUCTURED_OUTPUT="$(bin)pmuAlg_check_install_runtime
#
#$(cmt_local_pmuAlg_check_install_runtime_makefile) :: $(pmuAlg_check_install_runtime_dependencies) $(cmt_local_tagfile_pmuAlg_check_install_runtime) build_library_links dirs pmuAlg_check_install_runtimedirs
#else
#$(cmt_local_pmuAlg_check_install_runtime_makefile) :: $(pmuAlg_check_install_runtime_dependencies) $(cmt_local_tagfile_pmuAlg_check_install_runtime) build_library_links dirs
#endif
#else
#$(cmt_local_pmuAlg_check_install_runtime_makefile) :: $(cmt_local_tagfile_pmuAlg_check_install_runtime)
#endif

ifdef cmt_pmuAlg_check_install_runtime_has_target_tag

ifndef QUICK
$(cmt_local_pmuAlg_check_install_runtime_makefile) : $(pmuAlg_check_install_runtime_dependencies) build_library_links
	$(echo) "(constituents.make) Building pmuAlg_check_install_runtime.make"; \
	  $(cmtexe) -tag=$(tags) $(pmuAlg_check_install_runtime_extratags) build constituent_config -out=$(cmt_local_pmuAlg_check_install_runtime_makefile) pmuAlg_check_install_runtime
else
$(cmt_local_pmuAlg_check_install_runtime_makefile) : $(pmuAlg_check_install_runtime_dependencies) $(cmt_build_library_linksstamp) $(use_requirements)
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_pmuAlg_check_install_runtime) ] || \
	  [ ! -f $(cmt_final_setup_pmuAlg_check_install_runtime) ] || \
	  $(not_pmuAlg_check_install_runtime_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
	  echo "$(CMTMSGPREFIX)" "(constituents.make) Building pmuAlg_check_install_runtime.make"; \
	  $(cmtexe) -tag=$(tags) $(pmuAlg_check_install_runtime_extratags) build constituent_config -out=$(cmt_local_pmuAlg_check_install_runtime_makefile) pmuAlg_check_install_runtime; \
	  fi
endif
...
$(cmt_local_pmuAlg_check_install_runtime_makefile) : $(pmuAlg_check_install_runtime_dependencies) build_library_links
	$(echo) "(constituents.make) Building pmuAlg_check_install_runtime.make"; \
	  $(cmtexe) -f=$(bin)pmuAlg_check_install_runtime.in -tag=$(tags) $(pmuAlg_check_install_runtime_extratags) build constituent_makefile -without_cmt -out=$(cmt_local_pmuAlg_check_install_runtime_makefile) pmuAlg_check_install_runtime
else
$(cmt_local_pmuAlg_check_install_runtime_makefile) : $(pmuAlg_check_install_runtime_dependencies) $(cmt_build_library_linksstamp) $(bin)pmuAlg_check_install_runtime.in
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_pmuAlg_check_install_runtime) ] || \
	  [ ! -f $(cmt_final_setup_pmuAlg_check_install_runtime) ] || \
	  $(not_pmuAlg_check_install_runtime_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
...
#	  $(cmtexe) -tag=$(tags) $(pmuAlg_check_install_runtime_extratags) build constituent_makefile -out=$(cmt_local_pmuAlg_check_install_runtime_makefile) pmuAlg_check_install_runtime

pmuAlg_check_install_runtime :: $(pmuAlg_check_install_runtime_dependencies) $(cmt_local_pmuAlg_check_install_runtime_makefile) dirs pmuAlg_check_install_runtimedirs
	$(echo) "(constituents.make) Starting pmuAlg_check_install_runtime"
	@if test -f $(cmt_local_pmuAlg_check_install_runtime_makefile); then \
	  $(MAKE) -f $(cmt_local_pmuAlg_check_install_runtime_makefile) pmuAlg_check_install_runtime; \
	  fi
#	@$(MAKE) -f $(cmt_local_pmuAlg_check_install_runtime_makefile) pmuAlg_check_install_runtime
	$(echo) "(constituents.make) pmuAlg_check_install_runtime done"

clean :: pmuAlg_check_install_runtimeclean

pmuAlg_check_install_runtimeclean :: $(pmuAlg_check_install_runtimeclean_dependencies) ##$(cmt_local_pmuAlg_check_install_runtime_makefile)
	$(echo) "(constituents.make) Starting pmuAlg_check_install_runtimeclean"
	@-if test -f $(cmt_local_pmuAlg_check_install_runtime_makefile); then \
	  $(MAKE) -f $(cmt_local_pmuAlg_check_install_runtime_makefile) pmuAlg_check_install_runtimeclean; \
	fi
	$(echo) "(constituents.make) pmuAlg_check_install_runtimeclean done"
#	@-$(MAKE) -f $(cmt_local_pmuAlg_check_install_runtime_makefile) pmuAlg_check_install_runtimeclean

##	  /bin/rm -f $(cmt_local_pmuAlg_check_install_runtime_makefile) $(bin)pmuAlg_check_install_runtime_dependencies.make

install :: pmuAlg_check_install_runtimeinstall

pmuAlg_check_install_runtimeinstall :: $(pmuAlg_check_install_runtime_dependencies) $(cmt_local_pmuAlg_check_install_runtime_makefile)
	$(echo) "(constituents.make) Starting install pmuAlg_check_install_runtime"
	@-$(MAKE) -f $(cmt_local_pmuAlg_check_install_runtime_makefile) install
	$(echo) "(constituents.make) install pmuAlg_check_install_runtime done"

uninstall : pmuAlg_check_install_runtimeuninstall

$(foreach d,$(pmuAlg_check_install_runtime_dependencies),$(eval $(d)uninstall_dependencies += pmuAlg_check_install_runtimeuninstall))

pmuAlg_check_install_runtimeuninstall : $(pmuAlg_check_install_runtimeuninstall_dependencies) ##$(cmt_local_pmuAlg_check_install_runtime_makefile)
	$(echo) "(constituents.make) Starting uninstall pmuAlg_check_install_runtime"
	@if test -f $(cmt_local_pmuAlg_check_install_runtime_makefile); then \
	  $(MAKE) -f $(cmt_local_pmuAlg_check_install_runtime_makefile) uninstall; \
	  fi
#	@$(MAKE) -f $(cmt_local_pmuAlg_check_install_runtime_makefile) uninstall
	$(echo) "(constituents.make) uninstall pmuAlg_check_install_runtime done"

remove_library_links :: pmuAlg_check_install_runtimeuninstall
