...
ifdef READONLY
cmt_local_tagfile = /tmp/CMT_$(Jpsdecthreepi_tag).make$(cmt_lock_pid)
else
...
ifdef READONLY
cmt_local_setup = /tmp/CMT_Jpsdecthreepisetup$(cmt_lock_pid).make
cmt_final_setup = /tmp/CMT_Jpsdecthreepisetup.make
else
#cmt_local_setup = $(bin)Jpsdecthreepisetup$(cmt_lock_pid).make
...
$(cmt_local_tagfile_Jpsdecthreepi) :
	...
	$(echo) "(constituents.make) Rebuilding setup.make $(cmt_local_tagfile_Jpsdecthreepi)"
	@if test -f $(cmt_local_tagfile_Jpsdecthreepi); then /bin/rm -f $(cmt_local_tagfile_Jpsdecthreepi); fi ; \
	  ...
	  if test -f $(cmt_final_setup_Jpsdecthreepi); then /bin/rm -f $(cmt_final_setup_Jpsdecthreepi); fi; \
	  $(cmtexe) -tag=$(tags) $(Jpsdecthreepi_extratags) show setup >>$(cmt_final_setup_Jpsdecthreepi)
	$(echo) setup.make ok
...
Jpsdecthreepi :: $(Jpsdecthreepi_dependencies) $(cmt_local_Jpsdecthreepi_makefile)
	$(echo) "(constituents.make) Starting Jpsdecthreepi"
	@$(MAKE) -f $(cmt_local_Jpsdecthreepi_makefile) cmt_lock_pid=$${cmt_lock_pid} Jpsdecthreepi
...
Jpsdecthreepiclean :: $(Jpsdecthreepiclean_dependencies) ##$(cmt_local_Jpsdecthreepi_makefile)
	...
	@-if test -f $(cmt_local_Jpsdecthreepi_makefile); then \
	  $(MAKE) -f $(cmt_local_Jpsdecthreepi_makefile) cmt_lock_pid=$${cmt_lock_pid} Jpsdecthreepiclean; \
	fi
...
Jpsdecthreepiinstall :: $(Jpsdecthreepi_dependencies) $(cmt_local_Jpsdecthreepi_makefile)
	...
	@-$(MAKE) -f $(cmt_local_Jpsdecthreepi_makefile) cmt_lock_pid=$${cmt_lock_pid} install
	$(echo) "(constituents.make) install Jpsdecthreepi done"

uninstall :: Jpsdecthreepiuninstall

Jpsdecthreepiuninstall :: $(cmt_local_Jpsdecthreepi_makefile)
	$(echo) "(constituents.make) Starting uninstall Jpsdecthreepi"
	@-$(MAKE) -f $(cmt_local_Jpsdecthreepi_makefile) cmt_lock_pid=$${cmt_lock_pid} uninstall
...
ifdef READONLY
cmt_local_tagfile_install_includes = /tmp/CMT_$(Jpsdecthreepi_tag)_install_includes.make$(cmt_lock_pid)
cmt_final_setup_install_includes = /tmp/CMT_Jpsdecthreepi_install_includessetup.make
...
ifdef READONLY
cmt_local_tagfile_install_includes = /tmp/CMT_$(Jpsdecthreepi_tag).make$(cmt_lock_pid)
cmt_final_setup_install_includes = /tmp/CMT_Jpsdecthreepisetup.make
cmt_local_install_includes_makefile = /tmp/CMT_install_includes$(cmt_lock_pid).make
else
...
ifdef READONLY
cmt_local_tagfile_make = /tmp/CMT_$(Jpsdecthreepi_tag)_make.make$(cmt_lock_pid)
cmt_final_setup_make = /tmp/CMT_Jpsdecthreepi_makesetup.make
...
ifdef READONLY
cmt_local_tagfile_make = /tmp/CMT_$(Jpsdecthreepi_tag).make$(cmt_lock_pid)
cmt_final_setup_make = /tmp/CMT_Jpsdecthreepisetup.make
cmt_local_make_makefile = /tmp/CMT_make$(cmt_lock_pid).make
else
...
ifdef READONLY
cmt_local_tagfile_CompilePython = /tmp/CMT_$(Jpsdecthreepi_tag)_CompilePython.make$(cmt_lock_pid)
cmt_final_setup_CompilePython = /tmp/CMT_Jpsdecthreepi_CompilePythonsetup.make
...
ifdef READONLY
cmt_local_tagfile_CompilePython = /tmp/CMT_$(Jpsdecthreepi_tag).make$(cmt_lock_pid)
cmt_final_setup_CompilePython = /tmp/CMT_Jpsdecthreepisetup.make
cmt_local_CompilePython_makefile = /tmp/CMT_CompilePython$(cmt_lock_pid).make
else
...
ifdef READONLY
cmt_local_tagfile_qmtest_run = /tmp/CMT_$(Jpsdecthreepi_tag)_qmtest_run.make$(cmt_lock_pid)
cmt_final_setup_qmtest_run = /tmp/CMT_Jpsdecthreepi_qmtest_runsetup.make
...
ifdef READONLY
cmt_local_tagfile_qmtest_run = /tmp/CMT_$(Jpsdecthreepi_tag).make$(cmt_lock_pid)
cmt_final_setup_qmtest_run = /tmp/CMT_Jpsdecthreepisetup.make
cmt_local_qmtest_run_makefile = /tmp/CMT_qmtest_run$(cmt_lock_pid).make
else
...
ifdef READONLY
cmt_local_tagfile_qmtest_summarize = /tmp/CMT_$(Jpsdecthreepi_tag)_qmtest_summarize.make$(cmt_lock_pid)
cmt_final_setup_qmtest_summarize = /tmp/CMT_Jpsdecthreepi_qmtest_summarizesetup.make
...
ifdef READONLY
cmt_local_tagfile_qmtest_summarize = /tmp/CMT_$(Jpsdecthreepi_tag).make$(cmt_lock_pid)
cmt_final_setup_qmtest_summarize = /tmp/CMT_Jpsdecthreepisetup.make
cmt_local_qmtest_summarize_makefile = /tmp/CMT_qmtest_summarize$(cmt_lock_pid).make
else
...
ifdef READONLY
cmt_local_tagfile_TestPackage = /tmp/CMT_$(Jpsdecthreepi_tag)_TestPackage.make$(cmt_lock_pid)
cmt_final_setup_TestPackage = /tmp/CMT_Jpsdecthreepi_TestPackagesetup.make
...
ifdef READONLY
cmt_local_tagfile_TestPackage = /tmp/CMT_$(Jpsdecthreepi_tag).make$(cmt_lock_pid)
cmt_final_setup_TestPackage = /tmp/CMT_Jpsdecthreepisetup.make
cmt_local_TestPackage_makefile = /tmp/CMT_TestPackage$(cmt_lock_pid).make
else
...
ifdef READONLY
cmt_local_tagfile_TestProject = /tmp/CMT_$(Jpsdecthreepi_tag)_TestProject.make$(cmt_lock_pid)
cmt_final_setup_TestProject = /tmp/CMT_Jpsdecthreepi_TestProjectsetup.make
...
ifdef READONLY
cmt_local_tagfile_TestProject = /tmp/CMT_$(Jpsdecthreepi_tag).make$(cmt_lock_pid)
cmt_final_setup_TestProject = /tmp/CMT_Jpsdecthreepisetup.make
cmt_local_TestProject_makefile = /tmp/CMT_TestProject$(cmt_lock_pid).make
else
...
ifdef READONLY
cmt_local_tagfile_new_rootsys = /tmp/CMT_$(Jpsdecthreepi_tag)_new_rootsys.make$(cmt_lock_pid)
cmt_final_setup_new_rootsys = /tmp/CMT_Jpsdecthreepi_new_rootsyssetup.make
...
ifdef READONLY
cmt_local_tagfile_new_rootsys = /tmp/CMT_$(Jpsdecthreepi_tag).make$(cmt_lock_pid)
cmt_final_setup_new_rootsys = /tmp/CMT_Jpsdecthreepisetup.make
cmt_local_new_rootsys_makefile = /tmp/CMT_new_rootsys$(cmt_lock_pid).make
else
...
ifdef READONLY
cmt_local_tagfile_DatabaseSvc_check_install_scripts = /tmp/CMT_$(Jpsdecthreepi_tag)_DatabaseSvc_check_install_scripts.make$(cmt_lock_pid)
cmt_final_setup_DatabaseSvc_check_install_scripts = /tmp/CMT_Jpsdecthreepi_DatabaseSvc_check_install_scriptssetup.make
...
ifdef READONLY
cmt_local_tagfile_DatabaseSvc_check_install_scripts = /tmp/CMT_$(Jpsdecthreepi_tag).make$(cmt_lock_pid)
cmt_final_setup_DatabaseSvc_check_install_scripts = /tmp/CMT_Jpsdecthreepisetup.make
cmt_local_DatabaseSvc_check_install_scripts_makefile = /tmp/CMT_DatabaseSvc_check_install_scripts$(cmt_lock_pid).make
else
...
$(cmt_local_tagfile_Jpsdecthreepi_check_install_runtime) :
	...
	$(echo) "(constituents.make) Rebuilding setup.make $(cmt_local_tagfile_Jpsdecthreepi_check_install_runtime)"
	@if test -f $(cmt_local_tagfile_Jpsdecthreepi_check_install_runtime); then /bin/rm -f $(cmt_local_tagfile_Jpsdecthreepi_check_install_runtime); fi ; \
	  ...
	  if test -f $(cmt_final_setup_Jpsdecthreepi_check_install_runtime); then /bin/rm -f $(cmt_final_setup_Jpsdecthreepi_check_install_runtime); fi; \
	  $(cmtexe) -tag=$(tags) $(Jpsdecthreepi_check_install_runtime_extratags) show setup >>$(cmt_final_setup_Jpsdecthreepi_check_install_runtime)
	$(echo) setup.make ok
...
Jpsdecthreepi_check_install_runtime :: $(Jpsdecthreepi_check_install_runtime_dependencies) $(cmt_local_Jpsdecthreepi_check_install_runtime_makefile)
	$(echo) "(constituents.make) Creating Jpsdecthreepi_check_install_runtime${lock_suffix} and Starting Jpsdecthreepi_check_install_runtime"
	@${lock_command} Jpsdecthreepi_check_install_runtime${lock_suffix} || exit $$?; \
	  retval=$$?; \
	  trap '${unlock_command} Jpsdecthreepi_check_install_runtime${lock_suffix}; exit $${retval}' 1 2 15; \
	  $(MAKE) -f $(cmt_local_Jpsdecthreepi_check_install_runtime_makefile) cmt_lock_pid=$${cmt_lock_pid} Jpsdecthreepi_check_install_runtime; \
	  retval=$$?; ${unlock_command} Jpsdecthreepi_check_install_runtime${lock_suffix}; exit $${retval}
...
Jpsdecthreepi_check_install_runtimeclean :: $(Jpsdecthreepi_check_install_runtimeclean_dependencies) ##$(cmt_local_Jpsdecthreepi_check_install_runtime_makefile)
	...
	@-if test -f $(cmt_local_Jpsdecthreepi_check_install_runtime_makefile); then \
	  $(MAKE) -f $(cmt_local_Jpsdecthreepi_check_install_runtime_makefile) cmt_lock_pid=$${cmt_lock_pid} Jpsdecthreepi_check_install_runtimeclean; \
	fi
...
Jpsdecthreepi_check_install_runtimeinstall :: $(Jpsdecthreepi_check_install_runtime_dependencies) $(cmt_local_Jpsdecthreepi_check_install_runtime_makefile)
	...
	@-$(MAKE) -f $(cmt_local_Jpsdecthreepi_check_install_runtime_makefile) cmt_lock_pid=$${cmt_lock_pid} install
...
Jpsdecthreepi_check_install_runtimeuninstall :: $(cmt_local_Jpsdecthreepi_check_install_runtime_makefile)
	$(echo) "(constituents.make) Starting uninstall Jpsdecthreepi_check_install_runtime"
	@-$(MAKE) -f $(cmt_local_Jpsdecthreepi_check_install_runtime_makefile) cmt_lock_pid=$${cmt_lock_pid} uninstall
