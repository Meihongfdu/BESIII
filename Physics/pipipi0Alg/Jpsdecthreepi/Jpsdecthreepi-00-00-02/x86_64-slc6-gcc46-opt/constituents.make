...
#cmt_local_tagfile = $(Jpsdecthreepi_tag).make
cmt_local_tagfile = $(bin)$(Jpsdecthreepi_tag).make
...
cmt_local_setup_Jpsdecthreepi = $(bin)setup_Jpsdecthreepi$$$$.make
...
Jpsdecthreepi_extratags = -tag_add=target_Jpsdecthreepi

#$(cmt_local_tagfile_Jpsdecthreepi) : $(cmt_lock_setup)
ifndef QUICK
$(cmt_local_tagfile_Jpsdecthreepi) ::
else
$(cmt_local_tagfile_Jpsdecthreepi) :
endif
	$(echo) "(constituents.make) Rebuilding $@"; \
	  if test -f $(cmt_local_tagfile_Jpsdecthreepi); then /bin/rm -f $(cmt_local_tagfile_Jpsdecthreepi); fi ; \
	  $(cmtexe) -tag=$(tags) $(Jpsdecthreepi_extratags) build tag_makefile >>$(cmt_local_tagfile_Jpsdecthreepi)
	$(echo) "(constituents.make) Rebuilding $(cmt_final_setup_Jpsdecthreepi)"; \
	  test ! -f $(cmt_local_setup_Jpsdecthreepi) || \rm -f $(cmt_local_setup_Jpsdecthreepi); \
	  trap '\rm -f $(cmt_local_setup_Jpsdecthreepi)' 0 1 2 15; \
	  $(cmtexe) -tag=$(tags) $(Jpsdecthreepi_extratags) show setup >$(cmt_local_setup_Jpsdecthreepi) && \
	  if [ -f $(cmt_final_setup_Jpsdecthreepi) ] && \
	    \cmp -s $(cmt_final_setup_Jpsdecthreepi) $(cmt_local_setup_Jpsdecthreepi); then \
	    \rm $(cmt_local_setup_Jpsdecthreepi); else \
	    \mv -f $(cmt_local_setup_Jpsdecthreepi) $(cmt_final_setup_Jpsdecthreepi); fi
...
not_Jpsdecthreepi_dependencies = { n=0; for p in $?; do m=0; for d in $(Jpsdecthreepi_dependencies); do if [ $$p = $$d ]; then m=1; break; fi; done; if [ $$m -eq 0 ]; then n=1; break; fi; done; [ $$n -eq 1 ]; }

ifdef STRUCTURED_OUTPUT
Jpsdecthreepidirs :
	@if test ! -d $(bin)Jpsdecthreepi; then $(mkdir) -p $(bin)Jpsdecthreepi; fi
	$(echo) "STRUCTURED_OUTPUT="$(bin)Jpsdecthreepi
else
Jpsdecthreepidirs : ;
endif
...
#	$(echo) "STRUCTURED_OUTPUT="$(bin)Jpsdecthreepi
#
#$(cmt_local_Jpsdecthreepi_makefile) :: $(Jpsdecthreepi_dependencies) $(cmt_local_tagfile_Jpsdecthreepi) build_library_links dirs Jpsdecthreepidirs
#else
#$(cmt_local_Jpsdecthreepi_makefile) :: $(Jpsdecthreepi_dependencies) $(cmt_local_tagfile_Jpsdecthreepi) build_library_links dirs
#endif
#else
#$(cmt_local_Jpsdecthreepi_makefile) :: $(cmt_local_tagfile_Jpsdecthreepi)
#endif

ifdef cmt_Jpsdecthreepi_has_target_tag

ifndef QUICK
$(cmt_local_Jpsdecthreepi_makefile) : $(Jpsdecthreepi_dependencies) build_library_links
	$(echo) "(constituents.make) Building Jpsdecthreepi.make"; \
	  $(cmtexe) -tag=$(tags) $(Jpsdecthreepi_extratags) build constituent_config -out=$(cmt_local_Jpsdecthreepi_makefile) Jpsdecthreepi
else
$(cmt_local_Jpsdecthreepi_makefile) : $(Jpsdecthreepi_dependencies) $(cmt_build_library_linksstamp) $(use_requirements)
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_Jpsdecthreepi) ] || \
	  [ ! -f $(cmt_final_setup_Jpsdecthreepi) ] || \
	  $(not_Jpsdecthreepi_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
	  echo "$(CMTMSGPREFIX)" "(constituents.make) Building Jpsdecthreepi.make"; \
	  $(cmtexe) -tag=$(tags) $(Jpsdecthreepi_extratags) build constituent_config -out=$(cmt_local_Jpsdecthreepi_makefile) Jpsdecthreepi; \
	  fi
endif
...
$(cmt_local_Jpsdecthreepi_makefile) : $(Jpsdecthreepi_dependencies) build_library_links
	$(echo) "(constituents.make) Building Jpsdecthreepi.make"; \
	  $(cmtexe) -f=$(bin)Jpsdecthreepi.in -tag=$(tags) $(Jpsdecthreepi_extratags) build constituent_makefile -without_cmt -out=$(cmt_local_Jpsdecthreepi_makefile) Jpsdecthreepi
else
$(cmt_local_Jpsdecthreepi_makefile) : $(Jpsdecthreepi_dependencies) $(cmt_build_library_linksstamp) $(bin)Jpsdecthreepi.in
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_Jpsdecthreepi) ] || \
	  [ ! -f $(cmt_final_setup_Jpsdecthreepi) ] || \
	  $(not_Jpsdecthreepi_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
...
#	  $(cmtexe) -tag=$(tags) $(Jpsdecthreepi_extratags) build constituent_makefile -out=$(cmt_local_Jpsdecthreepi_makefile) Jpsdecthreepi

Jpsdecthreepi :: $(Jpsdecthreepi_dependencies) $(cmt_local_Jpsdecthreepi_makefile) dirs Jpsdecthreepidirs
	$(echo) "(constituents.make) Starting Jpsdecthreepi"
	@if test -f $(cmt_local_Jpsdecthreepi_makefile); then \
	  $(MAKE) -f $(cmt_local_Jpsdecthreepi_makefile) Jpsdecthreepi; \
	  fi
#	@$(MAKE) -f $(cmt_local_Jpsdecthreepi_makefile) Jpsdecthreepi
	$(echo) "(constituents.make) Jpsdecthreepi done"

clean :: Jpsdecthreepiclean

Jpsdecthreepiclean :: $(Jpsdecthreepiclean_dependencies) ##$(cmt_local_Jpsdecthreepi_makefile)
	$(echo) "(constituents.make) Starting Jpsdecthreepiclean"
	@-if test -f $(cmt_local_Jpsdecthreepi_makefile); then \
	  $(MAKE) -f $(cmt_local_Jpsdecthreepi_makefile) Jpsdecthreepiclean; \
	fi
	$(echo) "(constituents.make) Jpsdecthreepiclean done"
#	@-$(MAKE) -f $(cmt_local_Jpsdecthreepi_makefile) Jpsdecthreepiclean

##	  /bin/rm -f $(cmt_local_Jpsdecthreepi_makefile) $(bin)Jpsdecthreepi_dependencies.make

install :: Jpsdecthreepiinstall

Jpsdecthreepiinstall :: $(Jpsdecthreepi_dependencies) $(cmt_local_Jpsdecthreepi_makefile)
	$(echo) "(constituents.make) Starting install Jpsdecthreepi"
	@-$(MAKE) -f $(cmt_local_Jpsdecthreepi_makefile) install
	$(echo) "(constituents.make) install Jpsdecthreepi done"

uninstall : Jpsdecthreepiuninstall

$(foreach d,$(Jpsdecthreepi_dependencies),$(eval $(d)uninstall_dependencies += Jpsdecthreepiuninstall))

Jpsdecthreepiuninstall : $(Jpsdecthreepiuninstall_dependencies) ##$(cmt_local_Jpsdecthreepi_makefile)
	$(echo) "(constituents.make) Starting uninstall Jpsdecthreepi"
	@if test -f $(cmt_local_Jpsdecthreepi_makefile); then \
	  $(MAKE) -f $(cmt_local_Jpsdecthreepi_makefile) uninstall; \
	  fi
#	@$(MAKE) -f $(cmt_local_Jpsdecthreepi_makefile) uninstall
	$(echo) "(constituents.make) uninstall Jpsdecthreepi done"

remove_library_links :: Jpsdecthreepiuninstall
...
#cmt_local_tagfile_install_includes = $(Jpsdecthreepi_tag)_install_includes.make
cmt_local_tagfile_install_includes = $(bin)$(Jpsdecthreepi_tag)_install_includes.make
...
#cmt_final_setup_install_includes = $(bin)Jpsdecthreepi_install_includessetup.make
...
#cmt_local_tagfile_install_includes = $(Jpsdecthreepi_tag).make
cmt_local_tagfile_install_includes = $(bin)$(Jpsdecthreepi_tag).make
cmt_final_setup_install_includes = $(bin)setup.make
#cmt_final_setup_install_includes = $(bin)Jpsdecthreepisetup.make
cmt_local_install_includes_makefile = $(bin)install_includes.make
...
#cmt_local_tagfile_make = $(Jpsdecthreepi_tag)_make.make
cmt_local_tagfile_make = $(bin)$(Jpsdecthreepi_tag)_make.make
cmt_local_setup_make = $(bin)setup_make$$$$.make
cmt_final_setup_make = $(bin)setup_make.make
#cmt_final_setup_make = $(bin)Jpsdecthreepi_makesetup.make
...
#cmt_local_tagfile_make = $(Jpsdecthreepi_tag).make
cmt_local_tagfile_make = $(bin)$(Jpsdecthreepi_tag).make
cmt_final_setup_make = $(bin)setup.make
#cmt_final_setup_make = $(bin)Jpsdecthreepisetup.make
cmt_local_make_makefile = $(bin)make.make
...
#cmt_local_tagfile_CompilePython = $(Jpsdecthreepi_tag)_CompilePython.make
cmt_local_tagfile_CompilePython = $(bin)$(Jpsdecthreepi_tag)_CompilePython.make
cmt_local_setup_CompilePython = $(bin)setup_CompilePython$$$$.make
cmt_final_setup_CompilePython = $(bin)setup_CompilePython.make
#cmt_final_setup_CompilePython = $(bin)Jpsdecthreepi_CompilePythonsetup.make
...
#cmt_local_tagfile_CompilePython = $(Jpsdecthreepi_tag).make
cmt_local_tagfile_CompilePython = $(bin)$(Jpsdecthreepi_tag).make
cmt_final_setup_CompilePython = $(bin)setup.make
#cmt_final_setup_CompilePython = $(bin)Jpsdecthreepisetup.make
cmt_local_CompilePython_makefile = $(bin)CompilePython.make
...
#cmt_local_tagfile_qmtest_run = $(Jpsdecthreepi_tag)_qmtest_run.make
cmt_local_tagfile_qmtest_run = $(bin)$(Jpsdecthreepi_tag)_qmtest_run.make
cmt_local_setup_qmtest_run = $(bin)setup_qmtest_run$$$$.make
cmt_final_setup_qmtest_run = $(bin)setup_qmtest_run.make
#cmt_final_setup_qmtest_run = $(bin)Jpsdecthreepi_qmtest_runsetup.make
...
#cmt_local_tagfile_qmtest_run = $(Jpsdecthreepi_tag).make
cmt_local_tagfile_qmtest_run = $(bin)$(Jpsdecthreepi_tag).make
cmt_final_setup_qmtest_run = $(bin)setup.make
#cmt_final_setup_qmtest_run = $(bin)Jpsdecthreepisetup.make
cmt_local_qmtest_run_makefile = $(bin)qmtest_run.make
...
#cmt_local_tagfile_qmtest_summarize = $(Jpsdecthreepi_tag)_qmtest_summarize.make
cmt_local_tagfile_qmtest_summarize = $(bin)$(Jpsdecthreepi_tag)_qmtest_summarize.make
...
#cmt_final_setup_qmtest_summarize = $(bin)Jpsdecthreepi_qmtest_summarizesetup.make
...
#cmt_local_tagfile_qmtest_summarize = $(Jpsdecthreepi_tag).make
cmt_local_tagfile_qmtest_summarize = $(bin)$(Jpsdecthreepi_tag).make
cmt_final_setup_qmtest_summarize = $(bin)setup.make
#cmt_final_setup_qmtest_summarize = $(bin)Jpsdecthreepisetup.make
cmt_local_qmtest_summarize_makefile = $(bin)qmtest_summarize.make
...
#cmt_local_tagfile_TestPackage = $(Jpsdecthreepi_tag)_TestPackage.make
cmt_local_tagfile_TestPackage = $(bin)$(Jpsdecthreepi_tag)_TestPackage.make
cmt_local_setup_TestPackage = $(bin)setup_TestPackage$$$$.make
cmt_final_setup_TestPackage = $(bin)setup_TestPackage.make
#cmt_final_setup_TestPackage = $(bin)Jpsdecthreepi_TestPackagesetup.make
...
#cmt_local_tagfile_TestPackage = $(Jpsdecthreepi_tag).make
cmt_local_tagfile_TestPackage = $(bin)$(Jpsdecthreepi_tag).make
cmt_final_setup_TestPackage = $(bin)setup.make
#cmt_final_setup_TestPackage = $(bin)Jpsdecthreepisetup.make
cmt_local_TestPackage_makefile = $(bin)TestPackage.make
...
#cmt_local_tagfile_TestProject = $(Jpsdecthreepi_tag)_TestProject.make
cmt_local_tagfile_TestProject = $(bin)$(Jpsdecthreepi_tag)_TestProject.make
cmt_local_setup_TestProject = $(bin)setup_TestProject$$$$.make
cmt_final_setup_TestProject = $(bin)setup_TestProject.make
#cmt_final_setup_TestProject = $(bin)Jpsdecthreepi_TestProjectsetup.make
...
#cmt_local_tagfile_TestProject = $(Jpsdecthreepi_tag).make
cmt_local_tagfile_TestProject = $(bin)$(Jpsdecthreepi_tag).make
cmt_final_setup_TestProject = $(bin)setup.make
#cmt_final_setup_TestProject = $(bin)Jpsdecthreepisetup.make
cmt_local_TestProject_makefile = $(bin)TestProject.make
...
#cmt_local_tagfile_new_rootsys = $(Jpsdecthreepi_tag)_new_rootsys.make
cmt_local_tagfile_new_rootsys = $(bin)$(Jpsdecthreepi_tag)_new_rootsys.make
cmt_local_setup_new_rootsys = $(bin)setup_new_rootsys$$$$.make
cmt_final_setup_new_rootsys = $(bin)setup_new_rootsys.make
#cmt_final_setup_new_rootsys = $(bin)Jpsdecthreepi_new_rootsyssetup.make
...
#cmt_local_tagfile_new_rootsys = $(Jpsdecthreepi_tag).make
cmt_local_tagfile_new_rootsys = $(bin)$(Jpsdecthreepi_tag).make
cmt_final_setup_new_rootsys = $(bin)setup.make
#cmt_final_setup_new_rootsys = $(bin)Jpsdecthreepisetup.make
cmt_local_new_rootsys_makefile = $(bin)new_rootsys.make
...
#cmt_local_tagfile_DatabaseSvc_check_install_scripts = $(Jpsdecthreepi_tag)_DatabaseSvc_check_install_scripts.make
cmt_local_tagfile_DatabaseSvc_check_install_scripts = $(bin)$(Jpsdecthreepi_tag)_DatabaseSvc_check_install_scripts.make
...
#cmt_final_setup_DatabaseSvc_check_install_scripts = $(bin)Jpsdecthreepi_DatabaseSvc_check_install_scriptssetup.make
...
#cmt_local_tagfile_DatabaseSvc_check_install_scripts = $(Jpsdecthreepi_tag).make
cmt_local_tagfile_DatabaseSvc_check_install_scripts = $(bin)$(Jpsdecthreepi_tag).make
cmt_final_setup_DatabaseSvc_check_install_scripts = $(bin)setup.make
#cmt_final_setup_DatabaseSvc_check_install_scripts = $(bin)Jpsdecthreepisetup.make
cmt_local_DatabaseSvc_check_install_scripts_makefile = $(bin)DatabaseSvc_check_install_scripts.make
...
cmt_local_setup_Jpsdecthreepi_check_install_runtime = $(bin)setup_Jpsdecthreepi_check_install_runtime$$$$.make
...
Jpsdecthreepi_check_install_runtime_extratags = -tag_add=target_Jpsdecthreepi_check_install_runtime

#$(cmt_local_tagfile_Jpsdecthreepi_check_install_runtime) : $(cmt_lock_setup)
ifndef QUICK
$(cmt_local_tagfile_Jpsdecthreepi_check_install_runtime) ::
else
$(cmt_local_tagfile_Jpsdecthreepi_check_install_runtime) :
endif
	$(echo) "(constituents.make) Rebuilding $@"; \
	  if test -f $(cmt_local_tagfile_Jpsdecthreepi_check_install_runtime); then /bin/rm -f $(cmt_local_tagfile_Jpsdecthreepi_check_install_runtime); fi ; \
	  $(cmtexe) -tag=$(tags) $(Jpsdecthreepi_check_install_runtime_extratags) build tag_makefile >>$(cmt_local_tagfile_Jpsdecthreepi_check_install_runtime)
	$(echo) "(constituents.make) Rebuilding $(cmt_final_setup_Jpsdecthreepi_check_install_runtime)"; \
	  test ! -f $(cmt_local_setup_Jpsdecthreepi_check_install_runtime) || \rm -f $(cmt_local_setup_Jpsdecthreepi_check_install_runtime); \
	  trap '\rm -f $(cmt_local_setup_Jpsdecthreepi_check_install_runtime)' 0 1 2 15; \
	  $(cmtexe) -tag=$(tags) $(Jpsdecthreepi_check_install_runtime_extratags) show setup >$(cmt_local_setup_Jpsdecthreepi_check_install_runtime) && \
	  if [ -f $(cmt_final_setup_Jpsdecthreepi_check_install_runtime) ] && \
	    \cmp -s $(cmt_final_setup_Jpsdecthreepi_check_install_runtime) $(cmt_local_setup_Jpsdecthreepi_check_install_runtime); then \
	    \rm $(cmt_local_setup_Jpsdecthreepi_check_install_runtime); else \
	    \mv -f $(cmt_local_setup_Jpsdecthreepi_check_install_runtime) $(cmt_final_setup_Jpsdecthreepi_check_install_runtime); fi
...
not_Jpsdecthreepi_check_install_runtime_dependencies = { n=0; for p in $?; do m=0; for d in $(Jpsdecthreepi_check_install_runtime_dependencies); do if [ $$p = $$d ]; then m=1; break; fi; done; if [ $$m -eq 0 ]; then n=1; break; fi; done; [ $$n -eq 1 ]; }

ifdef STRUCTURED_OUTPUT
Jpsdecthreepi_check_install_runtimedirs :
	@if test ! -d $(bin)Jpsdecthreepi_check_install_runtime; then $(mkdir) -p $(bin)Jpsdecthreepi_check_install_runtime; fi
	$(echo) "STRUCTURED_OUTPUT="$(bin)Jpsdecthreepi_check_install_runtime
else
Jpsdecthreepi_check_install_runtimedirs : ;
endif
...
#	$(echo) "STRUCTURED_OUTPUT="$(bin)Jpsdecthreepi_check_install_runtime
#
#$(cmt_local_Jpsdecthreepi_check_install_runtime_makefile) :: $(Jpsdecthreepi_check_install_runtime_dependencies) $(cmt_local_tagfile_Jpsdecthreepi_check_install_runtime) build_library_links dirs Jpsdecthreepi_check_install_runtimedirs
#else
#$(cmt_local_Jpsdecthreepi_check_install_runtime_makefile) :: $(Jpsdecthreepi_check_install_runtime_dependencies) $(cmt_local_tagfile_Jpsdecthreepi_check_install_runtime) build_library_links dirs
#endif
#else
#$(cmt_local_Jpsdecthreepi_check_install_runtime_makefile) :: $(cmt_local_tagfile_Jpsdecthreepi_check_install_runtime)
#endif

ifdef cmt_Jpsdecthreepi_check_install_runtime_has_target_tag

ifndef QUICK
$(cmt_local_Jpsdecthreepi_check_install_runtime_makefile) : $(Jpsdecthreepi_check_install_runtime_dependencies) build_library_links
	$(echo) "(constituents.make) Building Jpsdecthreepi_check_install_runtime.make"; \
	  $(cmtexe) -tag=$(tags) $(Jpsdecthreepi_check_install_runtime_extratags) build constituent_config -out=$(cmt_local_Jpsdecthreepi_check_install_runtime_makefile) Jpsdecthreepi_check_install_runtime
else
$(cmt_local_Jpsdecthreepi_check_install_runtime_makefile) : $(Jpsdecthreepi_check_install_runtime_dependencies) $(cmt_build_library_linksstamp) $(use_requirements)
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_Jpsdecthreepi_check_install_runtime) ] || \
	  [ ! -f $(cmt_final_setup_Jpsdecthreepi_check_install_runtime) ] || \
	  $(not_Jpsdecthreepi_check_install_runtime_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
	  echo "$(CMTMSGPREFIX)" "(constituents.make) Building Jpsdecthreepi_check_install_runtime.make"; \
	  $(cmtexe) -tag=$(tags) $(Jpsdecthreepi_check_install_runtime_extratags) build constituent_config -out=$(cmt_local_Jpsdecthreepi_check_install_runtime_makefile) Jpsdecthreepi_check_install_runtime; \
	  fi
endif
...
$(cmt_local_Jpsdecthreepi_check_install_runtime_makefile) : $(Jpsdecthreepi_check_install_runtime_dependencies) build_library_links
	$(echo) "(constituents.make) Building Jpsdecthreepi_check_install_runtime.make"; \
	  $(cmtexe) -f=$(bin)Jpsdecthreepi_check_install_runtime.in -tag=$(tags) $(Jpsdecthreepi_check_install_runtime_extratags) build constituent_makefile -without_cmt -out=$(cmt_local_Jpsdecthreepi_check_install_runtime_makefile) Jpsdecthreepi_check_install_runtime
else
$(cmt_local_Jpsdecthreepi_check_install_runtime_makefile) : $(Jpsdecthreepi_check_install_runtime_dependencies) $(cmt_build_library_linksstamp) $(bin)Jpsdecthreepi_check_install_runtime.in
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_Jpsdecthreepi_check_install_runtime) ] || \
	  [ ! -f $(cmt_final_setup_Jpsdecthreepi_check_install_runtime) ] || \
	  $(not_Jpsdecthreepi_check_install_runtime_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
...
#	  $(cmtexe) -tag=$(tags) $(Jpsdecthreepi_check_install_runtime_extratags) build constituent_makefile -out=$(cmt_local_Jpsdecthreepi_check_install_runtime_makefile) Jpsdecthreepi_check_install_runtime

Jpsdecthreepi_check_install_runtime :: $(Jpsdecthreepi_check_install_runtime_dependencies) $(cmt_local_Jpsdecthreepi_check_install_runtime_makefile) dirs Jpsdecthreepi_check_install_runtimedirs
	$(echo) "(constituents.make) Starting Jpsdecthreepi_check_install_runtime"
	@if test -f $(cmt_local_Jpsdecthreepi_check_install_runtime_makefile); then \
	  $(MAKE) -f $(cmt_local_Jpsdecthreepi_check_install_runtime_makefile) Jpsdecthreepi_check_install_runtime; \
	  fi
#	@$(MAKE) -f $(cmt_local_Jpsdecthreepi_check_install_runtime_makefile) Jpsdecthreepi_check_install_runtime
	$(echo) "(constituents.make) Jpsdecthreepi_check_install_runtime done"

clean :: Jpsdecthreepi_check_install_runtimeclean

Jpsdecthreepi_check_install_runtimeclean :: $(Jpsdecthreepi_check_install_runtimeclean_dependencies) ##$(cmt_local_Jpsdecthreepi_check_install_runtime_makefile)
	$(echo) "(constituents.make) Starting Jpsdecthreepi_check_install_runtimeclean"
	@-if test -f $(cmt_local_Jpsdecthreepi_check_install_runtime_makefile); then \
	  $(MAKE) -f $(cmt_local_Jpsdecthreepi_check_install_runtime_makefile) Jpsdecthreepi_check_install_runtimeclean; \
	fi
	$(echo) "(constituents.make) Jpsdecthreepi_check_install_runtimeclean done"
#	@-$(MAKE) -f $(cmt_local_Jpsdecthreepi_check_install_runtime_makefile) Jpsdecthreepi_check_install_runtimeclean

##	  /bin/rm -f $(cmt_local_Jpsdecthreepi_check_install_runtime_makefile) $(bin)Jpsdecthreepi_check_install_runtime_dependencies.make

install :: Jpsdecthreepi_check_install_runtimeinstall

Jpsdecthreepi_check_install_runtimeinstall :: $(Jpsdecthreepi_check_install_runtime_dependencies) $(cmt_local_Jpsdecthreepi_check_install_runtime_makefile)
	$(echo) "(constituents.make) Starting install Jpsdecthreepi_check_install_runtime"
	@-$(MAKE) -f $(cmt_local_Jpsdecthreepi_check_install_runtime_makefile) install
	$(echo) "(constituents.make) install Jpsdecthreepi_check_install_runtime done"

uninstall : Jpsdecthreepi_check_install_runtimeuninstall

$(foreach d,$(Jpsdecthreepi_check_install_runtime_dependencies),$(eval $(d)uninstall_dependencies += Jpsdecthreepi_check_install_runtimeuninstall))

Jpsdecthreepi_check_install_runtimeuninstall : $(Jpsdecthreepi_check_install_runtimeuninstall_dependencies) ##$(cmt_local_Jpsdecthreepi_check_install_runtime_makefile)
	$(echo) "(constituents.make) Starting uninstall Jpsdecthreepi_check_install_runtime"
	@if test -f $(cmt_local_Jpsdecthreepi_check_install_runtime_makefile); then \
	  $(MAKE) -f $(cmt_local_Jpsdecthreepi_check_install_runtime_makefile) uninstall; \
	  fi
#	@$(MAKE) -f $(cmt_local_Jpsdecthreepi_check_install_runtime_makefile) uninstall
	$(echo) "(constituents.make) uninstall Jpsdecthreepi_check_install_runtime done"

remove_library_links :: Jpsdecthreepi_check_install_runtimeuninstall
