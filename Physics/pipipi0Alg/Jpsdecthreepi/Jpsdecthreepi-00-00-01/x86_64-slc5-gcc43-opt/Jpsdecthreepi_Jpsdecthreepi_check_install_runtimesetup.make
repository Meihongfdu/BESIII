...
use GammaConv GammaConv-00-00-01 Reconstruction (/besfs/users/vindy/cmt6.6.4/workarea/)
----------> tags
...
cmt6.6.4_no_config (from PROJECT) excludes [cmt6.6.4_config]
cmt6.6.4_root (from PROJECT) excludes [cmt6.6.4_no_root]
cmt6.6.4_cleanup (from PROJECT) excludes [cmt6.6.4_no_cleanup]
cmt6.6.4_no_prototypes (from PROJECT) excludes [cmt6.6.4_prototypes]
cmt6.6.4_with_installarea (from PROJECT) excludes [cmt6.6.4_without_installarea]
cmt6.6.4_with_version_directory (from PROJECT) excludes [cmt6.6.4_without_version_directory]
cmt6.6.4 (from PROJECT)
...
target_Jpsdecthreepi_check_install_runtime (from arguments)
...
----------> CMTPATH
# Add path /besfs/users/vindy/cmt6.6.4/workarea from initialization
