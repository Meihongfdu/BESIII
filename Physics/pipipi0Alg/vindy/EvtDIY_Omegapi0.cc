...
#include "EvtGenModels/EvtDIY_Omegapi0.hh"
#include "EvtGenBase/EvtRandom.hh"
#include <string>
using namespace std;  //::endl;

EvtDIY_Omegapi0::~EvtDIY_Omegapi0() {}

void EvtDIY_Omegapi0::getName(std::string& model_name){

  model_name="DIY_Omegapi0";     

}

EvtDecayBase* EvtDIY_Omegapi0::clone(){

  return new EvtDIY_Omegapi0;

}


void EvtDIY_Omegapi0::init(){
...
void EvtDIY_Omegapi0::initProbMax(){
  noProbMax();
}
...
void EvtDIY_Omegapi0::decay( EvtParticle *p ){
