...
#cmt_local_tagfile = $(pipipi0Alg_tag).make
cmt_local_tagfile = $(bin)$(pipipi0Alg_tag).make
...
cmt_local_setup_pipipi0Alg = $(bin)setup_pipipi0Alg$$$$.make
...
pipipi0Alg_extratags = -tag_add=target_pipipi0Alg

#$(cmt_local_tagfile_pipipi0Alg) : $(cmt_lock_setup)
ifndef QUICK
$(cmt_local_tagfile_pipipi0Alg) ::
else
$(cmt_local_tagfile_pipipi0Alg) :
endif
	$(echo) "(constituents.make) Rebuilding $@"; \
	  if test -f $(cmt_local_tagfile_pipipi0Alg); then /bin/rm -f $(cmt_local_tagfile_pipipi0Alg); fi ; \
	  $(cmtexe) -tag=$(tags) $(pipipi0Alg_extratags) build tag_makefile >>$(cmt_local_tagfile_pipipi0Alg)
	$(echo) "(constituents.make) Rebuilding $(cmt_final_setup_pipipi0Alg)"; \
	  test ! -f $(cmt_local_setup_pipipi0Alg) || \rm -f $(cmt_local_setup_pipipi0Alg); \
	  trap '\rm -f $(cmt_local_setup_pipipi0Alg)' 0 1 2 15; \
	  $(cmtexe) -tag=$(tags) $(pipipi0Alg_extratags) show setup >$(cmt_local_setup_pipipi0Alg) && \
	  if [ -f $(cmt_final_setup_pipipi0Alg) ] && \
	    \cmp -s $(cmt_final_setup_pipipi0Alg) $(cmt_local_setup_pipipi0Alg); then \
	    \rm $(cmt_local_setup_pipipi0Alg); else \
	    \mv -f $(cmt_local_setup_pipipi0Alg) $(cmt_final_setup_pipipi0Alg); fi
...
not_pipipi0Alg_dependencies = { n=0; for p in $?; do m=0; for d in $(pipipi0Alg_dependencies); do if [ $$p = $$d ]; then m=1; break; fi; done; if [ $$m -eq 0 ]; then n=1; break; fi; done; [ $$n -eq 1 ]; }

ifdef STRUCTURED_OUTPUT
pipipi0Algdirs :
	@if test ! -d $(bin)pipipi0Alg; then $(mkdir) -p $(bin)pipipi0Alg; fi
	$(echo) "STRUCTURED_OUTPUT="$(bin)pipipi0Alg
else
pipipi0Algdirs : ;
endif
...
#	$(echo) "STRUCTURED_OUTPUT="$(bin)pipipi0Alg
#
#$(cmt_local_pipipi0Alg_makefile) :: $(pipipi0Alg_dependencies) $(cmt_local_tagfile_pipipi0Alg) build_library_links dirs pipipi0Algdirs
#else
#$(cmt_local_pipipi0Alg_makefile) :: $(pipipi0Alg_dependencies) $(cmt_local_tagfile_pipipi0Alg) build_library_links dirs
#endif
#else
#$(cmt_local_pipipi0Alg_makefile) :: $(cmt_local_tagfile_pipipi0Alg)
#endif

ifdef cmt_pipipi0Alg_has_target_tag

ifndef QUICK
$(cmt_local_pipipi0Alg_makefile) : $(pipipi0Alg_dependencies) build_library_links
	$(echo) "(constituents.make) Building pipipi0Alg.make"; \
	  $(cmtexe) -tag=$(tags) $(pipipi0Alg_extratags) build constituent_config -out=$(cmt_local_pipipi0Alg_makefile) pipipi0Alg
else
$(cmt_local_pipipi0Alg_makefile) : $(pipipi0Alg_dependencies) $(cmt_build_library_linksstamp) $(use_requirements)
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_pipipi0Alg) ] || \
	  [ ! -f $(cmt_final_setup_pipipi0Alg) ] || \
	  $(not_pipipi0Alg_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
	  echo "$(CMTMSGPREFIX)" "(constituents.make) Building pipipi0Alg.make"; \
	  $(cmtexe) -tag=$(tags) $(pipipi0Alg_extratags) build constituent_config -out=$(cmt_local_pipipi0Alg_makefile) pipipi0Alg; \
	  fi
endif
...
$(cmt_local_pipipi0Alg_makefile) : $(pipipi0Alg_dependencies) build_library_links
	$(echo) "(constituents.make) Building pipipi0Alg.make"; \
	  $(cmtexe) -f=$(bin)pipipi0Alg.in -tag=$(tags) $(pipipi0Alg_extratags) build constituent_makefile -without_cmt -out=$(cmt_local_pipipi0Alg_makefile) pipipi0Alg
else
$(cmt_local_pipipi0Alg_makefile) : $(pipipi0Alg_dependencies) $(cmt_build_library_linksstamp) $(bin)pipipi0Alg.in
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_pipipi0Alg) ] || \
	  [ ! -f $(cmt_final_setup_pipipi0Alg) ] || \
	  $(not_pipipi0Alg_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
...
#	  $(cmtexe) -tag=$(tags) $(pipipi0Alg_extratags) build constituent_makefile -out=$(cmt_local_pipipi0Alg_makefile) pipipi0Alg

pipipi0Alg :: $(pipipi0Alg_dependencies) $(cmt_local_pipipi0Alg_makefile) dirs pipipi0Algdirs
	$(echo) "(constituents.make) Starting pipipi0Alg"
	@if test -f $(cmt_local_pipipi0Alg_makefile); then \
	  $(MAKE) -f $(cmt_local_pipipi0Alg_makefile) pipipi0Alg; \
	  fi
#	@$(MAKE) -f $(cmt_local_pipipi0Alg_makefile) pipipi0Alg
	$(echo) "(constituents.make) pipipi0Alg done"

clean :: pipipi0Algclean

pipipi0Algclean :: $(pipipi0Algclean_dependencies) ##$(cmt_local_pipipi0Alg_makefile)
	$(echo) "(constituents.make) Starting pipipi0Algclean"
	@-if test -f $(cmt_local_pipipi0Alg_makefile); then \
	  $(MAKE) -f $(cmt_local_pipipi0Alg_makefile) pipipi0Algclean; \
	fi
	$(echo) "(constituents.make) pipipi0Algclean done"
#	@-$(MAKE) -f $(cmt_local_pipipi0Alg_makefile) pipipi0Algclean

##	  /bin/rm -f $(cmt_local_pipipi0Alg_makefile) $(bin)pipipi0Alg_dependencies.make

install :: pipipi0Alginstall

pipipi0Alginstall :: $(pipipi0Alg_dependencies) $(cmt_local_pipipi0Alg_makefile)
	$(echo) "(constituents.make) Starting install pipipi0Alg"
	@-$(MAKE) -f $(cmt_local_pipipi0Alg_makefile) install
	$(echo) "(constituents.make) install pipipi0Alg done"

uninstall : pipipi0Alguninstall

$(foreach d,$(pipipi0Alg_dependencies),$(eval $(d)uninstall_dependencies += pipipi0Alguninstall))

pipipi0Alguninstall : $(pipipi0Alguninstall_dependencies) ##$(cmt_local_pipipi0Alg_makefile)
	$(echo) "(constituents.make) Starting uninstall pipipi0Alg"
	@if test -f $(cmt_local_pipipi0Alg_makefile); then \
	  $(MAKE) -f $(cmt_local_pipipi0Alg_makefile) uninstall; \
	  fi
#	@$(MAKE) -f $(cmt_local_pipipi0Alg_makefile) uninstall
	$(echo) "(constituents.make) uninstall pipipi0Alg done"

remove_library_links :: pipipi0Alguninstall
...
#cmt_local_tagfile_config = $(pipipi0Alg_tag)_config.make
cmt_local_tagfile_config = $(bin)$(pipipi0Alg_tag)_config.make
cmt_local_setup_config = $(bin)setup_config$$$$.make
cmt_final_setup_config = $(bin)setup_config.make
#cmt_final_setup_config = $(bin)pipipi0Alg_configsetup.make
...
#cmt_local_tagfile_config = $(pipipi0Alg_tag).make
cmt_local_tagfile_config = $(bin)$(pipipi0Alg_tag).make
cmt_final_setup_config = $(bin)setup.make
#cmt_final_setup_config = $(bin)pipipi0Algsetup.make
cmt_local_config_makefile = $(bin)config.make
...
#cmt_local_tagfile_install_includes = $(pipipi0Alg_tag)_install_includes.make
cmt_local_tagfile_install_includes = $(bin)$(pipipi0Alg_tag)_install_includes.make
...
#cmt_final_setup_install_includes = $(bin)pipipi0Alg_install_includessetup.make
...
#cmt_local_tagfile_install_includes = $(pipipi0Alg_tag).make
cmt_local_tagfile_install_includes = $(bin)$(pipipi0Alg_tag).make
cmt_final_setup_install_includes = $(bin)setup.make
#cmt_final_setup_install_includes = $(bin)pipipi0Algsetup.make
cmt_local_install_includes_makefile = $(bin)install_includes.make
...
#cmt_local_tagfile_make = $(pipipi0Alg_tag)_make.make
cmt_local_tagfile_make = $(bin)$(pipipi0Alg_tag)_make.make
cmt_local_setup_make = $(bin)setup_make$$$$.make
cmt_final_setup_make = $(bin)setup_make.make
#cmt_final_setup_make = $(bin)pipipi0Alg_makesetup.make
...
#cmt_local_tagfile_make = $(pipipi0Alg_tag).make
cmt_local_tagfile_make = $(bin)$(pipipi0Alg_tag).make
cmt_final_setup_make = $(bin)setup.make
#cmt_final_setup_make = $(bin)pipipi0Algsetup.make
cmt_local_make_makefile = $(bin)make.make
...
#cmt_local_tagfile_CompilePython = $(pipipi0Alg_tag)_CompilePython.make
cmt_local_tagfile_CompilePython = $(bin)$(pipipi0Alg_tag)_CompilePython.make
cmt_local_setup_CompilePython = $(bin)setup_CompilePython$$$$.make
cmt_final_setup_CompilePython = $(bin)setup_CompilePython.make
#cmt_final_setup_CompilePython = $(bin)pipipi0Alg_CompilePythonsetup.make
...
#cmt_local_tagfile_CompilePython = $(pipipi0Alg_tag).make
cmt_local_tagfile_CompilePython = $(bin)$(pipipi0Alg_tag).make
cmt_final_setup_CompilePython = $(bin)setup.make
#cmt_final_setup_CompilePython = $(bin)pipipi0Algsetup.make
cmt_local_CompilePython_makefile = $(bin)CompilePython.make
...
#cmt_local_tagfile_qmtest_run = $(pipipi0Alg_tag)_qmtest_run.make
cmt_local_tagfile_qmtest_run = $(bin)$(pipipi0Alg_tag)_qmtest_run.make
cmt_local_setup_qmtest_run = $(bin)setup_qmtest_run$$$$.make
cmt_final_setup_qmtest_run = $(bin)setup_qmtest_run.make
#cmt_final_setup_qmtest_run = $(bin)pipipi0Alg_qmtest_runsetup.make
...
#cmt_local_tagfile_qmtest_run = $(pipipi0Alg_tag).make
cmt_local_tagfile_qmtest_run = $(bin)$(pipipi0Alg_tag).make
cmt_final_setup_qmtest_run = $(bin)setup.make
#cmt_final_setup_qmtest_run = $(bin)pipipi0Algsetup.make
cmt_local_qmtest_run_makefile = $(bin)qmtest_run.make
...
#cmt_local_tagfile_qmtest_summarize = $(pipipi0Alg_tag)_qmtest_summarize.make
cmt_local_tagfile_qmtest_summarize = $(bin)$(pipipi0Alg_tag)_qmtest_summarize.make
...
#cmt_final_setup_qmtest_summarize = $(bin)pipipi0Alg_qmtest_summarizesetup.make
...
#cmt_local_tagfile_qmtest_summarize = $(pipipi0Alg_tag).make
cmt_local_tagfile_qmtest_summarize = $(bin)$(pipipi0Alg_tag).make
cmt_final_setup_qmtest_summarize = $(bin)setup.make
#cmt_final_setup_qmtest_summarize = $(bin)pipipi0Algsetup.make
cmt_local_qmtest_summarize_makefile = $(bin)qmtest_summarize.make
...
#cmt_local_tagfile_TestPackage = $(pipipi0Alg_tag)_TestPackage.make
cmt_local_tagfile_TestPackage = $(bin)$(pipipi0Alg_tag)_TestPackage.make
cmt_local_setup_TestPackage = $(bin)setup_TestPackage$$$$.make
cmt_final_setup_TestPackage = $(bin)setup_TestPackage.make
#cmt_final_setup_TestPackage = $(bin)pipipi0Alg_TestPackagesetup.make
...
#cmt_local_tagfile_TestPackage = $(pipipi0Alg_tag).make
cmt_local_tagfile_TestPackage = $(bin)$(pipipi0Alg_tag).make
cmt_final_setup_TestPackage = $(bin)setup.make
#cmt_final_setup_TestPackage = $(bin)pipipi0Algsetup.make
cmt_local_TestPackage_makefile = $(bin)TestPackage.make
...
#cmt_local_tagfile_TestProject = $(pipipi0Alg_tag)_TestProject.make
cmt_local_tagfile_TestProject = $(bin)$(pipipi0Alg_tag)_TestProject.make
cmt_local_setup_TestProject = $(bin)setup_TestProject$$$$.make
cmt_final_setup_TestProject = $(bin)setup_TestProject.make
#cmt_final_setup_TestProject = $(bin)pipipi0Alg_TestProjectsetup.make
...
#cmt_local_tagfile_TestProject = $(pipipi0Alg_tag).make
cmt_local_tagfile_TestProject = $(bin)$(pipipi0Alg_tag).make
cmt_final_setup_TestProject = $(bin)setup.make
#cmt_final_setup_TestProject = $(bin)pipipi0Algsetup.make
cmt_local_TestProject_makefile = $(bin)TestProject.make
...
#cmt_local_tagfile_new_rootsys = $(pipipi0Alg_tag)_new_rootsys.make
cmt_local_tagfile_new_rootsys = $(bin)$(pipipi0Alg_tag)_new_rootsys.make
cmt_local_setup_new_rootsys = $(bin)setup_new_rootsys$$$$.make
cmt_final_setup_new_rootsys = $(bin)setup_new_rootsys.make
#cmt_final_setup_new_rootsys = $(bin)pipipi0Alg_new_rootsyssetup.make
...
#cmt_local_tagfile_new_rootsys = $(pipipi0Alg_tag).make
cmt_local_tagfile_new_rootsys = $(bin)$(pipipi0Alg_tag).make
cmt_final_setup_new_rootsys = $(bin)setup.make
#cmt_final_setup_new_rootsys = $(bin)pipipi0Algsetup.make
cmt_local_new_rootsys_makefile = $(bin)new_rootsys.make
...
#cmt_local_tagfile_DatabaseSvc_check_install_scripts = $(pipipi0Alg_tag)_DatabaseSvc_check_install_scripts.make
cmt_local_tagfile_DatabaseSvc_check_install_scripts = $(bin)$(pipipi0Alg_tag)_DatabaseSvc_check_install_scripts.make
...
#cmt_final_setup_DatabaseSvc_check_install_scripts = $(bin)pipipi0Alg_DatabaseSvc_check_install_scriptssetup.make
...
#cmt_local_tagfile_DatabaseSvc_check_install_scripts = $(pipipi0Alg_tag).make
cmt_local_tagfile_DatabaseSvc_check_install_scripts = $(bin)$(pipipi0Alg_tag).make
cmt_final_setup_DatabaseSvc_check_install_scripts = $(bin)setup.make
#cmt_final_setup_DatabaseSvc_check_install_scripts = $(bin)pipipi0Algsetup.make
cmt_local_DatabaseSvc_check_install_scripts_makefile = $(bin)DatabaseSvc_check_install_scripts.make
