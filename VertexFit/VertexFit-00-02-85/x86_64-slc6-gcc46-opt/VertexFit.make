...
#  Library VertexFit
#
#   Generated Mon Mar  1 21:20:50 2021  by liumeihong
#
#====================================
...
$(VertexFitlib) :: $(bin)TrackPool.o $(bin)KalmanVertexFit.o $(bin)FastVertexFit.o $(bin)VertexFit.o $(bin)KinematicFit.o $(bin)BField.o $(bin)GammaShape.o $(bin)KinematicConstraints.o $(bin)VertexDbSvc.o $(bin)WTrackParameter.o $(bin)KalmanKinematicFit.o $(bin)HTrackParameter.o $(bin)Helix.o $(bin)VertexParameter.o $(bin)VertexConstraints.o $(bin)SecondVertexFit.o $(bin)VertexDbSvc_dll.o $(bin)VertexDbSvc_load.o $(bin)test_read.o
	$(lib_echo) library
	$(lib_silent) cd $(bin); \
	  $(ar) $(VertexFitlib) $?
...
VertexFitclean ::
	...
	$(cleanup_silent) cd $(bin); /bin/rm -f $(bin)TrackPool.o $(bin)KalmanVertexFit.o $(bin)FastVertexFit.o $(bin)VertexFit.o $(bin)KinematicFit.o $(bin)BField.o $(bin)GammaShape.o $(bin)KinematicConstraints.o $(bin)VertexDbSvc.o $(bin)WTrackParameter.o $(bin)KalmanKinematicFit.o $(bin)HTrackParameter.o $(bin)Helix.o $(bin)VertexParameter.o $(bin)VertexConstraints.o $(bin)SecondVertexFit.o $(bin)VertexDbSvc_dll.o $(bin)VertexDbSvc_load.o $(bin)test_read.o
